...
function scossdl_off_options() {
	...
	?>
		...
		<p><?php _e( 'The <a href="http://wordpress.org/extend/plugins/cdn-sync-tool/">CDN Sync Tool</a> plugin will help upload files to Amazon S3/Cloudfront if you would rather not depend on origin pull. See the <a href="http://wordpress.org/tags/cdn-sync-tool?forum_id=10">plugin support forum</a> if you have any queries about this plugin.', 'wp-super-cache' ); ?></p>
