...
export const title = __( 'Homepage Posts', 'jetpack' );
...
export const settings = {
	...
	attributes,
	category,
	keywords: [ __( 'posts', 'jetpack' ), __( 'articles', 'jetpack' ), __( 'latest', 'jetpack' ) ],
	description: __( 'A block for displaying homepage posts.', 'jetpack' ),
	styles: [
		{ name: 'default', label: _x( 'Default', 'block style', 'jetpack' ), isDefault: true },
		{ name: 'borders', label: _x( 'Borders', 'block style', 'jetpack' ) },
	],
	supports: {
		html: false,
		align: [ 'wide', 'full' ],
	...
	edit,
	save: () => null, // to use homepage-articles.php
	transforms: {
		from: [
			{
				type: 'block',
