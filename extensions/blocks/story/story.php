...
function render( $attributes ) {
	...
	$get_image_template = function( $media ) {
	...
	$get_video_template = function( $media ) {
		...
		return sprintf(
			'<video
				title="%s"
				type="%s"
				class="wp-story-video intrinsic-ignore wp-video-%d"
				data-id="%d"
				src="%s">
			</video>',
			esc_attr( $media['alt'] ),
	...
	return sprintf(
		'<div class="wp-story aligncenter" data-settings="%s">
