...
export const projectTypes = [ 'packages', 'plugins' ];
// export const projectTypes = [ 'editor-extensions', 'packages', 'plugins' ], // Swap out line above once there's editor-extensions in place.
