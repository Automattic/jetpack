...
- Rsync the Jetpack plugin to server destination and watch for changes: `jetpack rsync jetpack user@your.server.example.com:/home/path/to/wp-content/plugins`
