...
<?php
	...
	if ( !$wp_cache_mobile_enabled && strpos( $scrules, addcslashes( implode( '|', $mobile_browsers ), ' ' ) ) ) {
		...
		false === strpos( $scrules, addcslashes( implode( '|', $mobile_prefixes ), ' ' ) ) ||
		false === strpos( $scrules, addcslashes( implode( '|', $mobile_browsers ), ' ' ) ) ) 
		) {
	?>
...
RewriteCond %{HTTP_user_agent} !^(<?php echo addcslashes( implode( '|', $mobile_prefixes ), ' ' ); ?>).*</pre></div></li></ol></blockquote>
	<?php } ?>
	...
	wsc_mod_rewrite( $mobile_browsers, $mobile_prefixes );
...
function wsc_mod_rewrite( $mobile_browsers, $mobile_prefixes ) {
