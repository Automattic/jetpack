...
<?php
	...
	if ( $cache_enabled ) {
		...
		if ( $_POST[ 'action' ] == 'test' && $valid_nonce ) {
			...
			if ( preg_match( '/(Cached page generated by WP-Super-Cache on) ([0-9]*-[0-9]*-[0-9]* [0-9]*:[0-9]*:[0-9]*)/', $page, $matches1 ) &&
			preg_match( '/(Cached page generated by WP-Super-Cache on) ([0-9]*-[0-9]*-[0-9]* [0-9]*:[0-9]*:[0-9]*)/', $page2, $matches2 ) && $matches1[2] == $matches2[2] ) {
