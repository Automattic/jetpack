		...
		<div id="message" class="updated jp-wpcom-connect__container">
			...
			<div class="jp-wpcom-connect__vertical-nav">
				<div class="jp-wpcom-connect__vertical-nav-container">
					...
					<div class="vertical-menu__feature-item wp-app-logo">
						...
						<span class="vertical-menu__feature-item-label"><?php _e( 'WordPress Apps', 'jetpack' ); ?></span>
					</div>
					<div class="vertical-menu__feature-item">
						<div class="vertical-menu__feature-item-icon">
			...
			<div class="jp-wpcom-connect__content-container">
				...
				<div class="jp-wpcom-connect__slide-two">
					...
					<p><?php _e( 'Jetpack offers detailed stats and insights on your viewers. Make informed decisions about your content and drive more traffic to your site with our related posts and enhanced distribution features.', 'jetpack' ); ?> <a href="https://jetpack.com/features"><?php _e( 'Learn More', 'jetpack' ); ?></a></p>
				...
				<div class="jp-wpcom-connect__slide-three">
					...
					<p><?php _e( 'Jetpack protects your site against brute force attacks and unauthorized logins. We also monitor your site for downtime and keep your plugins updated.', 'jetpack' ); ?> <a href="https://jetpack.com/features"><?php _e( 'Learn More', 'jetpack' ); ?></a></p>
				...
				<div class="jp-wpcom-connect__slide-four">
					...
					<p><?php _e( 'Jetpack automatically optimizes and speeds up images using the global WordPress.com Content Delivery Network (CDN). Let us do the heavy lifting for you by reducing bandwidth usage which could potentially lower your hosting costs.', 'jetpack' ); ?> <a href="https://jetpack.com/features"><?php _e( 'Learn More', 'jetpack' ); ?></a></p>
				...
				<div class="jp-wpcom-connect__slide-five">
					...
					<p><?php _e( 'Publish content, track stats, moderate comments and so much more from anywhere in the world. Our mobile apps are open source, free and available to you on Apple or Android devices once Jetpack is connected to WordPress.com', 'jetpack' ); ?> <a href="https://apps.wordpress.com/"><?php _e( 'Learn More', 'jetpack' ); ?></a></p>
				...
				<div class="jp-wpcom-connect__slide-six">
					...
					<p><?php _e( 'Jetpack includes other features that help you customize your site including Custom CSS, Contact Forms, Galleries and Carousels, Notifications and Subscriptions, Configurable Widgets, and many more. Connect with WordPress.com to get started!', 'jetpack' ); ?> <a href="https://jetpack.com/features"><?php _e( 'Learn More', 'jetpack' ); ?></a></p>
