...
<?php
	...
	function admin_connect_notice() {
		...
		$dismiss_and_deactivate_url = wp_nonce_url(
		...
		<div id="message" class="updated jp-wpcom-connect__container">
			<div class="jp-wpcom-connect__inner-container">
				<a
					href="<?php echo esc_url( $dismiss_and_deactivate_url ); ?>"
				...
				<div class="jp-wpcom-connect__content-container">
					...
					<div class="jp-wpcom-connect__slide jp-wpcom-connect__slide-one jp__slide-is-active">
						...
						<p class="jp-banner__button-container">
							<a
								href="<?php echo $this->build_connect_url( false, false, 'banner' ) ?>"
							...
							<a
								...
								?>">
								<?php _e( 'Start quick tour', 'jetpack' ); ?>
							</a>
						</p>
					</div> <!-- end slide 1 -->
					...
					<div class="jp-wpcom-connect__slide jp-wpcom-connect__slide-six">
						...
						<p>
							<?php
								_e( 'Jetpack includes other features that help you customize your site including 
			...
			<?php if ( in_array( Jetpack_Options::get_option( 'activated' ) , array( 1, 2, 3 ) ) ) : ?>
					<div class="jp-banner__description-container">
						...
						<p class="jp-banner__description">
							<?php
								_e( 'Please connect to or create a WordPress.com account to enable Jetpack, including 
			...
			<?php else : ?>
				<div class="jp-banner__content">
					...
					<p>
						<?php
							_e(
								"It's ready to bring awesome, WordPress.com cloud-powered features to your site.",
								'jetpack'
							);
						?>
						</p>
				...
				<div class="jp-banner__action-container">
					<a href="<?php echo Jetpack::admin_url() ?>" class="jp-banner__button" id="wpcom-connect">
						<?php _e( 'Learn More', 'jetpack' ); ?>
					</a>
				</div>
			<?php endif; ?>
