...
function jetpack_render_tos_blurb() {
	printf(
		__( 'By clicking the button below, you agree to our fascinating <a href="%s" target="_blank">Terms of Service</a> and to <a href="%s" target="_blank">share details</a> with WordPress.com', 'jetpack' ),
