...
function jetpack_render_tos_blurb() {
	printf(
		__( 'By connecting your site you agree to our fascinating <a href="%s" rel="noopener noreferrer" target="_blank">Terms of Service</a> and to <a href="%s" rel="noopener noreferrer" target="_blank">share details</a> with WordPress.com', 'jetpack' ),
