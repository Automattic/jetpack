...
function jetpack_instagram_handler( $matches, $atts, $url ) {
	...
	if ( is_feed() ) {
		...
		return sprintf( '<a href="%s" title="%s" rel="noopener noreferrer" target="_blank"><img src="%s" alt="Instagram Photo" /></a>', esc_url( $url ), esc_attr__( 'View on Instagram', 'jetpack' ), esc_url( $media_url ) );
	}
