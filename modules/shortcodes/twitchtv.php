...
*/
function twitchtv_shortcode( $attr, $content = NULL ) {
        ...
        bump_stats_extras( 'twitchtv', 'shortcode' );
        if ( $video_id > 0 ) {
                // Archive video
...
add_shortcode( 'twitch', 'twitchtv_shortcode' );
add_shortcode( 'twitchtv', 'twitchtv_shortcode' );