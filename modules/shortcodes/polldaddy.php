...
CONTAINER;
			...
			$poll_link = sprintf( '<a href="%s" rel="noopener noreferrer" target="_blank">Take Our Poll</a>', $poll_url );
...
CONTAINER;
			...
			if ( in_array( $type, array( 'iframe', 'button', 'banner', 'slider' ) ) ) {
				...
				$survey_link = sprintf( '<a href="%s" rel="noopener noreferrer" target="_blank">%s</a>', $survey_url, esc_html( $title ) );
