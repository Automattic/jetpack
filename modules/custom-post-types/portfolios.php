	...
	function register_post_types() {
		...
		register_post_type( self::CUSTOM_POST_TYPE, array(
			...
			'labels' => array(
				...
				'items_list_navigation' => esc_html__( 'Project list naviagation',   'jetpack' ),
		...
		register_taxonomy( self::CUSTOM_TAXONOMY_TYPE, self::CUSTOM_POST_TYPE, array(
			...
			'labels'            => array(
				...
				'items_list_navigation' => esc_html__( 'Project type list naviagation', 'jetpack' ),
		...
		register_taxonomy( self::CUSTOM_TAXONOMY_TAG, self::CUSTOM_POST_TYPE, array(
			...
			'labels'            => array(
				...
				'items_list_navigation'      => esc_html__( 'Project tag list naviagation',   'jetpack' ),
