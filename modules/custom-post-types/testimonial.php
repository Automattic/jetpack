...
class Jetpack_Testimonial {
	...
	function maybe_register_cpt() {
		...
		add_action( 'template_redirect',                                         array( $this, 'maybe_set_infinite_scroll_posts_per_page' ), 9 );
	...
	/*
	 * Possibly adjust infinite scroll settings if we're on CPT or custom taxonomy archive.
	 */
	function maybe_set_infinite_scroll_posts_per_page() {
		global $wp_query;
