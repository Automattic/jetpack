...
class Grunion_Contact_Form_Field extends Crunion_Contact_Form_Shortcode {
	...
	function render() {
		...
		$field_class       = ( ! empty( $class ) ) ? ' ' . esc_attr( $class ) : '';
		...
		case 'email' :
			...
			$r .= "\t\t<input type='email' name='" . esc_attr( $field_id ) . "' id='" . esc_attr( $field_id ) . "' value='" . esc_attr( $field_value ) . "' class='email"  . $field_class . "' " . $field_placeholder . ( $field_required ? "required aria-required='true'" : "" ) . "/>\n";
			$r .= "\t</div>\n";
			break;
		case 'telephone' :
			$r .= "\n<div>\n";
			...
			$r .= "\t\t<input type='tel' name='" . esc_attr( $field_id ) . "' id='" . esc_attr( $field_id ) . "' value='" . esc_attr( $field_value ) . "' class='telephone' " . $field_class . "' " . $field_placeholder . "/>\n";
		case 'textarea' :
			$r .= "\n<div>\n";
			...
			$r .= "\t\t<textarea name='" . esc_attr( $field_id ) . "' id='contact-form-comment-" . esc_attr( $field_id ) . "' rows='20' " . ( ! empty( $class ) ? "class='" . $field_class . "'" : ' ' ) . $field_placeholder . " " . ( $field_required ? "required aria-required='true'" : "" ) . ">" . esc_textarea( $field_value ) . "</textarea>\n";
			$r .= "\t</div>\n";
			break;
		case 'radio' :
			...
			foreach ( $this->get_attribute( 'options' ) as $option ) {
				...
				$r .= "<input type='radio' name='" . esc_attr( $field_id ) . "' value='" . esc_attr( $option ) . "' class='radio" . $field_class . "' " . checked( $option, $field_value, false ) . " " . ( $field_required ? "required aria-required='true'" : "" ) . "/> ";
		...
		case 'checkbox' :
			...
			$r .= "\t\t<input type='checkbox' name='" . esc_attr( $field_id ) . "' value='" . esc_attr__( 'Yes', 'jetpack' ) . "' class='checkbox" . $field_class . "' " . checked( (bool) $field_value, true, false ) . " " . ( $field_required ? "required aria-required='true'" : "" ) . "/> \n";
		...
		case 'checkbox-multiple' :
			...
			foreach ( $this->get_attribute( 'options' ) as $option ) {
				...
				$r .= "<input type='checkbox' name='" . esc_attr( $field_id ) . "[]' value='" . esc_attr( $option ) . "' class='checkbox-multiple" . $field_class . "' " . checked( in_array( $option, (array) $field_value ), true, false ) . " /> ";
				$r .= esc_html( $option ) . "</label>\n";
				$r .= "\t\t<div class='clear-form'></div>\n";
			}
			$r .= "\t\t</div>\n";
		...
		case 'select' :
			...
			$r .= "\t<select name='" . esc_attr( $field_id ) . "' id='" . esc_attr( $field_id ) . "' class='select" . $field_class . "' " . ( $field_required ? "required aria-required='true'" : "" ) . ">\n";
			foreach ( $this->get_attribute( 'options' ) as $option ) {
				$option = Grunion_Contact_Form_Plugin::strip_tags( $option );
		...
		case 'date' :
			...
			$r .= "\t\t<input type='date' name='" . esc_attr( $field_id ) . "' id='" . esc_attr( $field_id ) . "' value='" . esc_attr( $field_value ) . "' class='" . esc_attr( $field_type ) . $field_class . "' " . ( $field_required ? "required aria-required='true'" : "" ) . "/>\n";
			$r .= "\t</div>\n";
		...
		default : // text field
			...
			$r .= "\n<div>\n";
			$r .= "\t\t<label for='" . esc_attr( $field_id ) . "' class='grunion-field-label " . esc_attr( $field_type ) . ( $this->is_error() ? ' form-error' : '' ) . "'>" . esc_html( $field_label ) . ( $field_required ? '<span>' . $required_field_text . '</span>' : '' ) . "</label>\n";
			$r .= "\t\t<input type='text' name='" . esc_attr( $field_id ) . "' id='" . esc_attr( $field_id ) . "' value='" . esc_attr( $field_value ) . "' class='" . esc_attr( $field_type ) . $field_class . "' " . $field_placeholder . ( $field_required ? "required aria-required='true'" : "" ) . "/>\n";
			$r .= "\t</div>\n";
		}
