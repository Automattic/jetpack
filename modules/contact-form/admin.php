...
function menu_alter() {
	...
	.jetpack-contact-form-icon { background: url("' . GRUNION_PLUGIN_URL . 'images/grunion-form.png") no-repeat; width: 16px; height: 16px; display: inline-block; vertical-align: middle; }
