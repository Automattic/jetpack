	...
	class Jetpack_Protect_Math_Authenticate {
		...
		static function math_authenticate() {
			...
			if ( ! $correct_ans && ! isset( $_POST['jetpack_protect_answer'] ) ) {
				...
				wp_die( __( '<strong>This site is not properly configured.</strong> Please ask this site\'s web developer to review <a href="http://bruteprotect.com/faqs/error-bp100/">for information on how to resolve this issue</a>.', 'jetpack' ) );
