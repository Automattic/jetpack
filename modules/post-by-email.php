				...
				if ( $this->check_user_connection() ) {
					...
					<div id="jp-pbe-info"<?php echo $info_hidden; ?>>
						<p id="jp-pbe-email-wrapper">
							...
							<span class="description"><a rel="noopener noreferrer" target="_blank" href="http://jetpack.com/support/post-by-email/"><?php esc_html_e( 'More information', 'jetpack' ); ?></a></span>
						</p>
						<p>
