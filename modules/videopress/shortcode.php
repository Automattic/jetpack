 ...
 */
function videopress_add_video_embed_hander() {
...
// We're running this right now, we just encapsulated it above for better documentation.
videopress_add_video_embed_hander();
