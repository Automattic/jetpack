...
class VideoPress_Player {
	...
	private function html_age_gate() {
		...
		$html .= '</fieldset>';
		$html .= '<p style="padding-top:20px;padding-bottom:60px;text-align:' . $text_align . ';"><a rel="noopener noreferrer" href="http://videopress.com/" target="_blank" style="color:rgb(128,128,128);text-decoration:underline;font-size:15px">' . __( 'More information', 'jetpack' ) . '</a></p>';
	...
	private function html5_static() {
		...
		if ( isset( $this->options['freedom'] ) && $this->options['freedom'] === true )
			$html .= '<p class="robots-nocontent">' . sprintf( __( 'You do not have sufficient <a rel="noopener noreferrer" href="%s" target="_blank">freedom levels</a> to view this video. Support free software and upgrade.', 'jetpack' ), 'http://www.gnu.org/philosophy/free-sw.html' ) . '</p>';
	...
	private function flash_object() {
		...
		$flash_help = sprintf( __( 'This video requires <a rel="noopener noreferrer" href="%s" target="_blank">Adobe Flash</a> for playback.', 'jetpack' ), 'http://www.adobe.com/go/getflashplayer');
