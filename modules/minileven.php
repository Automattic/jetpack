...
function minileven_configuration_screen() {
	...
	<a href="https://wordpress.org/mobile/" rel="noopener noreferrer" target="_blank"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>/minileven/images/wp-app-devices.png" width="332" height="73" /></a>
	<p><?php printf( __( 'We have apps for <a href="%s" rel="noopener noreferrer" target="_blank">iOS (iPhone, iPad, iPod Touch) and Android</a>!', 'jetpack' ), 'https://apps.wordpress.org/' ); ?></p>
	<?php
}
