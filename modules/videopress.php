...
include_once __DIR__ . '/videopress/shortcode.php';
include_once __DIR__ . '/videopress/class.videopress-options.php';
include_once __DIR__ . '/videopress/class.videopress-scheduler.php';
include_once __DIR__ . '/videopress/class.videopress-xmlrpc.php';
include_once __DIR__ . '/videopress/class.videopress-cli.php';
include_once __DIR__ . '/videopress/class.jetpack-videopress.php';
