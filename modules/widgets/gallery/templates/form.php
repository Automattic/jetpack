...
<p class="gallery-widget-link-wrapper">
	<label for="<?php echo $this->get_field_id( 'link' ); ?>"><?php esc_html_e( 'Link To:' ); ?></label>
	<select name="<?php echo $this->get_field_name( 'link' ); ?>" id="<?php echo $this->get_field_id( 'link' ); ?>" class="widefat">
		<?php foreach ( $allowed_values['link'] as $key => $label ) {
			...
			<option value="<?php echo $key; ?>" <?php echo $selected; ?>><?php esc_html_e( $label ); ?></option>
		<?php } ?>
	</select>
</p>

<p>
	<label for="<?php echo $this->get_field_id( 'random' ); ?>"><?php esc_html_e( 'Random Order:' ); ?></label>
	<?php $checked = '';
...
<p class="gallery-widget-style-wrapper">
	<label for="<?php echo $this->get_field_id( 'type' ); ?>"><?php esc_html_e( 'Style:' ); ?></label>
