...
class Admin_Color_Schemes {
	...
	public function register_admin_color_schemes() {
		...
		wp_admin_css_color(
			'aquatic',
			__( 'Aquatic', 'jetpack' ),
			plugins_url( 'colors/aquatic/colors.min.css', __FILE__ ),
		...
		wp_admin_css_color(
			...
			plugins_url( 'colors/classic-blue/colors.min.css', __FILE__ ),
		...
		wp_admin_css_color(
			...
			plugins_url( 'colors/classic-bright/colors.min.css', __FILE__ ),
		...
		wp_admin_css_color(
			...
			plugins_url( 'colors/classic-dark/colors.min.css', __FILE__ ),
		...
		wp_admin_css_color(
			'contrast',
			__( 'Contrast', 'jetpack' ),
			plugins_url( 'colors/contrast/colors.min.css', __FILE__ ),
		...
		wp_admin_css_color(
			...
			plugins_url( 'colors/nightfall/colors.min.css', __FILE__ ),
		...
		wp_admin_css_color(
			...
			plugins_url( 'colors/powder-snow/colors.min.css', __FILE__ ),
		...
		wp_admin_css_color(
			'sakura',
			__( 'Sakura', 'jetpack' ),
			plugins_url( 'colors/sakura/colors.min.css', __FILE__ ),
		...
		wp_admin_css_color(
			'sunset',
			__( 'Sunset', 'jetpack' ),
			plugins_url( 'colors/sunset/colors.min.css', __FILE__ ),
