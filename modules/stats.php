...
/**
 * Fetches stats from the /wpcom/v2 REST API endpoint.  Caches locally for 5 minutes.
 *
 * @param  string $resource Resource.
 * @return string
 */
function stats_get_from_wpcom_v2_restapi( $args = array(), $resource = '' ) {
	...
	// Do the dirty work.
	$response = Jetpack_Client::wpcom_json_api_request_as_user( $endpoint, $api_version, $args );
