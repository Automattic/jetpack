...
import SearchResultEngagement from './search-result-engagement';
...
import { RESULT_FORMAT_ENGAGEMENT, RESULT_FORMAT_PRODUCT } from '../lib/constants';
...
class SearchResult extends Component {
	...
	render() {
		...
		} else if ( this.props.resultFormat === RESULT_FORMAT_ENGAGEMENT ) {
			return <SearchResultEngagement onClick={ this.onClick } { ...this.props } />;
		}
