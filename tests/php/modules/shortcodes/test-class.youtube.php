...
class WP_Test_Jetpack_Shortcodes_Youtube extends WP_UnitTestCase {
	...
	public function test_jetpack_amp_youtube_shortcode( $url, $expected ) {
		...
		$this->assertEquals( $expected, youtube_id( $url ) );
	}
