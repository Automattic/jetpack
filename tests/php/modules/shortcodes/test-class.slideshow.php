	...
	public function get_slideshow_shortcode_amp() {
		return array(
			'without_autostart_attribute' => array(
				...
				'<div class="wp-block-jetpack-slideshow wp-amp-block wp-block-jetpack-slideshow__autoplay wp-block-jetpack-slideshow__autoplay-playing" id="wp-block-jetpack-slideshow__1"><div class="wp-block-jetpack-slideshow_container swiper-container"><amp-carousel width="800" height="600" layout="responsive" type="slides" data-next-button-aria-label="Next Slide" data-prev-button-aria-label="Previous Slide" controls loop autoplay delay=3000 id="wp-block-jetpack-slideshow__amp-carousel__1" on="slideChange:wp-block-jetpack-slideshow__amp-pagination__1.toggle(index=event.index, value=true)"><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div></amp-carousel><a aria-label="Pause Slideshow" class="wp-block-jetpack-slideshow_button-pause" role="button" on="tap:wp-block-jetpack-slideshow__amp-carousel__1.toggleAutoplay(toggleOn=false),wp-block-jetpack-slideshow__1.toggleClass(class=wp-block-jetpack-slideshow__autoplay-playing,force=false)"></a><a aria-label="Play Slideshow" class="wp-block-jetpack-slideshow_button-play" role="button" on="tap:wp-block-jetpack-slideshow__amp-carousel__1.toggleAutoplay(toggleOn=true),wp-block-jetpack-slideshow__1.toggleClass(class=wp-block-jetpack-slideshow__autoplay-playing,force=true)"></a><amp-selector id="wp-block-jetpack-slideshow__amp-pagination__1" class="wp-block-jetpack-slideshow_pagination swiper-pagination swiper-pagination-bullets amp-pagination" on="select:wp-block-jetpack-slideshow__amp-carousel__1.goToSlide(index=event.targetOption)" layout="container"><button option="0" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 1" selected></button><button option="1" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 2" ></button><button option="2" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 3" ></button><button option="3" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 4" ></button><button option="4" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 5" ></button><button option="5" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 6" ></button><button option="6" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 7" ></button><button option="7" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 8" ></button><button option="8" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 9" ></button><button option="9" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 10" ></button><button option="10" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 11" ></button><button option="11" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 12" ></button><button option="12" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 13" ></button><button option="13" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 14" ></button></amp-selector></div></div>',
			),
			'with_autostart_attribute'    => array(
				'[gallery type="slideshow" ids="' . $this->ids . '" autostart="true"]',
				'<div class="wp-block-jetpack-slideshow wp-amp-block wp-block-jetpack-slideshow__autoplay wp-block-jetpack-slideshow__autoplay-playing" id="wp-block-jetpack-slideshow__2"><div class="wp-block-jetpack-slideshow_container swiper-container"><amp-carousel width="800" height="600" layout="responsive" type="slides" data-next-button-aria-label="Next Slide" data-prev-button-aria-label="Previous Slide" controls loop autoplay delay=3000 id="wp-block-jetpack-slideshow__amp-carousel__2" on="slideChange:wp-block-jetpack-slideshow__amp-pagination__2.toggle(index=event.index, value=true)"><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_2}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div><div class="wp-block-jetpack-slideshow_slide"><figure><img width="1" height="1" src="{{url_1}}" class="wp-block-jetpack-slideshow_image" alt="" object-fit="contain" /></figure></div></amp-carousel><a aria-label="Pause Slideshow" class="wp-block-jetpack-slideshow_button-pause" role="button" on="tap:wp-block-jetpack-slideshow__amp-carousel__2.toggleAutoplay(toggleOn=false),wp-block-jetpack-slideshow__2.toggleClass(class=wp-block-jetpack-slideshow__autoplay-playing,force=false)"></a><a aria-label="Play Slideshow" class="wp-block-jetpack-slideshow_button-play" role="button" on="tap:wp-block-jetpack-slideshow__amp-carousel__2.toggleAutoplay(toggleOn=true),wp-block-jetpack-slideshow__2.toggleClass(class=wp-block-jetpack-slideshow__autoplay-playing,force=true)"></a><amp-selector id="wp-block-jetpack-slideshow__amp-pagination__2" class="wp-block-jetpack-slideshow_pagination swiper-pagination swiper-pagination-bullets amp-pagination" on="select:wp-block-jetpack-slideshow__amp-carousel__2.goToSlide(index=event.targetOption)" layout="container"><button option="0" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 1" selected></button><button option="1" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 2" ></button><button option="2" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 3" ></button><button option="3" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 4" ></button><button option="4" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 5" ></button><button option="5" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 6" ></button><button option="6" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 7" ></button><button option="7" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 8" ></button><button option="8" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 9" ></button><button option="9" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 10" ></button><button option="10" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 11" ></button><button option="11" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 12" ></button><button option="12" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 13" ></button><button option="13" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 14" ></button><button option="14" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 15" ></button><button option="15" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 16" ></button></amp-selector></div></div>',
			),
