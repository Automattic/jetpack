	...
	render() {
		return (
			<div>
				...
				<SocialLogo icon="bluesky" size={ 48 } onClick={ this.handleClick.bind( this, 'bluesky' ) } />
				...
				<SocialLogo icon="fediverse" size={ 48 } onClick={ this.handleClick.bind( this, 'fediverse' ) } />
				...
				<SocialLogo icon="mastodon" size={ 48 } onClick={ this.handleClick.bind( this, 'mastodon' ) } />
				...
				<SocialLogo icon="nextdoor" size={ 48 } onClick={ this.handleClick.bind( this, 'nextdoor' ) } />
				...
				<SocialLogo icon="sms" size={ 48 } onClick={ this.handleClick.bind( this, 'sms' ) } />
