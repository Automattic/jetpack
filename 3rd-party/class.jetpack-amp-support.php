...
if ( ! class_exists( 'Jetpack_AMP_Support' ) ) {
	...
	class Jetpack_AMP_Support {
		 ...
		 * Is AMP Canonical?
		 *
		 * @return boolean Is AMP Canonical.
		 */
		 ...
		 * Is Supported Widget.
		 *
		 * @param  string $widget_path Widget Path.
		 */
		...
		/**
		 * AMP Disable The Content Filters.
		 *
		 * @return [type] [description]
		 */
		...
		static function add_site_icon_to_metadata( $metadata ) {
			...
			} elseif ( $site_icon_url = Jetpack_Sync_Functions::site_icon_url( $size ) ) {
				$metadata['publisher']['logo'] = array(
					'@type'  => 'ImageObject',
					'url'    => $site_icon_url,
					'width'  => $size,
		...
		/**
		 * VideoPress Enable Freedom Mode.
		 *
		 ...
		 * Render Sharing HTML.
		 *
		 * @param  [type] $markup          Markup.
		 * @param  [type] $sharing_enabled Sharing Enabled.
		 * @return [type]                  [description]
		 */
