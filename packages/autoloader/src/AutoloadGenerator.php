...
function enqueue_packages_$suffix() {
	...
	if ( function_exists( 'has_action') && function_exists( 'did_action' ) && ! did_action( 'plugins_loaded' ) && ! has_action( 'plugins_loaded', __NAMESPACE__ . '\\file_loader' ) ) {
