...
class AutoloadGenerator extends BaseGenerator {
	...
	public function dump(
		...
		file_put_contents( $vendorPath . '/autoload_meta.php', $this->getAutoloadMeta( $mainPackage ) );
		$this->io->writeError( '<info>Generated ' . $vendorPath . '/autoload_meta.php</info>', true );
	}
...
FILE_CODE;
	...
	/**
	 * Take the main package object and generate the package metadata file to be later used by
	 * the autoloader to determine loading precedence.
	 *
	 * @param PackageInterface $mainPackage the main package object.
	 *
	 * @return string $metadata
	 */
	private function getAutoloadMeta( PackageInterface $mainPackage ) {

		$version = $mainPackage->getVersion();

		return <<<INCLUDE_META
<?php

// This file `autoload_meta.php` was auto generated by automattic/jetpack-autoloader.
...
function enqueue_packages_$suffix() {
	...
	\$package_meta = require_once dirname( __FILE__ ) . '/composer/autoload_meta.php';
