...
class Defaults {
	...
	static $default_callable_whitelist = array(
		...
		'main_network_site'                => array( __NAMESPACE__ . '\\Functions', 'main_network_site_url' ),
		'site_url'                         => array( __NAMESPACE__ . '\\Functions', 'site_url' ),
		'home_url'                         => array( __NAMESPACE__ . '\\Functions', 'home_url' ),
		'single_user_site'                 => array( '\\Jetpack', 'is_single_user_site' ),
		'updates'                          => array( '\\Jetpack', 'get_updates' ),
		'has_file_system_write_access'     => array( __NAMESPACE__ . '\\Functions', 'file_system_write_access' ),
		'is_version_controlled'            => array( __NAMESPACE__ . '\\Functions', 'is_version_controlled' ),
		'taxonomies'                       => array( __NAMESPACE__ . '\\Functions', 'get_taxonomies' ),
		'post_types'                       => array( __NAMESPACE__ . '\\Functions', 'get_post_types' ),
		'post_type_features'               => array( __NAMESPACE__ . '\\Functions', 'get_post_type_features' ),
		'shortcodes'                       => array( __NAMESPACE__ . '\\Functions', 'get_shortcodes' ),
		'rest_api_allowed_post_types'      => array( __NAMESPACE__ . '\\Functions', 'rest_api_allowed_post_types' ),
		'rest_api_allowed_public_metadata' => array( __NAMESPACE__ . '\\Functions', 'rest_api_allowed_public_metadata' ),
		...
		'locale'                           => '\\get_locale',
		'site_icon_url'                    => array( __NAMESPACE__ . '\\Functions', 'site_icon_url' ),
		'roles'                            => array( __NAMESPACE__ . '\\Functions', 'roles' ),
		'timezone'                         => array( __NAMESPACE__ . '\\Functions', 'get_timezone' ),
		'available_jetpack_blocks'         => array( '\\Jetpack_Gutenberg', 'get_availability' ), // Includes both Gutenberg blocks *and* plugins
		'paused_themes'                    => array( __NAMESPACE__ . '\\Functions', 'get_paused_themes' ),
		'paused_plugins'                   => array( __NAMESPACE__ . '\\Functions', 'get_paused_plugins' ),
	);
