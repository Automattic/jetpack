...
class Actions {
	...
	public static function should_initialize_sender() {
		...
		// Disable Sync on IXR Requests from Jetpack Rewind.
		// This is to protect sites and hosts from infinite request loops
		// generated by plugins that unexpectedly create a post on every request.
		// see https://wp.me/p7H4VZ-2FT .
