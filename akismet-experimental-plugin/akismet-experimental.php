 ...
 * Description: Internal R&D — experimental admin UI for Akismet. NOT for production. See MODERNIZATION_NOTES.md.
 * Version: 0.1.0
...
// Production sites do not define `AKISMET_EXPERIMENTAL_UI`, so this is a no-op for them.
