...
1. Once someone on your team has approved the changes, then it's ready to merge. If you need an extra review from someone familiar with the codebase, you can update the labels from **<span class="label status-needs-team-review">[Status] Needs Team Review</span>** to **<span class="label status-needs-review">[Status] Needs Review</span>**, and in that case Jetpack Approvers will do a final review of your Pull Request.
