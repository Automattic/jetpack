...
1. If you have [Composer installed](https://getcomposer.org/), you can run `composer install` and `vendor/bin/phpcs [directory or files updated]` to check your changes against WordPress coding standards. Many files are fully within the standard yet, but please ensure your changes respect current coding standards.
