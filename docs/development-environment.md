...
If you're ready to start, you should see all green `ok` or `yes` messages. If the script detects issues, you will see a red message indicating if you do not have a requirement or have a version outside of the expected range, along with a link to help you address the issue.
