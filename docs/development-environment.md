...
If you're ready to start, you should see all green `ok` or `yes` messages. If the script detects issues, you will see a red `no` message and a link that will help you figure out what you need to change/fix to address the issue.
