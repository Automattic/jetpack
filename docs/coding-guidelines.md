...
- Sanitize URLs, attributes, everything. VIP has this nice [article about the topic](https://vip.wordpress.com/documentation/vip/best-practices/security/validating-sanitizing-escaping/).
...
- Some Widgets ported from WPCOM must only be registered if Jetpack is connected.
