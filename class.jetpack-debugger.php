	...
	public static function jetpack_debug_display_handler() {
		...
		<div class="wrap">
			...
			<div class="entry-content">
				...
				<ol>
					<li><b><em><?php esc_html_e( 'A known issue.', 'jetpack' ); ?></em></b>  <?php echo sprintf( __( 'Some themes and plugins have <a href="%1$s" rel="noopener noreferrer" target="_blank">known conflicts</a> with Jetpack – check the <a href="%2$s" rel="noopener noreferrer" target="_blank">list</a>. (You can also browse the <a href="%3$s" rel="noopener noreferrer" target="_blank">Jetpack support pages</a> or <a href="%4$s" rel="noopener noreferrer" target="_blank">Jetpack support forum</a> to see if others have experienced and solved the problem.)', 'jetpack' ), 'http://jetpack.com/support/getting-started-with-jetpack/known-issues/', 'http://jetpack.com/support/getting-started-with-jetpack/known-issues/', 'http://jetpack.com/support/', 'https://wordpress.org/support/plugin/jetpack' ); ?></li>
