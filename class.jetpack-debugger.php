...
class Jetpack_Debugger {
	...
	<?php echo esc_html( is_wp_error( $test_info['result'] ) ? $test_info['result']->get_error_message() : print_r( $test_info['result'], 1 ) ); ?></pre>
			...
			<div class="entry-content">
				...
				<ol>
					<li><b><em><?php esc_html_e( 'A known issue.', 'jetpack' ); ?></em></b>  <?php echo sprintf( __( 'Some themes and plugins have <a href="%1$s" target="_blank">known conflicts</a> with Jetpack – check the <a href="%2$s" target="_blank">list</a>. (You can also browse the <a href="%3$s" target="_blank">Jetpack support pages</a> or <a href="%4$s" target="_blank">Jetpack support forum</a> to see if others have experienced and solved the problem.)', 'jetpack' ), 'https://jetpack.com/support/getting-started-with-jetpack/known-issues/', 'https://jetpack.com/support/getting-started-with-jetpack/known-issues/', 'https://jetpack.com/support/', 'https://wordpress.org/support/plugin/jetpack' ); ?></li>
