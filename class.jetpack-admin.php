...
class Jetpack_Admin {
	...
	function admin_styles() {
		...
		wp_enqueue_style( 'jetpack-admin', plugins_url( '_inc/jetpack-admin.css', __FILE__ ), array( 'genericons' ), JETPACK__VERSION . '-20121016' );
	}
	...
	function admin_page() {
		...
		<div class="module-grid">
			...
			<div class="jp-filter" id="jp-filters">
				...
				<a href="#" id="popular" data-filter="pop"><?php esc_html_e( 'Popular', 'jetpack' ); ?></a>
			</div>
		...
		<div class="page-content configure">
			...
			<div class="frame bottom">
				<div class="wrap">
					...
					<div class="manage-left">
						<table class="table table-bordered wp-list-table <?php echo implode( ' ', $list_table->get_table_classes() ); ?>">
							<tbody id="the-list">
