...
new WPCOM_JSON_API_Site_Settings_V1_4_Endpoint( array(
	...
	'request_format'  => array(
		...
		'jetpack_google_my_business_keyring_id' => '(int) The Keyring token ID for a Google My Business token to associate with the site',
		'jetpack_google_my_business_location_id' => '(string) The Keyring external user ID representing the associated Google My Business location for this site',
