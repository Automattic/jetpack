...
- For work under `projects/js-packages/charts/`, follow `projects/js-packages/charts/AGENTS.md`.
- When working on charts docs and stories, also follow `projects/js-packages/charts/docs/ai-documentation-guide.md`.
