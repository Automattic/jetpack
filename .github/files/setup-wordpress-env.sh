...
case "$WP_BRANCH" in
	master)
		git clone --depth=1 --branch trac-46149/test-bootstrap-improve-for-plugins-themes https://github.com/jrfnl/wordpress-develop-official.git /tmp/wordpress-master
		;;
	latest)
