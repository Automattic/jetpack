...
//abstract endpoints
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-post-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-comment-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-taxonomy-endpoint.php' );


require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-delete-media-endpoint.php' );
...
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-list-embeds-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-get-site-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-get-taxonomies-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-get-taxonomy-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-list-comments-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-list-media-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-list-posts-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-list-users-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-update-comment-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-update-media-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-update-post-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-update-taxonomy-endpoint.php' );
require_once( __DIR__ . '/json-endpoints/class.wpcom-json-api-upload-media-endpoint.php' );


// Jetpack Only Endpoints
//  TODO: move instantiations into this file?
require_once( __DIR__ . '/json-endpoints/class.json-api-jetpack-endpoints.php' );
