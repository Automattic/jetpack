 ...
 * @returns {boolean}         Whether option is being updated on the module
 */
...
/**
 * Returns the named module option
 *
 * @param  {object}  state -  Global state tree
 * @param  {string}  module_slug -  slug of the module to check
 * @param  {string}  option_name -  option key to check if currently updating
 ...
 *
 * @param  {object} state  -  Global state tree
 * @returns {boolean}        True if at least one of the security features is available.
 */
