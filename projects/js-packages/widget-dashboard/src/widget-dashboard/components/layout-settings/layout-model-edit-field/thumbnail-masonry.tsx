 ...
 */
export function MasonryThumbnail( { className }: MasonryThumbnailProps ): React.ReactNode {
	return (
		<SVG className={ className } viewBox="0 0 40 24" fill="currentColor" aria-hidden="true">
