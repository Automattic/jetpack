...
import type { ResizeHandleRenderProps } from '@automattic/jetpack-grid';
 ...
 */
export const WidgetResizeHandle = forwardRef< HTMLDivElement, WidgetResizeHandleProps >(
	function WidgetResizeHandle( { listeners, attributes, verticalResizable, isResizing }, ref ) {
		...
		return (
			<div
				ref={ ref }
				className={ clsx( styles.handle, styles.handleCorner, isResizing && styles.resizing ) }
				{ ...listeners }
				{ ...attributes }
			></div>
		);
