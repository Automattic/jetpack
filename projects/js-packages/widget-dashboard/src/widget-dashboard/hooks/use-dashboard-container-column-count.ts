...
import { useLayoutEffect, useMemo, useState, type Ref } from '@wordpress/element';
 ...
 */
export function useDashboardContainerColumnCount( forwardedRef?: Ref< HTMLDivElement > ): {
	...
	const containerRef = useMergeRefs( [ setContainer, resizeObserverRef, forwardedRef ] );
