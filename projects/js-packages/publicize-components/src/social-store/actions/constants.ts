...
export const POLLING_FOR_KEYRING_RESULT = 'POLLING_FOR_KEYRING_RESULT' as const;

export const FETCHING_KEYRING_RESULT = 'FETCHING_KEYRING_RESULT' as const;

export const RECEIVE_KEYRING_RESPONSE = 'RECEIVE_KEYRING_RESPONSE' as const;

export const CLEAR_KEYRING_REQUESTS = 'CLEAR_KEYRING_REQUESTS' as const;

export const SET_KEYRING_RESULT_POLLING_ABORT_CONTROLLER =
	'SET_KEYRING_RESULT_POLLING_ABORT_CONTROLLER' as const;
