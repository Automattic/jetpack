...
<Meta title="JS Packages/Charts/Components/Legend" of={ LegendStories } />
...
For detailed information about component props, types, and method signatures, see the [Legend API Reference](./?path=/docs/js-packages-charts-components-legend-api-reference--docs).
...
For detailed information about all optional props, see the [Legend API Reference](./?path=/docs/js-packages-charts-components-legend-api-reference--docs).
