...
- **Grouped comparison series**: A primary series and its `type: 'comparison'` overlay that share a `group` collapse into a single legend item labelled by the primary; toggling it shows or hides both series at once
