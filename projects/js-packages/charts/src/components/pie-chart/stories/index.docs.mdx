...
- **`labelBackgroundColor`** - Reserved for future implementation of label backgrounds. This property exists in the theme system but is not yet implemented for visual styling.
