...
Pie charts support integrated legends to identify segments:
...
<Canvas of={ PieChartStories.WithLegendTopRight } />
...
<Canvas of={ PieChartStories.WithLegendVertical } />
<Source
	language="jsx"
	code={ `<PieChart
		size={ 400 }
...
### Standalone Legend for Pie Charts

For complex layouts or dashboards, use the Legend component separately:
...
{/* Legend can be positioned independently */}
<Legend chartId="distribution-chart" orientation="vertical" />` }
/>

This approach is particularly useful for:
- Placing legends outside the chart's bounding box
- Creating unified legend panels for multiple pie charts
- Responsive designs where legends need to reflow

See the [Legend component documentation](?path=/docs/js-packages-charts-composites-legend--docs) for more examples.
