...
- **`labelTextColor`** - Controls the color of text displayed on pie chart segments. Defaults to `#333` (dark gray) for visibility.
...
| Prop                        | Type                            | Default        | Description                                                                       |
| --------------------------- | ------------------------------- | -------------- | --------------------------------------------------------------------------------- |
| `labelTextColor`            | `string`                        | `'#333'`       | Color of text displayed on pie chart segments                                    |
