...
const customTheme = {
	...
	labelBackgroundColor: 'rgba(0, 0, 0, 0.8)', // Semi-transparent black background
};
...
- **`labelBackgroundColor`** - Controls the background color of labels. Creates a rounded rectangle behind each label for enhanced readability. Supports any CSS color value including transparency (e.g., `rgba(0, 0, 0, 0.7)`).
...
| `labelBackgroundColor`      | `string`                        | `'rgba(255, 255, 255, 0.8)'` | Background color for labels displayed on pie chart segments |
