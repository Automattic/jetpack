...
const customTheme = {
	...
	labelBackgroundColor: '#000000', // Background color (future use)
};
...
- **`labelTextColor`** - Controls the color of text displayed on pie chart segments. Use contrasting colors for better readability.
- **`labelBackgroundColor`** - Reserved for future implementation of label backgrounds. Currently used internally but will support background styling for labels in future versions.

**Best Practices:**
- Use high contrast between `labelTextColor` and segment colors for optimal readability
...
| Prop                        | Type                            | Default        | Description                                                                       |
| --------------------------- | ------------------------------- | -------------- | --------------------------------------------------------------------------------- |
| `labelTextColor`            | `string`                        | `'#2c3338'`    | Color of text displayed on pie chart segments                                    |
| `labelBackgroundColor`      | `string`                        | `'#FFFFFF'`    | Background color for labels (reserved for future label background implementation) |
