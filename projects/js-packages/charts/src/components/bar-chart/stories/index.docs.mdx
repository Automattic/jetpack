...
<Canvas of={ BarChartStories.HorizontalBars } />
...
Display series information with automatic color and pattern matching (enabled by default):
...
### Legends with Horizontal Bars

Legends work seamlessly with both orientations:
