...
- **Vertical**: Short category names, traditional business charts, time-series data
- **Horizontal**: Long category names, rankings, when you have limited vertical space
