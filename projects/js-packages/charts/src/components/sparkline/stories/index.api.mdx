...
<Meta title="JS Packages/Charts/Types/Sparkline Chart/API Reference" />

# Sparkline Chart API Reference
...
| `aspectRatio` | `number` | - | Aspect ratio for responsive charts (responsive variant only) |
| `maxWidth` | `number` | - | Maximum width for responsive charts (responsive variant only) |
| `resizeDebounceTime` | `number` | `100` | Debounce time for resize events in ms (responsive variant only) |
