...
<Meta title="JS Packages/Charts/Types/Line Chart/Sparkline/API Reference" />

# Sparkline API Reference

## Overview

Sparkline is a preconfigured variant of [LineChart](?path=/docs/js-packages-charts-types-line-chart--docs) optimized for compact, inline visualizations. It provides a simplified API while using LineChart's rendering engine internally.
...
For more control over rendering, use LineChart directly with these props. See [LineChart API Reference](?path=/docs/js-packages-charts-types-line-chart-api-reference--docs) for full documentation.
