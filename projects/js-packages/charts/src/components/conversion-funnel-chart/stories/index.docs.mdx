...
<Meta title="JS Packages/Charts/Types/Conversion Funnel Chart" of={ ConversionFunnelChartStories } />
...
The component automatically integrates with the global charts theme system, inheriting colors and styling from your chart theme configuration.

### Custom Styling

Use the `style` prop or `className` prop for custom styling:
