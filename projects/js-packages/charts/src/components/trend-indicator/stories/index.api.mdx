...
|----------|----------------------|-------------|
| `--a8c-charts-color-trend-up` | `--wpds-color-foreground-content-success-weak` (`#008030`) | Colour for upward trends. |
| `--a8c-charts-color-trend-down` | `--wpds-color-foreground-content-error-weak` (`#cc1818`) | Colour for downward trends. |
| `--a8c-charts-color-trend-neutral` | `--wpds-color-foreground-content-neutral-weak` (`#707070`) | Colour for neutral trends. |
