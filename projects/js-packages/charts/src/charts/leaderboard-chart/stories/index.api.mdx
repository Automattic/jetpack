...
| `fitRows` | `boolean` | `false` | Show only complete rows that fit the chart height instead of scrolling. Use with `LeaderboardChartUnresponsive` inside a fixed-height container. |
