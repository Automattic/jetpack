...
<Source
	language="tsx"
	code={ `import { Leaderboard } from '@automattic/charts';
...
The Leaderboard expects pre-processed data. You'll need to transform your raw data into the required format:
...
<Source
	language="tsx"
	code={ `import { GlobalChartsProvider, Leaderboard, type ChartTheme } from '@automattic/charts';
...
<Source
	...
	code={ `// Responsive by default (fills parent container)
		<div style={{ width: '100%', height: '320px' }}>
			<Leaderboard data={ data } showLegend={ true } />
		</div>
...
<Source language="tsx" code={ `
	...
	<Leaderboard data={salesData} withComparison={true} />
` } />
...
<Source language="tsx" code={ `
	...
	<Leaderboard data={trafficData} withComparison={true} />
` } />
