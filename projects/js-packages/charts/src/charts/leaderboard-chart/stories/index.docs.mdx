...
<Source
	...
	function transformRawData(rawData) {
		...
		return rawData.map(item => {
			...
			// its missing-data placeholder. The reverse case, a row known only
			// from the comparison period, takes currentValue: null and
			// currentShare: 0; the chart draws a placeholder for the value.
