...
| `tooltipPlacement` | `'auto' \| 'beside'` | `'auto'` | Offsets from the band center on vertical charts, potentially overlapping wide bars; flips horizontally and clamps to viewport or clipping bounds, without vertical flipping. |
