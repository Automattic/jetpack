...
date-based series pick a default from the data's time span — hour ticks within a day,
calendar dates within a year, otherwise years — shared with the line and area charts.
