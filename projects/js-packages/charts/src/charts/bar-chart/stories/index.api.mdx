...
Default tooltip labels for date-based series keep per-bar precision (the calendar date,
plus the year across year boundaries and the hour for sub-daily buckets).
