...
| `color` | `string` | `--a8c-charts-color-series-1` | Color for the line stroke (hex or CSS color) |
...
The default line color, used when the `color` prop is not provided, is the first series palette color — set in CSS as `--a8c-charts-color-series-1`, not through the theme object.

The gradient's default `to` color is `--a8c-charts-color-background`, declared in CSS the same way.
