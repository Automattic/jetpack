...
The gradient's default `to` color is `--a8c-charts-color-background`, declared in CSS the same way. The `backgroundColor` theme field still carries it but is deprecated.
