...
| `displayMode` | `GeoDisplayMode` | `'auto'` | How data is rendered: `'regions'` shades areas, `'markers'` places sized markers, `'text'` places text labels, `'auto'` lets Google Charts infer the mode from the data |
