...
The remaining properties can be customized via the theme system:

| Property | Type | Default | Description |
| -------- | ---- | ------- | ----------- |
| `backgroundColor` | `string` | `'var(--a8c-charts-color-background, #fff)'` | Background color of the map |
| `geoChart.featureFillColor` | `string` | `'var(--a8c-charts-color-surface-secondary, #f4f4f4)'` | Fill color for countries without data values |
