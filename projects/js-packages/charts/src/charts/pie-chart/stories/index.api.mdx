...
| --- | --- | --- |
| `--a8c-charts-color-label-inverse` | `#f0f0f0` | Label text color. Used unless the slice fill contrasts better with `--a8c-charts-color-label`, or a label plate is set |
