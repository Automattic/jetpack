...
| --- | --- | --- |
| `--a8c-charts-color-label-inverse` | `#f0f0f0` | Color of text displayed on pie chart segments |
| `--a8c-charts-color-label-background` | `transparent` | The plate behind a label. Set any color to enable it |
