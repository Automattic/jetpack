...
| Prop | Type | Default | Description |
| ---- | ---- | ------- | ----------- |
| `labelTextColor` | `string` | `var(--a8c-charts-color-label-on-fill, #FFFFFF)` | Color of text displayed on pie chart segments. Deprecated — declare `--a8c-charts-color-label-on-fill` instead |
| `labelBackgroundColor` | `string` | `var(--a8c-charts-color-label-background, transparent)` | Background color for labels. Deprecated — declare `--a8c-charts-color-label-background` instead |
