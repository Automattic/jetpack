...
| `tooltipStyle` | `CSSProperties` | - | Override the container styles. The default renderer inherits color overrides, and a color-only override retains the default dark tooltip surface. |
