...
| `tooltipPlacement` | `'auto' \| 'below-axis' \| 'beside'` | `'auto'` | Position near the datum, below the x-axis label band, or [beside the datum](./?path=/docs/js-packages-charts-library-charts-bar-chart--docs#beside-tooltips). |
