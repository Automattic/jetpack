...
| `tooltipStyle` | `CSSProperties` | - | Override the container styles. For the default renderer, any color override starts from the tooltip-surface/label-inverse pair, and the content inherits both colors. |
