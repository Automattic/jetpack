...
| `tooltipPlacement` | `'auto' \| 'below-axis' \| 'beside'` | `'auto'` | Position near the datum, below the x-axis label band, or beside the datum without vertical flipping; beside placement still clamps to bounds. |
