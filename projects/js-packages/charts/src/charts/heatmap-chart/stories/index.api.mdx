...
| `cellGap` | `number` | chart theme (`4`, `2` when compact) | Pixel gap between cells. Defaults to the theme's `heatmapChart.cellGap`. |
| `cellRadius` | `number` | chart theme (`2`) | Corner radius for cells in px. Defaults to the theme's `heatmapChart.cellRadius`. |
