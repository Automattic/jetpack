...
| `primaryColor` | `string` | palette | Color the scale interpolates toward at the highest value. Resolution order: this prop > `heatmapChart.primaryColor` (deprecated) > the first series palette color (`--a8c-charts-color-series-1`). |
