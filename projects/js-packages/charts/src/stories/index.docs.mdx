...
For color configuration, see [the token catalog](?path=/docs/js-packages-charts-library-providers-globalchartsprovider--docs) and [bar point colors](?path=/docs/js-packages-charts-library-charts-bar-chart--docs#theming-integration).
