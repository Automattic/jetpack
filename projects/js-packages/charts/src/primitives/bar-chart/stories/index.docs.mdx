...
<Meta title="JS Packages/Charts/Primitives/Bar Chart" of={ BarChartStories } />
...
For detailed information about component props, types, and method signatures, see the [Bar Chart API Reference](./?path=/docs/js-packages-charts-primitives-bar-chart-api-reference--docs).
