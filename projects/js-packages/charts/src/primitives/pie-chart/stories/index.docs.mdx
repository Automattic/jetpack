...
<Meta title="JS Packages/Charts/Primitives/Pie Chart" of={ PieChartStories } />
...
For detailed prop information, compound components, and type definitions, see the [Pie Chart API Reference](./?path=/docs/js-packages-charts-primitives-pie-chart-api-reference--docs).
...
For detailed information about compound components (`PieChart.SVG`, `PieChart.HTML`, `PieChart.Legend`), see the [Pie Chart API Reference](./?path=/docs/js-packages-charts-primitives-pie-chart-api-reference--docs).
