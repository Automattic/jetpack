...
<Meta title="JS Packages/Charts/Primitives/Bar List Chart" of={ BarListChartStories } />
...
For detailed information about component props, types, and method signatures, see the [Bar List Chart API Reference](./?path=/docs/js-packages-charts-primitives-bar-list-chart-api-reference--docs).
...
For detailed prop information and configuration options, see the [Bar List Chart API Reference](./?path=/docs/js-packages-charts-primitives-bar-list-chart-api-reference--docs).
