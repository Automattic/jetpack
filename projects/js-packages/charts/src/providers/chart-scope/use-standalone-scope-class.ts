...
/**
 * Returns the catalog class when there is no `GlobalChartsProvider` above this
 * component, and `undefined` when there is.
 *
 * Standalone components need the catalog to resolve at all, but inside a provider
 * the tokens already inherit — re-declaring them there would shadow a consumer
 * override set anywhere in the tree.
 *
