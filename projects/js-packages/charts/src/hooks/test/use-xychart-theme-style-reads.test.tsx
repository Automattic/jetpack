...
describe( 'useXYChartTheme style reads', () => {
	...
	// The memo key serialises the strokes rather than joining them, so a colour containing a comma or a space survives the round-trip intact. `rgba(0, 0, 0, 0.5)` is the one that proves it: it holds both separators and comes back whole.
	//
