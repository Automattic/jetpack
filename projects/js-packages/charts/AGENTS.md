...
- **`var()` resolves in an SVG presentation attribute.** Verified in Blink, WebKit and Gecko. Much of this package's older commentary says the opposite; do not reintroduce a JS resolver on that basis.
