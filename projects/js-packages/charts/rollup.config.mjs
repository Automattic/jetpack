...
const inputConfig = {
	...
	'components/bar-chart/index': 'src/components/bar-chart/index.ts',
	...
	'components/pie-semi-circle-chart/index': 'src/components/pie-semi-circle-chart/index.ts',
	'components/bar-list-chart/index': 'src/components/bar-list-chart/index.ts',
	'components/leaderboard-chart/index': 'src/components/leaderboard-chart/index.ts',
	'components/conversion-funnel-chart/index': 'src/components/conversion-funnel-chart/index.ts',
	'components/tooltip/index': 'src/components/tooltip/index.ts',
	'components/legend/index': 'src/components/legend/index.ts',
	// Include hooks index files
...
const mainConfig = {
	...
	output: [
		...
		createOutputConfig( './dist/esm/', 'esm' ), // ES modules for modern bundlers
	],
