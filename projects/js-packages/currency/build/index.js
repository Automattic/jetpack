...
const number_1 = require("@woocommerce/number");
...
const CurrencyFactory = function (currencySetting) {
    ...
    function setCurrency(setting) {
        ...
        const config = Object.assign(Object.assign({}, defaultCurrency), setting);
        currency = {
    ...
    function formatAmount(number) {
        const formattedNumber = number_1.numberFormat(currency, number);
        if (formattedNumber === '') {
            return formattedNumber;
        }
        const { priceFormat, symbol } = currency;
        // eslint-disable-next-line @wordpress/valid-sprintf
        return i18n_1.sprintf(priceFormat, symbol, formattedNumber);
    }
    /**
     * Formats money value.
     *
    ...
    function formatCurrency(number) {
        deprecated_1.default('Currency().formatCurrency', {
            version: '5.0.0',
    ...
    function getDataForCountry(countryCode, localeInfo = {}, currencySymbols = {}) {
        ...
        return {
            ...
            symbol: html_entities_1.decodeEntities(symbol),
    ...
    return {
        ...
        render(number) {
            ...
            if (number < 0) {
                return (element_1.createElement("span", { className: "is-negative" }, formatAmount(number)));
            }
            return formatAmount(number);
        },
    };
...
function getCurrencyData() {
    deprecated_1.default('getCurrencyData', {
        version: '3.1.0',
