...
const sbconfig = {
	...
	framework: {
		...
		name: path.dirname(
			fileURLToPath( import.meta.resolve( '@storybook/react-webpack5/package.json' ) )
		),
		options: {},
	},
	staticDirs: [ '../public' ],
	...
	babel: async () => ( {
		presets: [
			fileURLToPath( import.meta.resolve( '@automattic/jetpack-webpack-config/babel/preset' ) ),
		],
	} ),
};
