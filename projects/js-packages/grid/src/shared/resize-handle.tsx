 ...
 */
function lockDocumentCursorWhileActive( getDocument: () => Document, cursor: string ): () => void {
 ...
 * @param root0
 * @param root0.itemId
 * @param root0.verticalResizable
 * @param root0.renderResizeHandle
 */
function ResizeHandle( {
	...
	useEffect( () => {
		...
		return lockDocumentCursorWhileActive( () => ownerDocumentRef.current ?? document, cursor );
