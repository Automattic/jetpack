...
export default {
	...
	argTypes: {
		data: {
			...
			options: [ 'vulnerability', 'current', 'historic', 'fixers' ],
			mapping: {
				vulnerability: freeData,
				current: currentData,
			...
			control: {
				type: 'select',
				labels: {
					vulnerability: 'Vulnerability Threats',
					current: 'Current Threats',
					historic: 'Historic Threats',
					fixers: 'Threats with Fixers',
				},
			},
		},
