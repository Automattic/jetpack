 ...
 */
import PopUpConnection from '../index';

describe( 'PopUpConnection', () => {
	const testProps = {
		title: 'Sample Title',
	...
	describe( 'Loading state', () => {
		...
		renderer.render( <PopUpConnection { ...testProps } isLoading={ true } /> );
	...
	describe( 'When the connect url is fetched', () => {
		const renderer = new ShallowRenderer();
		renderer.render( <PopUpConnection { ...testProps } /> );
		const wrapper = shallow( renderer.getRenderOutput() );
