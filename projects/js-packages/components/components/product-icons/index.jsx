...
export const ProtectIcon = ( { opacity = 1, size } ) => (
	<IconWrapper size={ size } opacity={ opacity }>
		<Path d="M12 3.17615L18.75 6.24433V10.8182C18.75 14.7171 16.2458 18.4088 12.7147 19.5734C12.2507 19.7264 11.7493 19.7264 11.2853 19.5734C7.75416 18.4088 5.25 14.7171 5.25 10.8182V6.24433L12 3.17615ZM6.75 7.2102V10.8182C6.75 14.1311 8.89514 17.2056 11.7551 18.1488C11.914 18.2012 12.086 18.2012 12.2449 18.1488C15.1049 17.2056 17.25 14.1311 17.25 10.8182V7.2102L12 4.82384L6.75 7.2102Z M11.3673 12.5988H12.6428L12.7643 7.75H11.2459L11.3673 12.5988ZM12.0051 15.1143C12.4656 15.1143 12.8301 14.765 12.8301 14.3196C12.8301 13.8742 12.4656 13.525 12.0051 13.525C11.5445 13.525 11.1801 13.8742 11.1801 14.3196C11.1801 14.765 11.5445 15.1143 12.0051 15.1143Z" />
	</IconWrapper>
);
