...
/**
 * A8cSvgTitle component definition.
 *
 * @param {object} props - Component properties.
 * @param {string} props.title - Title for SVG.
 * @param {number} props.height - height for SVG.
 * @param {number} props.className - className for the a wrapper, default: `jp-a8c-svg-title`.
 *
...
export default function A8cSvgTitle( {
	...
	return (
		<svg
			...
			{ ...otherProps }
		>
			<title id="a8c-svg-title">{ title }</title>
