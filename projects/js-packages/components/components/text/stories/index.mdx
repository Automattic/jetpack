...
import Text, { BOX_MODEL_VALUES, H2, H3, Title } from '../index.tsx';
...
**m** | margin
**mt** | margin-top
**mr** | margin-inline-end (right in LTR)
**mb** | margin-bottom
**ml** | margin-inline-start (left in LTR)
**mx** | margin left and right
**my** | margin top and bottom
**p** | padding
**pt** | padding-top
**pr** | padding-inline-end (right in LTR)
**pb** | padding-bottom
**pl** | padding-inline-start (left in LTR)
