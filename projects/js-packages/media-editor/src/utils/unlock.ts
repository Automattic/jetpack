...
/**
 * Get the unlock function to access WordPress private APIs.
 * This is based on the Jetpack mu-wpcom pattern.
 *
 * @return The unlock function or undefined if it fails.
 */
