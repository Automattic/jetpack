			...
			<form class="ui form" enctype="multipart/form-data" method="POST" action="#">
				...
				<?php if(defined('ZBS_CLIENTPRO_TEMPLATES') && $customer > 0){ ?>
					...
					<select class="ui field select" id="fileportal" name="fileportal">
							<option value="0"<?php if(isset($ourFile['portal']) && $ourFile['portal'] == 0 ) echo " selected"; ?>><?php echo esc_html( __( 'No', 'zero-bs-crm' ) ); ?></option>
							<option value="1"<?php if(isset($ourFile['portal']) && $ourFile['portal'] == 1 ) echo " selected"; ?>><?php echo esc_html( __( 'Yes', 'zero-bs-crm' ) ); ?></option>
					</select>
				<?php } else { 
				...
				if ($customer > 0){
					...
					if (count($fileSlots) > 0){
						...
						<select class="ui field select" id="fileslot" name="fileslot">
							<option value="-1"><?php echo esc_html( __( 'None', 'zero-bs-crm' ) );?></option><?php
