      ...
      if ( $zbs->DAL->contacts->getContactDoNotMail( $id ) ) {
          ...
          <div class="ui divided grid" style="margin-top:-1em;">
            ...
            <?php #DEBUG echo '<pre>'; print_r($contact); echo '</pre><hr>'; ?>
              ...
              <div id="zbs-vitals-box">
                <div class="ui top attached tabular menu">
                  ...
                  <?php if (count($zbsSocialAccountTypes) > 0 && count($contact_socials) > 0){ ?>
                    <div class="zbs-hide" data-tab="social" id="contact-tab-social" class="<?php if (!isset($activeVitalsTab)) { echo 'active '; $activeVitalsTab = 'social'; } ?>item"><?php esc_html_e('Social',"zero-bs-crm"); ?></div>                      
                  <?php } ?>
                  ...
                  if (is_array($zbsContactVitalTabs) && count($zbsContactVitalTabs) > 0){
                    ...
                    foreach ($zbsContactVitalTabs as $tab){
                      ...
                      ?><div data-tab="<?php echo esc_attr( $tabID ); ?>" class="item" id="contact-tab-<?php echo esc_attr( $tabID ) ?>"><?php echo esc_html( $tabName ); ?></div><?php
              ...
              <div id="zbs-doc-menu">
                <div class="ui top attached tabular menu">
                  <?php if ($useQuotes == "1"){ ?><div data-tab="quotes" class="<?php if (!isset($activeTab)) { echo 'active '; $activeTab = 'quotes'; } ?>item"><?php esc_html_e('Quotes',"zero-bs-crm"); ?></div><?php } ?>
