...
function jpcrm_render_placeholder_line( $placeholder_key = '', $placeholder_info = array() ){
	...
	?><div class="ui segment">
		...
		<h4 class="ui dividing header"><code><?php echo esc_html( $placeholder_key ); ?></code> - <?php if ( isset( $placeholder_info['description'] ) ) echo esc_html( $placeholder_info['description'] ); ?></h4>
	...
	<?php 
		...
		if ( is_array( $placeholders ) ){
			...
			foreach ( $placeholders as $placeholder_group_key => $placeholder_group ){
				...
				?><div class="title"><i class="dropdown icon"></i> <?php echo esc_html( ucwords( __( $placeholder_group_key, 'zero-bs-crm' ) ) ); ?></div><?php
