  ...
  ?>
        ...
        <div id="sbA" style="margin-right:1em">
                     ...
                     <thead>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          if (!$result[0] && $envCheckKey != 'devmode') echo '<div class="ui yellow label">'. esc_html__('Warning','zero-bs-crm').'</div>&nbsp;&nbsp;';
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="width:540px"><?php  
                              ...
                              } else echo esc_html__( 'Not yet run', 'zero-bs-crm' );
                        ...
                        <?php
                          ...
                          $timeoutIssues = zeroBSCRM_getSetting('migration300_timeout_issues'); 
                          if (isset($timeoutIssues) && $timeoutIssues == 1) echo '<tr><td colspan="2" style="text-align:center"><strong>'. esc_html__('Timeouts','zero-bs-crm').'</strong>: '. esc_html__('One or more migrations experienced timeouts while running. This may indicate that your server is not performing very well.','zero-bs-crm').'</td></tr>';
                    ...
                    <tbody>
                      ...
                      if (is_array($exts) && count($exts) > 0){
                        ...
                        foreach ($exts as $shortName => $e){
                          ...
                          ?><tr><td><?php echo esc_html( $e['name'] ); ?></td><td><?php echo esc_html( $e['ver'] ); ?></td></tr><?php
                    ...
                    <tbody>
                      ...
                      if (is_array($zbs->external_sources) && count($zbs->external_sources) > 0){
                        ...
                        foreach ($zbs->external_sources as $key => $extsource){
                          ...
                          ?><tr><td><?php echo esc_html( $extsource[0].' ('.$key.')' ); ?></td><td><?php if (isset($extsource['ico']) && !empty($extsource['ico'])) echo '<i class="fa '. esc_attr( $extsource['ico'] ) .'"></i>'; else echo '???'; ?></td></tr><?php
                                ...
                                <td><?php 
                                  ...
                                  if ( is_array( $package_info['installed'] ) ){
                                    ...
                                    if ( isset( $package_info['failed_installs'] ) && $package_info['failed_installs'] > 0 ){
                                      ...
                                      echo '<br><i class="exclamation triangle icon red"></i> ' . wp_kses( sprintf( __( '%d attempts to install this package failed. Please <a href="%s" target="_blank">contact support</a>.', 'zero-bs-crm' ), $package_info['failed_installs'], esc_url( $zbs->urls['support'] ) ), $zbs->acceptable_restricted_html );
                            ...
                            <?php
                              ...
                              foreach ($zbsPerfTestOpt as $perfTest){
                                ...
                                <td><?php 
                                  ...
                                  if (isset($perfTest['init'])) echo esc_html( date('F j, Y, g:i a',$perfTest['init']) );
              ...
              <div class="ui segment">
                ...
                <?php if ($zbs->isDAL3()){ ?><a href="<?php echo esc_url( zeroBSCRM_getAdminURL($zbs->slugs['systemstatus']).'&tab=status&v3migrationlog=1' ); ?>" class="ui button blue"><?php esc_html_e('v3 Migration Logs',"zero-bs-crm"); ?></a><?php } ?>
              </div>
