    ...
    <form method="post" action="?page=<?php echo esc_attr( $zbs->slugs['settings'] ); ?>&tab=mail">
            ...
            <tr>
                ...
                <td style="width:200px">
                    ...
                    <select class="winput" name="wpzbscrm_directmsgfrom" id="wpzbscrm_directmsgfrom">
                        <option value="1" <?php if (isset($settings['directmsgfrom']) && $settings['directmsgfrom'] == '1') echo ' selected="selected"'; ?>><?php esc_html_e('First Name Last Name @ CRM Name (e.g. John Doe @','zero-bs-crm'); echo ' '. esc_html( $coname ) .')';?></option>
                        <option value="2" <?php if (isset($settings['directmsgfrom']) && $settings['directmsgfrom'] == '2') echo ' selected="selected"'; ?>><?php esc_html_e('CRM Name (e.g.',"zero-bs-crm"); echo ' '. esc_html( $coname ).')'; ?></option>
                        <option value="3" <?php if (isset($settings['directmsgfrom']) && $settings['directmsgfrom'] == '3') echo ' selected="selected"'; ?>><?php esc_html_e('Mail Delivery Method Sender Name',"zero-bs-crm");?></option>
                    </select>
            </tr>
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                ...
                <td style="width:540px"><input type="text" class="winput form-control" name="wpzbs_unsub" id="wpzbs_unsub" value="<?php if (isset($settings['businessyourname']) && !empty($settings['unsub'])) echo esc_attr( $settings['unsub'] ); ?>" placeholder="<?php esc_attr_e("e.g. You're seeing this because you're registered as a contact of Michael Scott Paper Company, if you'd like to unsubscribe from any future communications please click ##UNSUB-LINK##.", 'zero-bs-crm' ); ?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width:540px"><input type="text" class="winput form-control" name="wpzbs_unsubmsg" id="wpzbs_unsubmsg" value="<?php if (isset($settings['unsubmsg']) && !empty($settings['unsubmsg'])) echo esc_attr( $settings['unsubmsg'] ); ?>" placeholder="e.g. You've been successfully unsubscribed." /></td>
            </tr>
