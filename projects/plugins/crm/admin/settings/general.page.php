    ...
    <form method="post" action="?page=<?php echo esc_attr( $zbs->slugs['settings'] ); ?>">
            ...
            <tr>
                ...
                <td style="width:540px">
                    <select class="winput" name="wpzbscrm_menulayout" id="wpzbscrm_menulayout">
                        ...
                        <option value="1" <?php if (isset($settings['menulayout']) && $settings['menulayout'] == '1') echo ' selected="selected"'; ?>><?php esc_html_e('Full',"zero-bs-crm");?></option>
                        <option value="2" <?php if (isset($settings['menulayout']) && $settings['menulayout'] == '2') echo ' selected="selected"'; ?>><?php esc_html_e('Slimline',"zero-bs-crm");?></option>
                        <option value="3" <?php if (isset($settings['menulayout']) && $settings['menulayout'] == '3') echo ' selected="selected"'; ?>><?php esc_html_e('CRM Only',"zero-bs-crm");?></option>
                    </select>
                    <br />
                    <div>
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                ...
                <td style="width:540px">
                    <input style="width:90%;padding:10px;" name="wpzbscrm_loginlogourl" id="wpzbscrm_loginlogourl" class="form-control link" type="text" value="<?php if (isset($settings['loginlogourl']) && !empty($settings['loginlogourl'])) echo esc_attr( $settings['loginlogourl'] ); ?>" />
            ...
            <tr>
                ...
                <td><input type="text" class="winput form-control" name="wpzbscrm_customheadertext" id="wpzbscrm_customheadertext" value="<?php if (isset($settings['customheadertext']) && !empty($settings['customheadertext'])) echo esc_attr( $settings['customheadertext'] ); ?>" placeholder="e.g. <?php esc_html_e("Your CRM","zero-bs-crm");?>" /></td>
            </tr>
            ...
            <tr>
                ...
                <td style="width:540px">
                    <?php foreach ($zbs->acceptable_mime_types as $filetype => $mimedeet){ ?>
                        <input type="checkbox" class="winput form-control" name="<?php echo esc_attr( 'wpzbscrm_ft_'.$filetype ); ?>" id="<?php echo esc_attr( 'wpzbscrm_ft_'.$filetype ); ?>" value="1"<?php if (isset($settings['filetypesupload']) && isset($settings['filetypesupload'][$filetype]) && $settings['filetypesupload'][$filetype] == "1") echo ' checked="checked"'; ?> /> <?php echo esc_html( '.'.$filetype ); ?><br />
                    <?php } ?>
                </td>
            </tr>
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            foreach ($autoLoggers as $autoLog){ ?>
                ...
                <tr>
                    ...
                    <td style="width:540px"><input type="checkbox" class="winput form-control" name="wpzbscrm_<?php echo esc_attr( $autoLog['fieldname'] ); ?>" id="wpzbscrm_<?php echo esc_attr( $autoLog['fieldname'] ); ?>" value="1"<?php if (isset($settings[$autoLog['fieldname']]) && $settings[$autoLog['fieldname']] == "1") echo ' checked="checked"'; ?> /></td>
                </tr>
