        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                ...
                <td style="width:540px">
                    <input style="padding:10px;" name="wpzbscrm_license_key" id="wpzbscrm_license_key" class="form-control" type="text" value="<?php if (isset($license_key_array['key']) && !empty($license_key_array['key'])) echo esc_attr( $license_key_array['key'] ); ?>" />
                </td>
            </tr>
