                        ...
                        <td>
                            <select class="winput short" name="wpzbscrm_currency" id="wpzbscrm_currency">
                                ...
                                <?php foreach ($whwpCurrencyList as $currencyObj): ?>
                                    <option value="<?= esc_attr( $currencyObj[1] ) ?>" <?php if (isset($settings['currency']) && isset($settings['currency']['strval']) && $settings['currency']['strval'] == $currencyObj[1]) echo ' selected="selected"'; ?>>
                                        <?= esc_html( $currencyObj[0].' ('.$currencyObj[1].')' ) ?>
                                    </option>
                                <?php endforeach ?>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width:540px">
                            ...
                            <select class='form-control' name="wpzbscrm_currency_position" id="wpzbscrm_currency_position">
                                <option value='0' <?php if($settings['currency_position'] == 0) echo 'selected'; ?>><?php esc_html_e('Left','zero-bs-crm');?></option>
                                <option value='1' <?php if($settings['currency_position'] == 1) echo 'selected'; ?>><?php esc_html_e('Right','zero-bs-crm');?></option>
                                <option value='2' <?php if($settings['currency_position'] == 2) echo 'selected'; ?>><?php esc_html_e('Left with space','zero-bs-crm');?></option>
                                <option value='3' <?php if($settings['currency_position'] == 3) echo 'selected'; ?>><?php esc_html_e('Right with space','zero-bs-crm');?></option>
                            </select>
