                ...
                <?php
                    ...
                    ?><tr>
                        ...
                        <td style="text-align: center;">
                            <?php switch ( $zbs->oauth->connection_status_string( $provider_key, true) ){
                                ...
                                case 'config-no-connect':
                                    ...
                                    // just connect button
                                    ?><button type="button" class="jpcrm-open-popup-href ui tiny green button" data-href="<?php echo esc_url( $zbs->oauth->get_callback_url( $provider_key ) ); ?>" data-title="<?php esc_url_e( 'Connect to CRM', 'zero-bs-crm' ); ?>" data-width="600" data-height="600"><i class="plug icon"></i> <?php esc_html_e( 'Connect', 'zero-bs-crm' ); ?></button><?php
