    ...
    <form method="post">
            ...
            <tr>
                <td class="wfieldname">
                    ...
                    <div style="margin-top:10px">
                        ...
                        <label for="reftype-manual"><?= esc_html__( "Manual input", "zero-bs-crm" ) ?></label>
                        <br>
                        <input type="radio" style="margin:0 5px 0 10px" class="winput form-control" name="reftype" id="reftype-autonumber" value="autonumber" <?= isset( $settings['reftype'] ) && $settings['reftype'] === 'autonumber' ? 'checked' : '' ?> /> <label for="reftype-autonumber"><?= esc_html__( "Auto-generated reference", "zero-bs-crm" ) ?></label>
                    </div>
                </td>
                <td style="width:540px; vertical-align: middle" class="zbs-settings-custom-fields" >
                    <div id="reftype-manual-block" class="reftype-block <?= ( isset( $settings['reftype'] ) && $settings['reftype'] === 'manual' ? 'reftype-set' : ! isset( $settings['reftype'] ) ) ? 'reftype-set' : '' ?>">
                        <div class="zbs-cf-type-autonumber-input-wrap">
                            <div class="ui labeled input">
                                <div class="ui label"><?= esc_html__( 'Default input', 'zero-bs-crm' ) ?></div>
                                <input type="text" class="form-control zbs-generic-hide zbs-cf-type-autonumber" name="defaultref" value="<?= isset( $settings['defaultref'] ) ? esc_attr( $settings['defaultref'] ) : '' ?>" placeholder="e.g. inv-" style="display: inline-block;">
                            </div>
                        </div>
                    </div>
                    <div id="reftype-autonumber-block" class="zbs-cf-type-autonumber-wrap zbs-generic-hide zbs-cf-type-autonumber reftype-block <?= isset( $settings['reftype'] ) && $settings['reftype'] === 'autonumber' ? 'reftype-set' : '' ?>">
                        ...
                        <div class="zbs-cf-type-autonumber-input-wrap">
                            <div class="ui labeled input">
                                <div class="ui label"><?= esc_html__( 'Prefix', 'zero-bs-crm' ) ?></div>
                                <input type="text" class="form-control zbs-generic-hide zbs-cf-type-autonumber" name="refprefix" value="<?= isset( $settings['refprefix'] ) ? esc_attr( $settings['refprefix'] ) : '' ?>" placeholder="Prefix (e.g. ABC-)" style="display: inline-block;">
                            </div>
                        </div>
                        <!-- Next number -->
                        <div class="zbs-cf-type-autonumber-input-wrap">
                            <div class="ui labeled input">
                                <div class="ui label"><?= esc_html__( 'Next number', 'zero-bs-crm' ) ?></div>
                                <input type="text" class="form-control zbs-generic-hide zbs-cf-type-autonumber" name="refnextnum" value="<?= isset( $settings['refnextnum'] ) ? esc_attr( $settings['refnextnum'] ) : '1' ?>" placeholder="Next Number (e.g. 1)" style="display: inline-block;">
                            </div>
                        </div>
                        <!-- Suffix -->
                        <div class="zbs-cf-type-autonumber-input-wrap">
                            <div class="ui labeled input">
                                <div class="ui label"><?= esc_html__( 'Suffix', 'zero-bs-crm' ) ?></div>
                                <input type="text" class="form-control zbs-generic-hide zbs-cf-type-autonumber" name="refsuffix" value="<?= isset( $settings['refsuffix'] ) ? esc_attr( $settings['refsuffix'] ) : '' ?>" placeholder="Suffix (e.g. -FINI)" style="display: inline-block;">
                            </div>
                        </div>
                    </div>
                </td>
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="winput form-control" id="reflabel" name="reflabel" placeholder="e.g. Ref." value="<?= isset( $settings['reflabel'] ) ? esc_attr( $settings['reflabel'] ) : esc_attr__('Reference', 'zero-bs-crm') ?>"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="width:540px"><textarea class="winput form-control" name="businessextra" id="businessextra"  placeholder="<?php esc_attr_e('e.g. Your Address','zero-bs-crm'); ?>" ><?php if (isset($settings['businessextra']) && !empty($settings['businessextra'])) echo wp_kses( $settings['businessextra'], $zbs->acceptable_restricted_html ); ?></textarea></td>
            </tr>
            ...
            <tr>
                ...
                <td style="width:540px"><textarea class="winput form-control" name="paymentinfo" id="paymentinfo"  placeholder="<?php esc_attr_e('e.g. BACS details','zero-bs-crm'); ?>" ><?php if (isset($settings['paymentinfo']) && !empty($settings['paymentinfo'])) echo wp_kses( $settings['paymentinfo'], $zbs->acceptable_restricted_html ); ?></textarea></td>
            </tr>
            ...
            <tr>
                ...
                <td style="width:540px">
                    <input type="text" class="winput form-control" id="jpcrm_invcustomfields" name="jpcrm_invcustomfields" placeholder="" value="<?= isset( $settings['invcustomfields'] ) ? esc_attr( $settings['invcustomfields'] ) : ''; ?>"/>
                    <?php
            ...
            <tr>
                ...
                <td style="width:540px">
                    <input type="text" class="winput form-control" id="jpcrm_contactcustomfields" name="jpcrm_contactcustomfields" placeholder="" value="<?= isset( $settings['contactcustomfields'] ) ? esc_attr( $settings['contactcustomfields'] ) : ''; ?>"/>
                    <?php
            ...
            <tr>
                ...
                <td style="width:540px">
                    <input type="text" class="winput form-control" id="jpcrm_companycustomfields" name="jpcrm_companycustomfields" placeholder="" value="<?= isset( $settings['companycustomfields'] ) ? esc_attr( $settings['companycustomfields'] ) : ''; ?>"/>
                    <?php
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                ...
                <td style="width:540px"><textarea class="winput form-control" name="zbsi_statementextra" id="zbsi_statementextra"  placeholder="<?php esc_attr_e('e.g. BACS details','zero-bs-crm'); ?>" ><?php if (isset($settings['statementextra']) && !empty($settings['statementextra'])) echo wp_kses( $settings['statementextra'], $zbs->acceptable_restricted_html ); ?></textarea></td>
            </tr>
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                ...
                <td style="width:540px"><textarea class="winput form-control" name="paythanks" id="paythanks"  placeholder="<?php esc_attr_e('e.g. Thank you for your custom. If you have any questions let us know','zero-bs-crm'); ?>" ><?php if (isset($settings['paythanks']) && !empty($settings['paythanks'])) echo wp_kses( $settings['paythanks'], $zbs->acceptable_restricted_html ); ?></textarea></td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <p style="text-align:center">
                        <a href="<?php echo jpcrm_esc_link( $zbs->slugs['settings'] ); echo '&tab=clients'; ?>" class="ui mini button blue"><?php esc_html_e('View Client Portal Settings','zero-bs-crm'); ?></a>
                        <?php ##WLREMOVE ?>
