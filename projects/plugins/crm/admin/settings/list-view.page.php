        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                ...
                <td style="width:540px">
                    <input style="width:100px;padding:10px;" name="wpzbscrm_notcontactedinx" id="wpzbscrm_notcontactedinx" class="form-control" type="text" value="<?php if (isset($settings['notcontactedinx']) && !empty($settings['notcontactedinx'])) echo esc_attr( $settings['notcontactedinx'] ); ?>" />
                </td>
            </tr>
            <tr>
                ...
                <td style="width:540px">
                    <input style="width:100px;padding:10px;" name="wpzbscrm_olderthanx" id="wpzbscrm_olderthanx" class="form-control" type="text" value="<?php if (isset($settings['olderthanx']) && !empty($settings['olderthanx'])) echo esc_attr( $settings['olderthanx'] ); ?>" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width:540px">
                    <input type="checkbox" name="wpzbscrm_show_totals_table" id="wpzbscrm_show_totals_table" class="form-control" value="1"<?php if (isset($show_totals_table) && $show_totals_table == "1") echo ' checked="checked"'; ?> />
                </td>
            </tr>
