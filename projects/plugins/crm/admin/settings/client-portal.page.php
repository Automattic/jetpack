...
if (current_user_can( 'admin_zerobs_manage_options' ) && !zeroBSCRM_isExtensionInstalled('clientportalpro')){
    ...
    // upsell button
    ?><a href="<?php echo esc_url( $zbs->urls['extcpp'] ); ?>" target="_blank" class="ui button orange right floated"><?php esc_html_e('Get Portal PRO','zero-bs-crm'); ?></a><?php
                ...
                <td style="width:540px" id="zbs-portal-users-statuses">
                    ...
                    if (is_array($zbsStatuses)) {
                        ...
                        foreach ($zbsStatuses as $statusStr){
                            ...
                            <input type="checkbox" value="1" name="wpzbscrm_portaluser_group_<?php echo esc_attr( $statusKey ); ?>" id="wpzbscrm_portaluser_group_<?php echo esc_attr( $statusKey ); ?>"<?php if ($checked) echo ' checked="checked"'; ?> />
