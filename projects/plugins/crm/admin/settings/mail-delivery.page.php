    ...
    if (count($zbsSMTPAccs) <= 0){
        ...
        <div class="ui icon big message zbs-non-wizard">
            ...
            <div class="content">
                ...
                <div><?php esc_html_e('Currently mail is sent from',"zero-bs-crm"); echo ' <div class="ui large teal horizontal label">'. esc_html( $defaultFromDeets['name'] ) .' ('. esc_html( $defaultFromDeets['email'] ) .')</div><br />'. esc_html__('Do you want to set up a different Mail Delivery option?',"zero-bs-crm"); ?></div>
            ...
            foreach ($zbsSMTPAccs as $accKey => $acc){
                ...
                <tr id="zbs-mail-delivery-<?php echo esc_attr( $accKey ); ?>">
                    <td class="zbs-mail-delivery-item-details"><?php
                        ...
                        if ($isDefault) { ?><div class="ui ribbon label zbs-default"><?php esc_html_e('Default',"zero-bs-crm"); ?></div><?php }
                        ...
                        if ($detailMode) echo '<div class="zbs-mail-delivery-detail">'. esc_html( $detailStr ) .'</div>';
                    ...
                    <td style="text-align:center">
                        ...
                        <button type="button" class="ui tiny teal button zbs-default-mail-delivery<?php if ($isDefault) echo ' disabled'; ?>" data-indx="<?php echo esc_attr( $accKey ); ?>"><i class="check circle outline icon"></i> Set as Default</button>
                    </td>
                </tr>
                <?php $accIndx++; } ?>
            </tbody>
                                    ...
                                    <select id="oauth_connections">
                                        <?php 
                                            ...
                                            if ( count( $oauth_available_providers ) > 0 ){
                                                ...
                                                <?php foreach ( $oauth_available_providers as $oauth_profile_key => $oauth_profile){
                                                ...
                                                ?><option value="-1" selected="selected" disabled="disabled"><?php esc_html_e( 'No active OAuth connections', "zero-bs-crm" ); ?></option><?php
