                ...
                if ( is_array( $variants ) && count( $variants ) > 0 ){ ?>              
                    <select id="<?php echo esc_attr( $setting_key ); ?>" name="<?php echo esc_attr( $setting_key ); ?>">
                        ...
                        foreach ( $variants as $template_path => $template_info ){
                            ...
                            ?><option value="<?php echo esc_attr( $option_value ); ?>"<?php if ( $settings[$setting_key] == $option_value ) { echo ' selected="selected"'; } ?>>
                                <?php if ( $default ) esc_html_e( 'Default Template:', 'zero-bs-crm' ).' '; ?>
