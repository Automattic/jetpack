        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                ...
                <td><select class="winput short" name="jpcrm_setting_coororg" id="jpcrm_setting_coororg">
                        <option value="co"<?php if (isset($label) && $label == 'co') echo ' selected="selected"'; ?>><?php esc_html_e('Company','zero-bs-crm'); ?></option>
                        <option value="org"<?php if (isset($label) && $label == 'org') echo ' selected="selected"'; ?>><?php esc_html_e('Organisation','zero-bs-crm'); ?></option>
                        <option value="domain"<?php if (isset($label) && $label == 'domain') echo ' selected="selected"'; ?>><?php esc_html_e('Domain','zero-bs-crm'); ?></option>
                    </select>
