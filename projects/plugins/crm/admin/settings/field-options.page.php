                        ...
                        <tr>
                            ...
                            <td>
                                <select class="winput form-control" name="wpzbscrm_filtersfromstatus" id="wpzbscrm_filtersfromstatus">
                                    <option value="1"<?php if (isset($settings['filtersfromstatus']) && $settings['filtersfromstatus'] == "1") echo ' selected="selected"'; ?>><?php esc_html_e('Automatic Status Quick Filters',"zero-bs-crm"); ?></option>
                                    <option value="-1"<?php if (isset($settings['filtersfromstatus']) && $settings['filtersfromstatus'] != "1") echo ' selected="selected"'; ?>><?php esc_html_e('No Status Quick Filters',"zero-bs-crm"); ?></option>
                                </select>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="winput form-control" name="wpzbscrm_filtersfromsegments" id="wpzbscrm_filtersfromsegments">
                                    <option value="1"<?php if (isset($settings['filtersfromsegments']) && $settings['filtersfromsegments'] == "1") echo ' selected="selected"'; ?>><?php esc_html_e('Automatic Segment Quick Filters',"zero-bs-crm"); ?></option>
                                    <option value="-1"<?php if (isset($settings['filtersfromsegments']) && $settings['filtersfromsegments'] != "1") echo ' selected="selected"'; ?>><?php esc_html_e('No Segment Quick Filters',"zero-bs-crm"); ?></option>
                                </select>
                            ...
                            <td>
                                ...
                                if (!empty($zbsStatusStr)) {
                                    ...
                                    if (is_array($zbsStatuses)) { foreach ($zbsStatuses as $statusStr){
                                        ...
                                        ?><option value="<?php echo esc_attr( $statusStr ); ?>"<?php
                                        if ($defaultStatusStr == $statusStr) echo ' selected="selected"';
                                        ?>><?php echo esc_html( $statusStr ); ?></option><?php

                                    }}else{

                                        ?><option value=""><?php esc_html_e("None (Set values above and save to enable this)","zero-bs-crm");?></option><?php
