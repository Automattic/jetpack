...
<div id="sbA">
    ...
    <form method="post" action="?page=<?php echo esc_attr( $zbs->slugs['settings'] ); ?>&tab=transactions">
                ...
                <td style="width:540px" id="jpcrm-transaction-include-status">
                    ...
                    if (is_array($zbsStatuses)) {
                        ...
                        foreach ($zbsStatuses as $statusStr){
                            ...
                            <input type="checkbox" value="1" name="wpzbscrm_transstatus_group_<?php echo esc_attr( $statusKey ); ?>" id="wpzbscrm_transstatus_group_<?php echo esc_attr( $statusKey ); ?>"<?php if ($checked) echo ' checked="checked"'; ?> />
                            <label for="wpzbscrm_transstatus_group_<?php echo esc_attr( $statusKey ); ?>"><?php echo esc_html( $statusStr ); ?></label>
                            </div><?php

                        }

                    } else esc_html_e('No Statuses Found',"zero-bs-crm");
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tbody>
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_transaction_fee"><?= esc_html__('Show fee',"zero-bs-crm") ?>:</label><br /><?= esc_html__('Tick if you need to use fees',"zero-bs-crm") ?></td>
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_transaction_tax"><?= esc_html__('Show tax',"zero-bs-crm") ?>:</label><br /><?= esc_html__('Tick if you need to use taxes',"zero-bs-crm") ?></td>
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_transaction_discount"><?= esc_html__('Show discount',"zero-bs-crm") ?>:</label><br /><?= esc_html__('Tick if you need to use discounts',"zero-bs-crm") ?></td>
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_transaction_net"><?= esc_html__('Show net amount',"zero-bs-crm") ?>:</label><br /><?= esc_html__('Tick if you need to use net amount',"zero-bs-crm") ?></td>
