                ...
                <div class="wizopt">
                    ...
                    <select class='form-control' id='zbs_crm_curr' name='zbs_crm_curr'>
                        ...
                        <?php foreach ($whwpCurrencyList as $currencyObj){ ?>
                            ?><option value="<?php echo esc_attr( $currencyObj[1] ); ?>"<?php if ($currSetting == $currencyObj[1]) echo ' selected="selected"'; ?>><?php echo esc_html( $currencyObj[0].' ('.$currencyObj[1].')' ); ?></option>
                        <?php } ?>
                    </select>
