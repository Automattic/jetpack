			...
			$workflow = array(
				...
				'steps'        => array(
					'step_1' => array(
						...
						'next_step'             => 'step_2',
						'title'                 => __( 'Invoice Status Updated', 'zero-bs-crm' ),
						'description'           => __( 'Triggered when an invoice status is updated', 'zero-bs-crm' ),
						'category'              => __( 'Invoice', 'zero-bs-crm' ),
						'type'                  => 'invoice',
					),
					'step_2' => array(
						'id'                    => 'step_2',
						...
						'attribute_definitions' => array(
							array(
								'slug'        => 'operator',
								'title'       => 'Operator',
								'description' => 'Determines how the status is compared to the specified value.',
								'data'        => array(
									'is'     => 'Is',
									'is_not' => 'Is not',
								),
						...
						'next_step'             => 'step_3',
						'title'                 => __( 'Invoice Status Changed', 'zero-bs-crm' ),
						'description'           => __( 'Condition for an invoice status changing', 'zero-bs-crm' ),
						'category'              => __( 'Invoice', 'zero-bs-crm' ),
						'type'                  => 'invoice',
					),
					'step_3' => array(
