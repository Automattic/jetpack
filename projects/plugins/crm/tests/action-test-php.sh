...
# Setup config.
cp tests/codecept/acceptance.suite.dist.yml tests/codecept/acceptance.suite.yml
sed -i 's/some_db_user/root/g' tests/codecept/acceptance.suite.yml
sed -i 's/some_db_pass/root/g' tests/codecept/acceptance.suite.yml
sed -i 's/host=localhost/host=127.0.0.1/g' tests/codecept/acceptance.suite.yml
sed -i 's!/path/to/test/file/must-overwrite-it-in-acceptance.suite.yml!'"$WORDPRESS_DIR"'!g' tests/codecept/acceptance.suite.yml
