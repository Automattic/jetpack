		...
		<form method="post">
			...
			<table class="table table-bordered table-striped wtab">
				...
				<tbody>
					...
					<tr>
						<td class="wfieldname">
							<label for="wpzbscrm_wccrminvreference"><?php esc_html_e( 'Use the Jetpack CRM invoice reference system for invoices generated by WooCommerce', 'zero-bs-crm' ); ?>:</label><br />
							<?php esc_html_e( 'Tick to use the Jetpack CRM invoice reference system for invoices generated by WooCommerce (only works with auto-generated references)', 'zero-bs-crm' ); ?>
						</td>
						<td style="width:540px">
							<input type="checkbox" class="winput form-control" name="wpzbscrm_wccrminvreference" id="wpzbscrm_wccrminvreference" value="1"<?php echo ( ! empty( $settings['wccrminvreference'] ) ? ' checked="checked"' : '' ); ?> />
						</td>
					</tr>
