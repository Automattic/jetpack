...
class Segment_Condition_Woo_Order_Count extends zeroBSCRM_segmentCondition {
	...
	public function conditionArg( $startingArg = false, $condition = false, $conditionKeySuffix = false ) {
		...
		} elseif ( $condition['operator'] == 'larger' ) {
			return array(
				'additionalWhereArr' =>
							array(
		...
		} elseif ( $condition['operator'] == 'largerequal' ) {
			return array(
				'additionalWhereArr' =>
						array(
		...
		} elseif ( $condition['operator'] == 'less' ) {
			return array(
				'additionalWhereArr' =>
							array(
		...
		} elseif ( $condition['operator'] == 'lessequal' ) {
			return array(
				'additionalWhereArr' =>
							array(
		...
		} elseif ( $condition['operator'] == 'intrange' ) {
			return array(
				'additionalWhereArr' =>
							array(
								'woo_order_count_larger' . $conditionKeySuffix => array(
