				...
				<?php 
					...
					if ( $email != '' ){
						...
						if ( $contact_id > 0 ){
							...
							$contact_transaction_count = $zbs->DAL->customer_has_count_obj_type( $contact_id, ZBS_TYPE_TRANSACTION, ZBS_TYPE_CONTACT ); // phpcs:ignore WordPress.NamingConventions.ValidVariableName.UsedPropertyNotSnakeCase
