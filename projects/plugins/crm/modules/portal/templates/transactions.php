...
$show_transaction_status = ( isset( $settings['portal_transactions_show_status'] ) && $settings['portal_transactions_show_status'] == '1' ); // phpcs:ignore Universal.Operators.StrictComparisons.LooseEqual
...
<div class="alignwide zbs-site-main zbs-portal-grid">
	...
	<div class="zbs-portal-content">
		...
		if ( $contact_id > 0 || $uinfo->has_cap( 'admin_zerobs_transactions' ) ) {
			// TODO: use pagination while getting from the db.
			$customer_transactions = $zbs->DAL->transactions->getTransactions( // phpcs:ignore WordPress.NamingConventions.ValidVariableName.UsedPropertyNotSnakeCase
				array(
