	...
	<form method="post">
		...
		<table class="table table-bordered table-striped wtab">
			...
			<tr>
				...
				<td style="width:540px"><input type="checkbox" class="winput form-control" name="jpcrm_tag_with_list" id="jpcrm_tag_with_list" value="1"
				<?php
				if ( isset( $settings['tag_with_list'] ) && $settings['tag_with_list'] == '1' ) {
			...
			<tr>
				...
				<td style="width:540px"><input type="checkbox" class="winput form-control" name="jpcrm_tag_with_tags" id="jpcrm_tag_with_tags" value="1"
				<?php
				if ( isset( $settings['tag_with_tags'] ) && $settings['tag_with_tags'] == '1' ) {
					echo ' checked="checked"';}
				?>
				/></td>
			</tr>
			...
			<tr>
				...
				<td style="width:540px"><input type="checkbox" class="winput form-control" name="jpcrm_autolog_changes" id="jpcrm_autolog_changes" value="1"
				<?php
				if ( isset( $settings['autolog_changes'] ) && $settings['autolog_changes'] == '1' ) {
					echo ' checked="checked"';}
				?>
				/></td>
			</tr>
