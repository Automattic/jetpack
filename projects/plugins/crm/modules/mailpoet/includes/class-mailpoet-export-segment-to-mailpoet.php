...
class Mailpoet_Export_Segment_To_MailPoet {
	...
	private function init_hooks() {
		...
		add_action(
			'jpcrm_segment_edit_export_mailpoet_button',
			function () {
		...
		add_filter(
			'zbs_globaljs_lang',
			function ( $language_labels = array() ) {
		 ...
		 */
		add_action(
			'wp_ajax_jpcrm_mailpoet_export_kick_off',
			function () {
		 ...
		 */
		add_action(
			'wp_ajax_jpcrm_mailpoet_export_segment',
			function () {
		 ...
		 */
		add_action(
			'wp_ajax_jpcrm_mailpoet_retrieve_list_summary',
			function () {
