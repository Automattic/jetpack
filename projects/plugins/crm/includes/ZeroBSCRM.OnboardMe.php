...
function jpcrm_onboardme_scripts() {
	...
	wp_enqueue_script( 'onboardme-front', ZEROBSCRM_URL . 'build/lib/js/hopscotch.min.js', array( 'jquery' ), $zbs::VERSION, true );
	wp_enqueue_style( 'onboardme-css', ZEROBSCRM_URL . 'build/lib/css/hopscotch.min.css', array(), $zbs::VERSION );
