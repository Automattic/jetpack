		...
		global $zbs;
            ...
            */
			...
			if ( isset( $obj->invoices_total ) ) {
				...
				$res['invoices_count']              = $zbs->DAL->customer_has_count_obj_type( $res['id'], ZBS_TYPE_INVOICE, ZBS_TYPE_COMPANY ); // phpcs:ignore WordPress.NamingConventions.ValidVariableName.UsedPropertyNotSnakeCase
