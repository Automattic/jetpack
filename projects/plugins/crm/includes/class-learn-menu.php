	...
	private function get_all_content() {
		...
		$learn_menu_array = array(
			...
			'editform'           => array(
				...
				'video'        => 'https://www.youtube.com/watch?v=mBPjV1KUb-w',
				'video_title'  => __( 'All about Forms', 'zero-bs-crm' ),
				'left_buttons' => '<a href="' . jpcrm_esc_link( 'create', -1, 'zerobs_form', false ) . '" class="jpcrm-button font-14px">' . __( 'Add new form', 'zero-bs-crm' ) . '</a>',
			),
			'formnew'            => array(
			...
			'quotenew'           => array(
				...
				'filter_function' => 'jpcrm_quotenew_learn_menu',
			),
			'quoteedit'          => array(
				...
				'content'         => '<p></p>',
				'back_slug'       => $zbs->slugs['managequotes'],
				'filter_function' => 'jpcrm_quoteedit_learn_menu',
			),
			'quotetags'          => array(
			...
			'transactionnew'     => array(
				...
				'filter_function' => 'jpcrm_transactionnew_learn_menu',
			),
			'transactionedit'    => array(
				...
				'back_slug'       => $zbs->slugs['managetransactions'],
				'filter_function' => 'jpcrm_transactionedit_learn_menu',
			),
