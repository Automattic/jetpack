			 ...
			 ===================== CUSTOMER ============================================== */
				...
				case 'customer':
					...
					#} Catch sorting
						...
						if (isset($listViewParams['sort']) && !empty($listViewParams['sort'])) {
							...
							if (!empty($possSortField) && $possSortField != false && $possSortField != "false"){
								...
								if ($sortField == 'post_id') $sortField = 'ID';
								if ($sortField == 'post_title') $sortField = 'zbsc_lname';
								if ($sortField == 'post_excerpt') $sortField = 'zbsc_lname';
					...
					// Retrieve data				
						...
						$sortIsCustomField = false; if (is_array($custFields) && array_key_exists($sortField,$custFields)) $sortIsCustomField = true;
						if (!$sortIsCustomField && $sortField != 'ID') $sortField = 'zbsc_'.$sortField;
