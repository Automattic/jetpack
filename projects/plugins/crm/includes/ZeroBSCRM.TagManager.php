						...
						<div class="twelve wide column">
							...
							<div id="zbs-column-manager-current-fields" class="ui segment zbs-column-manager-connected"> 
								...
								if ( is_array( $currentFields ) ) {
									foreach ( $currentFields as $colKey => $col ) {

										?>
									<div id="zbs-column-manager-field-<?php echo esc_attr( $colKey ); ?>" class="ui basic button zbs-column-manager-field" data-key="<?php echo esc_attr( $colKey ); ?>"><?php esc_html_e( $col[0], 'zero-bs-crm' ); ?></div>
										<?php
						...
						<div class="four wide column">
							...
							<div id="zbs-column-manager-available-fields" class="ui segment zbs-column-manager-connected"> 
								...
								if ( is_array( $allFields ) ) {
									foreach ( $allFields as $colKey => $col ) {
