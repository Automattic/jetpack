...
/* ======================================================
  ...
  global $zbsExtensionsExcludeFromSettings; $zbsExtensionsExcludeFromSettings = array('pdfinv','csvimporterlite','portal', 'cf7','cal','batchtagger','salesdash','envato','bulktag','clientportalpro','mailcampaigns','apiconnector','contactform7','awesomesupport','membermouse','bulktagger','systememailspro','woo','wpa','advancedsegments','contactform','pay');
...
function zeroBSCRM_extension_name_b2bmode(){ return __('B2B Mode',"zero-bs-crm"); }
