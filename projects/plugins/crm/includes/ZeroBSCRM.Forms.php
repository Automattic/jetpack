...
add_action(
	'widgets_init',
	function () {
		register_widget( 'ZBS_Form_Widget' );
	}
);
				...
				<div class="simple" style="border:0 !important">
					<div class="content">
						...
						if ( $showpoweredby_public ) {
							?>
								<div class="zbs_poweredby" style="font-size:11px;">Powered by <a href="<?php echo esc_url( $zbs->urls['home'] ); ?>" target="_blank">Jetpack CRM</a></div>
								<?php
						}
							##/WLREMOVE
						?>
