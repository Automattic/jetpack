	...
	public function html( $contact, $metabox ) {
		...
		?><div id="zbs-error-prep">
			...
			?>
				...
				if ( count( $tags ) == 0 ) {
					echo zeroBSCRM_UI2_messageHTML( 'info', __( 'No Tags Found', 'zero-bs-crm' ), __( 'There are no Tags here, create one using the box to the right.', 'zero-bs-crm' ), 'disabled warning sign', 'zbsNoTagResults' );
				}
