...
function zeroBSCRM_permsIsZBSUser() {
	...
	if ( $cu->has_cap( 'admin_zerobs_usr' ) ) {
		$zeroBSCRM_isZBSUser = true;
	}
	if ( $cu->has_cap( 'zerobs_customer' ) ) {
		$zeroBSCRM_isZBSUser = true;
	}
...
function zeroBSCRM_isZBSAdmin() {
	...
	if ( in_array( 'zerobs_admin', (array) $cu->roles ) ) {
		return true;
	}
...
function zeroBSCRM_permsSendEmailContacts() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_sendemails_contacts' ) ) {
		return true;
	}
	return false;
}
...
function zeroBSCRM_permsViewCustomers() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_view_customers' ) ) {
		return true;
	}
	return false;
}
function zeroBSCRM_permsCustomersTags() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_customers_tags' ) ) {
		return true;
	}
	return false;
}
function zeroBSCRM_permsQuotes() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_quotes' ) ) {
		return true;
	}
	return false;
}
function zeroBSCRM_permsViewQuotes() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_view_quotes' ) ) {
		return true;
	}
	return false;
}
function zeroBSCRM_permsInvoices() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_invoices' ) ) {
		return true;
	}
	return false;
}
function zeroBSCRM_permsViewInvoices() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_view_invoices' ) ) {
		return true;
	}
	return false;
}
function zeroBSCRM_permsTransactions() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_transactions' ) ) {
		return true;
	}
	return false;
}
function zeroBSCRM_permsViewTransactions() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_view_transactions' ) ) {
		return true;
	}
	return false;
}
function zeroBSCRM_permsMailCampaigns() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_mailcampaigns' ) ) {
		return true;
	}
	return false;
}
function zeroBSCRM_permsForms() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_forms' ) ) {
		return true;
	}
	return false;
}
...
function zeroBSCRM_perms_tasks() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_events' ) ) {
		return true;
	}
	return false;
}
function zeroBSCRM_permsNotify() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_notifications' ) ) {
		return true;
	}
	return false;
}
...
function zeroBSCRM_permsExport() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_customers' ) ) {
		return true;
	}
	return false;
}
...
function zeroBSCRM_permsLogsAddEdit() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_logs_addedit' ) ) {
		return true;
	}
	return false;
}
...
function zeroBSCRM_permsLogsDelete() {
	...
	$cu = wp_get_current_user();
	if ( $cu->has_cap( 'admin_zerobs_logs_delete' ) ) {
		return true;
	}
	return false;
}
...
function zeroBSCRM_permsClient() {
	// using Client to not confuse with Customer and Customer Manager
...
function zeroBS_getPossibleCustomerOwners() {
	return zeroBS_getPossibleOwners( array( 'zerobs_admin', 'zerobs_customermgr' ) ); }
function zeroBS_getPossibleCompanyOwners() {
	return zeroBS_getPossibleOwners( array( 'zerobs_admin', 'zerobs_customermgr' ) ); }
function zeroBS_getPossibleQuoteOwners() {
	return zeroBS_getPossibleOwners( array( 'zerobs_admin', 'zerobs_customermgr' ) ); }
function zeroBS_getPossibleInvoiceOwners() {
	return zeroBS_getPossibleOwners( array( 'zerobs_admin', 'zerobs_customermgr' ) ); }
function zeroBS_getPossibleTransactionOwners() {
	return zeroBS_getPossibleOwners( array( 'zerobs_admin', 'zerobs_customermgr' ) ); }
function zeroBS_getPossibleTaskOwners() {
	return zeroBS_getPossibleOwners( array( 'zerobs_admin', 'admin_zerobs_events' ) ); }
