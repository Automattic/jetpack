...
return [
    // # Issue statistics:
    // PhanUndeclaredVariable : 760+ occurrences
    ...
    // PhanImpossibleCondition : 170+ occurrences
    ...
    // PhanTypeSuspiciousEcho : 9 occurrences
    ...
    'file_suppressions' => [
        ...
        'includes/ZeroBSCRM.AdminPages.php' => ['PhanDeprecatedFunction', 'PhanImpossibleCondition', 'PhanPluginDuplicateAdjacentStatement', 'PhanPluginRedundantAssignment', 'PhanTypeExpectedObjectPropAccess', 'PhanTypeMismatchArgument', 'PhanTypeSuspiciousEcho'],
        ...
        'includes/ZeroBSCRM.Database.php' => ['PhanImpossibleCondition', 'PhanRedundantCondition', 'PhanSuspiciousValueComparison'],
        ...
        'includes/ZeroBSCRM.TagManager.php' => ['PhanEmptyForeach', 'PhanImpossibleCondition', 'PhanRedundantCondition', 'PhanUndeclaredProperty'],
        ...
        'includes/jpcrm-templating.php' => ['PhanImpossibleCondition', 'PhanTypeMismatchReturnProbablyReal', 'PhanUnextractableAnnotationElementName'],
        ...
        'modules/portal/class-client-portal.php' => ['PhanCommentParamWithoutRealParam', 'PhanRedundantCondition', 'PhanUndeclaredFunction', 'PhanUndeclaredTypeReturnType'],
