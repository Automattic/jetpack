			...
			function ( _dereq_, module, exports ) {
				...
				var MediaElement = function MediaElement( idOrNode, options, sources ) {
					...
					t.mediaElement.changeRenderer = function ( rendererName, mediaFiles ) {
						var t = _this,
							media =
								Object.keys( mediaFiles[ 0 ] ).length > 2 ? mediaFiles[ 0 ] : mediaFiles[ 0 ].src;
					...
					_createClass( Renderer, [
						...
						},
						{
							...
							set: function set( renderers ) {
								if (
									renderers !== null &&
									( typeof renderers === 'undefined' ? 'undefined' : _typeof( renderers ) ) !==
										'object'
								) {
				...
				var NativeDash = {
					...
					load: function load( settings ) {
						if ( typeof dashjs !== 'undefined' ) {
							...
							NativeDash.promise =
								NativeDash.promise || ( 0, _dom.loadScript )( settings.options.path );
				...
				var FlashMediaElementRenderer = {
					create: function create( mediaElement, options, mediaFiles ) {
						...
						if ( flash.options.streamDelimiter ) {
							flashVars.push(
								'streamdelimiter=' + encodeURIComponent( flash.options.streamDelimiter )
							);
						}
				...
				var NativeFlv = {
					...
					load: function load( settings ) {
						if ( typeof flvjs !== 'undefined' ) {
							...
							NativeFlv.promise =
								NativeFlv.promise || ( 0, _dom.loadScript )( settings.options.path );
				...
				var NativeHls = {
					...
					load: function load( settings ) {
						if ( typeof Hls !== 'undefined' ) {
							...
							NativeHls.promise =
								NativeHls.promise || ( 0, _dom.loadScript )( settings.options.path );
			...
			function ( _dereq_, module, exports ) {
				...
				function offset( el ) {
					var rect = el.getBoundingClientRect(),
						...
						scrollTop =
							_window2.default.pageYOffset || _document2.default.documentElement.scrollTop;
					...
					if ( isDropFrame( fps ) ) {
						...
						if ( m > dropFrames ) {
							f =
								f +
								dropFrames *
									Math.floor( ( m - dropFrames ) / Math.round( timeBase * 60 - dropFrames ) );
						}
