	...
	/******/ {
		/***/ '+B8m': /***/ function ( module, exports ) {
			...
			EmbedImage = AttachmentDisplay.extend(
				/** @lends wp.media.view.EmbedImage.prototype */ {
		...
		/***/ '04Ix': /***/ function ( module, exports ) {
			...
			Selection = wp.media.View.extend(
				/** @lends wp.media.view.Selection.prototype */ {
					tagName: 'div',
					...
					refresh: function () {
						...
						this.$( '.count' ).text(
							...
							sprintf(
								_n( '%s item selected', '%s items selected', collection.length ),
								collection.length
							)
						);
					},
		...
		/***/ '2NU8': /***/ function ( module, exports ) {
			 ...
			 */
			Toolbar = View.extend(
				/** @lends wp.media.view.Toolbar.prototype */ {
					tagName: 'div',
		...
		/***/ '2jku': /***/ function ( module, exports ) {
			...
			var Library = wp.media.view.Attachment.extend(
				/** @lends wp.media.view.Attachment.Library.prototype */ {
					buttons: {
						check: true,
					},
				}
		...
		/***/ '3nJM': /***/ function ( module, exports ) {
			...
			var FocusManager = wp.media.View.extend(
				/** @lends wp.media.view.FocusManager.prototype */ {
					events: {
					...
					setupAriaTabs: function () {
						...
						this.tabs.filter( '.active' ).removeAttr( 'tabindex' ).attr( 'aria-selected', 'true' );
					},
		...
		/***/ '4jjk': /***/ function ( module, exports ) {
			...
			Uploaded = wp.media.view.AttachmentFilters.extend(
				/** @lends wp.media.view.AttachmentFilters.Uploaded.prototype */ {
					createFilters: function () {
					...
					mainGalleryToolbar: function ( view ) {
						...
						view.set( 'gallery', {
							...
							click: function () {
								...
								edit.set(
									'library',
									new wp.media.model.Selection( models, {
		...
		/***/ '72mI': /***/ function ( module, exports ) {
			...
			AttachmentsBrowser = View.extend(
				/** @lends wp.media.view.AttachmentsBrowser.prototype */ {
					tagName: 'div',
					...
					announceSearchResults: _.debounce( function () {
						var count,
							...
							mediaFoundHasMoreResultsMessage = __(
					...
					createToolbar: function () {
						...
						if ( this.controller.isModeActive( 'grid' ) ) {
							...
							this.toolbar.set(
								...
								new wp.media.view.SelectModeToggleButton( {
								...
								new View( {
									el: $(
										'<div class="instructions">' +
											l10n.suggestedDimensions
												.replace( '%1$s', this.options.suggestedWidth )
												.replace( '%2$s', this.options.suggestedHeight ) +
											'</div>'
									)[ 0 ],
									priority: -40,
								} )
					...
					updateLoadMoreView: _.debounce( function () {
						...
						this.firstAddedMediaItem = this.$el
							.find( '.attachment' )
							.eq( this.firstAddedMediaItemIndex );
					...
					createSidebar: function () {
						...
						if ( this.controller.uploader ) {
							sidebar.set(
								'uploads',
								new wp.media.view.UploaderStatus( {
									controller: this.controller,
									priority: 40,
								} )
							);
					...
					createSingle: function () {
						...
						if ( this.options.display ) {
							sidebar.set(
								'display',
								new wp.media.view.Settings.AttachmentDisplay( {
									controller: this.controller,
		...
		/***/ '7Bpz': /***/ function ( module, exports ) {
			...
			UploaderInline = View.extend(
				/** @lends wp.media.view.UploaderInline.prototype */ {
					tagName: 'div',
					...
					ready: function () {
						...
						if ( this.controller.uploader ) {
							...
							$browser[ 0 ].setAttribute(
								'aria-labelledby',
								$browser[ 0 ].id + ' ' + $placeholder[ 0 ].getAttribute( 'aria-labelledby' )
							);
		...
		/***/ '99yY': /***/ function ( module, exports ) {
			...
			GalleryEdit = Library.extend(
				/** @lends wp.media.controller.GalleryEdit.prototype */ {
					defaults: {
						id: 'gallery-edit',
		...
		/***/ EVvK: /***/ function ( module, exports ) {
			 ...
			 */
			Router = Menu.extend(
				/** @lends wp.media.view.Router.prototype */ {
					tagName: 'div',
		...
		/***/ GXJ6: /***/ function ( module, exports ) {
			...
			ImageDetails = AttachmentDisplay.extend(
				/** @lends wp.media.view.ImageDetails.prototype */ {
		...
		/***/ GXkx: /***/ function ( module, exports ) {
			...
			EditorUploader = View.extend(
				/** @lends wp.media.view.EditorUploader.prototype */ {
					tagName: 'div',
					...
					initialize: function () {
						...
						this.$document.on(
							'dragover',
							'.uploader-editor',
							_.bind( this.dropzoneDragover, this )
						);
						this.$document.on(
							'dragleave',
							'.uploader-editor',
							_.bind( this.dropzoneDragleave, this )
						);
					...
					isDraggingFile: function ( event ) {
						...
						if (
							...
							_.isUndefined( event.originalEvent.dataTransfer )
						) {
							return false;
						}
		...
		/***/ IgEq: /***/ function ( module, exports ) {
			...
			Select = Toolbar.extend(
				/** @lends wp.media.view.Toolbar.Select.prototype */ {
					initialize: function () {
						var options = this.options;
		...
		/***/ JecU: /***/ function ( module, exports ) {
			...
			EmbedLink = wp.media.view.Settings.extend(
				/** @lends wp.media.view.EmbedLink.prototype */ {
		...
		/***/ Ju2C: /***/ function ( module, exports ) {
			...
			Menu = PriorityList.extend(
				/** @lends wp.media.view.Menu.prototype */ {
					tagName: 'div',
		...
		/***/ KerO: /***/ function ( module, exports ) {
			...
			All = wp.media.view.AttachmentFilters.extend(
				/** @lends wp.media.view.AttachmentFilters.All.prototype */ {
					createFilters: function () {
						var filters = {},
							uid = window.userSettings ? parseInt( window.userSettings.uid, 10 ) : 0;
						...
						if ( wp.media.view.settings.mediaTrash && this.controller.isModeActive( 'grid' ) ) {
							filters.trash = {
								text: l10n.trash,
								props: {
									uploadedTo: null,
		...
		/***/ LGdN: /***/ function ( module, exports ) {
			...
			var Frame = wp.media.View.extend(
				/** @lends wp.media.view.Frame.prototype */ {
					initialize: function () {
						_.defaults( this.options, {
							mode: [ 'select' ],
						} );
		...
		/***/ LZpE: /***/ function ( module, exports ) {
			...
			var Button = wp.media.View.extend(
				/** @lends wp.media.view.Button.prototype */ {
					tagName: 'button',
		...
		/***/ 'M+xU': /***/ function ( module, exports ) {
			...
			Cropper = wp.media.controller.State.extend(
				/** @lends wp.media.controller.Cropper.prototype */ {
					defaults: {
						id: 'cropper',
		...
		/***/ M5ZC: /***/ function ( module, exports ) {
			...
			var State = Backbone.Model.extend(
				/** @lends wp.media.controller.State.prototype */ {
					/**
					 * Constructor.
					 *
					 * @since 3.5.0
		...
		/***/ NguE: /***/ function ( module, exports ) {
			...
			UploaderStatus = View.extend(
				/** @lends wp.media.view.UploaderStatus.prototype */ {
					...
					progress: function () {
						...
						$bar.width(
							queue.reduce( function ( memo, attachment ) {
								if ( ! attachment.get( 'uploading' ) ) {
									return memo + 100;
								}
		...
		/***/ NjyZ: /***/ function ( module, exports ) {
			...
			var PriorityList = wp.media.View.extend(
				/** @lends wp.media.view.PriorityList.prototype */ {
					tagName: 'div',
		...
		/***/ Pt9x: /***/ function ( module, exports ) {
			...
			MediaFrame = Frame.extend(
				/** @lends wp.media.view.MediaFrame.prototype */ {
					...
					setRouterTabPanelAriaAttributes: function () {
						...
						// Set the tab panel attributes only if the tabs are visible.
						if (
							this.state().get( 'router' ) &&
							this.routerView &&
							this.routerView.isVisible &&
							this.content._mode
						) {
		...
		/***/ 'Q9T/': /***/ function ( module, exports ) {
			...
			var RouterItem = wp.media.view.MenuItem.extend(
				/** @lends wp.media.view.RouterItem.prototype */ {
					/**
		...
		/***/ S4jH: /***/ function ( module, exports ) {
			...
			UploaderWindow = wp.media.View.extend(
				/** @lends wp.media.view.UploaderWindow.prototype */ {
					tagName: 'div',
					...
					initialize: function () {
						...
						this.$browser = $( '<button type="button" class="browser" />' )
							.hide()
							.appendTo( 'body' );
		...
		/***/ U3Se: /***/ function ( module, exports ) {
			...
			_.extend(
				...
				Backbone.Events,
				/** @lends wp.media.controller.StateMachine.prototype */ {
					/**
					 * Fetch a state.
					 *
		...
		/***/ UmHM: /***/ function ( module, exports ) {
			...
			SiteIconCropper = View.Cropper.extend(
				/** @lends wp.media.view.SiteIconCropper.prototype */ {
					...
					addSidebar: function () {
						...
						this.sidebar.set(
							'preview',
							new wp.media.view.SiteIconPreview( {
								controller: this.controller,
								attachment: this.options.attachment,
							} )
						);
		...
		/***/ V6sy: /***/ function ( module, exports ) {
			...
			var Label = wp.media.View.extend(
				/** @lends wp.media.view.Label.prototype */ {
					tagName: 'label',
		...
		/***/ VIJ9: /***/ function ( module, exports ) {
			...
			ImageDetails = Select.extend(
				/** @lends wp.media.view.MediaFrame.ImageDetails.prototype */ {
					defaults: {
						id: 'image',
						url: '',
						menu: 'image-details',
					...
					initialize: function ( options ) {
						...
						this.options.selection = new wp.media.model.Selection( this.image.attachment, {
							multiple: false,
						} );
						Select.prototype.initialize.apply( this, arguments );
					},
		...
		/***/ Vh02: /***/ function ( module, exports ) {
			 ...
			 */
			Cropper = View.extend(
				/** @lends wp.media.view.Cropper.prototype */ {
					...
					onError: function () {
						...
						this.views.add(
							'.upload-errors',
							new wp.media.view.UploaderStatusError( {
		...
		/***/ VkcK: /***/ function ( module, exports ) {
			...
			DateFilter = wp.media.view.AttachmentFilters.extend(
				/** @lends wp.media.view.AttachmentFilters.Date.prototype */ {
		...
		/***/ 'W+32': /***/ function ( module, exports ) {
			...
			SiteIconCropper = Controller.Cropper.extend(
				/** @lends wp.media.controller.SiteIconCropper.prototype */ {
					activate: function () {
						this.frame.on( 'content:create:crop', this.createCropContent, this );
						this.frame.on( 'close', this.removeCropper, this );
						this.set( 'selection', new Backbone.Collection( this.frame._selection.single ) );
		...
		/***/ ZgZ7: /***/ function ( module, exports ) {
			...
			Search = wp.media.View.extend(
				/** @lends wp.media.view.Search.prototype */ {
					tagName: 'input',
					className: 'search',
		...
		/***/ d3xu: /***/ function ( module, exports ) {
			...
			SiteIconPreview = View.extend(
				/** @lends wp.media.view.SiteIconPreview.prototype */ {
		...
		/***/ dpRc: /***/ function ( module, exports ) {
			...
			MenuItem = wp.media.View.extend(
				/** @lends wp.media.view.MenuItem.prototype */ {
					tagName: 'button',
		...
		/***/ eqTc: /***/ function ( module, exports ) {
			...
			CustomizeImageCropper = Controller.Cropper.extend(
				/** @lends wp.media.controller.CustomizeImageCropper.prototype */ {
					/**
			...
			Select = MediaFrame.extend(
				/** @lends wp.media.view.MediaFrame.Select.prototype */ {
					...
					uploadContent: function () {
						this.$el.removeClass( 'hide-toolbar' );
						this.content.set(
							new wp.media.view.UploaderInline( {
								controller: this,
							} )
						);
					},
		...
		/***/ gOpb: /***/ function ( module, exports ) {
			...
			Modal = wp.media.View.extend(
				/** @lends wp.media.view.Modal.prototype */ {
					tagName: 'div',
					...
					open: function () {
						...
						if ( 'ontouchend' in document ) {
							if (
								( mceEditor = window.tinymce && window.tinymce.activeEditor ) &&
								! mceEditor.isHidden() &&
								mceEditor.iframeElement
							) {
					...
					close: function ( options ) {
						...
						if ( null !== this.clickedOpenerEl ) {
							...
							$( '#wpbody-content' ).attr( 'tabindex', '-1' ).trigger( 'focus' );
						}
		...
		/***/ ibOK: /***/ function ( module, exports ) {
			...
			EditImage = View.extend(
				/** @lends wp.media.view.EditImage.prototype */ {
		...
		/***/ iupV: /***/ function ( module, exports ) {
			...
			Details = Attachment.extend(
				/** @lends wp.media.view.Attachment.Details.prototype */ {
					tagName: 'div',
					...
					copyAttachmentDetailsURLClipboard: function () {
						...
						clipboard.on( 'success', function ( event ) {
							var triggerElement = $( event.trigger ),
								successElement = $(
									'.success',
									triggerElement.closest( '.copy-to-clipboard-container' )
								);
					...
					moveFocusToLastFallback: function () {
						...
						$( '.media-frame' ).attr( 'tabindex', '-1' ).trigger( 'focus' );
					},
					...
					toggleSelectionHandler: function ( event ) {
						if (
							...
							9 === event.keyCode &&
							event.shiftKey &&
							event.target === this.$( ':tabbable' ).get( 0 )
						) {
		...
		/***/ mVaH: /***/ function ( module, exports ) {
			...
			MediaLibrary = Library.extend(
				/** @lends wp.media.controller.MediaLibrary.prototype */ {
					defaults: _.defaults(
						{
							// Attachments browser defaults. @see media.view.AttachmentsBrowser
							filterable: 'uploaded',
		...
		/***/ nwwF: /***/ function ( module, exports ) {
			...
			Settings = View.extend(
				/** @lends wp.media.view.Settings.prototype */ {
					events: {
		...
		/***/ ojD6: /***/ function ( module, exports ) {
			...
			Attachments = View.extend(
				/** @lends wp.media.view.Attachments.prototype */ {
					tagName: 'ul',
					...
					bindEvents: function () {
						this.$window
							.off( this.resizeEvent )
							.on( this.resizeEvent, _.debounce( this.setColumns, 50 ) );
					},
					...
					setColumns: function () {
						...
						if ( width ) {
							this.columns =
								Math.min( Math.round( width / this.options.idealColumnWidth ), 12 ) || 1;
		...
		/***/ sULL: /***/ function ( module, exports ) {
			...
			Attachment = View.extend(
				/** @lends wp.media.view.Attachment.prototype */ {
					tagName: 'li',
					...
					initialize: function () {
						...
						this.listenTo(
							...
							'attachment:compat:waiting attachment:compat:ready',
							this.updateSave
						);
					},
					/**
		...
		/***/ t3nl: /***/ function ( module, exports ) {
			...
			var Iframe = wp.media.View.extend(
				/** @lends wp.media.view.Iframe.prototype */ {
		...
		/***/ 'tg/Y': /***/ function ( module, exports, __webpack_require__ ) {
			/**
		...
		/***/ wfCN: /***/ function ( module, exports ) {
			...
			Selection = Attachments.extend(
				/** @lends wp.media.view.Attachments.Selection.prototype */ {
					events: {},
					initialize: function () {
						_.defaults( this.options, {
							sortable: false,
		...
		/***/ xQvM: /***/ function ( module, exports ) {
			 ...
			 */
			Embed = Select.extend(
				/** @lends wp.media.view.Toolbar.Embed.prototype */ {
					initialize: function () {
						_.defaults( this.options, {
							text: l10n.insertIntoPost,
							requires: false,
		...
		/***/ 'z/+l': /***/ function ( module, exports ) {
			...
			ButtonGroup = wp.media.View.extend(
				/** @lends wp.media.view.ButtonGroup.prototype */ {
					tagName: 'div',
