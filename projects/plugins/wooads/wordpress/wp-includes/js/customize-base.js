...
( function ( exports, $ ) {
	...
	api.Value = api.Class.extend(
		/** @lends wp.customize.Value.prototype */ {
			/**
	...
	api.Values = api.Class.extend(
		/** @lends wp.customize.Values.prototype */ {
			/**
			...
			create: function ( id ) {
				return this.add(
					id,
					new this.defaultConstructor( api.Class.applicator, slice.call( arguments, 1 ) )
				);
			},
	...
	api.Messenger = api.Class.extend(
		/** @lends wp.customize.Messenger.prototype */ {
			/**
			 * Create a new Value.
			 *
	...
	api.Notification = api.Class.extend(
		/** @lends wp.customize.Notification.prototype */ {
			/**
