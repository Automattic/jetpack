this[ 'wp' ] = this[ 'wp' ] || {};
this[ 'wp' ][ 'blockSerializationDefaultParser' ] = /******/ ( function ( modules ) {
	// webpackBootstrap
	/******/ // The module cache
	...
	/************************************************************************/
	/******/ {
		/***/ SiJt: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			...
			function addBlockFromStack( endOffset ) {
				...
				if ( null !== leadingHtmlStart ) {
					output.push(
						Freeform( document.substr( leadingHtmlStart, tokenStart - leadingHtmlStart ) )
					);
				}
