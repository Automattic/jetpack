this[ 'wp' ] = this[ 'wp' ] || {};
this[ 'wp' ][ 'notices' ] = /******/ ( function ( modules ) {
	// webpackBootstrap
	/******/ // The module cache
	...
	/******/ {
		...
		/***/ Ko7W: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			__webpack_require__.d( actions_namespaceObject, 'createNotice', function () {
				return createNotice;
			} );
			__webpack_require__.d( actions_namespaceObject, 'createSuccessNotice', function () {
				return createSuccessNotice;
			} );
			__webpack_require__.d( actions_namespaceObject, 'createInfoNotice', function () {
				return createInfoNotice;
			} );
			__webpack_require__.d( actions_namespaceObject, 'createErrorNotice', function () {
				return createErrorNotice;
			} );
			__webpack_require__.d( actions_namespaceObject, 'createWarningNotice', function () {
				return createWarningNotice;
			} );
			__webpack_require__.d( actions_namespaceObject, 'removeNotice', function () {
				return removeNotice;
			} );
			...
			__webpack_require__.d( selectors_namespaceObject, 'getNotices', function () {
				return getNotices;
			} );
			...
			const notices = on_sub_key( 'context' )( function () {
				...
				switch ( action.type ) {
					case 'CREATE_NOTICE':
						...
						return [
							...Object( external_lodash_[ 'reject' ] )( state, {
								id: action.notice.id,
							} ),
							action.notice,
						];
			...
			function createNotice() {
				let status =
					arguments.length > 0 && arguments[ 0 ] !== undefined ? arguments[ 0 ] : DEFAULT_STATUS;
			...
			function removeNotice( id ) {
				let context =
					arguments.length > 1 && arguments[ 1 ] !== undefined ? arguments[ 1 ] : DEFAULT_CONTEXT;
				return {
					type: 'REMOVE_NOTICE',
					id,
					context,
