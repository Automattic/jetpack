...
this[ 'wp' ][ 'nux' ] = /******/ ( function ( modules ) {
	...
	/******/ {
		...
		/***/ '51Wn': /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			__webpack_require__.d( __webpack_exports__, 'DotTip', function () {
				return /* reexport */ dot_tip;
			} );

			// NAMESPACE OBJECT: ./node_modules/@wordpress/nux/build-module/store/actions.js
			var actions_namespaceObject = {};
			__webpack_require__.r( actions_namespaceObject );
			__webpack_require__.d( actions_namespaceObject, 'triggerGuide', function () {
				return triggerGuide;
			} );
			__webpack_require__.d( actions_namespaceObject, 'dismissTip', function () {
				return actions_dismissTip;
			} );
			__webpack_require__.d( actions_namespaceObject, 'disableTips', function () {
				return actions_disableTips;
			} );
			__webpack_require__.d( actions_namespaceObject, 'enableTips', function () {
				return enableTips;
			} );
			...
			__webpack_require__.d( selectors_namespaceObject, 'getAssociatedGuide', function () {
				return selectors_getAssociatedGuide;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'isTipVisible', function () {
				return selectors_isTipVisible;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'areTipsEnabled', function () {
				return selectors_areTipsEnabled;
			} );
			...
			const selectors_getAssociatedGuide = Object( rememo[ 'a' /* default */ ] )(
				( state, tipId ) => {
					for ( const tipIds of state.guides ) {
						if ( Object( external_lodash_[ 'includes' ] )( tipIds, tipId ) ) {
							const nonDismissedTips = Object( external_lodash_[ 'difference' ] )(
								tipIds,
								Object( external_lodash_[ 'keys' ] )( state.preferences.dismissedTips )
							);
			...
			function DotTip( _ref ) {
				...
				const onFocusOutsideCallback = Object( external_wp_element_[ 'useCallback' ] )(
					event => {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					external_wp_components_[ 'Popover' ],
					{
					...
					Object( external_wp_element_[ 'createElement' ] )( 'p', null, children ),
					Object( external_wp_element_[ 'createElement' ] )(
						...
						Object( external_wp_element_[ 'createElement' ] )(
							...
							hasNextTip
								? Object( external_wp_i18n_[ '__' ] )( 'See next tip' )
			...
			/* harmony default export */ var dot_tip = Object( external_wp_compose_[ 'compose' ] )(
				Object( external_wp_data_[ 'withSelect' ] )( ( select, _ref2 ) => {
					let { tipId } = _ref2;
