this[ 'wp' ] = this[ 'wp' ] || {};
this[ 'wp' ][ 'customizeWidgets' ] = /******/ ( function ( modules ) {
	// webpackBootstrap
	/******/ // The module cache
	...
	/******/ {
		...
		/***/ '9pbN': /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			function BlockInspectorButton( _ref ) {
				let { inspector, closeMenu, ...props } = _ref;
				const selectedBlockClientId = Object( external_wp_data_[ 'useSelect' ] )(
					select => select( external_wp_blockEditor_[ 'store' ] ).getSelectedBlockClientId(),
					[]
				);
				const selectedBlock = Object( external_wp_element_[ 'useMemo' ] )(
			...
			function Inserter( _ref ) {
				let { setIsOpened } = _ref;
				const inserterTitleId = Object( external_wp_compose_[ 'useInstanceId' ] )(
					Inserter,
					'customize-widget-layout__inserter-panel-title'
				);
				const insertionPoint = Object( external_wp_data_[ 'useSelect' ] )(
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )(
						...
						Object( external_wp_element_[ 'createElement' ] )(
							...
							Object( external_wp_i18n_[ '__' ] )( 'Add a block' )
						),
						Object( external_wp_element_[ 'createElement' ] )(
							external_wp_components_[ 'Button' ],
							{
			...
			function Header( _ref ) {
				...
				const [ [ hasUndo, hasRedo ], setUndoRedo ] = Object(
					external_wp_element_[ 'useState' ]
				)( [ sidebar.hasUndo(), sidebar.hasRedo() ] );
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createPortal' ] )(
						Object( external_wp_element_[ 'createElement' ] )( components_inserter, {
			...
			function useInserter( inserter ) {
				...
				return [
					isInserterOpened,
					Object( external_wp_element_[ 'useCallback' ] )(
						updater => {
							let isOpen = updater;

							if ( typeof updater === 'function' ) {
								isOpen = updater(
									Object( external_wp_data_[ 'select' ] )( store ).isInserterOpened()
								);
							}
			...
			var external_wp_isShallowEqual_default = /*#__PURE__*/ __webpack_require__.n(
				external_wp_isShallowEqual_
			);
			...
			function blockToWidget( block ) {
				...
				if ( isValidLegacyWidgetBlock ) {
					if ( block.attributes.id ) {
						...
						const { encoded, hash, raw, ...rest } = block.attributes.instance; // Widget that extends WP_Widget.

						widget = {
							idBase: block.attributes.idBase,
							instance: {
								...( existingWidget === null || existingWidget === void 0
									? void 0
				...
				return {
					...Object( external_lodash_[ 'omit' ] )( existingWidget, [ 'form', 'rendered' ] ),
					...widget,
				};
			}
			/**
			...
			function widgetToBlock( _ref ) {
				let { id, idBase, number, instance } = _ref;
				let block;
				const {
					encoded_serialized_instance: encoded,
					instance_hash_key: hash,
			...
			function useSidebarBlockEditor( sidebar ) {
				const [ blocks, setBlocks ] = Object( external_wp_element_[ 'useState' ] )( () =>
				...
				const onChangeBlocks = Object( external_wp_element_[ 'useCallback' ] )(
					nextBlocks => {
						setBlocks( prevBlocks => {
							if ( external_wp_isShallowEqual_default()( prevBlocks, nextBlocks ) ) {
								return prevBlocks;
							...
							const nextWidgets = nextBlocks.map( nextBlock => {
								...
								if ( widgetId && prevBlocksMap.has( widgetId ) ) {
									...
									if (
										Object( external_lodash_[ 'isEqual' ] )( nextBlock, prevBlock ) &&
										prevWidget
									) {
										return prevWidget;
									}
							...
							return nextBlocks.reduce( ( updatedNextBlocks, nextBlock, index ) => {
								...
								if ( addedWidgetId !== null ) {
									...
									updatedNextBlocks[ index ] = Object(
										external_wp_widgets_[ 'addWidgetIdToBlock' ]
									)( nextBlock, addedWidgetId );
								}
			...
			function FocusControl( _ref ) {
				let { api, sidebarControls, children } = _ref;
				const [ focusedWidgetIdRef, setFocusedWidgetIdRef ] = Object(
					external_wp_element_[ 'useState' ]
				)( {
					current: null,
				} );
				const focusWidget = Object( external_wp_element_[ 'useCallback' ] )(
					widgetId => {
			...
			const useFocusControl = () =>
				Object( external_wp_element_[ 'useContext' ] )( FocusControlContext );
			...
			function SidebarEditorProvider( _ref ) {
				let { sidebar, settings, children } = _ref;
			...
			function WelcomeGuide( _ref ) {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )(
						...
						Object( external_wp_i18n_[ '__' ] )( 'Got it' )
					),
					Object( external_wp_element_[ 'createElement' ] )( 'hr', {
					...
					! isEntirelyBlockWidgets &&
						Object( external_wp_element_[ 'createElement' ] )(
							...
							Object( external_wp_i18n_[ '__' ] )( 'Want to stick with the old widgets?' ),
							Object( external_wp_element_[ 'createElement' ] )( 'br', null ),
							Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )(
						...
						Object( external_wp_i18n_[ '__' ] )( 'New to the block editor?' ),
						Object( external_wp_element_[ 'createElement' ] )( 'br', null ),
						Object( external_wp_element_[ 'createElement' ] )(
							external_wp_components_[ 'ExternalLink' ],
							{
			...
			function KeyboardShortcutsRegister() {
				const { registerShortcut, unregisterShortcut } = Object(
			...
			function BlockAppender( props ) {
				...
				const isBlocksListEmpty = Object( external_wp_data_[ 'useSelect' ] )(
					select => select( external_wp_blockEditor_[ 'store' ] ).getBlockCount() === 0
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					external_wp_blockEditor_[ 'ButtonBlockAppender' ],
					Object( esm_extends[ 'a' /* default */ ] )( {}, props, {
						ref: ref,
					} )
				);
			}
			...
			function SidebarBlockEditor( _ref ) {
				let { blockEditorSettings, sidebar, inserter, inspector } = _ref;
				...
				const {
					...
					const { isFeatureActive } = select( build_module[ 'i' /* store */ ] );
					return {
			...
			function SidebarControls( _ref ) {
				let { sidebarControls, activeSidebarControl, children } = _ref;
				const context = Object( external_wp_element_[ 'useMemo' ] )(
					() => ( {
						sidebarControls,
			...
			function useSidebarControls() {
				const { sidebarControls } = Object( external_wp_element_[ 'useContext' ] )(
					SidebarControlsContext
				);
				return sidebarControls;
			}
			function useActiveSidebarControl() {
				const { activeSidebarControl } = Object( external_wp_element_[ 'useContext' ] )(
					SidebarControlsContext
				);
			...
			function useClearSelectedBlock( sidebarControl, popoverRef ) {
				const { hasSelectedBlock, hasMultiSelection } = Object( external_wp_data_[ 'useSelect' ] )(
					external_wp_blockEditor_[ 'store' ]
				);
					...
					if ( popoverRef.current && sidebarControl ) {
						...
						function handleClearSelectedBlock( element ) {
							if (
								...
								element &&
								ownerDocument.contains( element ) && // 3. It should also not exist in the container, the popover, nor the dialog.
								! container.contains( element ) &&
								! popoverRef.current.contains( element ) &&
								! element.closest( '[role="dialog"]' ) && // 4. The inspector should not be opened.
								! inspector.expanded()
							) {
								clearSelectedBlock();
							}
			...
			function CustomizeWidgets( _ref ) {
				let { api, sidebarControls, blockEditorSettings } = _ref;
				const [ activeSidebarControl, setActiveSidebarControl ] = Object(
					external_wp_element_[ 'useState' ]
				)( null );
				...
				const activeSidebar =
					...
					Object( external_wp_element_[ 'createPortal' ] )(
						Object( external_wp_element_[ 'createElement' ] )(
							...
							null,
							Object( external_wp_element_[ 'createElement' ] )( SidebarBlockEditor, {
								...
								this.parentSection.expand( {
									...
									completeCallback: () => {
										...
										if (
											...
											! this.contentContainer[ 0 ].contains( this.returnFocusWhenClose )
										) {
				...
				return class SidebarSection extends customize.Section {
					ready() {
						...
						this.inspector = new InspectorSection( getInspectorSectionId( this.id ), {
							...
							parentSection: this,
							customizeAction: [
								Object( external_wp_i18n_[ '__' ] )( 'Customizing' ),
						...
						const args = {
							...
							completeCallback() {
								...
								controls.forEach( control => {
									...
									( _control$onChangeSect = control.onChangeSectionExpanded ) === null ||
									_control$onChangeSect === void 0
										? void 0
										: _control$onChangeSect.call( control, expanded, args );
								} );
								( _args$completeCallbac = _args.completeCallback ) === null ||
								_args$completeCallbac === void 0
									? void 0
									: _args$completeCallbac.call( _args );
							},
						};
					...
					constructor() {
						...
						ownerWindow.addEventListener(
							...
							event => {
								if (
									this.expanded() &&
									( event.keyCode === external_wp_keycodes_[ 'ESCAPE' ] ||
										event.code === 'Escape' ) &&
						...
						this.expanded.bind( () => {
							if ( ! this.isFromInternalAction ) {
								...
								Object( external_wp_data_[ 'dispatch' ] )( store ).setIsInserterOpened(
									this.expanded()
								);
							}
						...
						if ( ! this.expanded() ) {
							...
							this.expand( {
								completeCallback() {
									...
									const searchBox = external_wp_dom_[ 'focus' ].tabbable.find(
										contentContainer
									)[ 1 ];
			...
			const withMoveToSidebarToolbarItem = Object(
				...
				BlockEdit => props => {
					...
					const hasMultipleSidebars =
						( sidebarControls === null || sidebarControls === void 0
							? void 0
							: sidebarControls.length ) > 1;
					const blockName = props.name;
					const clientId = props.clientId;
					const canInsertBlockInSidebar = Object( external_wp_data_[ 'useSelect' ] )(
						select => {
					...
					const block = Object( external_wp_data_[ 'useSelect' ] )(
						select => select( external_wp_blockEditor_[ 'store' ] ).getBlock( clientId ),
						[ clientId ]
					);
					const { removeBlock } = Object( external_wp_data_[ 'useDispatch' ] )(
						external_wp_blockEditor_[ 'store' ]
					);
							...
							Object( external_wp_element_[ 'createElement' ] )(
								...
								Object( external_wp_element_[ 'createElement' ] )(
									external_wp_widgets_[ 'MoveToWidgetArea' ],
									{
										...
										currentWidgetAreaId:
											activeSidebarControl === null || activeSidebarControl === void 0
												? void 0
			...
			const withWideWidgetDisplay = Object( external_wp_compose_[ 'createHigherOrderComponent' ] )(
				BlockEdit => props => {
					var _wp$customize$Widgets, _wp$customize$Widgets2;

					const { idBase } = props.attributes;
					const isWide =
						( _wp$customize$Widgets =
							( _wp$customize$Widgets2 = wide_widget_display_wp.customize.Widgets.data.availableWidgets.find(
								widget => widget.id_base === idBase
							) ) === null || _wp$customize$Widgets2 === void 0
								? void 0
								: _wp$customize$Widgets2.is_wide ) !== null && _wp$customize$Widgets !== void 0
							? _wp$customize$Widgets
							: false;
					return Object( external_wp_element_[ 'createElement' ] )(
						BlockEdit,
			...
			function initialize( editorName, blockEditorSettings ) {
				Object( external_wp_data_[ 'dispatch' ] )(
					build_module[ 'i' /* store */ ]
				).setFeatureDefaults( 'core/customize-widgets', {
					fixedToolbar: false,
					welcomeGuide: true,
				} );
				...
				build_module_wp.customize.bind( 'ready', () => {
					...
					Object( external_wp_element_[ 'render' ] )(
						Object( external_wp_element_[ 'createElement' ] )( CustomizeWidgets, {
