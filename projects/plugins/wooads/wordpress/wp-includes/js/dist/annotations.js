...
this[ 'wp' ][ 'annotations' ] = /******/ ( function ( modules ) {
	...
	/******/ {
		...
		/***/ '23Y4': /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			function applyAnnotations( record ) {
				...
				annotations.forEach( annotation => {
					...
					record = Object( external_wp_richText_[ 'applyFormat' ] )(
						record,
						{
							type: FORMAT_NAME,
							attributes: {
			...
			function removeAnnotations( record ) {
				return Object( external_wp_richText_[ 'removeFormat' ] )(
					record,
					'core/annotation',
					0,
					record.text.length
			...
			const { name: format_name, ...settings } = annotation_annotation;
					...
					case 'ANNOTATION_ADD':
						...
						const previousAnnotationsForBlock =
							( _state$blockClientId =
								state === null || state === void 0 ? void 0 : state[ blockClientId ] ) !== null &&
			...
			const __experimentalGetAnnotationsForBlock = Object( rememo[ 'a' /* default */ ] )(
				( state, blockClientId ) => {
					var _state$blockClientId;

					return ( ( _state$blockClientId =
						state === null || state === void 0 ? void 0 : state[ blockClientId ] ) !== null &&
					_state$blockClientId !== void 0
						? _state$blockClientId
						: []
			...
			const __experimentalGetAnnotationsForRichText = Object( rememo[ 'a' /* default */ ] )(
				( state, blockClientId, richTextIdentifier ) => {
					var _state$blockClientId4;

					return ( ( _state$blockClientId4 =
						state === null || state === void 0 ? void 0 : state[ blockClientId ] ) !== null &&
					_state$blockClientId4 !== void 0
		...
		/***/ '7Cbv': /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
