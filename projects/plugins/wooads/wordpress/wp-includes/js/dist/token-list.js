this[ 'wp' ] = this[ 'wp' ] || {};
this[ 'wp' ][ 'tokenList' ] = /******/ ( function ( modules ) {
	// webpackBootstrap
	/******/ // The module cache
	...
	/******/ {
		...
		/***/ hwXU: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			...
			class TokenList {
				...
				set value( value ) {
					value = String( value );
					this._valueAsArray = Object( lodash__WEBPACK_IMPORTED_MODULE_0__[ 'uniq' ] )(
						Object( lodash__WEBPACK_IMPORTED_MODULE_0__[ 'compact' ] )( value.split( /\s+/g ) )
					);
				...
				*[ Symbol.iterator ]() {
				...
				remove() {
					...
					this.value = Object( lodash__WEBPACK_IMPORTED_MODULE_0__[ 'without' ] )(
						this._valueAsArray,
						...items
					).join( ' ' );
				}
