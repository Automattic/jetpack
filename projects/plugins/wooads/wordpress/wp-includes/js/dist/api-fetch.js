...
this[ 'wp' ][ 'apiFetch' ] = /******/ ( function ( modules ) {
	...
	/******/ {
		...
		/***/ jqrR: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			function createNonceMiddleware( nonce ) {
				...
				const middleware = ( options, next ) => {
					...
					return next( { ...options, headers: { ...headers, 'X-WP-Nonce': middleware.nonce } } );
				};
			...
			function createPreloadingMiddleware( preloadedData ) {
				...
				return ( options, next ) => {
					...
					if ( ! rawPath && options.url ) {
						const pathFromQuery = Object( external_wp_url_[ 'getQueryArg' ] )(
							options.url,
							'rest_route'
						);
			...
			const userLocaleMiddleware = ( options, next ) => {
				if (
					...
					! Object( external_wp_url_[ 'hasQueryArg' ] )( options.url, '_locale' )
				) {
				...
				if (
					...
					! Object( external_wp_url_[ 'hasQueryArg' ] )( options.path, '_locale' )
				) {
