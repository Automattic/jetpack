this[ 'wp' ] = this[ 'wp' ] || {};
this[ 'wp' ][ 'serverSideRender' ] = /******/ ( function ( modules ) {
	// webpackBootstrap
	/******/ // The module cache
	...
	/******/ {
		...
		/***/ '4dqW': /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			function DefaultErrorResponsePlaceholder( _ref2 ) {
				...
				const errorMessage = Object( external_wp_i18n_[ 'sprintf' ] )(
					// translators: %s: error message describing the problem
					Object( external_wp_i18n_[ '__' ] )( 'Error loading block: %s' ),
					response.errorMsg
				);
				return Object( external_wp_element_[ 'createElement' ] )(
					external_wp_components_[ 'Placeholder' ],
			...
			function ServerSideRender( props ) {
				...
				function fetchData() {
					...
					const sanitizedAttributes =
						attributes &&
						Object( external_wp_blocks_[ '__experimentalSanitizeBlockAttributes' ] )(
							block,
							attributes
					...
					const urlAttributes = isPostRequest
						? null
						: sanitizedAttributes !== null && sanitizedAttributes !== void 0
						? sanitizedAttributes
						: null;
				...
				const debouncedFetchData = Object( external_wp_compose_[ 'useDebounce' ] )(
					fetchData,
					500
			...
			const ExportedServerSideRender = Object( external_wp_data_[ 'withSelect' ] )( select => {
				...
				let { urlQueryArgs = EMPTY_OBJECT, currentPostId, ...props } = _ref;
			...
			if ( window && window.wp && window.wp.components ) {
				window.wp.components.ServerSideRender = Object( external_wp_element_[ 'forwardRef' ] )(
					( props, ref ) => {
