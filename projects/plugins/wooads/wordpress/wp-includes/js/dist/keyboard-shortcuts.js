this[ 'wp' ] = this[ 'wp' ] || {};
this[ 'wp' ][ 'keyboardShortcuts' ] = /******/ ( function ( modules ) {
	// webpackBootstrap
	/******/ // The module cache
	...
	/******/ {
		...
		/***/ cFS5: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			__webpack_require__.d( __webpack_exports__, 'ShortcutProvider', function () {
				return /* reexport */ ShortcutProvider;
			} );
			__webpack_require__.d( __webpack_exports__, '__unstableUseShortcutEventMatch', function () {
			...
			__webpack_require__.d(
				...
				function () {
					return selectors_getAllShortcutKeyCombinations;
				}
			);
			__webpack_require__.d(
				selectors_namespaceObject,
			...
			function getShortcutRepresentation( state, name ) {
				let representation =
					arguments.length > 2 && arguments[ 2 ] !== undefined ? arguments[ 2 ] : 'display';
			...
			const selectors_getAllShortcutKeyCombinations = Object( rememo[ 'a' /* default */ ] )(
				( state, name ) => {
			...
			const getAllShortcutRawKeyCombinations = Object( rememo[ 'a' /* default */ ] )(
				( state, name ) => {
					return selectors_getAllShortcutKeyCombinations( state, name ).map( combination =>
			...
			const getCategoryShortcuts = Object( rememo[ 'a' /* default */ ] )(
				( state, categoryName ) => {
			...
			function useShortcutEventMatch() {
				const { getAllShortcutKeyCombinations } = Object( external_wp_data_[ 'useSelect' ] )(
					store
				);
				/**
