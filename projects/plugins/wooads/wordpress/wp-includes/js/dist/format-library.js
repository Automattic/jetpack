...
this[ 'wp' ][ 'formatLibrary' ] = /******/ ( function ( modules ) {
	...
	/************************************************************************/
	/******/ {
		/***/ '1Yn1': /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			...
			const code = Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
				...
				Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
					...
					{
						d:
							'M20.8 10.7l-4.3-4.3-1.1 1.1 4.3 4.3c.1.1.1.3 0 .4l-4.3 4.3 1.1 1.1 4.3-4.3c.7-.8.7-1.9 0-2.6zM4.2 11.8l4.3-4.3-1-1-4.3 4.3c-.7.7-.7 1.8 0 2.5l4.3 4.3 1.1-1.1-4.3-4.3c-.2-.1-.2-.3-.1-.4z',
					}
				)
			);
		...
		/***/ Bpkj: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
				'GRId'
			);
			...
			const link = Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
				_wordpress_primitives__WEBPACK_IMPORTED_MODULE_1__[ 'SVG' ],
				{
					xmlns: 'http://www.w3.org/2000/svg',
					viewBox: '0 0 24 24',
		...
		/***/ Crq9: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
				'GRId'
			);
			...
			const formatStrikethrough = Object(
		...
		/***/ Mp0b: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
				'GRId'
			);
			...
			const linkOff = Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
				_wordpress_primitives__WEBPACK_IMPORTED_MODULE_1__[ 'SVG' ],
				{
					xmlns: 'http://www.w3.org/2000/svg',
					viewBox: '0 0 24 24',
		...
		/***/ btIw: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
				'GRId'
			);
		...
		/***/ oMoS: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
				'GRId'
			);
			...
			const button = Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
				_wordpress_primitives__WEBPACK_IMPORTED_MODULE_1__[ 'SVG' ],
				{
					viewBox: '0 0 24 24',
					xmlns: 'http://www.w3.org/2000/svg',
				...
				Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
					...
					{
						d:
							'M19 6.5H5c-1.1 0-2 .9-2 2v7c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-7c0-1.1-.9-2-2-2zm.5 9c0 .3-.2.5-.5.5H5c-.3 0-.5-.2-.5-.5v-7c0-.3.2-.5.5-.5h14c.3 0 .5.2.5.5v7zM8 12.8h8v-1.5H8v1.5z',
					}
				)
			);
		...
		/***/ t1DA: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			const formatBold = Object( external_wp_element_[ 'createElement' ] )(
				...
				Object( external_wp_element_[ 'createElement' ] )( external_wp_primitives_[ 'Path' ], {
					d:
						'M14.7 11.3c1-.6 1.5-1.6 1.5-3 0-2.3-1.3-3.4-4-3.4H7v14h5.8c1.4 0 2.5-.3 3.3-1 .8-.7 1.2-1.7 1.2-2.9.1-1.9-.8-3.1-2.6-3.7zm-5.1-4h2.3c.6 0 1.1.1 1.4.4.3.3.5.7.5 1.2s-.2 1-.5 1.2c-.3.3-.8.4-1.4.4H9.6V7.3zm4.6 9c-.4.3-1 .4-1.7.4H9.6v-3.9h2.9c.7 0 1.3.2 1.7.5.4.3.6.8.6 1.5s-.2 1.2-.6 1.5z',
				} )
			);
			...
			const bold = {
				...
				edit( _ref ) {
					...
					function onToggle() {
						onChange(
							Object( external_wp_richText_[ 'toggleFormat' ] )( value, {
								type: bold_name,
								title,
							} )
						);
			...
			const code_code = {
				...
				__unstableInputRule( value ) {
					...
					value = Object( external_wp_richText_[ 'applyFormat' ] )(
						value,
						{
							type: code_name,
						},
			...
			const image_image = {
				...
				title: image_title,
				keywords: [
					Object( external_wp_i18n_[ '__' ] )( 'photo' ),
					Object( external_wp_i18n_[ '__' ] )( 'media' ),
				],
				object: true,
				tagName: 'img',
				className: null,
			...
			function Edit( _ref2 ) {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
						...
						external_wp_blockEditor_[ 'RichTextToolbarButton' ],
						{
							icon: Object( external_wp_element_[ 'createElement' ] )(
								...
								Object( external_wp_element_[ 'createElement' ] )(
									...
									{
										d:
											'M4 18.5h16V17H4v1.5zM16 13v1.5h4V13h-4zM5.1 15h7.8c.6 0 1.1-.5 1.1-1.1V6.1c0-.6-.5-1.1-1.1-1.1H5.1C4.5 5 4 5.5 4 6.1v7.8c0 .6.5 1.1 1.1 1.1zm.4-8.5h7V10l-1-1c-.3-.3-.8-.3-1 0l-1.6 1.5-1.2-.7c-.3-.2-.6-.2-.9 0l-1.3 1V6.5zm0 6.1l1.8-1.3 1.3.8c.3.2.7.2.9-.1l1.5-1.4 1.5 1.4v1.5h-7v-.9z',
									}
								)
							),
							title: image_title,
						...
						Object( external_wp_element_[ 'createElement' ] )(
							external_wp_blockEditor_[ 'MediaUpload' ],
							{
								...
								onSelect: _ref3 => {
									...
									closeModal();
									onChange(
										Object( external_wp_richText_[ 'insertObject' ] )( value, {
											type: image_name,
											attributes: {
					...
					isObjectActive &&
						Object( external_wp_element_[ 'createElement' ] )( InlineUI, {
							value: value,
							onChange: onChange,
			...
			const formatItalic = Object( external_wp_element_[ 'createElement' ] )(
				external_wp_primitives_[ 'SVG' ],
				{
					xmlns: 'http://www.w3.org/2000/svg',
					viewBox: '0 0 24 24',
			...
			function isValidHref( href ) {
				...
				if ( /^\S+:/.test( trimmedHref ) ) {
					...
					if (
						queryString &&
						! Object( external_wp_url_[ 'isValidQueryString' ] )( queryString )
					) {
						return false;
					}
				...
				if (
					...
					! Object( external_wp_url_[ 'isValidFragment' ] )( trimmedHref )
				) {
					return false;
				}
			...
			function getFormatBoundary( value, format ) {
				let startIndex =
					arguments.length > 2 && arguments[ 2 ] !== undefined ? arguments[ 2 ] : value.start;
				let endIndex =
					arguments.length > 3 && arguments[ 3 ] !== undefined ? arguments[ 3 ] : value.end;
				...
				const formatAtEndMinusOne = Object( external_lodash_[ 'find' ] )(
					newFormats[ endIndex - 1 ],
					{
						type: format.type,
					}
				);
			...
			const walkToStart = Object( external_lodash_[ 'partialRight' ] )(
				walkToBoundary,
				'backwards'
			);
			...
			function InlineLinkUI( _ref ) {
				...
				const { createPageEntity, userCanCreatePages } = Object( external_wp_data_[ 'useSelect' ] )(
					select => {
				...
				function onChangeLink( nextValue ) {
					...
					const didToggleSetting =
						linkValue.opensInNewTab !== nextValue.opensInNewTab && linkValue.url === nextValue.url; // If change handler was called as a result of a settings change during
					...
					if ( Object( external_wp_richText_[ 'isCollapsed' ] )( value ) && ! isActive ) {
						...
						const toInsert = Object( external_wp_richText_[ 'applyFormat' ] )(
						...
						if ( newText === richTextText ) {
							...
							newValue = Object( external_wp_richText_[ 'applyFormat' ] )(
								newValue,
								linkFormat,
								0,
								newText.length
							...
							newValue = Object( external_wp_richText_[ 'replace' ] )(
								value,
								richTextText,
								newValue
							);
				...
				const focusOnMount = Object( external_wp_element_[ 'useRef' ] )(
				...
				function createButtonText( searchTerm ) {
					return Object( external_wp_element_[ 'createInterpolateElement' ] )(
						Object( external_wp_i18n_[ 'sprintf' ] )(
							/* translators: %s: search term. */
							Object( external_wp_i18n_[ '__' ] )( 'Create Page: <mark>%s</mark>' ),
							searchTerm
						),
						{
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )(
						external_wp_blockEditor_[ '__experimentalLinkControl' ],
						{
							key: forceRemountKey,
							value: linkValue,
			...
			function link_Edit( _ref ) {
				let { isActive, activeAttributes, value, onChange, onFocus, contentRef } = _ref;
				const [ addingLink, setAddingLink ] = Object( external_wp_element_[ 'useState' ] )( false );

				function addLink() {
					const text = Object( external_wp_richText_[ 'getTextContent' ] )(
						Object( external_wp_richText_[ 'slice' ] )( value )
					);

					if ( text && Object( external_wp_url_[ 'isURL' ] )( text ) && isValidHref( text ) ) {
						onChange(
							Object( external_wp_richText_[ 'applyFormat' ] )( value, {
								type: link_name,
								attributes: {
									url: text,
								},
				...
				function onRemoveFormat() {
					...
					Object( external_wp_a11y_[ 'speak' ] )(
						Object( external_wp_i18n_[ '__' ] )( 'Link removed.' ),
						'assertive'
					);
				}
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					( addingLink || isActive ) &&
						Object( external_wp_element_[ 'createElement' ] )( inline, {
			...
			const textColor = Object( external_wp_element_[ 'createElement' ] )(
				external_wp_primitives_[ 'SVG' ],
				{
					xmlns: 'http://www.w3.org/2000/svg',
					viewBox: '0 0 24 24',
			...
			function getActiveColors( value, name, colorSettings ) {
				const activeColorFormat = Object( external_wp_richText_[ 'getActiveFormat' ] )(
					value,
					name
				);
			...
			function setColors( value, name, colorSettings, colors ) {
				...
				if ( color ) {
					const colorObject = Object( external_wp_blockEditor_[ 'getColorObjectByColorValue' ] )(
						colorSettings,
						color
					);
					...
					if ( colorObject ) {
						classNames.push(
							Object( external_wp_blockEditor_[ 'getColorClassName' ] )( 'color', colorObject.slug )
						);
					} else {
			...
			function ColorPicker( _ref ) {
				...
				const onColorChange = Object( external_wp_element_[ 'useCallback' ] )(
					color => {
						onChange(
				...
				const activeColors = Object( external_wp_element_[ 'useMemo' ] )(
   ...
   */
				const anchorRef = Object( external_wp_blockEditor_[ 'useCachedTruthy' ] )(
					Object( external_wp_richText_[ 'useAnchorRef' ] )( {
						ref: contentRef,
						value,
			...
			function TextColorEdit( _ref2 ) {
				...
				const allowCustomControl = Object( external_wp_blockEditor_[ 'useSetting' ] )(
					'color.custom'
				);
				const colors =
					Object( external_wp_blockEditor_[ 'useSetting' ] )( 'color.palette' ) || EMPTY_ARRAY;
				const [ isAddingColor, setIsAddingColor ] = Object( external_wp_element_[ 'useState' ] )(
					false
				);
				const enableIsAddingColor = Object( external_wp_element_[ 'useCallback' ] )(
					() => setIsAddingColor( true ),
					[ setIsAddingColor ]
				);
				const disableIsAddingColor = Object( external_wp_element_[ 'useCallback' ] )(
				...
				const hasColorsToChoose =
					! Object( external_lodash_[ 'isEmpty' ] )( colors ) || ! allowCustomControl;
					...
					Object( external_wp_element_[ 'createElement' ] )(
						external_wp_blockEditor_[ 'RichTextToolbarButton' ],
						{
							...
							onClick: hasColorsToChoose
								...
								: () =>
										onChange(
											Object( external_wp_richText_[ 'removeFormat' ] )( value, text_color_name )
										),
							role: 'menuitemcheckbox',
						}
					),
					isAddingColor &&
						Object( external_wp_element_[ 'createElement' ] )( InlineColorUI, {
			...
			const subscript = Object( external_wp_element_[ 'createElement' ] )(
				external_wp_primitives_[ 'SVG' ],
				{
					xmlns: 'http://www.w3.org/2000/svg',
					viewBox: '0 0 24 24',
				...
				Object( external_wp_element_[ 'createElement' ] )( external_wp_primitives_[ 'Path' ], {
					d:
						'M16.9 18.3l.8-1.2c.4-.6.7-1.2.9-1.6.2-.4.3-.8.3-1.2 0-.3-.1-.7-.2-1-.1-.3-.4-.5-.6-.7-.3-.2-.6-.3-1-.3s-.8.1-1.1.2c-.3.1-.7.3-1 .6l.2 1.3c.3-.3.5-.5.8-.6s.6-.2.9-.2c.3 0 .5.1.7.2.2.2.2.4.2.7 0 .3-.1.5-.2.8-.1.3-.4.7-.8 1.3L15 19.4h4.3v-1.2h-2.4zM14.1 7.2h-2L9.5 11 6.9 7.2h-2l3.6 5.3L4.7 18h2l2.7-4 2.7 4h2l-3.8-5.5 3.8-5.3z',
				} )
			);
			...
			const superscript = Object( external_wp_element_[ 'createElement' ] )(
				external_wp_primitives_[ 'SVG' ],
				{
					xmlns: 'http://www.w3.org/2000/svg',
					viewBox: '0 0 24 24',
				...
				Object( external_wp_element_[ 'createElement' ] )( external_wp_primitives_[ 'Path' ], {
					d:
						'M16.9 10.3l.8-1.3c.4-.6.7-1.2.9-1.6.2-.4.3-.8.3-1.2 0-.3-.1-.7-.2-1-.2-.2-.4-.4-.7-.6-.3-.2-.6-.3-1-.3s-.8.1-1.1.2c-.3.1-.7.3-1 .6l.1 1.3c.3-.3.5-.5.8-.6s.6-.2.9-.2c.3 0 .5.1.7.2.2.2.2.4.2.7 0 .3-.1.5-.2.8-.1.3-.4.7-.8 1.3l-1.8 2.8h4.3v-1.2h-2.2zm-2.8-3.1h-2L9.5 11 6.9 7.2h-2l3.6 5.3L4.7 18h2l2.7-4 2.7 4h2l-3.8-5.5 3.8-5.3z',
				} )
			);
