...
this[ 'wp' ][ 'blocks' ] = /******/ ( function ( modules ) {
	...
	/************************************************************************/
	/******/ {
		/***/ '0ATp': /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			__webpack_require__.d( __webpack_exports__, '__experimentalCloneSanitizedBlock', function () {
			...
			__webpack_require__.d( __webpack_exports__, '__unstableGetInnerBlocksProps', function () {
				return /* reexport */ getInnerBlocksProps;
			} );
			__webpack_require__.d( __webpack_exports__, '__unstableSerializeAndClean', function () {
			...
			__webpack_require__.d( __webpack_exports__, '__EXPERIMENTAL_ELEMENTS', function () {
				return /* reexport */ __EXPERIMENTAL_ELEMENTS;
			} );
			__webpack_require__.d( __webpack_exports__, '__EXPERIMENTAL_PATHS_WITH_MERGE', function () {
			...
			__webpack_require__.d( selectors_namespaceObject, 'getActiveBlockVariation', function () {
						...
						: variations.find( variation => {
								...
								if ( Array.isArray( variation.isActive ) ) {
									...
									return definedAttributes.every(
										attribute => attributes[ attribute ] === variation.attributes[ attribute ]
									);
								}
								...
								return ( _variation$isActive = variation.isActive ) === null ||
									...
									? void 0
									: _variation$isActive.call( variation, attributes, variation.attributes );
						  } );
				return match;
			}
			/**
			...
			const getChildBlockNames = Object( rememo[ 'a' /* default */ ] )(
				( state, blockName ) => {
					return Object( external_lodash_[ 'map' ] )(
						Object( external_lodash_[ 'filter' ] )( state.blockTypes, blockType => {
			...
			function isMatchingSearchTerm( state, nameOrType, searchTerm ) {
				...
				const isSearchMatch = Object( external_lodash_[ 'flow' ] )( [
					...
					normalizedCandidate =>
						Object( external_lodash_[ 'includes' ] )( normalizedCandidate, normalizedSearchTerm ),
				] );
				return (
			...
			function unstable__bootstrapServerSideBlockDefinitions( definitions ) {
				for ( const blockName of Object.keys( definitions ) ) {
					...
					serverSideBlockDefinitions[ blockName ] = Object( external_lodash_[ 'mapKeys' ] )(
			...
			function registerBlockType( blockNameOrMetadata, settings ) {
				...
				const blockType = {
					...
					variations: [],
					save: () => null,
					...( serverSideBlockDefinitions === null || serverSideBlockDefinitions === void 0
						? void 0
						: serverSideBlockDefinitions[ name ] ),
					...settings,
				};

				Object( external_wp_data_[ 'dispatch' ] )( store ).__experimentalRegisterBlockType(
					blockType
				);
			...
			function setFreeformContentHandlerName( blockName ) {
				Object( external_wp_data_[ 'dispatch' ] )( store ).setFreeformFallbackBlockName(
					blockName
				);
			}
			/**
			...
			function setUnregisteredTypeHandlerName( blockName ) {
				Object( external_wp_data_[ 'dispatch' ] )( store ).setUnregisteredFallbackBlockName(
					blockName
				);
			}
			/**
			...
			function registration_getBlockType( name ) {
				...
				return ( _select = Object( external_wp_data_[ 'select' ] )( store ) ) === null ||
					_select === void 0
					? void 0
			...
			function isReusableBlock( blockOrType ) {
				return (
					( blockOrType === null || blockOrType === void 0 ? void 0 : blockOrType.name ) ===
					'core/block'
				);
			}
			/**
			...
			const registration_hasChildBlocksWithInserterSupport = blockName => {
				return Object( external_wp_data_[ 'select' ] )( store ).hasChildBlocksWithInserterSupport(
					blockName
				);
			};
			/**
			...
			const getBlockTypesForPossibleFromTransforms = blocks => {
				...
				const blockTypesWithPossibleFromTransforms = Object( external_lodash_[ 'filter' ] )(
					allBlockTypes,
					blockType => {
			...
			function getBlockTransforms( direction, blockTypeOrName ) {
				...
				const filteredTransforms = usingMobileTransformations
					? Object( external_lodash_[ 'filter' ] )( transforms[ direction ], t => {
							...
							return Object( external_lodash_[ 'every' ] )( t.blocks, transformBlockName =>
			...
			function switchToBlockType( blocks, name ) {
				...
				if ( transformation.isMultiBlock ) {
					...
					Object( external_lodash_[ 'has' ] )( transformation, '__experimentalConvert' )
				) {
			...
			Object( colord[ 'b' /* extend */ ] )( [
				plugins_names[ 'a' /* default */ ],
				a11y[ 'a' /* default */ ],
			] );
			/**
			...
			function isUnmodifiedDefaultBlock( block ) {
				...
				return Object( external_lodash_[ 'every' ] )(
					blockType === null || blockType === void 0 ? void 0 : blockType.attributes,
				...
				if ( Object( external_lodash_[ 'has' ] )( icon, [ 'background' ] ) ) {
					...
					return {
						...
						foreground: icon.foreground
							? icon.foreground
							: Object( external_lodash_[ 'maxBy' ] )( ICON_COLORS, iconColor =>
			...
			function getBlockLabel( blockType, attributes ) {
				let context =
					arguments.length > 2 && arguments[ 2 ] !== undefined ? arguments[ 2 ] : 'visual';
			...
			function getAccessibleBlockLabel( blockType, attributes, position ) {
				let direction =
					arguments.length > 3 && arguments[ 3 ] !== undefined ? arguments[ 3 ] : 'vertical';
			...
			function __experimentalGetBlockAttributesNamesByRole( name, role ) {
				...
				const attributes =
					( _getBlockType = registration_getBlockType( name ) ) === null || _getBlockType === void 0
						? void 0
			...
			function processBlockType( blockType ) {
				...
				const settings = Object( external_wp_hooks_[ 'applyFilters' ] )(
				...
				if (
					...
					! Object( external_lodash_[ 'some' ] )(
						Object( external_wp_data_[ 'select' ] )( STORE_NAME ).getCategories(),
						{
			...
			function* __experimentalReapplyBlockTypeFilters() {
				const unprocessedBlockTypes = Object( external_wp_data_[ 'select' ] )(
					STORE_NAME
				).__experimentalGetUnprocessedBlockTypes();
			...
			function getInnerBlocksProps() {
				...
				const children = Object( external_wp_element_[ 'createElement' ] )(
			...
			function getSaveElement( blockTypeOrName, attributes ) {
				...
				if (
					...
					Object( external_wp_hooks_[ 'hasFilter' ] )( 'blocks.getSaveContent.extraProps' ) &&
			...
			function getCommentDelimitedContent( rawBlockName, attributes, content ) {
				const serializedAttributes = ! Object( external_lodash_[ 'isEmpty' ] )( attributes )
					? serializeAttributes( attributes ) + ' '
					: ''; // Strip core blocks of their namespace prefix.

				const blockName = Object( external_lodash_[ 'startsWith' ] )( rawBlockName, 'core/' )
			...
			function isEquivalentTextTokens( actual, expected ) {
				let logger =
					arguments.length > 2 && arguments[ 2 ] !== undefined ? arguments[ 2 ] : createLogger();
			...
			const isEqualAttributesOfName = {
				...
				...Object( external_lodash_[ 'fromPairs' ] )(
					BOOLEAN_ATTRIBUTES.map( attribute => [ attribute, external_lodash_[ 'stubTrue' ] ] )
				),
			};
			/**
			...
			function getHTMLTokens( html ) {
				let logger =
					arguments.length > 1 && arguments[ 1 ] !== undefined ? arguments[ 1 ] : createLogger();
			...
			function serializeRawBlock( rawBlock ) {
				...
				const { blockName, attrs = {}, innerBlocks = [], innerContent = [] } = rawBlock;
				let childIndex = 0;
			...
			function fixCustomClassname( blockAttributes, blockType, innerHTML ) {
				if ( registration_hasBlockSupport( blockType, 'customClassName', true ) ) {
					...
					const attributesSansClassName = Object( external_lodash_[ 'omit' ] )( blockAttributes, [
						'className',
					] );
					const serialized = getSaveContent( blockType, attributesSansClassName );
					const defaultClasses = getHTMLRootElementClasses( serialized );
					const actualClasses = getHTMLRootElementClasses( innerHTML );
					const customClasses = Object( external_lodash_[ 'difference' ] )(
						actualClasses,
						defaultClasses
					);
			...
			function applyBlockDeprecatedVersions( block, rawBlock, blockType ) {
				...
				for ( let i = 0; i < deprecatedDefinitions.length; i++ ) {
					...
					const { isEligible = external_lodash_[ 'stubFalse' ] } = deprecatedDefinitions[ i ];
					...
					if ( migrate ) {
						[
							...
							migrate( migratedAttributes, block.innerBlocks )
						);
					}
			...
			function convertLegacyBlocks( rawBlock ) {
				...
				return { ...rawBlock, blockName: correctName, attrs: correctedAttributes };
			}
			/**
			...
			function parseRawBlock( rawBlock ) {
				...
				const parsedInnerBlocks = normalizedBlock.innerBlocks
					.map( parseRawBlock ) // See https://github.com/WordPress/gutenberg/pull/17164.
					.filter( innerBlock => !! innerBlock ); // Get the fully parsed block.

				let parsedBlock = createBlock(
					normalizedBlock.blockName,
					getBlockAttributes( blockType, normalizedBlock.innerHTML, normalizedBlock.attrs ),
					parsedInnerBlocks
				);
			...
			function parser_parse( content ) {
				return Object( external_wp_blockSerializationDefaultParser_[ 'parse' ] )( content ).reduce(
			...
			function isInline( node, contextTag ) {
				...
				return inlineAllowedTagGroups.some(
					tagGroup =>
						Object( external_lodash_[ 'difference' ] )( [ tag, contextTag ], tagGroup ).length === 0
				);
			}
			...
			function wrapFigureContent( element ) {
				let beforeElement =
					arguments.length > 1 && arguments[ 1 ] !== undefined ? arguments[ 1 ] : element;
			...
			function segmentHTMLToShortcodeBlock( HTML ) {
				...
				const transformTag = Object( external_lodash_[ 'find' ] )( transformTags, tag =>
					Object( external_wp_shortcode_[ 'regexp' ] )( tag ).test( HTML )
				);
				let match;
				const previousIndex = lastIndex;

				if (
					( match = Object( external_wp_shortcode_[ 'next' ] )( transformTag, HTML, lastIndex ) )
				) {
					...
					if (
						! Object( external_lodash_[ 'includes' ] )( match.shortcode.content || '', '<' ) &&
					...
					let block = createBlock(
						transformation.blockName,
						getBlockAttributes( transformationBlockType, match.shortcode.content, attributes )
					);
			...
			function getBlockContentSchemaFromTransforms( transforms, context ) {
				const phrasingContentSchema = Object( external_wp_dom_[ 'getPhrasingContentSchema' ] )(
					context
				);
				const schemaArgs = {
				...
				const schemas = transforms.map( _ref => {
					...
					return Object( external_lodash_[ 'mapValues' ] )( schema, value => {
						...
						return { ...value, attributes, isMatch: isMatch ? isMatch : undefined };
					} );
				} );
			...
			function pasteHandler( _ref ) {
				let { HTML = '', plainText = '', mode = 'AUTO', tagName, preserveWhiteSpace } = _ref;
				...
				if (
					mode === 'AUTO' &&
					blocks.length === 1 &&
					registration_hasBlockSupport( blocks[ 0 ].name, '__unstablePasteTextInline', false )
				) {
			...
			function doBlocksMatchTemplate() {
				...
				return (
					...
					Object( external_lodash_[ 'every' ] )( template, ( _ref, index ) => {
						let [ name, , innerBlocksTemplate ] = _ref;
						const block = blocks[ index ];
						return (
							name === block.name && doBlocksMatchTemplate( block.innerBlocks, innerBlocksTemplate )
						);
					} )
				);
			}
			...
			function synchronizeBlocksWithTemplate() {
				...
				return Object( external_lodash_[ 'map' ] )( template, ( _ref2, index ) => {
					...
					const isHTMLAttribute = attributeDefinition =>
						Object( external_lodash_[ 'get' ] )( attributeDefinition, [ 'source' ] ) === 'html';

					const isQueryAttribute = attributeDefinition =>
						Object( external_lodash_[ 'get' ] )( attributeDefinition, [ 'source' ] ) === 'query';
			...
			const { Consumer, Provider } = Object( external_wp_element_[ 'createContext' ] )( () => {} );
			/**
			...
			const withBlockContentContext = Object(
				...
				return props =>
					Object( external_wp_element_[ 'createElement' ] )( Consumer, null, context =>
		...
		/***/ '7bKH': /***/ function ( __webpack_module__, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			var o = function ( o ) {
					var t = o / 255;
				...
				function validate( extension, name ) {
					...
					for ( var i = 0; i < extension.length; ++i ) {
						...
						if ( ! showdown.helper.isString( ext.type ) ) {
							ret.valid = false;
							ret.error =
								baseMsg + 'property "type" must be a string, but ' + typeof ext.type + ' given';
							return ret;
						}
						...
						if ( ext.filter ) {
							if ( typeof ext.filter !== 'function' ) {
								ret.valid = false;
								ret.error =
									baseMsg + '"filter" must be a function, but ' + typeof ext.filter + ' given';
								return ret;
							}
						} else if ( ext.regex ) {
							...
							if ( showdown.helper.isUndefined( ext.replace ) ) {
								ret.valid = false;
								ret.error =
									baseMsg + '"regex" extensions must implement a replace string or function';
								return ret;
							}
						}
					}
				...
				showdown.helper.replaceRecursiveRegExp = function ( str, replacement, left, right, flags ) {
					...
					if ( lng > 0 ) {
						...
						for ( var i = 0; i < lng; ++i ) {
							...
							if ( i < lng - 1 ) {
								bits.push(
									str.slice( matchPos[ i ].wholeMatch.end, matchPos[ i + 1 ].wholeMatch.start )
								);
							}
						}
    ...
    */
				...
				showdown.subParser( 'makeMarkdown.list', function ( node, globals, type ) {
					...
					for ( var i = 0; i < listItemsLenght; ++i ) {
						...
						// parse list item
						txt +=
							bullet + showdown.subParser( 'makeMarkdown.listItem' )( listItems[ i ], globals );
						++listNum;
					}
		...
		/***/ abaT: /***/ function ( __webpack_module__, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			/* harmony default export */ __webpack_exports__[ 'a' ] = function ( e, f ) {
				var a = {
						white: '#ffffff',
						bisque: '#ffe4c4',
						blue: '#0000ff',
		...
		/***/ fHnH: /***/ function ( __webpack_module__, __webpack_exports__, __webpack_require__ ) {
			'use strict';
