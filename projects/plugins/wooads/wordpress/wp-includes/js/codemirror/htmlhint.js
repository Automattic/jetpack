...
var HTMLHint = ( function ( e ) {
	...
	return (
		...
		( a.verify = function ( t, n ) {
			( n === e || 0 === Object.keys( n ).length ) && ( n = a.defaultRuleset ),
				( t = t.replace( /^\s*<!--\s*htmlhint\s+([^\r\n]+?)\s*-->/i, function ( t, a ) {
					return (
						n === e && ( n = {} ),
						a.replace( /(?:^|,)\s*([^:,]+)\s*(?:\:\s*([^,\s]+))?/g, function ( t, a, r ) {
			...
			var r,
				i = new HTMLParser(),
				s = new a.Reporter( t, n ),
				o = a.rules;
			for ( var l in n ) ( r = o[ l ] ), r !== e && n[ l ] !== ! 1 && r.init( i, s, n[ l ] );
		...
		( a.format = function ( e, a ) {
			...
			a.colors && ( ( r.white = '[37m' ), ( r.grey = '[90m' ), ( r.red = '[31m' ), ( r.reset = '[39m' ) );
			var i = a.indent || 0;
			return (
				e.forEach( function ( e ) {
					var a = 40,
						...
						d = o.length,
						c = u > a + 1 ? u - a : 1,
						f = o.length > u + s ? u + s : d;
					a + 1 > u && ( f += a - u + 1 ),
						( o = o.replace( /\t/g, ' ' ).substring( c - 1, f ) ),
						c > 1 && ( ( o = '...' + o ), ( c -= 3 ) ),
						d > f && ( o += '...' ),
						n.push( r.white + t( i ) + 'L' + l + ' |' + r.grey + o + r.reset );
					var g = u - c,
						h = o.substring( 0, g ).match( /[^\u0000-\u00ff]/g );
					null !== h && ( g += h.length ),
						n.push(
							r.white +
								t( i ) +
...
'object' == typeof exports && exports && ( exports.HTMLHint = HTMLHint ),
	( function ( e ) {
		var t = function () {
			var e = this;
		...
		( t.prototype = {
			...
			error: function ( e, t, a, n, r ) {
				this.report( 'error', e, t, a, n, r );
			},
			warn: function ( e, t, a, n, r ) {
				this.report( 'warning', e, t, a, n, r );
			},
			info: function ( e, t, a, n, r ) {
				this.report( 'info', e, t, a, n, r );
			},
			report: function ( e, t, a, n, r, i ) {
				for (
					var s, o, l = this, u = l.lines, d = l.brLen, c = a - 1, f = u.length;
					f > c && ( ( s = u[ c ] ), ( o = s.length ), n > o && f > a );
					c++
				)
					a++, ( n -= o ), 1 !== n && ( n -= d );
				l.messages.push( {
...
var HTMLParser = ( function ( e ) {
	...
	return (
		( t.prototype = {
			...
			makeMap: function ( e ) {
				for ( var t = {}, a = e.split( ',' ), n = 0; a.length > n; n++ ) t[ a[ n ] ] = ! 0;
				return t;
			},
			parse: function ( t ) {
				function a( t, a, n, r ) {
					...
					r === e && ( r = {} ),
						...
						L.push( r ),
						c.fire( t, r );
					for ( var s; ( s = m.exec( a ) );  ) w++, ( b = n + m.lastIndex );
				}
				var n,
					r,
					i,
					...
					if (
						...
						if ( o ) u.push( n[ 0 ] );
							...
							for ( var y, T = n[ 5 ], H = 0; ( y = h.exec( T ) );  ) {
								var x = y[ 1 ],
									M = y[ 2 ] ? y[ 2 ] : y[ 4 ] ? y[ 4 ] : '',
									N = y[ 3 ] ? y[ 3 ] : y[ 5 ] ? y[ 5 ] : y[ 6 ] ? y[ 6 ] : '';
								s.push( { name: x, value: N, quote: M, index: y.index, raw: y[ 0 ] } ),
									( H += y[ 0 ].length );
							}
							H === T.length
								? ( a( 'tagstart', n[ 0 ], r, { tagName: i, attrs: s, close: n[ 6 ] } ),
								  f[ i ] && ( ( o = i ), ( l = s.concat() ), ( u = [] ), ( v = p ) ) )
								: a( 'text', n[ 0 ], r );
						} else
							( n[ 2 ] || n[ 3 ] ) &&
								a( 'comment', n[ 0 ], r, { content: n[ 2 ] || n[ 3 ], long: n[ 2 ] ? ! 0 : ! 1 } );
					else a( 'tagend', n[ 0 ], r, { tagName: i } );
				t.length > p && ( ( d = t.substring( p, t.length ) ), a( 'text', d, p ) ),
					c.fire( 'end', { pos: p, line: w, col: t.length - b + 1 } );
			},
			addListener: function ( t, a ) {
				for ( var n, r = this._listeners, i = t.split( /[,\s]/ ), s = 0, o = i.length; o > s; s++ )
			...
			fire: function ( t, a ) {
				...
				for ( var l = 0, u = r.length; u > l; l++ ) r[ l ].call( n, a );
			},
			...
			fixPos: function ( e, t ) {
				var a,
					...
					s = e.line;
				return (
					i > 0 ? ( ( s += i ), ( a = r[ i ].length + 1 ) ) : ( a = e.col + t ), { line: s, col: a }
				);
			},
...
'object' == typeof exports && exports && ( exports.HTMLParser = HTMLParser ),
	HTMLHint.addRule( {
		id: 'alt-require',
		description:
				...
				'img' !== i || 'alt' in s
					? ( ( 'area' === i && 'href' in s ) || ( 'input' === i && 'image' === s.type ) ) &&
					  ( ( 'alt' in s && '' !== s.alt ) ||
							...
							t.warn( 'The alt attribute of ' + r + ' must have a value.', n.line, o, a, n.raw ) ) )
					: t.warn( 'An alt attribute must be present on <img> elements.', n.line, o, a, n.raw );
			} );
		},
	} ),
	HTMLHint.addRule( {
		...
		init: function ( e, t, a ) {
			...
			e.addListener( 'tagstart', function ( e ) {
				for (
					var a, i = e.attrs, s = e.col + e.tagName.length + 1, o = 0, l = i.length;
					l > o;
					o++
				) {
					a = i[ o ];
	...
	HTMLHint.addRule( {
		...
		init: function ( e, t ) {
			...
			e.addListener( 'tagstart', function ( e ) {
				for (
					var n, r, i = e.attrs, s = e.col + e.tagName.length + 1, o = {}, l = 0, u = i.length;
					u > l;
					l++
				)
					( n = i[ l ] ),
	...
	HTMLHint.addRule( {
		...
		init: function ( e, t ) {
			...
			e.addListener( 'tagstart', function ( e ) {
				for (
					var n, r = e.attrs, i = e.col + e.tagName.length + 1, s = 0, o = r.length;
					o > s;
					s++
				)
					( n = r[ s ] ),
						( ( '' !== n.value && '"' !== n.quote ) || ( '' === n.value && "'" === n.quote ) ) &&
							t.error(
								'The value of attribute [ ' + n.name + ' ] must be in double quotes.',
								e.line,
								i + n.index,
								a,
								n.raw
			...
			var a = this,
				n = function ( r ) {
					'start' === r.type ||
						...
						( ( ( 'comment' !== r.type && r.long === ! 1 ) ||
							/^DOCTYPE\s+/i.test( r.content ) === ! 1 ) &&
							t.error( 'Doctype must be declared first.', r.line, r.col, a, r.raw ),
		...
		init: function ( e, t ) {
			function a( e ) {
				e.long === ! 1 &&
					...
					t.warn( 'Invalid doctype. Use: "<!DOCTYPE html>"', e.line, e.col, r, e.raw );
			}
			function n() {
	...
	HTMLHint.addRule( {
		...
		init: function ( e, t ) {
			function a( a ) {
				...
				'head' === l && ( s = ! 0 ),
					s !== ! 0 ||
						'script' !== l ||
						( o && i.test( o ) !== ! 0 ) ||
						t.warn( 'The <script> tag cannot be used in a <head> tag.', a.line, a.col, r, a.raw );
			}
			function n( t ) {
			...
			var r = this,
				i = /^(text\/javascript|application\/javascript)$/i,
				s = ! 1;
				...
				for (
					...
					if ( ( ( a = i[ o ] ), 'href' === a.name ) ) {
						( ( 'absolute' === r && /^\w+?:/.test( a.value ) === ! 1 ) ||
							...
							t.warn(
								'The value of the href attribute [ ' + a.value + ' ] must be ' + r + '.',
								e.line,
								s + a.index,
								n,
								a.raw
	...
	HTMLHint.addRule( {
		...
		init: function ( e, t ) {
			...
			e.addListener( 'tagstart', function ( e ) {
				for (
					var n, r, i = e.attrs, s = e.col + e.tagName.length + 1, o = 0, l = i.length;
					l > o;
					o++
				)
					( n = i[ o ] ),
						...
						/^(id|class)$/i.test( r ) &&
							...
							t.warn(
								'The value of attribute ' + r + ' cannot use the ad keyword.',
								e.line,
								s + n.index,
								a,
								n.raw
	...
	HTMLHint.addRule( {
		...
		init: function ( e, t, a ) {
			...
			if ( ( ( n = 'string' == typeof a ? i[ a ] : a ), n && n.regId ) ) {
				var s = n.regId,
					o = n.message;
				e.addListener( 'tagstart', function ( e ) {
					for (
						var a, n = e.attrs, i = e.col + e.tagName.length + 1, l = 0, u = n.length;
						u > l;
						l++
					)
						if (
							...
							for ( var d, c = a.value.split( /\s+/g ), f = 0, g = c.length; g > f; f++ )
								( d = c[ f ] ), d && s.test( d ) === ! 1 && t.warn( o, e.line, i + a.index, r, d );
				} );
			}
		},
	} ),
	HTMLHint.addRule( {
		...
		init: function ( e, t ) {
			...
			e.addListener( 'tagstart', function ( e ) {
				for (
					var r, i, s = e.attrs, o = e.col + e.tagName.length + 1, l = 0, u = s.length;
					u > l;
					l++
				)
			...
			e.addListener( 'cdata', function ( r ) {
				if ( 'script' === r.tagName.toLowerCase() ) {
					var i = e.getMapAttrs( r.attrs ),
						s = i.type;
					if ( void 0 !== i.src || ( s && /^(text\/javascript)$/i.test( s ) === ! 1 ) ) return;
					var o;
					if (
						( ( o = 'object' == typeof exports && require ? require( 'jshint' ).JSHINT : JSHINT ),
						void 0 !== a )
					) {
						var l = r.line - 1,
							u = r.col - 1,
							d = r.raw.replace( /\t/g, ' ' );
						try {
							var c = o( d, a, a.globals );
							c === ! 1 &&
								o.errors.forEach( function ( e ) {
									var a = e.line;
									t.warn( e.reason, l + a, ( 1 === a ? u : 0 ) + e.character, n, e.evidence );
								} );
						} catch ( f ) {}
					}
				}
					...
					if ( 1 === u.col ) {
						...
						'space' === r
							? i
								...
								: /^ +$/.test( d ) === ! 1 &&
								  t.warn( 'Please use space for indentation.', u.line, 1, n, a.raw )
							: 'tab' === r && /^\t+$/.test( d ) === ! 1
							? t.warn( 'Please use tab for indentation.', u.line, 1, n, a.raw )
							: / +\t|\t+ /.test( d ) === ! 0 &&
							  t.warn( 'Do not mix tabs and spaces for indentation.', u.line, 1, n, a.raw );
					}
				}
			} );
		},
	...
	HTMLHint.addRule( {
		...
		init: function ( e, t ) {
			...
			e.addListener( 'tagstart', function ( e ) {
				for (
					var n, r = e.tagName, i = e.attrs, s = e.col + r.length + 1, o = 0, l = i.length;
					l > o;
					o++
				)
					( n = i[ o ] ),
						( ( /^(img|script|embed|bgsound|iframe)$/.test( r ) === ! 0 && 'src' === n.name ) ||
							( 'link' === r && 'href' === n.name ) ||
							( 'object' === r && 'data' === n.name ) ) &&
							'' === n.value &&
							t.error(
								'The attribute [ ' + n.name + ' ] of the tag [ ' + r + ' ] must have a value.',
								e.line,
								s + n.index,
								a,
								n.raw
	...
	HTMLHint.addRule( {
		...
		init: function ( e, t ) {
			...
			e.addListener( 'tagstart', function ( e ) {
				...
				void 0 !== r[ t ] || e.close || n.push( { tagName: t, line: e.line, raw: e.raw } );
			} ),
				e.addListener( 'tagend', function ( e ) {
					...
					if ( i >= 0 ) {
						for ( var s = [], o = n.length - 1; o > i; o-- ) s.push( '</' + n[ o ].tagName + '>' );
						if ( s.length > 0 ) {
							var l = n[ n.length - 1 ];
							t.error(
				...
				e.addListener( 'end', function ( e ) {
					for ( var r = [], i = n.length - 1; i >= 0; i-- ) r.push( '</' + n[ i ].tagName + '>' );
					if ( r.length > 0 ) {
						var s = n[ n.length - 1 ];
						t.error(
							'Tag must be paired, missing: [ ' +
	...
	HTMLHint.addRule( {
		...
		init: function ( e, t ) {
			...
			e.addListener( 'tagstart,tagend', function ( e ) {
				...
				n !== n.toLowerCase() &&
					t.error(
						'The html element name of [ ' + n + ' ] must be in lowercase.',
						e.line,
						e.col,
						a,
						e.raw
	...
	HTMLHint.addRule( {
		...
		init: function ( e, t ) {
			function a( e ) {
				var t = e.tagName.toLowerCase();
				'head' === t ? ( i = ! 0 ) : 'title' === t && i && ( s = ! 0 );
			}
			function n( i ) {
				var o = i.tagName.toLowerCase();
				if ( s && 'title' === o ) {
					var l = i.lastEvent;
					( 'text' !== l.type || ( 'text' === l.type && /^\s*$/.test( l.raw ) === ! 0 ) ) &&
						t.error( '<title></title> must not be empty.', i.line, i.col, r, i.raw );
				} else
					'head' === o &&
						( s === ! 1 &&
							t.error( '<title> must be present in <head> tag.', i.line, i.col, r, i.raw ),
						e.removeListener( 'tagstart', a ),
						e.removeListener( 'tagend', n ) );
			}
			var r = this,
				i = ! 1,
				s = ! 1;
