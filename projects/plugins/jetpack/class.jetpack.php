...
<p><?php echo esc_html( $message ); ?></p>
	...
	/**
	 * Register the on-upgrade init hooks, extracted so they can be exercised in tests
	 * without invoking plugin_upgrade(), whose guards make it unreliable to trigger.
	 *
	 * @return void
	 */
