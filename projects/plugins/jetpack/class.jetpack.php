...
class Jetpack {
	 ...
	 * menu alongside the existing Stats UI; it does not replace or hide any of
	 * the legacy Stats menu, admin-bar entries, post-list column, or WP
	 * dashboard widget. The Stats module's tracking is unaffected either way —
	 * Stats v2 depends on it.
	 *
