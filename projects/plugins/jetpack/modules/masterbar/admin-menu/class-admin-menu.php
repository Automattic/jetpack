...
<div class="upsell_banner">
	 ...
	 *
	 * @param array $current_product The site's product if they have one. This is passed from WPcom_Admin_Menu to
	 * prevent redundant database queries.
	 */
	public function add_woocommerce_installation_menu( $current_product = null ) {
		/**
