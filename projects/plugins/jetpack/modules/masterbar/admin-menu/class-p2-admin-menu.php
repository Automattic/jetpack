...
class P2_Admin_Menu extends WPcom_Admin_Menu {
	...
	private function remove_menus_for_hub() {
		...
		add_submenu_page( $this->tools_slug, esc_attr__( 'Integrations', 'jetpack' ), __( 'Integrations', 'jetpack' ), 'manage_options', 'https://wordpress.com/marketing/connections/' . $this->domain, null, 0 );
		// Hide settings.
