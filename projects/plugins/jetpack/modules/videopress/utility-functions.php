...
function videopress_get_attachment_url( $post_id, $ignore_compat = false ) {
	...
	if ( ! $ignore_compat && isset( $meta['videopress']['files']['hd_1080p_compat']['mp4'] ) ) {
	...
	} elseif ( ! $ignore_compat && isset( $meta['videopress']['files']['hd']['mp4'] ) && ! isset( $meta['videopress']['files']['hd']['hls'] ) ) {
		...
		if ( isset( $meta['original'] ) ) {
			$return = isset( $meta['original']['url'] ) ? $meta['original']['url'] : $meta['original'];
		} else {
