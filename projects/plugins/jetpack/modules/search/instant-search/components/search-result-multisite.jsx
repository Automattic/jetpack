			...
			<ul className="jetpack-instant-search__search-result-multisite__footer">
				<li>
					<PhotonImage
						...
						lazyLoad={ false }
					/>
					<span className="jetpack-instant-search__search-result-multisite__footer-blog">{ fields.blog_name }</span>
				</li>
				<li>
					<span className="jetpack-instant-search__search-result-multisite__footer-author">{ fields.author }</span>
				</li>
				<li>
					<span className="jetpack-instant-search__search-result-multisite__footer-date">{ getDateString( fields.date ) }</span>
				</li>
			</ul>
		</li>
	);
