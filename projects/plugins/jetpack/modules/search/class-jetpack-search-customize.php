...
class Jetpack_Search_Customize {
	...
	public function customize_register( $wp_customize ) {
		...
		$wp_customize->add_setting(
			$id,
			array(
				'default'   => Automattic\Jetpack\Search\Options::OVERLAY_TRIGGER_IMMEDIATE,
				'transport' => 'postMessage',
				'type'      => 'option',
			)
		);
		$wp_customize->add_control(
			...
			array(
				...
				'type'        => 'select',
				'choices'     => array(
					Automattic\Jetpack\Search\Options::OVERLAY_TRIGGER_IMMEDIATE => __( 'Open when user starts typing', 'jetpack' ),
					Automattic\Jetpack\Search\Options::OVERLAY_TRIGGER_RESULTS   => __( 'Open when results are available', 'jetpack' ),
					Automattic\Jetpack\Search\Options::OVERLAY_TRIGGER_SUBMIT    => __( 'Open when user submits the form', 'jetpack' ),
				),
			)
		);
