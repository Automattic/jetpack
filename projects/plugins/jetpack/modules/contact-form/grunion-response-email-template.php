							...
							<tbody>
								...
								<tr>
									<td class="build-your-own-jetpack-new-section" align="left" style="border-collapse: collapse; background-color: #F9F9F6; font-family: \'SF Pro Display\', Helvetica, Arial, sans-serif; padding: 32px 24px;">
										<span class="build-your-own-jetpack-new-section-eyebrow" style="color: #008710; font-weight: 600; line-height: 1.8; font-size: 16px;">' . esc_html__( 'Did you know?', 'jetpack' ) . '</span>
										<h2 class="build-your-own-jetpack-new-section-header-text" style="font-size: 26px; font-weight: 600; line-height: 1.2; margin: 16px 0;">' . esc_html__( 'Export your form responses to Google Sheets with just one click', 'jetpack' ) . '</h2>
									...
									<td class="footer-november-2022" style="border-collapse: collapse; font-family: \'SF Pro Display\', Helvetica, Arial, sans-serif; padding: 48px 56px;">
										<table style="border-collapse: collapse; width: 100%%;">
											...
											<tr>
												...
												<h2 class="footer-november-2022-header-text" style="color: #101517; font-size: 16px; line-height: 1.2; margin-bottom: 8px; margin-top: 0;">' . esc_html__( 'Get Jetpack on the go', 'jetpack' ) . '</h2>

													<p class="footer-november-2022-body-text" style="direction: ltr; color: #3c434a; font-size: 14px; line-height: 1.4; margin-bottom: 16px; margin-top: 0;">' . esc_html__( 'View site activity and stats, get notifications when your site is down, fix malware threats, and restore your site from anywhere.', 'jetpack' ) . '</p>
												</td>
											</tr>
											<tr>
