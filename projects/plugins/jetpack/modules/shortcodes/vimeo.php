 ...
 *
 * @deprecated $$next-version$$ Use Automattic\Jetpack\Post_Media\Shortcodes::get_vimeo_id() instead.
 *
 * @param array $atts Shortcode attributes.
 */
function jetpack_shortcode_get_vimeo_id( $atts ) {
	_deprecated_function( __FUNCTION__, 'jetpack-$$next-version$$', 'Automattic\Jetpack\Post_Media\Shortcodes::get_vimeo_id' );
	return \Automattic\Jetpack\Post_Media\Shortcodes::get_vimeo_id( $atts );
}
