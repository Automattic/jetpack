...
<tr valign="top">
	...
	<td>
		...
		printf(
			...
			( 1 === (int) $disable ) ? esc_attr( ' checked="checked"' ) : null,
			esc_html_e( 'Advanced. If this option is checked, you must include these files in your theme manually for the sharing links to work.', 'jetpack' )
		);
		?>
	</td>
</tr>
