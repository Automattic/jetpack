...
class Sharing_Admin {
	...
	public function output_service( $id, $service, $show_dropdown = false ) { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable
		...
		if ( $service->is_deprecated() ) {
			...
			$title     = sprintf( __( 'The %1$s sharing service is no longer supported. This sharing button is not displayed to your visitors and should be removed.', 'jetpack' ), $service->get_name() );
			$klasses[] = 'share-deprecated';
		}
