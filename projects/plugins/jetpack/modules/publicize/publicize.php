...
abstract class Publicize_Base {
	...
	*/
	 ...
	 * @var bool
	 */
	public $POST_SHARE_FEATURE_ENABLED = '_wpas_share_feature_enabled';
 ...
 */
	...
	function register_post_meta() {
		...
		foreach ( get_post_types() as $post_type ) {
			...
			$share_post_feature_args['object_subtype'] = $post_type;

			register_meta( 'post', $this->POST_MESS, $message_args );
			register_meta( 'post', $this->POST_TWEETSTORM, $tweetstorm_args );
			register_meta( 'post', $this->POST_SHARE_FEATURE_ENABLED, $share_post_feature_args );
		}
	}
