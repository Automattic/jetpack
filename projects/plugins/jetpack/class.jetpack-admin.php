...
class Jetpack_Admin {
	...
	private function __construct() {
		...
		require_once JETPACK__PLUGIN_DIR . '_inc/lib/admin-pages/class-jetpack-custom-page.php';
		$jetpack_custom = new Jetpack_Custom_Page();
		...
		add_action( 'jetpack_admin_menu', array( $jetpack_custom, 'add_actions' ) );
