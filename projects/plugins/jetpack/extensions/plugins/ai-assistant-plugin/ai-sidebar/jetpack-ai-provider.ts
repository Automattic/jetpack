 ...
 * @return {HTMLElement|null} The block element, or null.
 */
 ...
 * @return {object} Result with returnToAgent: false.
 */
 ...
 *
 * @return {boolean} True when window.wp.abilities.getAbilities exists.
 */
...
function setupAutoScrollFix(): void {
	...
	// Inject CSS override to remove margin-top: auto from messages
 ...
 * @return {string} Normalized name (e.g., 'wpcom__select_title').
 */
...
export const toolProvider = {
	 ...
	 *
	 * @return {Promise<any[]>} Array of ability descriptors.
	 */
	 ...
	 * @return {Promise<{result: Record<string, unknown>, returnToAgent?: boolean}>} Execution result.
	 */
 ...
 * @return {any} Serialized block with name, clientId, attributes, innerBlocks.
 */
 ...
 * @return {string} The resolved HTML string.
 */
...
export const contextProvider = {
	 ...
	 *
	 * @return {any} Context with page content, selected block, and block content.
	 */
 ...
 * @return {ComponentType|null} The matching component, or null.
 */
 ...
 *
 * @return {object} Object containing a suggestions array.
 */
