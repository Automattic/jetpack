...
function render_block( $attributes ) {
	...
	$data = array(
		...
		'excluded_newsletter_categories' => get_attribute( $attributes, 'excludedNewsletterCategoryIds', array() ),
	);
				...
				>
					<div class="wp-block-jetpack-subscriptions__form-elements">
						...
						>
							...
							if ( ! empty( $data['excluded_newsletter_categories'] ) ) {
								echo '<input type="hidden" name="excluded_newsletter_categories" value="' . esc_attr( implode( ',', $data['excluded_newsletter_categories'] ) ) . '"/>';
							}
							?>
							<button type="submit"
								<?php if ( ! empty( $classes['submit_button'] ) ) : ?>
