...
function render_amp( $attr ) {
	...
	return sprintf(
		'<div class="%1$s" id="wp-block-jetpack-slideshow__%2$d"><div class="wp-block-jetpack-slideshow_container swiper-container" tabindex="0" role="group" aria-label="Image slideshow">%3$s%4$s%5$s</div></div>',
		esc_attr( $classes ),
