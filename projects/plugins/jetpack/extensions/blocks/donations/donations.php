...
function get_trigger_icon_svg( $icon_key ) {
	$paths = array(
		...
		'coffee'     => array(
			'd'         => 'M5.5 5.25h11v2.5h1a2 2 0 010 4H16.5v.5a3 3 0 01-3 3H8.5a3 3 0 01-3-3V5.25zm1.5 1.5v6a1.5 1.5 0 001.5 1.5h5a1.5 1.5 0 001.5-1.5v-6h-8zm10 2.5H16.5v2h.5a1 1 0 000-2zM5 18.75h14V17.25H5z',
			'fill-rule' => 'evenodd',
		),
