...
function get_trigger_icon_svg( $icon_key ) {
	$paths = array(
		...
		'coffee'     => array(
			'd'         => 'M4 5.25h11v2.5h1.5a2.5 2.5 0 010 5H15v.5a3 3 0 01-3 3H7a3 3 0 01-3-3V5.25zm1.5 1.5v6a1.5 1.5 0 001.5 1.5h5a1.5 1.5 0 001.5-1.5v-6h-8zm10 2.5H15v2h.5a1 1 0 000-2zM4 18.75h11V17.25H4z',
			'fill-rule' => 'evenodd',
		),
