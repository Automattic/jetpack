...
function GooglePhotosPickerMedia( props ) {
	const {
		account,
		allowedTypes,
		copyMedia,
	...
	const listUrl = getApiUrl( 'list', SOURCE_GOOGLE_PHOTOS_PICKER, params );
	...
	const onCopy = useCallback(
		items => {
			copyMedia(
				items,
				getApiUrl( 'copy', SOURCE_GOOGLE_PHOTOS_PICKER ),
				SOURCE_GOOGLE_PHOTOS_PICKER
			);
		},
		[ copyMedia ]
...
export default GooglePhotosPickerMedia;
