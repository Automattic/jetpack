...
export const a8c_tb_show = function ( caption, url, imageGroup ) {
	...
	if (
		...
		const TB_WIDTH = params.width * 1 + 30 || 630; //defaults to 630 if no paramaters were added to URL
		const TB_HEIGHT = params.height * 1 + 40 || 440; //defaults to 440 if no paramaters were added to URL
				...
				document
					...
					.insertAdjacentHTML(
						...
						"<div id='TB_title'><div id='TB_ajaxWindowTitle'>" +
							...
							"' onload='a8c_tb_showIframe()' style='width:" +
							( ajaxContentW + 29 ) +
							'px;height:' +
							( ajaxContentH + 17 ) +
							"px;' > </iframe>"
