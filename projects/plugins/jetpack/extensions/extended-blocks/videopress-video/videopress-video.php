 ...
 * @param string|null $dynamic_playlist_metadata_file Path to the dynamic playlist block.json; null uses the package default.
 */
function register_videopress_blocks( $playlist_metadata_file = null, $dynamic_playlist_metadata_file = null ) {
	...
	if ( method_exists( 'Automattic\Jetpack\VideoPress\Initializer', 'register_videopress_dynamic_playlist_block' ) ) {
		VideoPress_Pkg_Initializer::register_videopress_dynamic_playlist_block( $dynamic_playlist_metadata_file );
	}
}
