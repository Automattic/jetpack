...
export const Ads = withModuleSettingsFormHelpers(
	class extends React.Component {
		...
		render() {
			...
			const wordads_bottom_sticky_enabled = this.props.getOptionValue(
				'wordads_bottom_sticky_enabled',
				'wordads'
			);
			const wordads_sidebar_sticky_right_enabled = this.props.getOptionValue(
				...
				>
					...
					>
						...
						<FormFieldset>
							...
							/>
							<ToggleControl
								checked={ wordads_bottom_sticky_enabled }
								disabled={
									! isAdsActive ||
									unavailableInOfflineMode ||
									this.props.isSavingAnyOption( [ 'wordads' ] )
