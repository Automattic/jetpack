import { PreflightTest, PreflightTestStatus, PreflightTestStatusType } from './types';
 ...
 * @param {PreflightTest[]} tests - An array of PreflightTest objects.
 * @returns {PreflightTestStatusType} The overall status as a PreflightTestStatus enum value.
 */
export const calculateOverallStatus = ( tests: PreflightTest[] ): PreflightTestStatusType => {
