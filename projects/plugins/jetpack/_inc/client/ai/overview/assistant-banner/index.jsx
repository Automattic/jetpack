...
export default function AssistantBanner() {
	...
	const handleDismiss = useCallback( () => {
		...
		// 'true'/'false' strings — same shape as mcp/tracks.js, which is
		// documented as jetpack_mcp_*-only and so not reused here.
		const { isA11n = false, isTest = false } = window?.jetpackAiSettings ?? {};
		analytics.tracks.recordEvent( 'jetpack_ai_hub_assistant_banner_dismiss', {
