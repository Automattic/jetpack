...
export const PRODUCT_DESCRIPTION_PRODUCTS = {
	...
	JETPACK_PROTECT_FIREWALL: 'protect-firewall',
	JETPACK_SCAN: 'scan',
...
export const myJetpackRoutes = [
	...
	`/add-${ PRODUCT_DESCRIPTION_PRODUCTS.JETPACK_PROTECT_FIREWALL }`,
...
export const productIllustrations = {
	...
	[ PRODUCT_DESCRIPTION_PRODUCTS.JETPACK_PROTECT_FIREWALL ]: `${ imagePath }products/illustration-scan.png`,
