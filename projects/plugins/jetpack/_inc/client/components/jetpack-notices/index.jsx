...
import { getLicensingError, clearLicensingError, hasAvailableUserLicenses } from 'state/licensing';
	...
	render() {
		...
		return (
			<div aria-live="polite">
				...
				{ this.props.hasAvailableUserLicenses && (
					<SimpleNotice
						showDismiss={ true }
...
export default connect(
	state => {
		return {
			...
			hasAvailableUserLicenses: hasAvailableUserLicenses( state ),
		};
	},
	dispatch => {
		return {
