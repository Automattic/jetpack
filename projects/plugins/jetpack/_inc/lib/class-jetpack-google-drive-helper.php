 ...
 *
 * @deprecated $$next-version$$ Use Automattic\Jetpack\Forms\Service\Google_Drive_Helper
 */
class Jetpack_Google_Drive_Helper {
	/**
	 * Checks if the user has a valid connection to Google Drive
	 *
	 * @deprecated $$next-version$$ Use Automattic\Jetpack\Forms\Service\Google_Drive_Helper->has_valid_connection
	 * @param int $user_id The user ID.
	 * @return array       Array with single 'valid' (bool) entry.
	 */
	public static function has_valid_connection( $user_id ) {
		_deprecated_function( __METHOD__, 'jetpack-$$next-version$$', 'Automattic\Jetpack\Forms\Service\Google_Drive_Helper->has_valid_connection' );
	 ...
	 *
	 * @deprecated $$next-version$$ Use Automattic\Jetpack\Forms\Service\Google_Drive_Helper->create_sheet
	 * @param int    $user_id The user ID.
	...
	public static function create_sheet( $user_id, $title, $rows = array() ) {
		_deprecated_function( __METHOD__, 'jetpack-$$next-version$$', 'Automattic\Jetpack\Forms\Service\Google_Drive_Helper->create_sheet' );
		$site_id = Manager::get_site_id();
		if ( is_wp_error( $site_id ) ) {
			return false;
		}
