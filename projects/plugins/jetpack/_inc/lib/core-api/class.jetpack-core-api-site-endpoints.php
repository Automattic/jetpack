...
use Automattic\Jetpack\Search\Initializer;
...
class Jetpack_Core_API_Site_Endpoint {
	...
	public static function get_benefits() {
		...
		// TODO: check if `search/jetpack-search.php` is the release path.
		if ( Jetpack::is_module_active( 'search' ) && ! Jetpack::is_plugin_active( 'search/jetpack-search.php' ) && class_exists( Initializer::class ) ) {
			$benefits[] = array(
				'name'        => 'search',
