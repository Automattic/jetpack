...
function jetpack_current_user_data() {
	_deprecated_function( __METHOD__, 'jetpack-10.0.0', 'Automattic\\Jetpack\\Connection\\Manager::get_all_current_user_data' );
	return ( new Connection_Manager( 'jetpack' ) )->get_all_current_user_data();
}
