...
### Enhancements
- Jetpack Forms: display carriage returns in user response text to properly display multiline text. [#29698]
- Jetpack Protect: remove account connection requirement to use the brute force protection feature. [#28401]
- Jetpack Protect: share IP allow list between the Jetpack Firewall and Brute Force Protection modules. [#28401]
- Jetpack Social: add a toggle to enable image generator and choose a default template. [#29722]
...
- Jetpack Forms: add a check for array on $attributes before trying to set an item on it. [#29557]
- Jetpack Forms: add all source post IDs on forms/responses endpoint. [#29428]
- Jetpack Forms: add search input and styles. [#29397]
...
- Jetpack Forms: use Contact_Form_Plugin::init instead of requiring the old module file. [#29648]
