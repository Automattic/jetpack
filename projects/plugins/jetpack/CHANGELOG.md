...
## 13.6-a.1 - 2024-06-10
### Bug fixes
- External media: Ensured the connect URL has the correct blog ID and verification values. [#37689]
...
- Memberships: fixes paid content access in some cases of mixed products. [#37527]
