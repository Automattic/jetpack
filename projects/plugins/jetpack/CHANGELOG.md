...
- AI: Make the Overview and AI Features tabs available on self-hosted sites and apply their controls. [#51909]
- AI: Only show the AI SEO control on sites where the feature it turns on can run. [#51918]
- AI: Show a connect-account card on the MCP settings page when the current user is not connected to WordPress.com. [#51822]
- Blogging Prompts: Mark a post as a prompt answer when it is created through the REST API, so answers written in the Write editor keep their prompt tags and roundup link. [#51671]
...
- Podcast: Replace the stats date range picker with one built on the WordPress design system calendar. [#51902]
- Premium Analytics: Add an "Any feedback?" action to the dashboard header. [#51870]
- Premium Analytics: Add a page options menu with a Customize action on the post, email, and video detail pages. [#51772]
- Premium Analytics: Add a page option that switches the new Traffic tab off, asks why on the way out, and returns to classic Stats. [#52025]
- Premium Analytics: Comparison control: mark an active comparison with a "vs" prefix, and name the compared window in the trigger's tooltip. [#51820]
- Premium Analytics: Disable the dashboard's date controls while customizing its layout. [#52024]
- Premium Analytics: Display the dashboard on a three-column grid and rearrange the default Traffic widgets. [#51873]
- Premium Analytics: Even out the header spacing on the post detail page to match the video page. [#51875]
- Premium Analytics: Follow the onboarding welcome modal with a three-step spotlight tour of the customization menu, the date controls and the widgets. [#51949]
- Premium Analytics: Hide the report pages behind tabs the Stats dashboard does not show. [#51983]
- Premium Analytics: Include the current day in the last-N-day ranges, and count the 12-month range in whole calendar months, to match Jetpack Stats. [#51428]
- Premium Analytics: Lay the post and video detail pages out on the three-column grid the dashboard uses. [#52044]
- Premium Analytics: Match the Jetpack logo in the Stats header to the 20px size used by the other Jetpack admin pages. [#52060]
- Premium Analytics: Match the post and video page headers to the layout used across the rest of Analytics. [#51875]
- Premium Analytics: Move the dashboard feedback action into a page options menu. [#52023]
- Premium Analytics: Open a welcome modal the first time a reader reaches the dashboard. [#51948]
- Premium Analytics: Open the Authors, Clicks and UTM reports folded to their top-level groups, and move the drill-down control to the right of the row title. [#51806]
- Premium Analytics: Pick the date period from a dropdown instead of a row of buttons, with the calendar beside it on Custom range. [#51842]
- Premium Analytics: Revise the onboarding welcome modal copy and reorder the tour to start from the widgets and end on the page options menu. [#52025]
- Premium Analytics: Send dashboard feedback on to Jetpack support, so it is not lost when analytics are blocked. [#51921]
- Premium Analytics: Show the onboarding again to a reader who switches the new Traffic tab back on. [#52038]
- Subscriptions: Remove the transitional Subscribers announcement page and redirect its URL to Newsletter. [#51906]
- VideoPress: Add a site-wide setting to turn off player preloading for every embed. [#51991]
- VideoPress: Open the file picker directly from the dashboard welcome modal's Upload a video button, then land on the Library to follow the upload's progress. [#51791]

### Bug fixes
- Admin pages: Fix Jetpack dashboards overlapping the admin menu in right-to-left languages. [#51963]
...
- Charts: Use the site's time zone and locale for line and area chart date ticks, hourly labels, and tooltips. [#51813]
...
- Premium Analytics: Keep keyboard focus inside the onboarding tour card and let screen reader users skip the tour. [#51975]
- Premium Analytics: Keep the dashboard off while the Stats module is inactive. [#51958]
- Premium Analytics: Keep the date picker on the range a chart drill-down applies. [#51924]
...
- Subscriptions: Recognize subscriber sessions in the Subscriber Login and Premium Content blocks. [#52051]
- Tiled Gallery: Fix the gallery growing without bound inside a vertical Group or Stack, and keep its width in step with the space available when a surrounding block is resized or re-aligned. [#51620]
- VideoPress: Avoid incorrect limits and upgrade prompts when site features cannot be loaded. [#52050]
- VideoPress: Fix "Add to a post or page" opening an empty editor instead of inserting the selected video block. [#51996]
- VideoPress: Fix playlist block video titles overlapping when long, and apostrophes rendering as HTML entities. [#51849]
- VideoPress: Fix the dashboard rendering blank on WordPress 7.0.x. [#51847]
- VideoPress: Register the Video Playlist block from the Jetpack plugin when the VideoPress module is active. [#52013]

### Other changes <!-- Non-user-facing changes go here. This section will not be copied to readme.txt. -->
- Agents Manager: Show an “Agent” label beside the admin bar's AI chat icon while the chat is hidden. [#51926]
- AI: Rename the AI Search row to AI Answers, and drop the Preview label from the Search dashboard. [#51891]
- AI: Send VIP sites to the Jetpack user connection screen from the MCP connect card. [#52039]
- AI Assistant: Update the WordPress Agent notice to point at the "Agent" button. [#52027]
- Premium Analytics: Limit dashboard customization to moving and resizing widgets. [#51986]
...
- VideoPress: Make the `welcome=1` review parameter reopen the dashboard welcome modal after it has been dismissed. [#51791]

## 16.2-a.5 - 2026-09-01
### Enhancements
- AI: Add Quick start links for connecting Claude and ChatGPT to the AI Hub Overview. [#51691]
- AI: Rename the admin page and menu item to Jetpack AI, update the page description, and point the "turned off" notice at Jetpack Products. [#51604]
- AI: Show the Learn more link for the Writing Assistant instead of the editor link. [#51703]
- Boost: Wait up to four minutes for slow speed tests in My Jetpack and At a Glance instead of timing out after two. [#51605]
...
- Connection: Cache the WordPress.com site record briefly so the Jetpack dashboard does not make a request per view. [#51146]
- Forms: Add a guide to the form editor for people new to the block editor. [#51039]
- Forms: Add help text to form fields and show the date field's expected format below its input. [#51122]
- Forms: Allow a file upload field to accept more than one file. [#51551]
- Forms: Make form navigation actions real links so they can be opened in a new tab. [#51563]
- Forms: Remember which response columns are shown, and their order, for each form. [#51615]
- Forms: Rewrite the missing forms modal to reassure people that forms already on their pages keep working, and spell out the steps to add them to the list. [#47568]
...
- AI: Make the editor and automatic-generation toggles follow the AI SEO control, preserving saved choices when it is switched off and back on. [#51415]
- AI: On sites with the WordPress Agent, replace the "Improve with AI" panel with a dismissible notice pointing to it. [#51388]
- AI: Return to the Jetpack AI Hub after upgrading from it, and point My Jetpack's AI links at the Hub. [#51756]
- AI: Support the AI Hub on WordPress.com Simple sites. [#51661]
- My Jetpack: Allow the Automattic for Agencies banner to be dismissed. [#51441]
- Premium Analytics: Add a year dropdown to the Year in review (Highlights) widget header, defaulting to the current year, and drop its metric selector so the card always shows posts, words, likes, and comments. [#51638]
- Premium Analytics: Add breathing room above and below the Top locations map. [#51593]
- Premium Analytics: Add the Most popular day widget to the default Insights layout, and say in its help note that its figures are all-time. [#51645]
- Premium Analytics: Add the Most popular time card to the default Insights layout. [#51636]
- Premium Analytics: Add total and per-post image counts to the Annual insights report. [#51747]
- Premium Analytics: Build the comparison menu from the applied date range and restore the same-period-last-week option. [#51779]
- Premium Analytics: Chart interval control: name the active interval in the button's tooltip, and give its menu a heading. [#51770]
- Premium Analytics: Click a point on the Traffic chart to narrow the dashboard to that period. [#51544]
- Premium Analytics: Date range control: name a custom range covering a whole month or year by that period, and spell the dates out in the button's tooltip. [#51817]
- Premium Analytics: Divide a widget's metrics with lines instead of boxing each one. [#51749]
- Premium Analytics: Fold the video detail highlight metrics into the Video performance chart as selectable tabs. [#51501]
- Premium Analytics: Give shared leaderboard rows one row height, bar radius, and link hover. [#51595]
- Premium Analytics: Lead the post and video detail date presets with All time and match the selected preset to the design. [#51533]
- Premium Analytics: Match the Most viewed and Videos leaderboard row labels to the other widgets. [#51599]
- Premium Analytics: Match the remaining leaderboard row labels to the other widgets. [#51602]
- Premium Analytics: Move the Ads date range into the WordAds card's own header, and drop the section header's date filter. [#51543]
- Premium Analytics: Post detail: the email tabs' opens and clicks timelines cover the first 30 days after the send instead of the page date filter, which no longer shows there; the other email cards stay all-time. [#51547]
- Premium Analytics: Remove the date configuration subtitle from the section header. [#51707]
- Premium Analytics: Remove the page descriptions from the dashboard and report pages. [#51707]
- Premium Analytics: Rename the Top pages CSV comparison column to "Views (Previous Period)" and move it after the primary columns. [#51705]
- Premium Analytics: Retitle the Popular post card to "Most popular post in the last 12 months" and pin it to the last 12 months. [#51649]
- Premium Analytics: Shorten the Popular post card title so it survives a narrow dashboard cell. [#51746]
- Premium Analytics: Show all-time views, visitors, and posts in the default Insights layout. [#51635]
...
- Stats: Use the page-level chart interval for the Traffic summary chart. [#51532]
- VideoPress: Add a first-run welcome modal to the dashboard. [#51520]
- VideoPress: Invite the first upload with a dropzone when the video library is empty. [#51717]
...
- Admin bar: Fix a fatal error when the endpoint's global `$wp_admin_bar` is null. [#51720]
...
- Blocks: Keep blocks that load outside the post editor available in front-end block editors such as P2, by never deferring their registration. See JETPACK-1747. [#49926]
...
- Forms: Fix checkbox and consent field alignment in the editor on classic themes. [#51560]
...
- Forms: Keep the remaining files when a folder or dragged text is included in a multi-file drop on the file upload field. [#51183]
- Forms: Let screen readers announce a date field's own label instead of the date picker instructions. [#51406]
...
- Newsletter: Hide the "View delivery details" stats link in the publish panels when the Stats module is disabled, so the copy no longer points to an unavailable page. [#51552]
- Newsletter: Prevent unsupported date filtering on the Subscribers page. [#51782]
- Podcast: Scope the generated episodes list to the posts the current user can edit, matching the Posts screen. [#51816]
- Premium Analytics: Align title link styling across widgets: external video rows gain the standard outbound marker, long titles no longer clip it, and hover underlines cover only the title text. [#51534]
- Premium Analytics: Drop the Last 24 hours range from the WordAds card, which has no hourly data to chart. [#51633]
- Premium Analytics: Fall back to the last page of a table instead of reporting no results when a date range returns fewer rows than the current page. [#51755]
- Premium Analytics: Fix the email opens/clicks timeline charting hours outside the selected window. [#51588]
- Premium Analytics: Fix the Subscribers summary help text to describe the cumulative subscriber total the chart plots, not new subscribers. [#51697]
- Premium Analytics: Include the last day of the selected range in the WordAds card. [#51751]
- Premium Analytics: Keep the custom range Apply button disabled when re-selecting "No comparison". [#51764]
- Premium Analytics: Keep the Year in review report link reachable. [#51747]
- Premium Analytics: Link a subscriber's name to their subscriber details page. [#51634]
- Premium Analytics: Most popular day gives its Day and Views labels the weight the design has them at and the heading structure a screen reader can navigate, states a share of views only when there is an all-time total to take it from, and drops the Retry a reader without stats access cannot use. [#51645]
- Premium Analytics: Post detail: stop the Post traffic layout from flashing when an email tab is opened directly, and show placeholder lines in the header while the title loads. [#51805]
- Premium Analytics: Print Tags & categories view counts in full, and list far more rows in its report. [#51646]
- Premium Analytics: Print the Annual insights words-per-post average whole, as the old Stats report does. [#51747]
- Premium Analytics: Remove the quarterly chart interval option, which never changed the chart. [#51631]
- Premium Analytics: Show abbreviated month names on chart x-axes in line and area views. [#51531]
- Premium Analytics: Show a notice when a refresh fails, instead of silently leaving the previous numbers on screen. [#51383]
- Premium Analytics: Show email subject lines with characters like "&" instead of their HTML codes. [#51596]
- Premium Analytics: Show the Most popular time day and hour in the site's locale. [#51636]
- Premium Analytics: Show the most recent subscribers in the Latest subscribers widget. [#51598]
- Premium Analytics: Show the whole Most popular day card on a short tile instead of clipping it. [#51645]
- Premium Analytics: Show titles and names with characters like "&" instead of their HTML codes. [#51632]
...
- Tiled Gallery: Remove the forced gray background on images that made transparent areas appear gray. [#49196]
...
### Other changes <!-- Non-user-facing changes go here. This section will not be copied to readme.txt. -->
- Admin Bar endpoint: Expose the Agents Manager help and Ask AI nodes. [#51657]
- AI: Record Tracks events for Overview tab views and walkthrough video clicks. [#51606]
- AI: Add an internal Scheduled tasks view to Jetpack AI Hub. [#51319]
- AI: Add an Overview tab for internal testing environments. [#51109]
- AI: Send usage events from Jetpack AI Hub on self-hosted sites. [#51745]
- AI Features: Point the AI Search "Open Search Settings" link at the AI tab of the Search dashboard. [#51689]
- AI Hub: Show the Overview connection notices without a surrounding card, matching the WordPress Agent tab. [#51692]
- Deprecate `jetpack_shim_setcookie()` function. PHP 7.4+'s `setcookie()` can be used directly. [#51575]
- Newsletter: Add an endpoint serving the email design editor's data. [#51525]
- Premium Analytics: Remove the settings drawer from the post detail Email highlights and Email breakdown cards; their metric and view are fixed by the tab layout. [#51659]
...
- Performance: Add early-return guard conditions to skip loading scripts and styles on pages where they are not needed. [#47495]
...
- AI Site Logo extension: Fix static import of @wordpress/edit-post that was breaking the P2 frontend block inserter. [#47987]
...
- Improve author Gravatar URLs by converting email-based or no-login URLs to hashed versions. [#48309]
...
- Update package dependencies. [#47102] [#47890] [#47998] [#47907] [#48064] [#48106] [#48141] [#48302]
...
- Settings: Modernize page UI. [#47490] [#47942] [#47656]
- Sync: Improve checksum performance for meta tables. [#47579]
- Update admin page footer with Products and Help navigation links. [#47840]
...
- SEO: Prevent PHP warnings when handling malformed data. [#47804]
...
- Sync: Add 'note' to the default whitelisted comment types. [#47746]
- Update dependencies. [#47472]
- Update design of the sidebar upsell. [#47909]
- Update package dependencies. [#47496] [#47499] [#47505] [#47684] [#47799] [#47818] [#47825] [#47899]
