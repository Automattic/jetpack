...
class Jetpack_AMP_Support_Test extends WP_UnitTestCase {
	...
	public function test_render_sharing_html() {
		...
		$this->assertEquals( '<div class="sd-content"><amp-social-share type="pocket" height="32px" width="32px" aria-label="Share on Pocket" title="Share on Pocket" data-share-endpoint="https://getpocket.com/save/?url=http%3A%2F%2Fexample.org%2F%3Fp%3D' . $post->ID . '&amp;title=Test%20post"></amp-social-share></div>', $social_icons );
