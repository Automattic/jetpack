 ...
 * WPCOM_REST_API_V2_Post_Publicize_Connections_Field_Test (this class's complementary class)
 ...
 * @group rest-api
 */
class WPCOM_REST_API_V2_Post_Publicize_Connections_Field_Inactive_Test extends Jetpack_REST_TestCase {
	/**
	 * User ID.
	 *
	 * @var int
