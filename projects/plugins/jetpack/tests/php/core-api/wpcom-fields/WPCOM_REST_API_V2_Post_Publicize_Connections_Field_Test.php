 ...
 *
 * (This class's complement, WPCOM_REST_API_V2_Post_Publicize_Connections_Field_Inactive_Test,
 ...
 * @group rest-api
 */
class WPCOM_REST_API_V2_Post_Publicize_Connections_Field_Test extends Jetpack_REST_TestCase {
	 ...
	 * @var array
	 */
	private static $token_ids = array();
	...
	public static function setup_connections_jetpack() {
		...
		self::$connection_ids[] = '123';
		self::$token_ids[]      = 'test-unique-id456';
		self::$token_ids[]      = 'test-unique-id123';
	}
