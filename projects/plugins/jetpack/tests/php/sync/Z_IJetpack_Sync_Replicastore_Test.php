 ...
 *
 * @todo The `store_provider()` relies on classes having been loaded already by earlier tests, hence the `Z_` prefix. Somehow this should be fixed to not rely on the ordering.
 */
class Z_IJetpack_Sync_Replicastore_Test extends TestCase {
