...
require_once __DIR__ . '/Jetpack_Sync_Plugins_Test.php';
require_once __DIR__ . '/class.silent-upgrader-skin.php';

/**
 * Testing CRUD on Plugins
 */
class Jetpack_Sync_Plugins_Updates_Test extends Jetpack_Sync_TestBase {
		...
		return (object) array(
			'response' => array(
				'the/the.php' => (object) array(
					'package' => Jetpack_Sync_Plugins_Test::PLUGIN_ZIP,
				),
			),
		);
	}
	...
	public function set_update_plugin_transient_with_error() {
		return (object) array(
			'response' => array(
				'the/the.php' => (object) array(
					'package' => Jetpack_Sync_Plugins_Test::PLUGIN_ZIP . '-doesnotexitst.zip',
				),
			),
		);
	}
