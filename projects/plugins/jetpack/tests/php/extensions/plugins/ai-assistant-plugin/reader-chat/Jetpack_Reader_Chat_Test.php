...
class Jetpack_Reader_Chat_Test extends WP_UnitTestCase {
	...
	public function tear_down() {
		...
		unregister_setting( 'jetpack_search', 'reader_chat_brand' );
	...
	public function test_register_settings_registers_reader_chat_setting() {
		...
		$this->assertSame( 'jetpack_search', $registered_settings['reader_chat_brand']['group'] );
		$this->assertContains( 'reader_chat_brand', $new_allowed_options['jetpack_search'] ?? array() );
		$this->assertNotContains( 'reader_chat_brand', $new_allowed_options['general'] ?? array() );
	}
