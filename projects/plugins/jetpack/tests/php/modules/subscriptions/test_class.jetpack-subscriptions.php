...
class WP_Test_Jetpack_Subscriptions extends WP_UnitTestCase {
	...
	public function test_jetpack_cookie_user() {
		...
		unset( $_COOKIE[ Jetpack_Token_Subscription_Service::JWT_AUTH_TOKEN_COOKIE_NAME ] );

		$this->assertNotContains( Jetpack_Token_Subscription_Service::JWT_AUTH_TOKEN_COOKIE_NAME, $_COOKIE );
		...
		$this->assertNotNull( $_COOKIE[ Jetpack_Token_Subscription_Service::JWT_AUTH_TOKEN_COOKIE_NAME ] );
	...
	private function set_returned_token( $payload ) {
		...
		remove_all_filters( 'earn_get_user_subscriptions_for_site_id' );
		$service       = new Jetpack_Token_Subscription_Service();
	...
	public function test_subscriber_access_level( $type_user_id, $logged, $token_set, $post_access_level, $should_email_be_sent, $should_user_access_post, $subscription_end_date = null, $status = null ) {
		...
		if ( $token_set ) {
			...
			$token_subscription_service = new Jetpack_Token_Subscription_Service();
