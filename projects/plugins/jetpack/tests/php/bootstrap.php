...
if ( '1' != getenv( 'JETPACK_TEST_WOOCOMMERCE' ) ) { // phpcs:ignore Universal.Operators.StrictComparisons.LooseNotEqual
...
function _manually_load_plugin() {
	if ( '1' == getenv( 'JETPACK_TEST_WOOCOMMERCE' ) ) { // phpcs:ignore Universal.Operators.StrictComparisons.LooseEqual
