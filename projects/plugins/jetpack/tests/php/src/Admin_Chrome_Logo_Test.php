<?php
/**
 * Tests the Admin_Chrome_Logo class.
 *
 ...
 * Tests the Admin_Chrome_Logo class.
 *
 * @covers \Automattic\Jetpack\Plugin\Admin_Chrome_Logo
 */
#[CoversClass( Admin_Chrome_Logo::class )]
class Admin_Chrome_Logo_Test extends WP_UnitTestCase {
	...
	public function test_a_label_names_the_mark() {
		$svg = Admin_Chrome_Logo::render( 20, '', 'Jetpack logo' );
	...
	public function test_no_label_hides_the_mark() {
		$svg = Admin_Chrome_Logo::render( 16, 'jp-akismet-logo' );
	...
	public function test_class_is_omitted_when_empty() {
		$this->assertStringContainsString( 'class="jp-akismet-logo"', Admin_Chrome_Logo::render( 16, 'jp-akismet-logo' ) );
		$this->assertStringNotContainsString( 'class=', Admin_Chrome_Logo::render( 20 ) );
	}
	...
	public function test_height_comes_from_the_caller() {
		$this->assertStringContainsString( 'height="20"', Admin_Chrome_Logo::render( 20 ) );
		$this->assertStringContainsString( 'height="16"', Admin_Chrome_Logo::render( 16 ) );
	}
	...
	public function test_markup_matches_what_the_call_sites_rendered() {
		$this->assertSame(
			...
			Admin_Chrome_Logo::render( 20, '', 'Jetpack logo' )
		);
		$this->assertSame(
			...
			Admin_Chrome_Logo::render( 16, 'jp-akismet-logo' )
		);
	}
}
