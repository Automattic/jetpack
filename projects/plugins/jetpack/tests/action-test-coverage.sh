...
TESTS[client]="pnpm run test-client --coverage --collectCoverageFrom='_inc/client/state/**/*.{js,mjs,cjs,jsx,ts,tsx,mts,cts}' --coverageDirectory=\"$COVERAGE_DIR/client\" --coverageReporters=json"
TESTS[gui]="pnpm run test-gui --coverage --collectCoverageFrom='_inc/client/state/**/*.{js,mjs,cjs,jsx,ts,tsx,mts,cts}' --coverageDirectory=\"$COVERAGE_DIR/client\" --coverageReporters=json"
TESTS[extensions]="pnpm run test-extensions --coverage --collectCoverageFrom='_inc/client/state/**/*.{js,mjs,cjs,jsx,ts,tsx,mts,cts}' --coverageDirectory=\"$COVERAGE_DIR/client\" --coverageReporters=json"
