...
TESTS[php-multisite]="WP_TESTS_CONFIG_FILE_PATH=\"${WP_TESTS_CONFIG_FILE_PATH%.php}.multi.php\" WP_MULTISITE=1 php -dpcov.directory=. \"$(command -v phpunit-select-config)\" -c tests/php.multisite.#.xml --coverage-php \"$COVERAGE_DIR/multisite/php.cov\""
