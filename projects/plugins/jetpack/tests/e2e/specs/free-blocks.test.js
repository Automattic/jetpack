...
import PinterestBlock from 'jetpack-e2e-core/pages/wp-admin/blocks/pinterest';
import EventbriteBlock from 'jetpack-e2e-core/pages/wp-admin/blocks/eventbrite';
