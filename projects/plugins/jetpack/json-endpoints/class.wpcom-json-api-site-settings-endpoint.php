...
new WPCOM_JSON_API_Site_Settings_Endpoint(
	array(
		...
		'request_format'      => array(
			...
			'jetpack_account_protection_password_detection' => '(bool) Whether compromised password detection is enabled',
			'jetpack_account_protection_strong_passwords' => '(bool) Whether strong password enforcement is enabled',
			...
			switch ( $key ) {
				...
				case 'settings':
					...
					$response[ $key ] = array(
						...
						'jetpack_account_protection_password_detection' => (bool) get_option( 'jetpack_account_protection_password_detection' ),
						'jetpack_account_protection_strong_passwords' => (bool) get_option( 'jetpack_account_protection_strong_passwords' ),
