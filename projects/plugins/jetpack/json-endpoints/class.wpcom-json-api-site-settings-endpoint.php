	...
	public function update_settings() {
		...
		foreach ( $input as $key => $value ) {
			...
			switch ( $key ) {
				...
				case 'lang_id':
					// Due to the fact that locale variants are set in a locale_variant option, changing locale from variant to primary
					// would look like the same lang_id is being saved and update_option would return false, even though the correct
					// options would be set by pre_update_option_lang_id, so we should always return lang_id as updated
