...
new WPCOM_JSON_API_Site_Settings_Endpoint(
	array(
		...
		'request_format'      => array(
			...
			'wpcom_partner_sharing_opt_out'           => '(bool) Did the site opt out of public content sharing with partners?',
			...
			switch ( $key ) {
				...
				case 'settings':
					...
					$response[ $key ] = array(
						...
						'wpcom_partner_sharing_opt_out'    => (bool) get_option( 'wpcom_wpcom_partner_sharing_opt_out' ),
