...
return [
    ...
    'file_suppressions' => [
        ...
        'modules/theme-tools/social-menu.php' => ['PhanTypeMismatchArgumentNullable', 'PhanRedefineFunction'],
        'modules/theme-tools/social-menu/icon-functions.php' => ['PhanPluginSimplifyExpressionBool', 'PhanTypeExpectedObjectPropAccess', 'PhanRedefineFunction'],
