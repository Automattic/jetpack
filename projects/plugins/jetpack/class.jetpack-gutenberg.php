	...
	public static function enqueue_block_editor_assets() {
		...
		if ( ( new Modules() )->is_active( 'publicize' ) ) {
			$initial_state['social'] = array(
				'sharesData'  => publicize_init()->get_publicize_shares_info( $blog_id ),
				'hasPaidPlan' => Current_Plan::supports( 'social-shares-1000' ),
			);
		}

		wp_localize_script( 'jetpack-blocks-editor', 'Jetpack_Editor_Initial_State', $initial_state );
	}
