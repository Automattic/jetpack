...
- /wp-content/plugins/jetpack/\_inc/social-logos/social-logos.html
- Check the new logos
...
There's a new feature introduced into Jetpack to detect if the WordPress site has the core site editor feature enabled. With it comess a contextual adjustment to the user interface. The Jetpack > Settings > Writing > Custom CSS toggle is now conditionally rendered based on whether the site uses a block-based theme or not. For sites using a block-based theme, this toggle is removed, aligning with the concept that such themes inherently offer greater flexibility for customization and thus the additional CSS settings might not be necessary.
...
- AI Assistant: add Gutenberg syntax parsing. [https://github.com/Automattic/jetpack/pull/31766]
- AI Assistant: display upgrade prompt for Simple and Atomic sites. [https://github.com/Automattic/jetpack/pull/31643]
- AI Assistant: do not pre-populate inner blocks if Gutenberg syntax is not enabled. [https://github.com/Automattic/jetpack/pull/31822]
- AI Assistant: extend blocks when upgrade is required. [https://github.com/Automattic/jetpack/pull/31814]
- AI Assistant: extend list block and enhance content parsing. [https://github.com/Automattic/jetpack/pull/31901]
- AI Assistant: fix transform issue when content has formatted text. [https://github.com/Automattic/jetpack/pull/31790]
- AI Assistant: update AI Assistant request to be POST based. [https://github.com/Automattic/jetpack/pull/31128]
- AI Assistant: introduce `ghostwriter` into AI Assistant block prompt. [https://github.com/Automattic/jetpack/pull/31806]
- AI Extension: fix transform issue when Ask AI Assistant option. [https://github.com/Automattic/jetpack/pull/31842]
- Sync: add cache check when trying to spawn dedicated sync or update JETPACK\_\_VERSION to avoid additional requests to the DB. [https://github.com/Automattic/jetpack/pull/31645]

## 12.4-a.3 - 2023-07-10

### Enhancements

- AI Assistant: add dev playground panel [https://github.com/Automattic/jetpack/pull/31762]
- AI Assistant: Add GPT4 endpoint parameter [https://github.com/Automattic/jetpack/pull/31763]
- AI Assistant: Enable custom prompt if provided [https://github.com/Automattic/jetpack/pull/31764]
- Akismet: use Akismet logo instead of Jetpack logo in masthead [https://github.com/Automattic/jetpack/pull/31464]

### Improved compatibility

- Sharing: deprecate the Skype sharing button, as Skype ddoes not support those buttons anymore. [https://github.com/Automattic/jetpack/pull/31636]

### Bug fixes

- AI Assistant: Only append flag if no error [https://github.com/Automattic/jetpack/pull/31767]
- Fixed users menu item pointing to wp-admin on Atomic sites. [https://github.com/Automattic/jetpack/pull/31699]

### Other changes <!-- Non-user-facing changes go here. This section will not be copied to readme.txt. -->

- AI Assistant: Add playground flag in initial state [https://github.com/Automattic/jetpack/pull/31757]

## 12.4-a.1 - 2023-07-05

### Enhancements

- AI Assistant: Keep original content when trying again after transforming a paragraph using the "Ask AI Assistant" button. [https://github.com/Automattic/jetpack/pull/31597]
- Contact Forms: remove the default title ("You got a new response!") added to emails sent for new feedback received. [https://github.com/Automattic/jetpack/pull/31667]
- Cookie Consent Block: Persist markup and ensure it is rendered in the footer. [https://github.com/Automattic/jetpack/pull/31511]
- Custom CSS: Display a notice to recommend the use of Global Styles when you use a Block theme on your site. [https://github.com/Automattic/jetpack/pull/31413]
- Subscribers page: Add subscribers page to menu. [https://github.com/Automattic/jetpack/pull/31567]

### Improved compatibility

- Tiled Galleries: Fix deprecation notices that may appear in logs when using PHP 8.2. [https://github.com/Automattic/jetpack/pull/31640]

### Bug fixes

- Dashboard: Fix Jetpack footer accessibility issues. [https://github.com/Automattic/jetpack/pull/31417]
- Search: when using a block theme, display a link to add a Search Block instead of a Search Widget in the Jetpack dashboard. [https://github.com/Automattic/jetpack/pull/31614]

### Other changes <!-- Non-user-facing changes go here. This section will not be copied to readme.txt. -->

- Add wpcom_site_setup property to /sites/{siteId} endpoint [https://github.com/Automattic/jetpack/pull/31664]
- Dashboard: update wording for Custom CSS section when using a Block theme. [https://github.com/Automattic/jetpack/pull/31634]
- Sync wpcom_site_setup site option [https://github.com/Automattic/jetpack/pull/31662]
- Updated package dependencies. [https://github.com/Automattic/jetpack/pull/31659]
- Updated package dependencies. [https://github.com/Automattic/jetpack/pull/31661]
- WordPress.com Toolbar: only add Blaze Dashboard link once. [https://github.com/Automattic/jetpack/pull/31617]
