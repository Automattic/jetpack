...
- VideoPress: Use the shared in-page player for the `[videopress]` shortcode, video blocks and embeds on sites that return `false` from the `jetpack_videopress_player_use_iframe` filter, instead of one inline script per video.
