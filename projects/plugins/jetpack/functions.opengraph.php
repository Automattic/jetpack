...
/**
 * Strips premium content blocks from the description to prevent leaking of paid content in tags.
 *
 * @param string $description Text coming from WordPress (autogenerated or manually generated by author).
 *
 * @return string $description String with premium content removed.
 */
function jetpack_og_remove_premium_content( $description = '' ) {
	return preg_replace(
		'/<!-- wp:premium-content\/container -->(.+?)<!-- \/wp:premium-content\/container -->/s',
		'',
		$description
	);
}
...
function jetpack_og_get_description( $description = '', $data = null ) {
	// Remove all premium content.
	$description = jetpack_og_remove_premium_content( $description );
