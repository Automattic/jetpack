...
$log_file_link = "<a href='" . home_url( str_replace( $_SERVER['DOCUMENT_ROOT'] . $wp_cache_home_path, '', "{$cache_path}view_{$wp_cache_debug_log}?wp-admin=1&wp-json=1&filter=" ) ) . "'>$wp_cache_debug_log</a>";
