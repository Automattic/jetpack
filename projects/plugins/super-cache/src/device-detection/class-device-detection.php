...
class Device_Detection {
	...
	public static function get_info( $ua = '' ) {
		...
		if ( function_exists( 'apply_filters' ) ) {
			/**
			 * Filter the value of Automattic\WPSC\Device_Detection::get_info.
			 *
			 * @since 1.0.0
			 *
			 * @param array           $info    Array of device information.
			 * @param string          $ua      User agent string passed to Automattic\WPSC\Device_Detection::get_info.
	* @param User_Agent_Info $ua_info Instance of Automattic\WPSC\Device_Detection\User_Agent_Info.
			 */
