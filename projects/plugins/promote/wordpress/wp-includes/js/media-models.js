	...
	/******/ {
		/***/ '0Ym0': /***/ function ( module, exports ) {
			...
			Attachment = Backbone.Model.extend(
				/** @lends wp.media.model.Attachment.prototype */ {
					/**
		...
		/***/ 'Io+g': /***/ function ( module, exports ) {
			...
			Selection = Attachments.extend(
				/** @lends wp.media.model.Selection.prototype */ {
					/**
		...
		/***/ 'K0z/': /***/ function ( module, exports ) {
			...
			var Attachments = Backbone.Collection.extend(
				/** @lends wp.media.model.Attachments.prototype */ {
					/**
					...
					_changeFilteredProps: function ( model ) {
						...
						var changed = _.chain( model.changed )
							.map( function ( t, prop ) {
				...
				/** @lends wp.media.model.Attachments */ {
					...
					filters: {
						...
						search: function ( attachment ) {
							...
							return _.any(
								[ 'title', 'filename', 'description', 'caption', 'name' ],
								function ( key ) {
		...
		/***/ dx5j: /***/ function ( module, exports, __webpack_require__ ) {
			/**
			...
			_.extend(
				...
				/** @lends wp.media */ {
					...
					truncate: function ( string, length, replacement ) {
						...
						return (
							string.substr( 0, length / 2 ) + replacement + string.substr( ( -1 * length ) / 2 )
						);
					},
				}
			);
		...
		/***/ efdO: /***/ function ( module, exports ) {
			...
			Query = Attachments.extend(
				/** @lends wp.media.model.Query.prototype */ {
					/**
					...
					initialize: function ( models, options ) {
						...
						if (
							wp.Uploader &&
							_( this.args ).chain().keys().difference( allowed ).isEmpty().value()
						) {
					...
					more: function ( options ) {
						...
						return ( this._more = this.fetch( options ).done( function ( response ) {
							if (
								_.isEmpty( response ) ||
								-1 === query.args.posts_per_page ||
								response.length < query.args.posts_per_page
							) {
		...
		/***/ r1z7: /***/ function ( module, exports ) {
			...
			var PostImage = Backbone.Model.extend(
				/** @lends wp.media.model.PostImage.prototype */ {
