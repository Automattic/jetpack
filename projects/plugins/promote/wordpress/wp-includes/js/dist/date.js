...
this[ 'wp' ][ 'date' ] = /******/ ( function ( modules ) {
	...
	************************************/
		...
		/***/ BWYS: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			...
			/* harmony import */ var moment_timezone_moment_timezone__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__.n(
				moment_timezone_moment_timezone__WEBPACK_IMPORTED_MODULE_1__
			);
			/* harmony import */ var moment_timezone_moment_timezone_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
				'4CCe'
			);
			/* harmony import */ var moment_timezone_moment_timezone_utils__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/ __webpack_require__.n(
			...
			const formatMap = {
				 ...
				 */
				B( momentDate ) {
					const timezoned = moment__WEBPACK_IMPORTED_MODULE_0___default()( momentDate ).utcOffset(
						60
					);
			...
			function format( dateFormat ) {
				let dateValue =
					arguments.length > 1 && arguments[ 1 ] !== undefined ? arguments[ 1 ] : new Date();
				let i, char;
				const newFormat = [];
