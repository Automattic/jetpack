...
this[ 'wp' ][ 'data' ] = /******/ ( function ( modules ) {
	...
	/******/ {
		...
		/***/ FtRg: /***/ function ( module, exports, __webpack_require__ ) {
			'use strict';
					...
					_createClass( EquivalentKeyMap, [
						...
						},
						{
							...
							value: function forEach( callback ) {
								...
								var thisArg =
									arguments.length > 1 && arguments[ 1 ] !== undefined ? arguments[ 1 ] : this;
		...
		/***/ pfJ3: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			__webpack_require__.r( __webpack_exports__ );

			// EXPORTS
			__webpack_require__.d( __webpack_exports__, 'withSelect', function () {
				return /* reexport */ with_select;
			} );
			__webpack_require__.d( __webpack_exports__, 'withDispatch', function () {
				return /* reexport */ with_dispatch;
			} );
			__webpack_require__.d( __webpack_exports__, 'withRegistry', function () {
				return /* reexport */ with_registry;
			} );
			__webpack_require__.d( __webpack_exports__, 'RegistryProvider', function () {
				return /* reexport */ context;
			} );
			__webpack_require__.d( __webpack_exports__, 'RegistryConsumer', function () {
				return /* reexport */ RegistryConsumer;
			} );
			__webpack_require__.d( __webpack_exports__, 'useRegistry', function () {
				return /* reexport */ useRegistry;
			} );
			__webpack_require__.d( __webpack_exports__, 'useSelect', function () {
				return /* reexport */ useSelect;
			} );
			__webpack_require__.d( __webpack_exports__, 'useDispatch', function () {
				return /* reexport */ use_dispatch;
			} );
			__webpack_require__.d( __webpack_exports__, 'AsyncModeProvider', function () {
				return /* reexport */ async_mode_provider_context;
			} );
			__webpack_require__.d( __webpack_exports__, 'createRegistry', function () {
				return /* reexport */ createRegistry;
			} );
			__webpack_require__.d( __webpack_exports__, 'createRegistrySelector', function () {
				return /* reexport */ createRegistrySelector;
			} );
			__webpack_require__.d( __webpack_exports__, 'createRegistryControl', function () {
				return /* reexport */ createRegistryControl;
			} );
			__webpack_require__.d( __webpack_exports__, 'controls', function () {
				return /* reexport */ controls_controls;
			} );
			__webpack_require__.d( __webpack_exports__, 'createReduxStore', function () {
				return /* reexport */ createReduxStore;
			} );
			__webpack_require__.d( __webpack_exports__, 'plugins', function () {
				return /* reexport */ plugins_namespaceObject;
			} );
			__webpack_require__.d( __webpack_exports__, 'combineReducers', function () {
				return /* reexport */ turbo_combine_reducers_default.a;
			} );
			__webpack_require__.d( __webpack_exports__, 'select', function () {
				return /* binding */ build_module_select;
			} );
			__webpack_require__.d( __webpack_exports__, 'resolveSelect', function () {
				return /* binding */ build_module_resolveSelect;
			} );
			__webpack_require__.d( __webpack_exports__, 'dispatch', function () {
				return /* binding */ build_module_dispatch;
			} );
			__webpack_require__.d( __webpack_exports__, 'subscribe', function () {
				return /* binding */ build_module_subscribe;
			} );
			__webpack_require__.d( __webpack_exports__, 'registerGenericStore', function () {
				return /* binding */ build_module_registerGenericStore;
			} );
			__webpack_require__.d( __webpack_exports__, 'registerStore', function () {
				return /* binding */ registerStore;
			} );
			__webpack_require__.d( __webpack_exports__, 'use', function () {
				return /* binding */ build_module_use;
			} );
			__webpack_require__.d( __webpack_exports__, 'register', function () {
				return /* binding */ build_module_register;
			} );

			// NAMESPACE OBJECT: ./node_modules/@wordpress/data/build-module/redux-store/metadata/selectors.js
			var selectors_namespaceObject = {};
			__webpack_require__.r( selectors_namespaceObject );
			__webpack_require__.d( selectors_namespaceObject, 'getIsResolving', function () {
				return getIsResolving;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'hasStartedResolution', function () {
				return hasStartedResolution;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'hasFinishedResolution', function () {
				return hasFinishedResolution;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'isResolving', function () {
				return isResolving;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'getCachedResolvers', function () {
				return getCachedResolvers;
			} );

			// NAMESPACE OBJECT: ./node_modules/@wordpress/data/build-module/redux-store/metadata/actions.js
			var actions_namespaceObject = {};
			__webpack_require__.r( actions_namespaceObject );
			__webpack_require__.d( actions_namespaceObject, 'startResolution', function () {
				return startResolution;
			} );
			__webpack_require__.d( actions_namespaceObject, 'finishResolution', function () {
				return finishResolution;
			} );
			__webpack_require__.d( actions_namespaceObject, 'startResolutions', function () {
				return startResolutions;
			} );
			__webpack_require__.d( actions_namespaceObject, 'finishResolutions', function () {
				return finishResolutions;
			} );
			__webpack_require__.d( actions_namespaceObject, 'invalidateResolution', function () {
				return invalidateResolution;
			} );
			__webpack_require__.d( actions_namespaceObject, 'invalidateResolutionForStore', function () {
			...
			__webpack_require__.d( plugins_namespaceObject, 'controls', function () {
				return plugins_controls;
			} );
			__webpack_require__.d( plugins_namespaceObject, 'persistence', function () {
				return plugins_persistence;
			} );

			// EXTERNAL MODULE: ./node_modules/turbo-combine-reducers/index.js
			var turbo_combine_reducers = __webpack_require__( '8mpt' );
			var turbo_combine_reducers_default = /*#__PURE__*/ __webpack_require__.n(
				turbo_combine_reducers
			);
			...
			var external_wp_reduxRoutine_default = /*#__PURE__*/ __webpack_require__.n(
				external_wp_reduxRoutine_
			);
			...
			function controls_select( storeNameOrDefinition, selectorName ) {
				...
				return {
					type: SELECT,
					storeKey: Object( external_lodash_[ 'isObject' ] )( storeNameOrDefinition )
			...
			const builtinControls = {
				[ SELECT ]: createRegistryControl( registry => _ref => {
					let { storeKey, selectorName, args } = _ref;
					return registry.select( storeKey )[ selectorName ]( ...args );
				} ),
				[ RESOLVE_SELECT ]: createRegistryControl( registry => _ref2 => {
					let { storeKey, selectorName, args } = _ref2;
					const method = registry.select( storeKey )[ selectorName ].hasResolver
						? 'resolveSelect'
						: 'select';
					return registry[ method ]( storeKey )[ selectorName ]( ...args );
				} ),
				[ DISPATCH ]: createRegistryControl( registry => _ref3 => {
					let { storeKey, actionName, args } = _ref3;
			...
			const createResolversCacheMiddleware = ( registry, reducerKey ) => () => next => action => {
				...
				Object.entries( resolvers ).forEach( _ref => {
					...
					const resolver = Object( external_lodash_[ 'get' ] )( registry.stores, [
						reducerKey,
						'resolvers',
						selectorName,
					] );
			...
			const subKeysIsResolved = onSubKey( 'selectorName' )( function () {
				let state =
					arguments.length > 0 && arguments[ 0 ] !== undefined
						? arguments[ 0 ]
						: new equivalent_key_map_default.a();
				let action = arguments.length > 1 ? arguments[ 1 ] : undefined;
			...
			const isResolved = function () {
				...
				switch ( action.type ) {
					...
					case 'INVALIDATE_RESOLUTION_FOR_STORE_SELECTOR':
						return Object( external_lodash_[ 'has' ] )( state, [ action.selectorName ] )
							? Object( external_lodash_[ 'omit' ] )( state, [ action.selectorName ] )
							: state;
			...
			function createResolversCache() {
				...
				return {
					isRunning( selectorName, args ) {
						return (
							cache[ selectorName ] && cache[ selectorName ].get( trimUndefinedValues( args ) )
						);
					},
			...
			function createReduxStore( key, options ) {
				return {
					...
					instantiate: registry => {
						...
						let resolvers;
						const actions = mapActions( { ...actions_namespaceObject, ...options.actions }, store );
			...
			function instantiateReduxStore( key, options, registry, thunkArgs ) {
				const controls = { ...options.controls, ...builtinControls };
				const normalizedControls = Object( external_lodash_[ 'mapValues' ] )( controls, control =>
					control.isRegistryControl ? control( registry ) : control
				);
				const middlewares = [
					resolvers_cache_middleware( registry, key ),
					promise_middleware,
			...
			function mapResolveSelectors( selectors, store ) {
				return Object( external_lodash_[ 'mapValues' ] )(
					Object( external_lodash_[ 'omit' ] )( selectors, [
						'getIsResolving',
			...
			function createRegistry() {
				...
				function select( storeNameOrDefinition ) {
					const storeName = Object( external_lodash_[ 'isObject' ] )( storeNameOrDefinition )
						? storeNameOrDefinition.name
						: storeNameOrDefinition;
				...
				function use( plugin, options ) {
					registry = { ...registry, ...plugin( registry, options ) };
					return registry;
				}
				...
				return {
					registerStore( storeName, options ) {
						...
						if ( persistedState !== undefined ) {
							...
							if (
								Object( external_lodash_[ 'isPlainObject' ] )( initialState ) &&
								Object( external_lodash_[ 'isPlainObject' ] )( persistedState )
							) {
								...
								initialState = Object( external_lodash_[ 'merge' ] )(
									{},
									initialState,
									persistedState
								);
			...
			function migrateFeaturePreferencesToInterfaceStore( persistence, sourceStoreName ) {
				...
				const sourcePreferences =
					( _state$sourceStoreNam = state[ sourceStoreName ] ) === null ||
					_state$sourceStoreNam === void 0
						? void 0
						: _state$sourceStoreNam.preferences;
				const sourceFeatures =
					sourcePreferences === null || sourcePreferences === void 0
						? void 0
						: sourcePreferences.features;

				if ( sourceFeatures ) {
					var _state$interfaceStore, _state$interfaceStore2;

					const targetFeatures =
						( _state$interfaceStore = state[ interfaceStoreName ] ) === null ||
						_state$interfaceStore === void 0
							? void 0
							: ( _state$interfaceStore2 = _state$interfaceStore.preferences ) === null ||
							  _state$interfaceStore2 === void 0
							? void 0
							: _state$interfaceStore2.features; // Avoid migrating features again if they've previously been migrated.

					if (
						! (
							targetFeatures !== null &&
							targetFeatures !== void 0 &&
						...
						persistence.set( interfaceStoreName, {
							preferences: {
								features: { ...targetFeatures, [ sourceStoreName ]: sourceFeatures },
							},
						} ); // Remove feature preferences from the source.

						persistence.set( sourceStoreName, {
							preferences: { ...sourcePreferences, features: undefined },
						} );
					}
				}
			}
			...
			function useSelect( _mapSelect, deps ) {
				...
				const trapSelect = Object( external_wp_element_[ 'useCallback' ] )(
					callback => registry.__experimentalMarkListeningStores( callback, listeningStores ),
					[ registry ]
				); // Generate a "flag" for used in the effect dependency array.
				// It's different than just using `mapSelect` since deps could be undefined,
				// in that case, we would still want to memoize it.

				const depsChangedFlag = Object( external_wp_element_[ 'useMemo' ] )(
					() => ( {} ),
					deps || []
				);
				let mapOutput;
					...
					const onStoreChange = () => {
						if ( isMountedAndNotUnsubscribing.current ) {
							try {
								...
								if (
									external_wp_isShallowEqual_default()( latestMapOutput.current, newMapOutput )
								) {
									return;
								}
			...
			const withSelect = mapSelectToProps =>
				Object( external_wp_compose_[ 'createHigherOrderComponent' ] )(
					WrappedComponent =>
						Object( external_wp_compose_[ 'pure' ] )( ownProps => {
							...
							return Object( external_wp_element_[ 'createElement' ] )(
								WrappedComponent,
								Object( esm_extends[ 'a' /* default */ ] )( {}, ownProps, mergeProps )
							);
						} ),
					'withSelect'
				);
			...
			const withDispatch = mapDispatchToProps =>
				Object( external_wp_compose_[ 'createHigherOrderComponent' ] )(
					WrappedComponent => ownProps => {
						...
						return Object( external_wp_element_[ 'createElement' ] )(
							WrappedComponent,
							Object( esm_extends[ 'a' /* default */ ] )( {}, ownProps, dispatchProps )
						);
					},
					'withDispatch'
				);
			...
			const withRegistry = Object( external_wp_compose_[ 'createHigherOrderComponent' ] )(
				OriginalComponent => props =>
					Object( external_wp_element_[ 'createElement' ] )( RegistryConsumer, null, registry =>
