...
this[ 'wp' ][ 'widgets' ] = /******/ ( function ( modules ) {
	...
	/******/ {
		...
		/***/ '4g8P': /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			__webpack_require__.r( __webpack_exports__ );

			// EXPORTS
			__webpack_require__.d( __webpack_exports__, 'MoveToWidgetArea', function () {
				return /* reexport */ MoveToWidgetArea;
			} );
			__webpack_require__.d( __webpack_exports__, 'getWidgetIdFromBlock', function () {
				return /* reexport */ getWidgetIdFromBlock;
			} );
			__webpack_require__.d( __webpack_exports__, 'addWidgetIdToBlock', function () {
				return /* reexport */ addWidgetIdToBlock;
			} );
			__webpack_require__.d( __webpack_exports__, 'registerLegacyWidgetBlock', function () {
				return /* binding */ registerLegacyWidgetBlock;
			} );
			__webpack_require__.d( __webpack_exports__, 'registerWidgetGroupBlock', function () {
				return /* binding */ registerWidgetGroupBlock;
			} );
			__webpack_require__.d( __webpack_exports__, 'registerLegacyWidgetVariations', function () {
			...
			__webpack_require__.d( legacy_widget_namespaceObject, 'metadata', function () {
				return legacy_widget_metadata;
			} );
			__webpack_require__.d( legacy_widget_namespaceObject, 'name', function () {
				return legacy_widget_name;
			} );
			__webpack_require__.d( legacy_widget_namespaceObject, 'settings', function () {
			...
			__webpack_require__.d( widget_group_namespaceObject, 'metadata', function () {
				return widget_group_metadata;
			} );
			__webpack_require__.d( widget_group_namespaceObject, 'name', function () {
				return widget_group_name;
			} );
			__webpack_require__.d( widget_group_namespaceObject, 'settings', function () {
			...
			const widget_widget = Object( external_wp_element_[ 'createElement' ] )(
				...
				Object( external_wp_element_[ 'createElement' ] )( external_wp_primitives_[ 'Path' ], {
					d:
						'M6 3H8V5H16V3H18V5C19.1046 5 20 5.89543 20 7V19C20 20.1046 19.1046 21 18 21H6C4.89543 21 4 20.1046 4 19V7C4 5.89543 4.89543 5 6 5V3ZM18 6.5H6C5.72386 6.5 5.5 6.72386 5.5 7V8H18.5V7C18.5 6.72386 18.2761 6.5 18 6.5ZM18.5 9.5H5.5V19C5.5 19.2761 5.72386 19.5 6 19.5H18C18.2761 19.5 18.5 19.2761 18.5 19V9.5ZM11 11H13V13H11V11ZM7 11V13H9V11H7ZM15 13V11H17V13H15Z',
				} )
			);
			...
			function WidgetTypeSelector( _ref ) {
				...
				const widgetTypes = Object( external_wp_data_[ 'useSelect' ] )( select => {
					...
					const hiddenIds =
						( _select$getSettings$w =
							( _select$getSettings = select(
								...
								? void 0
								: _select$getSettings.widgetTypesToHideFromLegacyWidgetBlock ) !== null &&
					...
					return ( _select$getWidgetType = select(
						...
						? void 0
						: _select$getWidgetType.filter( widgetType => ! hiddenIds.includes( widgetType.id ) );
				}, [] );
			...
			function InspectorCard( _ref ) {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )( 'span', null, description )
				);
			}
			...
			class control_Control {
				 ...
				 */
				constructor( _ref ) {
					let { id, idBase, instance, onChangeInstance, onChangeHasPreview, onError } = _ref;
					this.id = id;
					this.idBase = idBase;
									...
									( this.form = el(
										...
										[
											...
											el( 'input', {
												...
												name: 'id_base',
												value:
													( _this$idBase = this.idBase ) !== null && _this$idBase !== void 0
														? _this$idBase
														: this.id,
											} ),
											el( 'input', {
			...
			function Form( _ref ) {
				...
				const isMediumLargeViewport = Object( external_wp_compose_[ 'useViewportMatch' ] )(
					'small'
			...
			function NoPreview( _ref ) {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					name && Object( external_wp_element_[ 'createElement' ] )( 'h3', null, name ),
					Object( external_wp_element_[ 'createElement' ] )(
						'p',
						null,
			...
			const legacyWidgetTransforms = [
				...
				return {
					...
					isMatch: _ref13 => {
						...
						return (
							idBase === widget && !! ( instance !== null && instance !== void 0 && instance.raw )
						);
					},
					transform: _ref14 => {
						var _instance$raw;
			...
			function edit_Edit( props ) {
				...
				const { innerBlocks } = Object( external_wp_data_[ 'useSelect' ] )(
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					innerBlocks.length === 0
						? Object( external_wp_element_[ 'createElement' ] )( PlaceholderContent, props )
						: Object( external_wp_element_[ 'createElement' ] )( PreviewContent, props )
				);
			}
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )(
						external_wp_blockEditor_[ 'RichText' ],
						{
							...
							value:
								( _attributes$title = attributes.title ) !== null && _attributes$title !== void 0
									? _attributes$title
									: '',
							onChange: title =>
								setAttributes( {
			...
			function save( _ref ) {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					null,
					Object( external_wp_element_[ 'createElement' ] )(
						external_wp_blockEditor_[ 'RichText' ].Content,
						{
							tagName: 'h2',
							className: 'widget-title',
					...
					Object( external_wp_element_[ 'createElement' ] )(
						external_wp_blockEditor_[ 'InnerBlocks' ].Content,
						null
					)
				);
			}
					...
					from: [
						{
							...
							__experimentalConvert( blocks ) {
								...
								let innerBlocks = [
									...blocks.map( block => {
										return Object( external_wp_blocks_[ 'createBlock' ] )(
											block.name,
											block.attributes,
											block.innerBlocks
										);
			...
			const moveTo = Object( external_wp_element_[ 'createElement' ] )(
				...
				Object( external_wp_element_[ 'createElement' ] )( external_wp_primitives_[ 'Path' ], {
					d:
						'M19.75 9c0-1.257-.565-2.197-1.39-2.858-.797-.64-1.827-1.017-2.815-1.247-1.802-.42-3.703-.403-4.383-.396L11 4.5V6l.177-.001c.696-.006 2.416-.02 4.028.356.887.207 1.67.518 2.216.957.52.416.829.945.829 1.688 0 .592-.167.966-.407 1.23-.255.281-.656.508-1.236.674-1.19.34-2.82.346-4.607.346h-.077c-1.692 0-3.527 0-4.942.404-.732.209-1.424.545-1.935 1.108-.526.579-.796 1.33-.796 2.238 0 1.257.565 2.197 1.39 2.858.797.64 1.827 1.017 2.815 1.247 1.802.42 3.703.403 4.383.396L13 19.5h.714V22L18 18.5 13.714 15v3H13l-.177.001c-.696.006-2.416.02-4.028-.356-.887-.207-1.67-.518-2.216-.957-.52-.416-.829-.945-.829-1.688 0-.592.167-.966.407-1.23.255-.281.656-.508 1.237-.674 1.189-.34 2.819-.346 4.606-.346h.077c1.692 0 3.527 0 4.941-.404.732-.209 1.425-.545 1.936-1.108.526-.579.796-1.33.796-2.238z',
				} )
			);
			...
			function addWidgetIdToBlock( block, widgetId ) {
				return {
					...block,
					attributes: { ...( block.attributes || {} ), __internalWidgetId: widgetId },
				};
			}
...
*/
		...
		/***/ u6za: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			...
			const group = Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
				...
				Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
					...
					{
						d:
							'M18 4h-7c-1.1 0-2 .9-2 2v3H6c-1.1 0-2 .9-2 2v7c0 1.1.9 2 2 2h7c1.1 0 2-.9 2-2v-3h3c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-4.5 14c0 .3-.2.5-.5.5H6c-.3 0-.5-.2-.5-.5v-7c0-.3.2-.5.5-.5h3V13c0 1.1.9 2 2 2h2.5v3zm0-4.5H11c-.3 0-.5-.2-.5-.5v-2.5H13c.3 0 .5.2.5.5v2.5zm5-.5c0 .3-.2.5-.5.5h-3V11c0-1.1-.9-2-2-2h-2.5V6c0-.3.2-.5.5-.5h7c.3 0 .5.2.5.5v7z',
					}
				)
			);
