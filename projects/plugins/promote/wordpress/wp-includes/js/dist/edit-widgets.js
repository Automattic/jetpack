...
this[ 'wp' ][ 'editWidgets' ] = /******/ ( function ( modules ) {
	...
	/************************************************************************/
	/******/ {
		/***/ '//Lo': /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			...
			const blockDefault = Object(
				...
				Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
					...
					{
						d:
							'M19 8h-1V6h-5v2h-2V6H6v2H5c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-8c0-1.1-.9-2-2-2zm.5 10c0 .3-.2.5-.5.5H5c-.3 0-.5-.2-.5-.5v-8c0-.3.2-.5.5-.5h14c.3 0 .5.2.5.5v8z',
					}
				)
			);
		...
		/***/ F35A: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			__webpack_require__.d( actions_namespaceObject, 'persistStubPost', function () {
				return persistStubPost;
			} );
			__webpack_require__.d( actions_namespaceObject, 'saveEditedWidgetAreas', function () {
				return actions_saveEditedWidgetAreas;
			} );
			__webpack_require__.d( actions_namespaceObject, 'saveWidgetAreas', function () {
				return saveWidgetAreas;
			} );
			__webpack_require__.d( actions_namespaceObject, 'saveWidgetArea', function () {
				return saveWidgetArea;
			} );
			__webpack_require__.d( actions_namespaceObject, 'setWidgetIdForClientId', function () {
				return setWidgetIdForClientId;
			} );
			__webpack_require__.d( actions_namespaceObject, 'setWidgetAreasOpenState', function () {
				return setWidgetAreasOpenState;
			} );
			__webpack_require__.d( actions_namespaceObject, 'setIsWidgetAreaOpen', function () {
			...
			__webpack_require__.d( actions_namespaceObject, 'setIsListViewOpened', function () {
				return actions_setIsListViewOpened;
			} );
			__webpack_require__.d( actions_namespaceObject, 'closeGeneralSidebar', function () {
				return actions_closeGeneralSidebar;
			} );
			__webpack_require__.d( actions_namespaceObject, 'moveBlockToWidgetArea', function () {
			...
			__webpack_require__.d( resolvers_namespaceObject, 'getWidgetAreas', function () {
				return getWidgetAreas;
			} );
			__webpack_require__.d( resolvers_namespaceObject, 'getWidgets', function () {
				return getWidgets;
			} );
			...
			__webpack_require__.d( selectors_namespaceObject, 'getWidgets', function () {
				return selectors_getWidgets;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'getWidget', function () {
				return getWidget;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'getWidgetAreas', function () {
				return selectors_getWidgetAreas;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'getWidgetAreaForWidgetId', function () {
				return getWidgetAreaForWidgetId;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'getParentWidgetAreaBlock', function () {
				return selectors_getParentWidgetAreaBlock;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'getEditedWidgetAreas', function () {
				return selectors_getEditedWidgetAreas;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'getReferenceWidgetBlocks', function () {
				return getReferenceWidgetBlocks;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'isSavingWidgetAreas', function () {
				return selectors_isSavingWidgetAreas;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'getIsWidgetAreaOpen', function () {
			...
			__webpack_require__.d( selectors_namespaceObject, 'canInsertBlockInWidgetArea', function () {
				return selectors_canInsertBlockInWidgetArea;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'isListViewOpened', function () {
				return selectors_isListViewOpened;
			} );
			...
			__webpack_require__.d( widget_area_namespaceObject, 'metadata', function () {
				return widget_area_metadata;
			} );
			__webpack_require__.d( widget_area_namespaceObject, 'name', function () {
				return widget_area_name;
			} );
			__webpack_require__.d( widget_area_namespaceObject, 'settings', function () {
			...
			function transformWidgetToBlock( widget ) {
				...
				return Object( external_wp_widgets_[ 'addWidgetIdToBlock' ] )(
					Object( external_wp_blocks_[ 'createBlock' ] )( 'core/legacy-widget', attributes, [] ),
					widget.id
				);
			}
			/**
			...
			const persistStubPost = ( id, blocks ) => _ref => {
				...
				registry.dispatch( external_wp_coreData_[ 'store' ] ).receiveEntityRecords(
					KIND,
					POST_TYPE,
					stubPost,
					{
			...
			const actions_saveEditedWidgetAreas = () => async _ref2 => {
				let { select, dispatch, registry } = _ref2;
				...
				try {
					...
					registry
						...
						.createSuccessNotice( Object( external_wp_i18n_[ '__' ] )( 'Widgets saved.' ), {
							type: 'snackbar',
						} );
				} catch ( e ) {
			...
			const saveWidgetAreas = widgetAreas => async _ref3 => {
				...
				try {
					...
					await registry
						.dispatch( external_wp_coreData_[ 'store' ] )
						.finishResolution(
							'getEntityRecord',
							KIND,
			...
			const saveWidgetArea = widgetAreaId => async _ref4 => {
				let { dispatch, select, registry } = _ref4;
				const widgets = select.getWidgets();
				const post = registry
					.select( external_wp_coreData_[ 'store' ] )
					.getEditedEntityRecord( KIND, POST_TYPE, buildWidgetAreaPostId( widgetAreaId ) ); // Get all widgets from this area
				...
				for ( let i = 0; i < widgetsBlocks.length; i++ ) {
					...
					if ( oldWidget ) {
						...
						registry.dispatch( external_wp_coreData_[ 'store' ] ).editEntityRecord(
							'root',
							'widget',
							widgetId,
						...
						batchTasks.push( _ref6 => {
							let { saveEditedEntityRecord } = _ref6;
							return saveEditedEntityRecord( 'root', 'widget', widgetId );
						} );
					} else {
						// Create a new widget.
						batchTasks.push( _ref7 => {
							let { saveEntityRecord } = _ref7;
							return saveEntityRecord( 'root', 'widget', { ...widget, sidebar: widgetAreaId } );
						} );
					}
				...
				for ( let i = 0; i < preservedRecords.length; i++ ) {
					...
					if ( error ) {
						...
						failedWidgetNames.push(
							( ( _block$attributes = block.attributes ) === null || _block$attributes === void 0
								? void 0
				...
				if ( failedWidgetNames.length ) {
					throw new Error(
						Object( external_wp_i18n_[ 'sprintf' ] )(
							...
							Object( external_wp_i18n_[ '__' ] )( 'Could not save the following widgets: %s.' ),
			...
			const actions_moveBlockToWidgetArea = ( clientId, widgetAreaId ) => async _ref11 => {
				let { dispatch, select, registry } = _ref11;
				const sourceRootClientId = registry
					.select( external_wp_blockEditor_[ 'store' ] )
					.getBlockRootClientId( [ clientId ] ); // Search the top level blocks (widget areas) for the one with the matching
			...
			const getWidgetAreas = () => async _ref => {
				let { dispatch, registry } = _ref;
				const query = buildWidgetAreasQuery();
				const widgetAreas = await registry
					.resolveSelect( external_wp_coreData_[ 'store' ] )
			...
			const getWidgets = () => async _ref2 => {
				...
				for ( const sidebarId in groupedBySidebar ) {
					if ( groupedBySidebar.hasOwnProperty( sidebarId ) ) {
						...
						dispatch(
							persistStubPost( buildWidgetAreaPostId( sidebarId ), groupedBySidebar[ sidebarId ] )
						);
					}
				}
			};
			...
			const selectors_getWidgets = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => () => {
					const widgets = select( external_wp_coreData_[ 'store' ] ).getEntityRecords(
						'root',
						'widget',
						buildWidgetsQuery()
					);
			...
			const selectors_getWidgetAreas = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => () => {
					const query = buildWidgetAreasQuery();
					return select( external_wp_coreData_[ 'store' ] ).getEntityRecords(
						KIND,
						WIDGET_AREA_ENTITY_TYPE,
						query
					);
			...
			const getWidgetAreaForWidgetId = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => ( state, widgetId ) => {
					const widgetAreas = select( STORE_NAME ).getWidgetAreas();
					return widgetAreas.find( widgetArea => {
						const post = select( external_wp_coreData_[ 'store' ] ).getEditedEntityRecord(
							KIND,
							POST_TYPE,
			...
			const selectors_getEditedWidgetAreas = Object(
				...
				return widgetAreas
					.filter( _ref2 => {
						let { id } = _ref2;
						return select( external_wp_coreData_[ 'store' ] ).hasEditsForEntityRecord(
							KIND,
							POST_TYPE,
			...
			const getReferenceWidgetBlocks = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select =>
					function ( state ) {
						let referenceWidgetName =
								...
								if (
									...
									( ! referenceWidgetName ||
										...
										_block$attributes === void 0
											? void 0
											: _block$attributes.referenceWidgetName ) === referenceWidgetName )
								) {
									results.push( block );
								}
							}
			...
			const selectors_isSavingWidgetAreas = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => () => {
					var _select$getWidgetArea;

					const widgetAreasIds =
						( _select$getWidgetArea = select( STORE_NAME ).getWidgetAreas() ) === null ||
						_select$getWidgetArea === void 0
							? void 0
							: _select$getWidgetArea.map( _ref4 => {
									let { id } = _ref4;
									return id;
							  } );
					...
					for ( const id of widgetAreasIds ) {
						const isSaving = select( external_wp_coreData_[ 'store' ] ).isSavingEntityRecord(
							KIND,
							WIDGET_AREA_ENTITY_TYPE,
							id
						);
			...
			const selectors_canInsertBlockInWidgetArea = Object(
				...
				return select( external_wp_blockEditor_[ 'store' ] ).canInsertBlockType(
					blockName,
			...
			const withMoveToWidgetAreaToolbarItem = Object(
				...
				BlockEdit => props => {
					...
					const { widgetAreas, currentWidgetAreaId, canInsertBlockInWidgetArea } = Object(
							...
							return {
								...
								currentWidgetAreaId:
									widgetAreaBlock === null || widgetAreaBlock === void 0
										? void 0
										: ( _widgetAreaBlock$attr = widgetAreaBlock.attributes ) === null ||
										  _widgetAreaBlock$attr === void 0
										? void 0
					...
					const { moveBlockToWidgetArea } = Object( external_wp_data_[ 'useDispatch' ] )( store );
					const hasMultipleWidgetAreas =
						( widgetAreas === null || widgetAreas === void 0 ? void 0 : widgetAreas.length ) > 1;
			...
			function WidgetAreaEdit( _ref ) {
				...
				const { setIsWidgetAreaOpen } = Object( external_wp_data_[ 'useDispatch' ] )( store );
			...
			function KeyboardShortcuts() {
				const { redo, undo } = Object( external_wp_data_[ 'useDispatch' ] )(
					external_wp_coreData_[ 'store' ]
				);
				const { saveEditedWidgetAreas } = Object( external_wp_data_[ 'useDispatch' ] )( store );
			...
			const useLastSelectedWidgetArea = () =>
				Object( external_wp_data_[ 'useSelect' ] )( select => {
					...
					const { getEntityRecord } = select( external_wp_coreData_[ 'store' ] );
			...
			function WidgetAreasBlockEditorProvider( _ref ) {
				let { blockEditorSettings, children, ...props } = _ref;
				const {
					...
					select => ( {
						hasUploadPermissions: Object( external_lodash_[ 'defaultTo' ] )(
							select( external_wp_coreData_[ 'store' ] ).canUser( 'create', 'media' ),
							true
						),
						widgetAreas: select( store ).getWidgetAreas(),
						widgets: select( store ).getWidgets(),
						reusableBlocks: ALLOW_REUSABLE_BLOCKS
							? select( external_wp_coreData_[ 'store' ] ).getEntityRecords(
									'postType',
									'wp_block'
							  )
							: [],
						isFixedToolbarActive: select( build_module[ 'i' /* store */ ] ).isFeatureActive(
							'core/edit-widgets',
							'fixedToolbar'
						),
						keepCaretInsideBlock: select( build_module[ 'i' /* store */ ] ).isFeatureActive(
							'core/edit-widgets',
							'keepCaretInsideBlock'
						),
					} ),
				...
				const { setIsInserterOpened } = Object( external_wp_data_[ 'useDispatch' ] )( store );
				const settings = Object( external_wp_element_[ 'useMemo' ] )( () => {
					let mediaUploadBlockEditor;

					if ( hasUploadPermissions ) {
						mediaUploadBlockEditor = _ref2 => {
							let { onError, ...argumentsObject } = _ref2;
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )( keyboard_shortcuts.Register, null ),
					Object( external_wp_element_[ 'createElement' ] )(
				...
				const selectedWidgetArea = Object( external_wp_element_[ 'useMemo' ] )(
					() =>
						...
						( widgetAreas === null || widgetAreas === void 0
							? void 0
							: widgetAreas.find( widgetArea => widgetArea.id === selectedWidgetAreaId ) ),
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )(
						...
						Object( external_wp_element_[ 'createElement' ] )(
							...
							( widgetAreas === null || widgetAreas === void 0 ? void 0 : widgetAreas.length ) ===
								0 &&
								Object( external_wp_element_[ 'createElement' ] )(
									'p',
									null,
			...
			function ComplementaryAreaTab( _ref ) {
				let { identifier, label, isActive } = _ref;
				const { enableComplementaryArea } = Object( external_wp_data_[ 'useDispatch' ] )(
			...
			function Sidebar() {
				...
				const {
					...
					const { getSelectedBlock, getBlock, getBlockParentsByBlockName } = select(
						external_wp_blockEditor_[ 'store' ]
					);
					const { getActiveComplementaryArea } = select( build_module[ 'i' /* store */ ] );
					...
					if ( selectedBlock ) {
						if ( selectedBlock.name === 'core/widget-area' ) {
							...
							widgetAreaBlock = getBlock(
								getBlockParentsByBlockName( selectedBlock.clientId, 'core/widget-area' )[ 0 ]
							);
						}
					}
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					build_module[ 'b' /* ComplementaryArea */ ],
					{
						...
						header: Object( external_wp_element_[ 'createElement' ] )(
							...
							Object( external_wp_element_[ 'createElement' ] )(
								'li',
								null,
								Object( external_wp_element_[ 'createElement' ] )( ComplementaryAreaTab, {
					...
					currentArea === WIDGET_AREAS_IDENTIFIER &&
						Object( external_wp_element_[ 'createElement' ] )( WidgetAreas, {
							selectedWidgetAreaId:
								selectedWidgetAreaBlock === null || selectedWidgetAreaBlock === void 0
									? void 0
			...
			function SaveButton() {
				const { hasEditedWidgetAreaIds, isSaving } = Object( external_wp_data_[ 'useSelect' ] )(
					select => {
			...
			function UndoButton() {
				const hasUndo = Object( external_wp_data_[ 'useSelect' ] )(
					select => select( external_wp_coreData_[ 'store' ] ).hasUndo(),
					[]
				);
			...
			function RedoButton() {
				const hasRedo = Object( external_wp_data_[ 'useSelect' ] )(
					select => select( external_wp_coreData_[ 'store' ] ).hasRedo(),
					[]
				);
			...
			function MoreMenu() {
				const [ isKeyboardShortcutsModalActive, setIsKeyboardShortcutsModalVisible ] = Object(
					external_wp_element_[ 'useState' ]
				)( false );
			...
			function Header() {
				...
				const isLastSelectedWidgetAreaOpen = Object( external_wp_data_[ 'useSelect' ] )(
					select => select( store ).getIsWidgetAreaOpen( widgetAreaClientId ),
					[ widgetAreaClientId ]
				);
				const { isInserterOpen, isListViewOpen } = Object( external_wp_data_[ 'useSelect' ] )(
					select => {
						const { isInserterOpened, isListViewOpened } = select( store );
						return {
				...
				const { setIsWidgetAreaOpen, setIsInserterOpened, setIsListViewOpened } = Object(
    ...
    characters. */
								...
								isMediumViewport &&
									Object( external_wp_element_[ 'createElement' ] )(
										external_wp_element_[ 'Fragment' ],
										null,
										Object( external_wp_element_[ 'createElement' ] )( UndoButton, null ),
										Object( external_wp_element_[ 'createElement' ] )( RedoButton, null ),
										Object( external_wp_element_[ 'createElement' ] )(
											external_wp_components_[ 'ToolbarItem' ],
											{
												as: external_wp_components_[ 'Button' ],
			...
			function WidgetAreasBlockEditorContent( _ref ) {
				let { blockEditorSettings } = _ref;
				const hasThemeStyles = Object( external_wp_data_[ 'useSelect' ] )(
					select =>
						select( build_module[ 'i' /* store */ ] ).isFeatureActive(
							'core/edit-widgets',
							'themeStyles'
						),
					[]
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )( components_notices, null ),
					Object( external_wp_element_[ 'createElement' ] )(
			...
			function InserterSidebar() {
				...
				const { rootClientId, insertionIndex } = use_widget_library_insertion_point();
				const { setIsInserterOpened } = Object( external_wp_data_[ 'useDispatch' ] )( store );
			...
			function ListViewSidebar() {
				const { setIsListViewOpened } = Object( external_wp_data_[ 'useDispatch' ] )( store );
			...
			function Interface( _ref ) {
				...
				const { setIsInserterOpened, setIsListViewOpened, closeGeneralSidebar } = Object(
					external_wp_data_[ 'useDispatch' ]
				)( store );
				const {
					...
					select => ( {
						...
						hasBlockBreadCrumbsEnabled: select( build_module[ 'i' /* store */ ] ).isFeatureActive(
							'core/edit-widgets',
							'showBlockBreadcrumbs'
						),
						previousShortcut: select(
							external_wp_keyboardShortcuts_[ 'store' ]
						).getAllShortcutKeyCombinations( 'core/edit-widgets/previous-region' ),
						nextShortcut: select(
							external_wp_keyboardShortcuts_[ 'store' ]
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					build_module[ 'e' /* InterfaceSkeleton */ ],
					{
						...
						secondarySidebar:
							hasSecondarySidebar &&
							Object( external_wp_element_[ 'createElement' ] )( SecondarySidebar, null ),
						sidebar:
							hasSidebarEnabled &&
							Object( external_wp_element_[ 'createElement' ] )(
					...
					widgetAreas === null || widgetAreas === void 0
						...
						: widgetAreas.every(
								widgetArea =>
									...
									widgetArea.widgets.every( widgetId => widgetId.startsWith( 'block-' ) )
						  );
				const numWidgetAreas =
					( _widgetAreas$filter$l =
						widgetAreas === null || widgetAreas === void 0
							? void 0
							: widgetAreas.filter( widgetArea => widgetArea.id !== 'wp_inactive_widgets' )
			...
			function Layout( _ref ) {
				let { blockEditorSettings, onError } = _ref;
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )(
						...
						Object( external_wp_element_[ 'createElement' ] )( UnsavedChangesWarning, null ),
		...
		/***/ K2cm: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
				'GRId'
			);
			...
			const redo = Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
				_wordpress_primitives__WEBPACK_IMPORTED_MODULE_1__[ 'SVG' ],
				{
					xmlns: 'http://www.w3.org/2000/svg',
					viewBox: '0 0 24 24',
				...
				Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
					...
					{
						d:
							'M15.6 6.5l-1.1 1 2.9 3.3H8c-.9 0-1.7.3-2.3.9-1.4 1.5-1.4 4.2-1.4 5.6v.2h1.5v-.3c0-1.1 0-3.5 1-4.5.3-.3.7-.5 1.3-.5h9.2L14.5 15l1.1 1.1 4.6-4.6-4.6-5z',
					}
				)
			);
		...
		/***/ Ntru: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
				'GRId'
			);
			...
			const undo = Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
				_wordpress_primitives__WEBPACK_IMPORTED_MODULE_1__[ 'SVG' ],
				{
					xmlns: 'http://www.w3.org/2000/svg',
					viewBox: '0 0 24 24',
				...
				Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
					...
					{
						d:
							'M18.3 11.7c-.6-.6-1.4-.9-2.3-.9H6.7l2.9-3.3-1.1-1-4.5 5L8.5 16l1-1-2.7-2.7H16c.5 0 .9.2 1.3.5 1 1 1 3.4 1 4.5v.3h1.5v-.2c0-1.5 0-4.3-1.5-5.7z',
					}
				)
			);
