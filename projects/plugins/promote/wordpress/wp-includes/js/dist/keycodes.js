...
this[ 'wp' ][ 'keycodes' ] = /******/ ( function ( modules ) {
	...
	/******/ {
		...
		/***/ z7pY: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			__webpack_require__.d( __webpack_exports__, 'PAGEUP', function () {
				return /* binding */ PAGEUP;
			} );
			__webpack_require__.d( __webpack_exports__, 'PAGEDOWN', function () {
			...
			const rawShortcut = Object( external_lodash_[ 'mapValues' ] )( modifiers, modifier => {
				return (
					...
					function ( character ) {
						let _isApple =
							arguments.length > 1 && arguments[ 1 ] !== undefined ? arguments[ 1 ] : isAppleOS;
			...
			const displayShortcutList = Object( external_lodash_[ 'mapValues' ] )(
				modifiers,
				modifier => {
					return (
						/** @type {WPKeyHandler<string[]>} */
						function ( character ) {
							...
							const modifierKeys = modifier( _isApple ).reduce(
								( accumulator, key ) => {
									const replacementKey = Object( external_lodash_[ 'get' ] )(
										replacementKeyMap,
										key,
										key
				...
				return (
					...
					function ( character ) {
						...
						return [ ...modifier( _isApple ), character ]
							.map( key =>
								Object( external_lodash_[ 'capitalize' ] )(
				...
				getModifiers => {
					return (
						...
						function ( event, character ) {
							let _isApple =
								arguments.length > 2 && arguments[ 2 ] !== undefined ? arguments[ 2 ] : isAppleOS;
