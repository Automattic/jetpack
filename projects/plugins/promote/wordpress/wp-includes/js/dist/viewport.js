...
this[ 'wp' ][ 'viewport' ] = /******/ ( function ( modules ) {
	...
	/******/ {
		...
		/***/ PR0u: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			const addDimensionsEventListener = ( breakpoints, operators ) => {
				...
				const setIsMatching = Object( external_lodash_[ 'debounce' ] )(
					() => {
						const values = Object( external_lodash_[ 'mapValues' ] )(
							queries,
							query => query.matches
						);
				...
				const queries = Object( external_lodash_[ 'reduce' ] )(
					breakpoints,
					( result, width, name ) => {
			...
			const withViewportMatch = queries => {
				const useViewPortQueriesResult = () =>
					Object( external_lodash_[ 'mapValues' ] )( queries, query => {
				...
				return Object( external_wp_compose_[ 'createHigherOrderComponent' ] )( WrappedComponent => {
					return Object( external_wp_compose_[ 'pure' ] )( props => {
						...
						return Object( external_wp_element_[ 'createElement' ] )(
							WrappedComponent,
							Object( esm_extends[ 'a' /* default */ ] )( {}, props, queriesResult )
						);
					} );
				}, 'withViewportMatch' );
			};
			...
			const ifViewportMatches = query =>
				Object( external_wp_compose_[ 'createHigherOrderComponent' ] )(
					Object( external_wp_compose_[ 'compose' ] )( [
						with_viewport_match( {
							isViewportMatch: query,
						} ),
						Object( external_wp_compose_[ 'ifCondition' ] )( props => props.isViewportMatch ),
					] ),
					'ifViewportMatches'
				);
