...
this[ 'wp' ][ 'coreData' ] = /******/ ( function ( modules ) {
	...
	/******/ {
		...
		/***/ dsJ0: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			__webpack_require__.d( __webpack_exports__, 'store', function () {
				return /* binding */ build_module_store;
			} );
			...
			__webpack_require__.d( __webpack_exports__, '__experimentalFetchUrlData', function () {
			...
			__webpack_require__.d(
				...
				function () {
					return actions_unstableCreateUndoLevel;
				}
			);
			...
			__webpack_require__.d(
				...
				'getEntityRecord',
				function () {
					return selectors_getEntityRecord;
				}
			);
			__webpack_require__.d(
				build_module_selectors_namespaceObject,
			...
			__webpack_require__.d(
				...
				function () {
					return selectors_getEditedEntityRecord;
				}
			);
			__webpack_require__.d(
				build_module_selectors_namespaceObject,
			...
			__webpack_require__.d( resolvers_namespaceObject, 'canUserEditEntityRecord', function () {
			...
			function createBatch() {
				let processor =
					arguments.length > 0 && arguments[ 0 ] !== undefined ? arguments[ 0 ] : defaultProcessor;
				let lastId = 0;
				let queue = [];
				...
				return {
					...
					async run() {
						...
						for ( const [ result, { resolve, reject } ] of Object( external_lodash_[ 'zip' ] )(
							results,
							queue
						) ) {
							if ( result !== null && result !== void 0 && result.error ) {
								...
								resolve(
									( _result$output =
										result === null || result === void 0 ? void 0 : result.output ) !== null &&
			...
			function receiveEntityRecords( kind, name, records, query ) {
				...
				// on the server.
				if ( kind === 'postType' ) {
					records = Object( external_lodash_[ 'castArray' ] )( records ).map( record =>
			...
			const deleteEntityRecord = function ( kind, name, recordId, query ) {
				let { __unstableFetch = external_wp_apiFetch_default.a } =
				...
				return async _ref => {
					...
					if (
						! entity ||
						( entity !== null && entity !== void 0 && entity.__experimentalNoFetch )
					) {
						return;
					}
					...
					const edit = {
						...
						edits: Object.keys( edits ).reduce( ( acc, key ) => {
							...
							const value = mergedEdits[ key ]
								...
								: edits[ key ];
							acc[ key ] = Object( external_lodash_[ 'isEqual' ] )( recordValue, value )
								? undefined
								: value;
							return acc;
						}, {} ),
			...
			const saveEntityRecord = function ( kind, name, record ) {
				let { isAutosave = false, __unstableFetch = external_wp_apiFetch_default.a } =
				...
				return async _ref5 => {
					...
					const lock = await dispatch.__unstableAcquireStoreLock(
						STORE_NAME,
						[ 'entities', 'data', kind, name, recordId || Object( v4[ 'a' /* default */ ] )() ],
						{
							exclusive: true,
						}
					);
						...
						try {
							...
							if ( isAutosave ) {
								...
								if ( entity.__unstablePrePersist ) {
									edits = { ...edits, ...entity.__unstablePrePersist( persistedRecord, edits ) };
								}
				...
				const api = {
					saveEntityRecord( kind, name, record, options ) {
						return batch.add( add =>
							dispatch.saveEntityRecord( kind, name, record, { ...options, __unstableFetch: add } )
						);
					},
				...
				},
				{
					...
					getTitle: record => {
						return Object( external_lodash_[ 'get' ] )(
							record,
							[ 'title' ],
							Object( external_wp_i18n_[ '__' ] )( 'Site Title' )
						);
					},
				},
				{
					...
					getTitle: record => {
						...
						return (
							( record === null || record === void 0
								? void 0
								: ( _record$title = record.title ) === null || _record$title === void 0
								? void 0
				...
				return Object( external_lodash_[ 'map' ] )( postTypes, ( postType, name ) => {
					...
					const namespace =
						( _postType$rest_namesp =
							postType === null || postType === void 0 ? void 0 : postType.rest_namespace ) !==
							null && _postType$rest_namesp !== void 0
							? _postType$rest_namesp
							: 'wp/v2';
					return {
						kind: 'postType',
						...
						getTitle: record => {
							...
							return (
								( record === null || record === void 0
									? void 0
									: ( _record$title2 = record.title ) === null || _record$title2 === void 0
									? void 0
									: _record$title2.rendered ) ||
								( record === null || record === void 0 ? void 0 : record.title ) ||
								( isTemplate
									? Object( external_lodash_[ 'startCase' ] )( record.slug )
									: String( record.id ) )
							);
						},
				...
				return Object( external_lodash_[ 'map' ] )( taxonomies, ( taxonomy, name ) => {
					...
					const namespace =
						( _taxonomy$rest_namesp =
							taxonomy === null || taxonomy === void 0 ? void 0 : taxonomy.rest_namespace ) !==
							null && _taxonomy$rest_namesp !== void 0
							? _taxonomy$rest_namesp
							: 'wp/v2';
					return {
						kind: 'taxonomy',
			...
			function reducer_items() {
				...
				switch ( action.type ) {
								...
								...action.items.reduce( ( accumulator, value ) => {
									...
									accumulator[ itemId ] = conservativeMapItem(
										state === null || state === void 0
											? void 0
											: ( _state$context = state[ context ] ) === null || _state$context === void 0
											? void 0
					...
					case 'REMOVE_ITEMS':
						return Object( external_lodash_[ 'mapValues' ] )( state, contextState =>
							Object( external_lodash_[ 'omit' ] )( contextState, action.itemIds )
						);
				}
			...
			const receiveQueries = Object( external_lodash_[ 'flowRight' ] )( [
				...
				switch ( action.type ) {
					case 'RECEIVE_USER_QUERY':
						return {
							...
							queries: {
								...state.queries,
								[ action.queryID ]: Object( external_lodash_[ 'map' ] )(
									action.users,
									user => user.id
								),
							},
									...
									const context =
										( _action$query$context =
											action === null || action === void 0
												? void 0
												: ( _action$query = action.query ) === null || _action$query === void 0
												? void 0
												: _action$query.context ) !== null && _action$query$context !== void 0
											? _action$query$context
											: 'default';
										...
										const nextEdits = Object.keys( edits ).reduce( ( acc, key ) => {
											...
											if (
												...
												! Object( external_lodash_[ 'isEqual' ] )(
													edits[ key ],
													Object( external_lodash_[ 'get' ] )( record[ key ], 'raw', record[ key ] )
			...
			function entitiesConfig() {
				let state =
					arguments.length > 0 && arguments[ 0 ] !== undefined ? arguments[ 0 ] : defaultEntities;
				let action = arguments.length > 1 ? arguments[ 1 ] : undefined;
			...
			const reducer_entities = function () {
				...
				if ( ! entitiesDataReducer || newConfig !== state.config ) {
					...
					entitiesDataReducer = Object( external_wp_data_[ 'combineReducers' ] )(
						Object.entries( entitiesByKind ).reduce( ( memo, _ref ) => {
							let [ kind, subEntities ] = _ref;
							const kindReducer = Object( external_wp_data_[ 'combineReducers' ] )(
								subEntities.reduce(
			...
			function getQueriedItemsUncached( state, query ) {
				...
				const { stableKey, page, perPage, include, fields, context } = get_query_parts( query );
				let itemIds;
				...
				for ( let i = startOffset; i < endOffset; i++ ) {
					...
					if ( Array.isArray( fields ) ) {
						...
						if (
							! (
								( _state$itemIsComplete = state.itemIsComplete[ context ] ) !== null &&
			...
			const isRequestingEmbedPreview = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => ( state, url ) => {
			...
			function getAuthors( state, query ) {
				...
				const path = Object( external_wp_url_[ 'addQueryArgs' ] )(
			...
			const getUserQueryResults = Object( rememo[ 'a' /* default */ ] )(
				( state, queryID ) => {
			...
			const selectors_getEntityRecord = Object( rememo[ 'a' /* default */ ] )(
				( state, kind, name, key, query ) => {
					var _query$context, _queriedState$items$c;

					const queriedState = Object( external_lodash_[ 'get' ] )( state.entities.data, [
						kind,
						name,
						'queriedData',
					] );
					...
					const context =
						( _query$context = query === null || query === void 0 ? void 0 : query.context ) !==
					...
					if ( query === undefined ) {
						...
						if (
							! (
								( _queriedState$itemIsC = queriedState.itemIsComplete[ context ] ) !== null &&
				...
				( state, kind, name, recordId, query ) => {
					...
					const context =
						( _query$context2 = query === null || query === void 0 ? void 0 : query.context ) !==
							null && _query$context2 !== void 0
							? _query$context2
							: 'default';
					return [
						Object( external_lodash_[ 'get' ] )( state.entities.data, [
							kind,
							name,
							'queriedData',
							'items',
			...
			const getRawEntityRecord = Object( rememo[ 'a' /* default */ ] )(
				( state, kind, name, key ) => {
					...
					return (
						...
						Object.keys( record ).reduce( ( accumulator, _key ) => {
							if ( isRawAttribute( getEntity( state, kind, name ), _key ) ) {
								...
								accumulator[ _key ] = Object( external_lodash_[ 'get' ] )(
									record[ _key ],
									'raw',
									record[ _key ]
								);
				...
				( state, kind, name, recordId, query ) => {
					...
					const context =
						( _query$context3 = query === null || query === void 0 ? void 0 : query.context ) !==
			...
			const __experimentalGetDirtyEntityRecords = Object( rememo[ 'a' /* default */ ] )(
				state => {
					const {
						entities: { data },
					} = state;
						...
						Object.keys( data[ kind ] ).forEach( name => {
							const primaryKeys = Object.keys( data[ kind ][ name ].edits ).filter(
								(
									...
									selectors_getEntityRecord( state, kind, name, primaryKey ) &&
							...
							if ( primaryKeys.length ) {
								...
								primaryKeys.forEach( primaryKey => {
									...
									const entityRecord = selectors_getEditedEntityRecord(
										state,
										kind,
										name,
										primaryKey
									...
									dirtyRecords.push( {
										...
										title:
											( entity === null || entity === void 0
												? void 0
												: ( _entity$getTitle = entity.getTitle ) === null ||
												  _entity$getTitle === void 0
												? void 0
												: _entity$getTitle.call( entity, entityRecord ) ) || '',
										name,
										kind,
									} );
								} );
			...
			const __experimentalGetEntitiesBeingSaved = Object( rememo[ 'a' /* default */ ] )(
				state => {
					const {
						entities: { data },
					} = state;
					...
					Object.keys( data ).forEach( kind => {
						Object.keys( data[ kind ] ).forEach( name => {
							const primaryKeys = Object.keys( data[ kind ][ name ].saving ).filter( primaryKey =>
								...
								primaryKeys.forEach( primaryKey => {
									...
									recordsBeingSaved.push( {
										...
										title:
											( entity === null || entity === void 0
												? void 0
												: ( _entity$getTitle2 = entity.getTitle ) === null ||
												  _entity$getTitle2 === void 0
												? void 0
												: _entity$getTitle2.call( entity, entityRecord ) ) || '',
										name,
										kind,
									} );
								} );
			...
			const getEntityRecordNonTransientEdits = Object( rememo[ 'a' /* default */ ] )(
			...
			const selectors_getEditedEntityRecord = Object( rememo[ 'a' /* default */ ] )(
				( state, kind, name, recordId ) => ( {
				...
				( state, kind, name, recordId, query ) => {
					...
					const context =
						( _query$context4 = query === null || query === void 0 ? void 0 : query.context ) !==
			...
			function isAutosavingEntityRecord( state, kind, name, recordId ) {
				const { pending, isAutosave } = Object( external_lodash_[ 'get' ] )(
					state.entities.data,
			...
			function getThemeSupports( state ) {
				...
				return ( _getCurrentTheme$them =
					( _getCurrentTheme = getCurrentTheme( state ) ) === null || _getCurrentTheme === void 0
						? void 0
						: _getCurrentTheme.theme_supports ) !== null && _getCurrentTheme$them !== void 0
			...
			const hasFetchedAutosaves = Object( external_wp_data_[ 'createRegistrySelector' ] )(
			...
			const getReferenceByDistinctEdits = Object( rememo[ 'a' /* default */ ] )(
				() => [],
			...
			function __experimentalGetTemplateForLink( state, link ) {
				...
				const template =
					records !== null && records !== void 0 && records.length ? records[ 0 ] : null;
				...
				return async _ref3 => {
					...
					try {
						if ( query !== undefined && query._fields ) {
							...
							query = {
								...query,
								_fields: Object( external_lodash_[ 'uniq' ] )( [
						...
						const path = Object( external_wp_url_[ 'addQueryArgs' ] )(
							entity.baseURL + ( key ? '/' + key : '' ),
							{ ...entity.baseURLParams, ...query }
						);
			...
			const resolvers_getEntityRecords = function ( kind, name ) {
				...
				return async _ref4 => {
					...
					try {
						...
						const path = Object( external_wp_url_[ 'addQueryArgs' ] )( entity.baseURL, {
						...
						if (
							! ( ( _query = query ) !== null && _query !== void 0 && _query._fields ) &&
							! query.context
						) {
			...
			const resolvers_experimentalGetTemplateForLink = link => async _ref11 => {
				...
				try {
					template = await window
						.fetch(
							Object( external_wp_url_[ 'addQueryArgs' ] )( link, {
			...
			const resolvers_experimentalGetCurrentGlobalStylesId = () => async _ref13 => {
				...
				const globalStylesURL = Object( external_lodash_[ 'get' ] )( activeThemes, [
					0,
					'_links',
			...
			function reducer_locks() {
				let state =
					arguments.length > 0 && arguments[ 0 ] !== undefined ? arguments[ 0 ] : DEFAULT_STATE;
				let action = arguments.length > 1 ? arguments[ 1 ] : undefined;
			...
			const entity_provider_entities = {
			...
			function EntityProvider( _ref ) {
				let { kind, type, id, children } = _ref;
			...
			function useEntityId( kind, type ) {
				return Object( external_wp_element_[ 'useContext' ] )(
					entity_provider_getEntity( kind, type ).context
				);
			}
			/**
			...
			function useEntityProp( kind, type, prop, _id ) {
				...
				const { value, fullValue } = Object( external_wp_data_[ 'useSelect' ] )(
					select => {
				...
				const { editEntityRecord } = Object( external_wp_data_[ 'useDispatch' ] )( STORE_NAME );
				const setValue = Object( external_wp_element_[ 'useCallback' ] )(
					newValue => {
			...
			function useEntityBlockEditor( kind, type ) {
				...
				const providerId = useEntityId( kind, type );
				const id = _id !== null && _id !== void 0 ? _id : providerId;
				const { content, blocks } = Object( external_wp_data_[ 'useSelect' ] )(
					select => {
				...
				const { __unstableCreateUndoLevel, editEntityRecord } = Object(
				...
				const onChange = Object( external_wp_element_[ 'useCallback' ] )(
					( newBlocks, options ) => {
				...
				const onInput = Object( external_wp_element_[ 'useCallback' ] )(
					( newBlocks, options ) => {
						const { selection } = options;
						const edits = {
							blocks: newBlocks,
				...
				return [
					blocks !== null && blocks !== void 0 ? blocks : entity_provider_EMPTY_ARRAY,
					onInput,
					onChange,
				];
			}
						...
						.map(
							...
							result => {
								...
								return {
									...
									url: result.url,
									title:
										Object( external_wp_htmlEntities_[ 'decodeEntities' ] )( result.title || '' ) ||
										Object( external_wp_i18n_[ '__' ] )( '(no title)' ),
									type: result.subtype || result.type,
									kind:
										result === null || result === void 0
											? void 0
											: ( _result$meta = result.meta ) === null || _result$meta === void 0
											? void 0
											: _result$meta.kind,
								};
							}
			...
			const fetchUrlData = async function ( url ) {
				...
				if (
					! Object( external_wp_url_[ 'isValidProtocol' ] )( protocol ) ||
			...
			const entitySelectors = defaultEntities.reduce( ( result, entity ) => {
				...
				result[ getMethodName( kind, name ) ] = ( state, key, query ) =>
					selectors_getEntityRecord( state, kind, name, key, query );
			...
			const storeConfig = () => ( {
				...
				selectors: { ...build_module_selectors_namespaceObject, ...entitySelectors },
			...
			const build_module_store = Object( external_wp_data_[ 'createReduxStore' ] )(
				STORE_NAME,
				storeConfig()
			);
