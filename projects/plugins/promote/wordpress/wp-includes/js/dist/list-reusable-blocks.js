...
this[ 'wp' ][ 'listReusableBlocks' ] = /******/ ( function ( modules ) {
	...
	/******/ {
		...
		/***/ SdGz: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			async function importReusableBlock( file ) {
				...
				if (
					...
					! Object( external_lodash_[ 'isString' ] )( parsedContent.title ) ||
					! Object( external_lodash_[ 'isString' ] )( parsedContent.content )
				) {
						...
						.catch( error => {
							...
							switch ( error.message ) {
								...
								case 'Invalid Reusable block JSON file':
									uiMessage = Object( external_wp_i18n_[ '__' ] )(
				...
				render() {
					...
					return Object( external_wp_element_[ 'createElement' ] )(
						...
						Object( external_wp_element_[ 'createElement' ] )(
							...
							Object( external_wp_i18n_[ '__' ] )( 'File' )
						),
			...
			document.addEventListener( 'DOMContentLoaded', () => {
				...
				const showNotice = () => {
					...
					notice.innerHTML = `<p>${ Object( external_wp_i18n_[ '__' ] )(
				...
				Object( external_wp_element_[ 'render' ] )(
					Object( external_wp_element_[ 'createElement' ] )( import_dropdown, {
						onUpload: showNotice,
					} ),
					container
				);
