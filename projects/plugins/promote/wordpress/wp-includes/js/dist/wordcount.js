...
this[ 'wp' ][ 'wordcount' ] = /******/ ( function ( modules ) {
	...
	/******/ {
		...
		/***/ pC98: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			function loadSettings( type, userSettings ) {
				...
				const settings = Object( external_lodash_[ 'extend' ] )(
					{},
					defaultSettings,
					userSettings
				);
				settings.shortcodes =
					( _settings$l10n$shortc =
						( _settings$l10n = settings.l10n ) === null || _settings$l10n === void 0
							? void 0
							: _settings$l10n.shortcodes ) !== null && _settings$l10n$shortc !== void 0
						? _settings$l10n$shortc
						: [];
