...
this[ 'wp' ][ 'reusableBlocks' ] = /******/ ( function ( modules ) {
	...
	/******/ {
		...
		/***/ iqm2: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			const __experimentalConvertBlocksToReusable = ( clientIds, title ) => async _ref2 => {
				...
				const reusableBlock = {
					...
					content: Object( external_wp_blocks_[ 'serialize' ] )(
						registry.select( external_wp_blockEditor_[ 'store' ] ).getBlocksByClientId( clientIds )
					),
					status: 'publish',
				};
			...
			const reusable_block_reusableBlock = Object( external_wp_element_[ 'createElement' ] )(
				...
				Object( external_wp_element_[ 'createElement' ] )( external_wp_primitives_[ 'Path' ], {
					d:
						'M7 7.2h8.2L13.5 9l1.1 1.1 3.6-3.6-3.5-4-1.1 1 1.9 2.3H7c-.9 0-1.7.3-2.3.9-1.4 1.5-1.4 4.2-1.4 5.6v.2h1.5v-.3c0-1.1 0-3.5 1-4.5.3-.3.7-.5 1.2-.5zm13.8 4V11h-1.5v.3c0 1.1 0 3.5-1 4.5-.3.3-.7.5-1.3.5H8.8l1.7-1.7-1.1-1.1L5.9 17l3.5 4 1.1-1-1.9-2.3H17c.9 0 1.7-.3 2.3-.9 1.5-1.4 1.5-4.2 1.5-5.6z',
				} )
			);
			...
			function ReusableBlockConvertButton( _ref ) {
				...
				const { __experimentalConvertBlocksToReusable: convertBlocksToReusable } = Object(
			...
			function ReusableBlocksManageButton( _ref ) {
				...
				const { __experimentalConvertBlockToStatic: convertBlockToStatic } = Object(
					external_wp_data_[ 'useDispatch' ]
				)( store );
			...
			function ReusableBlocksMenuItems( _ref ) {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					external_wp_element_[ 'Fragment' ],
					null,
					Object( external_wp_element_[ 'createElement' ] )( ReusableBlockConvertButton, {
						clientIds: clientIds,
						rootClientId: rootClientId,
					} ),
					clientIds.length === 1 &&
						Object( external_wp_element_[ 'createElement' ] )( reusable_blocks_manage_button, {
			...
			/* harmony default export */ var reusable_blocks_menu_items = Object(
				...
				const { getSelectedBlockClientIds } = select( external_wp_blockEditor_[ 'store' ] );
				return {
