...
this[ 'wp' ][ 'i18n' ] = /******/ ( function ( modules ) {
	...
	/******/ {
		...
		/***/ Vhyj: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			__webpack_require__.d( __webpack_exports__, 'resetLocaleData', function () {
			...
			const createI18n = ( initialData, initialDomain, hooks ) => {
				...
				const getLocaleData = function () {
					let domain =
						arguments.length > 0 && arguments[ 0 ] !== undefined ? arguments[ 0 ] : 'default';
				...
				const doSetLocaleData = function ( data ) {
					let domain =
						arguments.length > 1 && arguments[ 1 ] !== undefined ? arguments[ 1 ] : 'default';
					tannin.data[ domain ] = { ...DEFAULT_LOCALE_DATA, ...tannin.data[ domain ], ...data }; // Populate default domain configuration (supported locale date which omits
				...
				const hasTranslation = ( single, context, domain ) => {
					...
					let result = !! (
						...
						_tannin$data !== void 0 &&
						( _tannin$data2 =
							_tannin$data[ domain !== null && domain !== void 0 ? domain : 'default' ] ) !==
							null &&
