...
this[ 'wp' ][ 'editor' ] = /******/ ( function ( modules ) {
	...
	/************************************************************************/
	/******/ {
		/***/ '//kF': /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			...
			const footer = Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
		...
		/***/ FnAh: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
				'GRId'
			);
			...
			const info = Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
				_wordpress_primitives__WEBPACK_IMPORTED_MODULE_1__[ 'SVG' ],
				{
					xmlns: 'http://www.w3.org/2000/svg',
					viewBox: '0 0 24 24',
		...
		/***/ G8mJ: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
				'GRId'
			);
			...
			const header = Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
				_wordpress_primitives__WEBPACK_IMPORTED_MODULE_1__[ 'SVG' ],
				{
					xmlns: 'http://www.w3.org/2000/svg',
					viewBox: '0 0 24 24',
...
*/
		...
		/***/ OE6V: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
				'GRId'
			);
		...
		/***/ PLxR: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			__webpack_require__.d( __webpack_exports__, 'EditorSnackbars', function () {
			...
			__webpack_require__.d( __webpack_exports__, 'ThemeSupportCheck', function () {
			...
			__webpack_require__.d( __webpack_exports__, 'getTemplatePartIcon', function () {
			...
			__webpack_require__.d(
				...
				function () {
					return selectors_getCurrentPostRevisionsCount;
				}
			);
			__webpack_require__.d(
				selectors_namespaceObject,
				...
				function () {
					return selectors_getCurrentPostLastRevisionId;
				}
			);
			...
			__webpack_require__.d( selectors_namespaceObject, 'getReferenceByDistinctEdits', function () {
				return selectors_getReferenceByDistinctEdits;
			} );
			...
			__webpack_require__.d(
				...
				function () {
					return selectors_isSavingNonPostEntityChanges;
				}
			);
			...
			__webpack_require__.d( selectors_namespaceObject, 'getEditorSelection', function () {
			...
			__webpack_require__.d( selectors_namespaceObject, 'getPostTypeLabel', function () {
			...
			const selectors_isEditedPostDirty = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => state => {
					...
					if (
						select( external_wp_coreData_[ 'store' ] ).hasEditsForEntityRecord(
							'postType',
							postType,
							postId
						)
			...
			const selectors_getCurrentPost = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => state => {
					const postId = selectors_getCurrentPostId( state );
					const postType = selectors_getCurrentPostType( state );
					const post = select( external_wp_coreData_[ 'store' ] ).getRawEntityRecord(
						'postType',
						postType,
						postId
					);
			...
			const selectors_getPostEdits = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => state => {
					const postType = selectors_getCurrentPostType( state );
					const postId = selectors_getCurrentPostId( state );
					return (
						select( external_wp_coreData_[ 'store' ] ).getEntityRecordEdits(
							'postType',
							postType,
							postId
						) || EMPTY_OBJECT
			...
			const selectors_getReferenceByDistinctEdits = Object(
				external_wp_data_[ 'createRegistrySelector' ]
			)( select => () => {
			...
			const getAutosaveAttribute = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => ( state, attributeName ) => {
					if (
						! Object( external_lodash_[ 'includes' ] )( AUTOSAVE_PROPERTIES, attributeName ) &&
					...
					const currentUserId = Object( external_lodash_[ 'get' ] )(
						select( external_wp_coreData_[ 'store' ] ).getCurrentUser(),
						[ 'id' ]
					);
					const autosave = select( external_wp_coreData_[ 'store' ] ).getAutosave(
						postType,
						postId,
						currentUserId
					);
				...
				return (
					...
					( post.status === 'future' &&
						! Object( external_wp_date_[ 'isInTheFuture' ] )(
							new Date(
								Number( Object( external_wp_date_[ 'getDate' ] )( post.date ) ) - ONE_MINUTE_IN_MS
							)
						) )
				);
			}
			...
			function isEditedPostEmpty( state ) {
				...
				if ( blocks.length ) {
					...
					if (
						blockName !== Object( external_wp_blocks_[ 'getDefaultBlockName' ] )() &&
						blockName !== Object( external_wp_blocks_[ 'getFreeformContentHandlerName' ] )()
					) {
						return false;
					}
				}
			...
			const selectors_isEditedPostAutosaveable = Object(
				...
				const postType = selectors_getCurrentPostType( state );
				const postId = selectors_getCurrentPostId( state );
				const hasFetchedAutosave = select( external_wp_coreData_[ 'store' ] ).hasFetchedAutosaves(
					postType,
					postId
				);
				const currentUserId = Object( external_lodash_[ 'get' ] )(
			...
			const selectors_isSavingPost = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => state => {
					const postType = selectors_getCurrentPostType( state );
					const postId = selectors_getCurrentPostId( state );
					return select( external_wp_coreData_[ 'store' ] ).isSavingEntityRecord(
						'postType',
						postType,
						postId
					);
			...
			const selectors_isSavingNonPostEntityChanges = Object(
				external_wp_data_[ 'createRegistrySelector' ]
			)( select => state => {
			...
			const didPostSaveRequestSucceed = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => state => {
					const postType = selectors_getCurrentPostType( state );
					const postId = selectors_getCurrentPostId( state );
					return ! select( external_wp_coreData_[ 'store' ] ).getLastEntitySaveError(
						'postType',
						postType,
						postId
					);
			...
			const didPostSaveRequestFail = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => state => {
					const postType = selectors_getCurrentPostType( state );
					const postId = selectors_getCurrentPostId( state );
					return !! select( external_wp_coreData_[ 'store' ] ).getLastEntitySaveError(
			...
			const getEditedPostContent = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => state => {
					const postId = selectors_getCurrentPostId( state );
					const postType = selectors_getCurrentPostType( state );
					const record = select( external_wp_coreData_[ 'store' ] ).getEditedEntityRecord(
						'postType',
						postType,
						postId
					);
			...
			function selectors_canUserUseUnfilteredHTML( state ) {
				return Object( external_lodash_[ 'has' ] )( selectors_getCurrentPost( state ), [
					'_links',
			...
			function __experimentalGetDefaultTemplateTypes( state ) {
				...
				return ( _getEditorSettings = selectors_getEditorSettings( state ) ) === null ||
			...
			const __experimentalGetDefaultTemplatePartAreas = Object( rememo[ 'a' /* default */ ] )(
				state => {
					var _getEditorSettings2;

					const areas =
						( ( _getEditorSettings2 = selectors_getEditorSettings( state ) ) === null ||
				...
				state => {
					...
					return [
						( _getEditorSettings3 = selectors_getEditorSettings( state ) ) === null ||
			...
			const __experimentalGetDefaultTemplateType = Object( rememo[ 'a' /* default */ ] )(
				( state, slug ) =>
					Object( external_lodash_[ 'find' ] )( __experimentalGetDefaultTemplateTypes( state ), {
						slug,
					} ) || {},
			...
			function __experimentalGetTemplateInfo( state, template ) {
				...
				const templateTitle = Object( external_lodash_[ 'isString' ] )( title )
					...
					? void 0
					: title.rendered;
				const templateDescription = Object( external_lodash_[ 'isString' ] )( excerpt )
					? excerpt
					: excerpt === null || excerpt === void 0
					? void 0
					: excerpt.raw;
				const templateIcon =
					( ( _experimentalGetDefa = __experimentalGetDefaultTemplatePartAreas( state ).find(
						item => area === item.area
					) ) === null || _experimentalGetDefa === void 0
						? void 0
			...
			const getPostTypeLabel = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => state => {
					var _postType$labels;

					const currentPostType = selectors_getCurrentPostType( state );
					const postType = select( external_wp_coreData_[ 'store' ] ).getPostType(
						currentPostType
					...
					return postType === null || postType === void 0
						? void 0
						: ( _postType$labels = postType.labels ) === null || _postType$labels === void 0
						? void 0
			...
			function* actions_savePost() {
				...
				if (
					! ( yield external_wp_data_[ 'controls' ].select( STORE_NAME, 'isEditedPostSaveable' ) )
				) {
					return;
				}
			...
			const controls = {
				LOCAL_AUTOSAVE_SET( _ref ) {
					let { postId, isPostNew, title, content, excerpt } = _ref;
			...
			const storeConfig = {
				...
				controls: { ...external_wp_dataControls_[ 'controls' ], ...store_controls },
			};
			/**
				...
				Object( external_wp_compose_[ 'createHigherOrderComponent' ] )(
					BlockEdit => _ref => {
						...
						const postType = Object( external_wp_data_[ 'useSelect' ] )(
							select => select( store ).getCurrentPostType(),
							[]
						);
						const [ meta, setMeta ] = Object( external_wp_coreData_[ 'useEntityProp' ] )(
							'postType',
							postType,
							'meta'
						);
			...
			/* harmony default export */ var autocompleters_user = {
				...
				useItems( filterValue ) {
					const users = Object( external_wp_data_[ 'useSelect' ] )(
						select => {
							const { getUsers } = select( external_wp_coreData_[ 'store' ] );
							return getUsers( {
								context: 'view',
			...
			/* harmony default export */ var autosave_monitor = Object(
				...
				Object( external_wp_data_[ 'withSelect' ] )( ( select, ownProps ) => {
					const { getReferenceByDistinctEdits } = select( external_wp_coreData_[ 'store' ] );
					const {
						isEditedPostDirty,
				...
				Object( external_wp_data_[ 'withDispatch' ] )( ( dispatch, ownProps ) => ( {
					autosave() {
						const { autosave = dispatch( store ).autosave } = ownProps;
						autosave();
					},
				} ) ),
			...
			const computeOutlineHeadings = function () {
				...
				return Object( external_lodash_[ 'flatMap' ] )( blocks, function () {
					...
					if ( block.name === 'core/heading' ) {
						return { ...block, level: block.attributes.level, isEmpty: isEmptyHeading( block ) };
					}
			...
			const DocumentOutline = _ref => {
				let { blocks = [], title, onSelect, isTitleSupported, hasOutlineItemsDisabled } = _ref;
			...
			/* harmony default export */ var check = Object( external_wp_data_[ 'withSelect' ] )(
				select => ( {
			...
			function SaveShortcut( _ref ) {
				...
				const { resetEditorBlocks, savePost } = Object( external_wp_data_[ 'useDispatch' ] )(
					store
				);
				const { isEditedPostDirty, getPostEdits, isPostSavingLocked } = Object(
			...
			function VisualEditorGlobalKeyboardShortcuts() {
				const { redo, undo } = Object( external_wp_data_[ 'useDispatch' ] )( store );
			...
			/* harmony default export */ var editor_notices = Object( external_wp_compose_[ 'compose' ] )(
				[
					Object( external_wp_data_[ 'withSelect' ] )( select => ( {
			...
			function EntityRecordItem( _ref ) {
				...
				const parentBlockId = Object( external_wp_data_[ 'useSelect' ] )( select => {
					...
					// Get entity's blocks.
					const { blocks = [] } = select( external_wp_coreData_[ 'store' ] ).getEditedEntityRecord(
						kind,
						name,
						key
					); // Get parents of the entity's first block.

					const parents = select( external_wp_blockEditor_[ 'store' ] ).getBlockParents(
						( _blocks$ = blocks[ 0 ] ) === null || _blocks$ === void 0 ? void 0 : _blocks$.clientId
				...
				const entityRecordTitle = Object( external_wp_data_[ 'useSelect' ] )(
					select => {
						...
						const template = select( external_wp_coreData_[ 'store' ] ).getEditedEntityRecord(
							kind,
							name,
							key
						);
					...
					Object( external_wp_element_[ 'createElement' ] )(
						external_wp_components_[ 'CheckboxControl' ],
						{
							label: Object( external_wp_element_[ 'createElement' ] )(
								'strong',
								null,
								Object( external_wp_htmlEntities_[ 'decodeEntities' ] )( entityRecordTitle ) ||
			...
			function EntityTypeList( _ref ) {
				let { list, unselectedEntities, setUnselectedEntities, closePanel } = _ref;
				...
				const entityLabel =
					name === 'wp_template_part'
						? Object( external_wp_i18n_[ '_n' ] )( 'Template Part', 'Template Parts', list.length )
						: entity.label; // Set description based on type of entity.
			...
			function EntitiesSavedStates( _ref ) {
				...
				const { dirtyEntityRecords } = Object( external_wp_data_[ 'useSelect' ] )( select => {
					...
					const siteEdits = select( external_wp_coreData_[ 'store' ] ).getEntityRecordEdits(
						'root',
						'site'
					);
				...
				const { __unstableMarkLastChangeAsPersistent } = Object(
					external_wp_data_[ 'useDispatch' ]
				)( external_wp_blockEditor_[ 'store' ] ); // To group entities by type.

				const partitionedSavables = Object( external_lodash_[ 'groupBy' ] )(
					dirtyEntityRecords,
					'name'
				); // Sort entity groups.
				...
				const saveCheckedEntities = () => {
					...
					Promise.all( pendingSavedRecords )
						...
						.catch( error =>
							createErrorNotice(
								`${ Object( external_wp_i18n_[ '__' ] )( 'Saving failed.' ) } ${ error }`
							)
						);
				...
				const dismissPanel = Object( external_wp_element_[ 'useCallback' ] )( () => close(), [
					close,
				] );
			...
			function useAutosaveNotice() {
				...
				const { getEditedPostAttribute } = Object( external_wp_data_[ 'useSelect' ] )( store );
				const { createWarningNotice, removeNotice } = Object( external_wp_data_[ 'useDispatch' ] )(
					external_wp_notices_[ 'store' ]
				);
				const { editPost, resetEditorBlocks } = Object( external_wp_data_[ 'useDispatch' ] )(
					store
				);
				Object( external_wp_element_[ 'useEffect' ] )( () => {
			...
			function useAutosavePurge() {
				const { postId, isEditedPostNew, isDirty, isAutosaving, didError } = Object(
					external_wp_data_[ 'useSelect' ]
				)(
					select => ( {
						postId: select( store ).getCurrentPostId(),
			...
			function LocalAutosaveMonitor() {
				const { autosave } = Object( external_wp_data_[ 'useDispatch' ] )( store );
				...
				useAutosaveNotice();
				useAutosavePurge();
				const { localAutosaveInterval } = Object( external_wp_data_[ 'useSelect' ] )(
					select => ( {
						localAutosaveInterval: select( store ).getEditorSettings()
			...
			function PageAttributesParent() {
				...
				const { parentPost, parentPostId, items, postType } = Object(
					...
					select => {
						...
						const { getCurrentPostId, getEditedPostAttribute } = select( store );
			...
			function PostTemplate( _ref ) {
				...
				const { availableTemplates, selectedTemplate, isViewable } = Object(
					...
					const { getEditedPostAttribute, getEditorSettings, getCurrentPostType } = select( store );
					const { getPostType } = select( external_wp_coreData_[ 'store' ] );
					return {
			...
			function PostAuthorCombobox() {
				...
				const { authorId, isLoading, authors, postAuthor } = Object(
					...
					select => {
						const { getUser, getUsers, isResolving } = select( external_wp_coreData_[ 'store' ] );
						const { getEditedPostAttribute } = select( store );
				...
				const authorOptions = Object( external_wp_element_[ 'useMemo' ] )( () => {
					const fetchedAuthors = ( authors !== null && authors !== void 0 ? authors : [] ).map(
						author => {
							return {
								value: author.id,
			...
			function PostAuthorSelect() {
				const { editPost } = Object( external_wp_data_[ 'useDispatch' ] )( store );
				const { postAuthor, authors } = Object( external_wp_data_[ 'useSelect' ] )( select => {
					return {
			...
			function PostAuthorCheck( _ref ) {
				let { children } = _ref;
				const { hasAssignAuthorAction, hasAuthors } = Object( external_wp_data_[ 'useSelect' ] )(
					select => {
			...
			/* harmony default export */ var post_comments = Object( external_wp_compose_[ 'compose' ] )(
				[
					Object( external_wp_data_[ 'withSelect' ] )( select => {
						return {
			...
			/* harmony default export */ var theme_support_check = Object(
				...
				const { getThemeSupports } = select( external_wp_coreData_[ 'store' ] );
				const { getEditedPostAttribute } = select( store );
				return {
			...
			const DEFAULT_REMOVE_FEATURE_IMAGE_LABEL = Object( external_wp_i18n_[ '__' ] )(
				'Remove image'
			);
			...
			function PostFeaturedImage( _ref ) {
				...
				if ( media ) {
					...
					if (
						Object( external_lodash_[ 'has' ] )( media, [ 'media_details', 'sizes', mediaSize ] )
					) {
						...
						const fallbackMediaSize = Object( external_wp_hooks_[ 'applyFilters' ] )(
							'editor.PostFeaturedImage.imageSize',
							'thumbnail',
							media.id,
							currentPostId
							...
							Object( external_wp_element_[ 'createElement' ] )(
								...
								! media.alt_text &&
									Object( external_wp_i18n_[ 'sprintf' ] )(
										...
										( ( _media$media_details$ = media.media_details.sizes ) === null ||
										_media$media_details$ === void 0
											? void 0
											: ( _media$media_details$2 = _media$media_details$.full ) === null ||
											...
											Object( external_wp_element_[ 'createElement' ] )(
												external_wp_components_[ 'Button' ],
												{
													...
													'aria-label': ! featuredImageId
														? null
														: Object( external_wp_i18n_[ '__' ] )( 'Edit or update the image' ),
			...
			const applyWithSelect = Object( external_wp_data_[ 'withSelect' ] )( select => {
				const { getMedia, getPostType } = select( external_wp_coreData_[ 'store' ] );
				const { getCurrentPostId, getEditedPostAttribute } = select( store );
			...
			const applyWithDispatch = Object( external_wp_data_[ 'withDispatch' ] )(
				( dispatch, _ref4, _ref5 ) => {
					let { noticeOperations } = _ref4;
					let { select } = _ref5;
			...
			/* harmony default export */ var post_featured_image = Object(
				...
				applyWithSelect,
				applyWithDispatch,
				Object( external_wp_components_[ 'withFilters' ] )( 'editor.PostFeaturedImage' )
			)( PostFeaturedImage );
			...
			function PostFormat() {
				...
				const { postFormat, suggestedFormat, supportedFormats } = Object(
					...
					const { getEditedPostAttribute, getSuggestedPostFormat } = select( store );
							...
							Object( external_wp_element_[ 'createElement' ] )(
								...
								Object( external_wp_element_[ 'createElement' ] )(
									...
									Object( external_wp_i18n_[ 'sprintf' ] )(
										...
										Object( external_wp_i18n_[ '__' ] )( 'Apply format: %s' ),
										suggestion.caption
									)
								)
							)
			...
			/* harmony default export */ var post_last_revision_check = Object(
				...
				const { getCurrentPostLastRevisionId, getCurrentPostRevisionsCount } = select( store );
				return {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )(
						...
						Object( external_wp_i18n_[ 'sprintf' ] )(
							...
							Object( external_wp_i18n_[ '_n' ] )( '%d Revision', '%d Revisions', revisionsCount ),
							revisionsCount
						)
					)
				);
	...
	`;
			...
			function PostLockedModal() {
				...
				const { autosave, updatePostLock } = Object( external_wp_data_[ 'useDispatch' ] )( store );
				const {
					isLocked,
					isTakeover,
					user,
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					{
						title: isTakeover
							? Object( external_wp_i18n_[ '__' ] )( 'Someone else has taken over this post.' )
							: Object( external_wp_i18n_[ '__' ] )( 'This post is already being edited.' ),
						focusOnMount: true,
					...
					! isTakeover &&
						Object( external_wp_element_[ 'createElement' ] )(
							...
							Object( external_wp_element_[ 'createElement' ] )(
								...
								Object( external_wp_element_[ 'createElement' ] )( post_preview_button, null ),
								Object( external_wp_element_[ 'createElement' ] )(
									external_wp_components_[ 'Button' ],
									{
										variant: 'primary',
			...
			/* harmony default export */ var post_pending_status_check = Object(
				...
				Object( external_wp_data_[ 'withSelect' ] )( select => {
					const { isCurrentPostPublished, getCurrentPostType, getCurrentPost } = select( store );
					return {
			...
			/* harmony default export */ var post_pingbacks = Object( external_wp_compose_[ 'compose' ] )(
				[
					Object( external_wp_data_[ 'withSelect' ] )( select => {
						return {
			...
			class post_publish_button_PostPublishButton extends external_wp_element_[ 'Component' ] {
				...
				createOnClick( callback ) {
					...
					return function () {
						...
						const { hasNonPostEntityChanges, setEntitiesSavedStatesCallback } = _this.props; // If a post with non-post entities is published, but the user
			...
			/* harmony default export */ var post_publish_button = Object(
				...
				Object( external_wp_data_[ 'withDispatch' ] )( dispatch => {
					const { editPost, savePost } = dispatch( store );
					return {
				...
				render() {
					...
					return [
						Object( external_wp_element_[ 'createElement' ] )(
							...
							visibilityOptions.map( _ref => {
								let { value, label, info } = _ref;
								return Object( external_wp_element_[ 'createElement' ] )(
									'div',
									{
										key: value,
			...
			/* harmony default export */ var post_visibility = Object(
				...
				Object( external_wp_data_[ 'withSelect' ] )( select => {
					const { getEditedPostAttribute, getEditedPostVisibility } = select( store );
					return {
				...
				Object( external_wp_data_[ 'withDispatch' ] )( dispatch => {
					const { savePost, editPost } = dispatch( store );
					return {
						onSave: savePost,
			...
			function getDayOfTheMonth() {
				let date =
					arguments.length > 0 && arguments[ 0 ] !== undefined ? arguments[ 0 ] : new Date();
			...
			function PostSchedule() {
				...
				const [ previewedMonth, setPreviewedMonth ] = Object( external_wp_element_[ 'useState' ] )(
					getDayOfTheMonth( postDate )
				); // Pick up published and schduled site posts.

				const eventsByPostType = Object( external_wp_data_[ 'useSelect' ] )(
					select =>
						select( external_wp_coreData_[ 'store' ] ).getEntityRecords( 'postType', postType, {
				...
				const events = Object( external_wp_element_[ 'useMemo' ] )(
					() =>
						( eventsByPostType || [] ).map( _ref => {
							let { title, type, date: eventDate } = _ref;
							return {
			...
			function MostUsedTerms( _ref ) {
				...
				const { _terms, showTerms } = Object( external_wp_data_[ 'useSelect' ] )( select => {
					const mostUsedTerms = select( external_wp_coreData_[ 'store' ] ).getEntityRecords(
						'taxonomy',
						taxonomy.slug,
						DEFAULT_QUERY
					);
					...
					.catch( error => {
						...
						if ( errorCode === 'term_exists' ) {
							...
							const addRequest = external_wp_apiFetch_default()( {
								path: Object( external_wp_url_[ 'addQueryArgs' ] )( `/wp/v2/${ restBase }`, {
									...flat_term_selector_DEFAULT_QUERY,
									search: escapedTermName,
								} ),
							} ).then( unescapeTerms );
							return addRequest.then( searchResult => {
								return Object( external_lodash_[ 'find' ] )( searchResult, result =>
			...
			function FlatTermSelector( _ref ) {
				...
				const {
					...
					select => {
						const { getCurrentPost, getEditedPostAttribute } = select( store );
						const { getEntityRecords, getTaxonomy, hasFinishedResolution } = select(
							external_wp_coreData_[ 'store' ]
						);
				...
				const { searchResults } = Object( external_wp_data_[ 'useSelect' ] )(
					select => {
						const { getEntityRecords } = select( external_wp_coreData_[ 'store' ] );
						return {
				...
				const suggestions = Object( external_wp_element_[ 'useMemo' ] )( () => {
					return ( searchResults !== null && searchResults !== void 0
						? searchResults
						: []
				...
				function onChange( termNames ) {
					const availableTerms = [
						...terms,
						...( searchResults !== null && searchResults !== void 0 ? searchResults : [] ),
					];
					const uniqueTerms = Object( external_lodash_[ 'uniqBy' ] )( termNames, term =>
						term.toLowerCase()
					);
					const newTermNames = uniqueTerms.filter(
						termName =>
							! Object( external_lodash_[ 'find' ] )( availableTerms, term =>
								isSameTermName( term.name, termName )
							)
					...
					Promise.all(
						newTermNames.map( termName => findOrCreateTerm( termName, taxonomy.rest_base ) )
					).then( newTerms => {
			...
			/* harmony default export */ var flat_term_selector = Object(
				external_wp_components_[ 'withFilters' ]
			)( 'editor.PostTaxonomyType' )( FlatTermSelector );
			...
			/* harmony default export */ var maybe_tags_panel = Object(
				...
				Object( external_wp_data_[ 'withSelect' ] )( select => {
					...
					const tags =
						tagsTaxonomy && select( store ).getEditedPostAttribute( tagsTaxonomy.rest_base );
					return {
						areTagsFetched: tagsTaxonomy !== undefined,
						isPostTypeSupported:
							tagsTaxonomy &&
							Object( external_lodash_[ 'some' ] )( tagsTaxonomy.types, type => type === postType ),
			...
			function PostFormatPanel() {
				const { currentPostFormat, suggestion } = Object( external_wp_data_[ 'useSelect' ] )(
					select => {
						const { getEditedPostAttribute, getSuggestedPostFormat } = select( store );
						const supportedFormats = Object( external_lodash_[ 'get' ] )(
							select( external_wp_coreData_[ 'store' ] ).getThemeSupports(),
							[ 'formats' ],
							[]
						);
						return {
			...
			function PostPublishPanelPrepublish( _ref ) {
				...
				const {
					...
					const { getCurrentPost, isEditedPostBeingScheduled } = select( store );
					const { getEntityRecord, isResolving } = select( external_wp_coreData_[ 'store' ] );
					...
					return {
						...
						siteHome:
							siteData.home && Object( external_wp_url_[ 'filterURLForDisplay' ] )( siteData.home ),
					};
				}, [] );
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )(
						'div',
						null,
						Object( external_wp_element_[ 'createElement' ] )( 'strong', null, prePublishTitle )
					),
					Object( external_wp_element_[ 'createElement' ] )( 'p', null, prePublishBodyText ),
					Object( external_wp_element_[ 'createElement' ] )(
						'div',
						{
					...
					hasPublishAction &&
						Object( external_wp_element_[ 'createElement' ] )(
							...
							Object( external_wp_element_[ 'createElement' ] )(
								...
								Object( external_wp_element_[ 'createElement' ] )( PostSchedule, null )
							)
						),
			...
			class postpublish_PostPublishPanelPostpublish extends external_wp_element_[ 'Component' ] {
				...
				render() {
					...
					const addNewPostLabel = Object( external_lodash_[ 'get' ] )( postType, [
						'labels',
						'add_new_item',
					] );
					...
					const postPublishNonLinkHeader = isScheduled
						? Object( external_wp_element_[ 'createElement' ] )(
								external_wp_element_[ 'Fragment' ],
								null,
								Object( external_wp_i18n_[ '__' ] )( 'is now scheduled. It will go live on' ),
								' ',
								Object( external_wp_element_[ 'createElement' ] )( post_schedule_label, null ),
								'.'
						  )
					...
					return Object( external_wp_element_[ 'createElement' ] )(
						...
						Object( external_wp_element_[ 'createElement' ] )(
							...
							Object( external_wp_element_[ 'createElement' ] )(
								...
								Object( external_wp_htmlEntities_[ 'decodeEntities' ] )( post.title ) ||
			...
			/* harmony default export */ var postpublish = Object( external_wp_data_[ 'withSelect' ] )(
				select => {
			...
			class post_publish_panel_PostPublishPanel extends external_wp_element_[ 'Component' ] {
				...
				render() {
					...
					const propsForPanel = Object( external_lodash_[ 'omit' ] )( additionalProps, [
						'hasPublishAction',
						'isDirty',
						'isPostTypeViewable',
					] );
						...
						Object( external_wp_element_[ 'createElement' ] )(
							...
							isPrePublish &&
								Object( external_wp_element_[ 'createElement' ] )(
									...
									null,
									PrePublishExtension &&
										Object( external_wp_element_[ 'createElement' ] )( PrePublishExtension, null )
								),
							isPostPublish &&
								Object( external_wp_element_[ 'createElement' ] )(
									postpublish,
									...
									PostPublishExtension &&
										Object( external_wp_element_[ 'createElement' ] )( PostPublishExtension, null )
								),
							isSaving &&
								Object( external_wp_element_[ 'createElement' ] )(
									external_wp_components_[ 'Spinner' ],
			...
			/* harmony default export */ var post_publish_panel = Object(
				...
				Object( external_wp_data_[ 'withSelect' ] )( select => {
					...
					const { isPublishSidebarEnabled } = select( store );
					const postType = getPostType( getEditedPostAttribute( 'type' ) );
					return {
						hasPublishAction: Object( external_lodash_[ 'get' ] )(
							getCurrentPost(),
				...
				Object( external_wp_data_[ 'withDispatch' ] )( ( dispatch, _ref ) => {
					...
					const { disablePublishSidebar, enablePublishSidebar } = dispatch( store );
					return {
						onTogglePublishSidebar: () => {
			...
			const cloud = Object( external_wp_element_[ 'createElement' ] )(
				...
				Object( external_wp_element_[ 'createElement' ] )( external_wp_primitives_[ 'Path' ], {
					d:
						'M17.3 10.1c0-2.5-2.1-4.4-4.8-4.4-2.2 0-4.1 1.4-4.6 3.3h-.2C5.7 9 4 10.7 4 12.8c0 2.1 1.7 3.8 3.7 3.8h9c1.8 0 3.2-1.5 3.2-3.3.1-1.6-1.1-2.9-2.6-3.2zm-.5 5.1h-9c-1.2 0-2.2-1.1-2.2-2.3s1-2.4 2.2-2.4h1.3l.3-1.1c.4-1.3 1.7-2.2 3.2-2.2 1.8 0 3.3 1.3 3.3 2.9v1.3l1.3.2c.8.1 1.4.9 1.4 1.8-.1 1-.9 1.8-1.8 1.8z',
				} )
			);
			...
			/* harmony default export */ var post_switch_to_draft_button = Object(
				...
				Object( external_wp_data_[ 'withSelect' ] )( select => {
					const { isSavingPost, isCurrentPostPublished, isCurrentPostScheduled } = select( store );
					return {
						isSaving: isSavingPost(),
						isPublished: isCurrentPostPublished(),
						isScheduled: isCurrentPostScheduled(),
			...
			function PostSavedState( _ref ) {
						...
						return {
							...
							hasPublishAction:
								( _getCurrentPost$_link =
									( _getCurrentPost = getCurrentPost() ) === null || _getCurrentPost === void 0
										? void 0
										: ( _getCurrentPost$_link2 = _getCurrentPost._links ) === null ||
				...
				const { savePost } = Object( external_wp_data_[ 'useDispatch' ] )( store );
			...
			/* harmony default export */ var post_schedule_check = Object(
				...
				Object( external_wp_data_[ 'withSelect' ] )( select => {
					const { getCurrentPost, getCurrentPostType } = select( store );
					return {
						hasPublishAction: Object( external_lodash_[ 'get' ] )(
							getCurrentPost(),
							[ '_links', 'wp:action-publish' ],
			...
			/* harmony default export */ var post_slug = Object( external_wp_compose_[ 'compose' ] )( [
				Object( external_wp_data_[ 'withSelect' ] )( select => {
					const { getCurrentPost, getEditedPostAttribute } = select( store );
			...
			/* harmony default export */ var post_sticky = Object( external_wp_compose_[ 'compose' ] )( [
				Object( external_wp_data_[ 'withSelect' ] )( select => {
					return {
			...
			function HierarchicalTermSelector( _ref ) {
				...
				const [ filteredTermsTree, setFilteredTermsTree ] = Object(
					external_wp_element_[ 'useState' ]
				)( [] );
				const debouncedSpeak = Object( external_wp_compose_[ 'useDebounce' ] )(
					external_wp_a11y_[ 'speak' ],
					500
				);
				const {
					hasCreateAction,
					...
					select => {
						...
						return {
							...
							availableTerms:
								getEntityRecords( 'taxonomy', slug, hierarchical_term_selector_DEFAULT_QUERY ) ||
								hierarchical_term_selector_EMPTY_ARRAY,
							taxonomy: _taxonomy,
						};
					},
				...
				const availableTermsTree = Object( external_wp_element_[ 'useMemo' ] )(
				...
				const onAddTerm = async event => {
					...
					if ( existingTerm ) {
						...
						if (
							! Object( external_lodash_[ 'some' ] )( terms, term => term === existingTerm.id )
						) {
			...
			/* harmony default export */ var hierarchical_term_selector = Object(
				external_wp_components_[ 'withFilters' ]
			)( 'editor.PostTaxonomyType' )( HierarchicalTermSelector );
			...
			function PostTaxonomies( _ref ) {
				let { postType, taxonomies, taxonomyWrapper = external_lodash_[ 'identity' ] } = _ref;
				const availableTaxonomies = Object( external_lodash_[ 'filter' ] )( taxonomies, taxonomy =>
			...
			function PostTaxonomiesCheck( _ref ) {
				...
				const hasTaxonomies = Object( external_lodash_[ 'some' ] )( taxonomies, taxonomy =>
					Object( external_lodash_[ 'includes' ] )( taxonomy.types, postType )
				);
			...
			function PostTextEditor() {
				const postContent = Object( external_wp_data_[ 'useSelect' ] )(
					select => select( store ).getEditedPostContent(),
					[]
				);
				const { editPost, resetEditorBlocks } = Object( external_wp_data_[ 'useDispatch' ] )(
					store
			...
			function PostTitle() {
				...
				const { isCleanNewPost, title, placeholder, isFocusMode, hasFixedToolbar } = Object(
					external_wp_data_[ 'useSelect' ]
				)( select => {
					const { getEditedPostAttribute, isCleanNewPost: _isCleanNewPost } = select( store );
					const { getSettings } = select( external_wp_blockEditor_[ 'store' ] );
					const { titlePlaceholder, focusMode, hasFixedToolbar: _hasFixedToolbar } = getSettings();
					return {
				...
				function onPaste( event ) {
					...
					if ( typeof content !== 'string' && content.length ) {
						...
						if (
							! title &&
							( firstBlock.name === 'core/heading' || firstBlock.name === 'core/paragraph' )
						) {
				...
				const decodedPlaceholder =
					Object( external_wp_htmlEntities_[ 'decodeEntities' ] )( placeholder ) ||
					Object( external_wp_i18n_[ '__' ] )( 'Add title' );

				const { ref: richTextRef } = Object( external_wp_richText_[ '__unstableUseRichText' ] )( {
					value: title,
					onChange,
			...
			function PostTrash( _ref ) {
				let { isNew, postId, postType, ...props } = _ref;
			...
			/* harmony default export */ var post_trash = Object( external_wp_compose_[ 'compose' ] )( [
				Object( external_wp_data_[ 'withSelect' ] )( select => {
					const { isEditedPostNew, getCurrentPostId, getCurrentPostType } = select( store );
					return {
						isNew: isEditedPostNew(),
						postId: getCurrentPostId(),
						postType: getCurrentPostType(),
			...
			/* harmony default export */ var post_trash_check = Object(
				...
				const { isEditedPostNew, getCurrentPostId, getCurrentPostType } = select( store );
				const { getPostType, canUser } = select( external_wp_coreData_[ 'store' ] );
				const postId = getCurrentPostId();
				const postType = getPostType( getCurrentPostType() );
				const resource =
					( postType === null || postType === void 0 ? void 0 : postType.rest_base ) || ''; // eslint-disable-line camelcase
			...
			function WordCount() {
				const content = Object( external_wp_data_[ 'useSelect' ] )(
					select => select( store ).getEditedPostAttribute( 'content' ),
					[]
				);
				/*
			...
			function TableOfContentsPanel( _ref ) {
				...
				const { headingCount, paragraphCount, numberOfBlocks } = Object(
					...
					const { getGlobalBlockCount } = select( external_wp_blockEditor_[ 'store' ] );
					return {
					...
					Object( external_wp_element_[ 'createElement' ] )(
							...
							Object( external_wp_element_[ 'createElement' ] )(
								...
								Object( external_wp_element_[ 'createElement' ] )(
									...
									Object( external_wp_element_[ 'createElement' ] )(
										...
										Object( external_wp_element_[ 'createElement' ] )( CharacterCount, null )
									)
								),
								Object( external_wp_element_[ 'createElement' ] )(
									'li',
						...
						headingCount > 0 &&
							Object( external_wp_element_[ 'createElement' ] )(
								...
								Object( external_wp_element_[ 'createElement' ] )( document_outline, {
			...
			function TableOfContents( _ref, ref ) {
				...
				const hasBlocks = Object( external_wp_data_[ 'useSelect' ] )(
					select => !! select( external_wp_blockEditor_[ 'store' ] ).getBlockCount(),
					[]
				);
				return Object( external_wp_element_[ 'createElement' ] )(
			...
			const withRegistryProvider = Object( external_wp_compose_[ 'createHigherOrderComponent' ] )(
				WrappedComponent =>
					Object( external_wp_data_[ 'withRegistry' ] )( props => {
						...
						const [ subRegistry, setSubRegistry ] = Object( external_wp_element_[ 'useState' ] )(
							null
						);
						Object( external_wp_element_[ 'useEffect' ] )( () => {
			...
			function mediaUpload( _ref ) {
				...
				const { getCurrentPostId, getEditorSettings } = Object( external_wp_data_[ 'select' ] )(
					store
				);
			...
			function useBlockEditorSettings( settings, hasTemplate ) {
				const {
					...
					const { canUserUseUnfilteredHTML } = select( store );
			...
			function EditorProvider( _ref ) {
				let { __unstableTemplate, post, settings, recovery, initialEdits, children } = _ref;
				...
				const { selection, isReady } = Object( external_wp_data_[ 'useSelect' ] )( select => {
					const { getEditorSelection, __unstableIsEditorReady } = select( store );
					return {
				...
				const { createWarningNotice } = Object( external_wp_data_[ 'useDispatch' ] )(
					external_wp_notices_[ 'store' ]
			...
			const RichText = deprecateComponent( 'RichText', external_wp_blockEditor_[ 'RichText' ], [
				'Content',
			] );
...
*/
		...
		/***/ rvQu: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
				'GRId'
			);
			...
			const sidebar = Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
				_wordpress_primitives__WEBPACK_IMPORTED_MODULE_1__[ 'SVG' ],
				{
					xmlns: 'http://www.w3.org/2000/svg',
					viewBox: '0 0 24 24',
				...
				Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
					...
					{
						d:
							'M18 5.5H6a.5.5 0 00-.5.5v3h13V6a.5.5 0 00-.5-.5zm.5 5H10v8h8a.5.5 0 00.5-.5v-7.5zM6 4h12a2 2 0 012 2v12a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2z',
					}
				)
			);
