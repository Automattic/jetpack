this[ 'wp' ] = this[ 'wp' ] || {};
this[ 'wp' ][ 'mediaUtils' ] = /******/ ( function ( modules ) {
	// webpackBootstrap
	/******/ // The module cache
	...
	/******/ {
		...
		/***/ 'Lb+8': /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			__webpack_require__.r( __webpack_exports__ );

			// EXPORTS
			__webpack_require__.d( __webpack_exports__, 'MediaUpload', function () {
				return /* reexport */ media_upload;
			} );
			__webpack_require__.d( __webpack_exports__, 'uploadMedia', function () {
				return /* reexport */ uploadMedia;
			} );
						...
						this.states.add( [
							new wp.media.controller.Library( {
								...
								library: wp.media.query(
									Object( external_lodash_[ 'defaults' ] )(
										{
											type: 'image',
										},
			...
			class media_upload_MediaUpload extends external_wp_element_[ 'Component' ] {
				...
				onOpen() {
					...
					const attachments = getAttachmentsCollection(
						Object( external_lodash_[ 'castArray' ] )( this.props.value )
					...
					attachments.more().done( function () {
						...
						if (
							...
							attachments !== null &&
							attachments !== void 0 &&
							( _attachments$models = attachments.models ) !== null &&
							_attachments$models !== void 0 &&
							_attachments$models.length
						) {
			...
			function getMimeTypesArray( wpMimeTypesObject ) {
				...
				return Object( external_lodash_[ 'flatMap' ] )(
					wpMimeTypesObject,
					( mime, extensionsString ) => {
						const [ type ] = mime.split( '/' );
						const extensions = extensionsString.split( '|' );
						return [
							mime,
							...Object( external_lodash_[ 'map' ] )(
								extensions,
			...
			async function uploadMedia( _ref ) {
				...
				const setAndUpdateFiles = ( idx, value ) => {
					Object( external_wp_blob_[ 'revokeBlobURL' ] )(
						Object( external_lodash_[ 'get' ] )( filesSet, [ idx, 'url' ] )
					);
					filesSet[ idx ] = value;
				...
				for ( const mediaFile of files ) {
					...
					if (
						...
						triggerError( {
							...
							message: Object( external_wp_i18n_[ '__' ] )(
				...
				for ( let idx = 0; idx < validFiles.length; ++idx ) {
					...
					try {
						...
						const mediaObject = {
							...Object( external_lodash_[ 'omit' ] )( savedMedia, [ 'alt_text', 'source_url' ] ),
						...
						if ( Object( external_lodash_[ 'has' ] )( error, [ 'message' ] ) ) {
							...
							message = Object( external_wp_i18n_[ 'sprintf' ] )(
			...
			function createMediaFromFile( file, additionalData ) {
				...
				Object( external_lodash_[ 'forEach' ] )( additionalData, ( value, key ) =>
