...
this[ 'wp' ][ 'editSite' ] = /******/ ( function ( modules ) {
	...
	/************************************************************************/
	/******/ {
		/***/ '0Ene': /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			...
			const plugins = Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
		...
		/***/ B9Az: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
		...
		/***/ IqXm: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			// ESM COMPAT FLAG
			...
			__webpack_require__.d( __webpack_exports__, '__experimentalNavigationToggle', function () {
			...
			__webpack_require__.d( actions_namespaceObject, 'setTemplate', function () {
				return actions_setTemplate;
			} );
			__webpack_require__.d( actions_namespaceObject, 'addTemplate', function () {
				return addTemplate;
			} );
			__webpack_require__.d( actions_namespaceObject, 'removeTemplate', function () {
				return actions_removeTemplate;
			} );
			__webpack_require__.d( actions_namespaceObject, 'setTemplatePart', function () {
				return actions_setTemplatePart;
			} );
			__webpack_require__.d( actions_namespaceObject, 'setHomeTemplateId', function () {
				return setHomeTemplateId;
			} );
			__webpack_require__.d( actions_namespaceObject, 'setPage', function () {
				return actions_setPage;
			} );
			__webpack_require__.d( actions_namespaceObject, 'setNavigationPanelActiveMenu', function () {
				return setNavigationPanelActiveMenu;
			} );
			__webpack_require__.d( actions_namespaceObject, 'openNavigationPanelToMenu', function () {
				return openNavigationPanelToMenu;
			} );
			__webpack_require__.d( actions_namespaceObject, 'setIsNavigationPanelOpened', function () {
			...
			__webpack_require__.d( actions_namespaceObject, 'updateSettings', function () {
			...
			__webpack_require__.d( actions_namespaceObject, 'revertTemplate', function () {
			...
			__webpack_require__.d( selectors_namespaceObject, 'getCanUserCreateMedia', function () {
				return getCanUserCreateMedia;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'getReusableBlocks', function () {
				return getReusableBlocks;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'getSettings', function () {
				return selectors_getSettings;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'getHomeTemplateId', function () {
				return getHomeTemplateId;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'getEditedPostType', function () {
				return selectors_getEditedPostType;
			} );
			__webpack_require__.d( selectors_namespaceObject, 'getEditedPostId', function () {
			...
			__webpack_require__.d( selectors_namespaceObject, 'isNavigationOpened', function () {
			...
			function isTemplateRevertable( template ) {
				...
				return (
					( template === null || template === void 0 ? void 0 : template.source ) === 'custom' &&
					( template === null || template === void 0 ? void 0 : template.has_theme_file )
				);
			...
			function* actions_setPage( page ) {
				...
				yield {
					type: 'SET_PAGE',
					page: ! templateSlug ? page : { ...page, context: { ...page.context, templateSlug } },
					templateId,
				};
				return templateId;
			}
			...
			function* actions_revertTemplate( template ) {
				...
				try {
					...
					const errorMessage =
						error.message && error.code !== 'unknown_error'
							? error.message
							: Object( external_wp_i18n_[ '__' ] )( 'Template revert failed. Please reload.' );
					yield external_wp_data_[ 'controls' ].dispatch(
						external_wp_notices_[ 'store' ],
						'createErrorNotice',
						errorMessage,
			...
			)( select => () => select( external_wp_coreData_[ 'store' ] ).canUser( 'create', 'media' ) );
			/**
			...
			const getReusableBlocks = Object( external_wp_data_[ 'createRegistrySelector' ] )(
				select => () => {
			...
			const getCurrentTemplateNavigationPanelSubMenu = Object(
				...
				if ( 'wp_template_part' === templateType ) {
					...
					return (
						( ( _TEMPLATE_PARTS_SUB_M = TEMPLATE_PARTS_SUB_MENUS.find(
							submenu =>
								submenu.area ===
								( template === null || template === void 0 ? void 0 : template.area )
				...
				const templates = select( external_wp_coreData_[ 'store' ] ).getEntityRecords(
					'postType',
					'wp_template'
				);
				const showOnFront = select( external_wp_coreData_[ 'store' ] ).getEditedEntityRecord(
					'root',
					'site'
				).show_on_front;
			...
			const getCurrentTemplateTemplateParts = Object(
				...
				const templateParts = select( external_wp_coreData_[ 'store' ] ).getEntityRecords(
					'postType',
					'wp_template_part',
					{
						per_page: -1,
				...
				return ( ( _template$blocks = template.blocks ) !== null && _template$blocks !== void 0
					? _template$blocks
					: []
				)
					.filter( block => Object( external_wp_blocks_[ 'isTemplatePart' ] )( block ) )
					.map( block => {
						const {
			...
			function history_push( params, state ) {
				return originalHistoryPush.call(
					history_history,
					Object( external_wp_url_[ 'addQueryArgs' ] )( window.location.href, params ),
					state
				);
			}
			...
			function getLocationWithParams( location ) {
				...
				return { ...location, params: Object.fromEntries( searchParams.entries() ) };
			}

			function Routes( _ref ) {
				let { children } = _ref;
				const [ location, setLocation ] = Object( external_wp_element_[ 'useState' ] )( () =>
						...
						shortcuts.map( ( shortcut, index ) =>
							Object( external_wp_element_[ 'createElement' ] )(
								...
								Object( external_lodash_[ 'isString' ] )( shortcut )
									? Object( external_wp_element_[ 'createElement' ] )( DynamicShortcut, {
											name: shortcut,
									  } )
			...
			function FeatureToggle( _ref ) {
				let { feature, label, info, messageActivated, messageDeactivated } = _ref;
			...
			function MoreMenu() {
				const [ isModalActive, toggleModal ] = Object( external_wp_element_[ 'useReducer' ] )(
					isActive => ! isActive,
					false
				);
						...
						_ref => {
							...
							return Object( external_wp_element_[ 'createElement' ] )(
								...
								Object( external_wp_element_[ 'createElement' ] )(
									...
									Object( external_wp_element_[ 'createElement' ] )( SiteExport, null ),
									Object( external_wp_element_[ 'createElement' ] )(
										external_wp_components_[ 'MenuItem' ],
										{
											onClick: toggleModal,
			...
			function SaveButton( _ref ) {
				...
				const { isDirty, isSaving } = Object( external_wp_data_[ 'useSelect' ] )( select => {
					const { __experimentalGetDirtyEntityRecords, isSavingEntityRecord } = select(
						external_wp_coreData_[ 'store' ]
					);
					...
					return {
						...
						isSaving: Object( external_lodash_[ 'some' ] )( dirtyEntityRecords, record =>
			...
			function DocumentActions( _ref ) {
				let { entityTitle, entityLabel, isLoaded, children: dropdownContent } = _ref;
			...
			function Link( _ref ) {
				let { params = {}, state, replace: shouldReplace = false, children, ...props } = _ref;
			...
			function TemplatePartItemMore( _ref ) {
				...
				const { revertTemplate } = Object( external_wp_data_[ 'useDispatch' ] )( store );
			...
			function TemplatePartItem( _ref2 ) {
				...
				const { selectBlock, toggleBlockHighlight } = Object( external_wp_data_[ 'useDispatch' ] )(
					external_wp_blockEditor_[ 'store' ]
				);
			...
			function EditTemplateTitle( _ref ) {
				let { template } = _ref;
				const [ title, setTitle ] = Object( external_wp_coreData_[ 'useEntityProp' ] )(
					'postType',
					template.type,
					'title',
					template.id
			...
			function TemplateDetails( _ref ) {
				...
				const { title, description } = Object( external_wp_data_[ 'useSelect' ] )(
					select =>
						select( external_wp_editor_[ 'store' ] ).__experimentalGetTemplateInfo( template ),
					[]
				);
				const { revertTemplate } = Object( external_wp_data_[ 'useDispatch' ] )( store );
				const templateSubMenu = Object( external_wp_element_[ 'useMemo' ] )( () => {
					if (
						( template === null || template === void 0 ? void 0 : template.type ) === 'wp_template'
					) {
						return {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )(
						...
						template.is_custom
							? Object( external_wp_element_[ 'createElement' ] )( EditTemplateTitle, {
									template: template,
							  } )
							: Object( external_wp_element_[ 'createElement' ] )(
			...
			function Header( _ref ) {
				...
				const {
					...
					const { getEditedEntityRecord } = select( external_wp_coreData_[ 'store' ] );
			...
			const styles_styles = Object( external_wp_element_[ 'createElement' ] )(
				...
				Object( external_wp_element_[ 'createElement' ] )( external_wp_primitives_[ 'Path' ], {
					d:
						'M12 4c-4.4 0-8 3.6-8 8v.1c0 4.1 3.2 7.5 7.2 7.9h.8c4.4 0 8-3.6 8-8s-3.6-8-8-8zm0 15V5c3.9 0 7 3.1 7 7s-3.1 7-7 7z',
				} )
			);
			...
			function findInPresetsBy(
				...
				const orderedPresetsByOrigin = [
					Object( external_lodash_[ 'get' ] )( features, [ 'blocks', blockName, ...presetPath ] ),
			...
			const useGlobalStylesReset = () => {
				const { user: config, setUserConfig } = Object( external_wp_element_[ 'useContext' ] )(
					GlobalStylesContext
				);
				const canReset =
					!! config && ! Object( external_lodash_[ 'isEqual' ] )( config, EMPTY_CONFIG );
				return [
					canReset,
			...
			function useSetting( path, blockName ) {
				...
				const { merged: mergedConfig, base: baseConfig, user: userConfig, setUserConfig } = Object(
				...
				const setSetting = newValue => {
					setUserConfig( currentConfig => {
						...
						const pathToSet = external_wp_blocks_[ '__EXPERIMENTAL_PATHS_WITH_MERGE' ][ path ]
							? fullPath + '.custom'
							: fullPath;
				...
				const getSettingValueForContext = name => {
					...
					const getSettingValue = configToUse => {
						...
						if ( external_wp_blocks_[ '__EXPERIMENTAL_PATHS_WITH_MERGE' ][ path ] ) {
							...
							return ( _ref =
								( _result$custom =
									result === null || result === void 0 ? void 0 : result.custom ) !== null &&
								_result$custom !== void 0
									? _result$custom
				...
				const resultWithFallback =
					( _getSettingValueForCo = getSettingValueForContext( blockName ) ) !== null &&
					_getSettingValueForCo !== void 0
				...
				const setStyle = newValue => {
					setUserConfig( currentConfig => {
						...
						Object( external_lodash_[ 'set' ] )(
							newUserConfig,
							finalPath,
							getPresetVariableFromValue( mergedConfig.settings, blockName, path, newValue )
						);
						return newUserConfig;
					} );
				};
				...
				switch ( source ) {
					case 'all':
						result = getValueFromVariable(
							...
							blockName,
							( _get = Object( external_lodash_[ 'get' ] )( userConfig, finalPath ) ) !== null &&
								_get !== void 0
								? _get
			...
			function getSupportedGlobalStylesPanels( name ) {
				...
				const supportKeys = [];
				Object.keys( external_wp_blocks_[ '__EXPERIMENTAL_STYLE_PROPERTY' ] ).forEach(
					styleName => {
						...
						if (
							external_wp_blocks_[ '__EXPERIMENTAL_STYLE_PROPERTY' ][ styleName ].requiresOptOut
						) {
							if (
								Object( external_lodash_[ 'has' ] )(
									blockType.supports,
									external_wp_blocks_[ '__EXPERIMENTAL_STYLE_PROPERTY' ][ styleName ].support[ 0 ]
								) &&
								Object( external_lodash_[ 'get' ] )(
									blockType.supports,
									external_wp_blocks_[ '__EXPERIMENTAL_STYLE_PROPERTY' ][ styleName ].support
								) !== false
							) {
			...
			function DimensionsPanel( _ref ) {
				...
				const paddingSides = Object( external_wp_blockEditor_[ '__experimentalUseCustomSides' ] )(
					name,
					'padding'
				);
				...
				const marginSides = Object( external_wp_blockEditor_[ '__experimentalUseCustomSides' ] )(
					name,
					'margin'
				);
				const isAxialMargin =
			...
			function useHasLineHeightControl( name ) {
				const supports = getSupportedGlobalStylesPanels( name );
				return (
					useSetting( 'typography.lineHeight', name )[ 0 ] && supports.includes( 'lineHeight' )
				);
			}
			...
			function useHasAppearanceControl( name ) {
				const supports = getSupportedGlobalStylesPanels( name );
				const hasFontStyles =
					useSetting( 'typography.fontStyle', name )[ 0 ] && supports.includes( 'fontStyle' );
				const hasFontWeights =
					useSetting( 'typography.fontWeight', name )[ 0 ] && supports.includes( 'fontWeight' );
					...
					hasAppearanceControl &&
						Object( external_wp_element_[ 'createElement' ] )(
							external_wp_blockEditor_[ '__experimentalFontAppearanceControl' ],
							{
								...
								onChange: _ref2 => {
									let { fontStyle: newFontStyle, fontWeight: newFontWeight } = _ref2;
				...
				const paletteButtonText =
					colors.length > 0
						? Object( external_wp_i18n_[ 'sprintf' ] )(
								...
								Object( external_wp_i18n_[ '_n' ] )( '%d color', '%d colors', colors.length ),
								colors.length
						  )
			...
			function ScreenColorPalette( _ref ) {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					currentTab === 'gradient' &&
						Object( external_wp_element_[ 'createElement' ] )( GradientPalettePanel, {
							name: name,
						} )
				);
			}
			...
			function GlobalStylesUI() {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )(
						...
						Object( external_wp_element_[ 'createElement' ] )( screen_block_list, null )
					),
					blocks.map( block =>
						Object( external_wp_element_[ 'createElement' ] )(
							external_wp_components_[ '__experimentalNavigatorScreen' ],
			...
			function compileStyleValue( uncompiledValue ) {
				...
				if (
					Object( external_lodash_[ 'startsWith' ] )( uncompiledValue, VARIABLE_REFERENCE_PREFIX )
				) {
						...
						[ 'default', 'theme', 'custom' ].forEach( origin => {
							if ( presetByOrigin[ origin ] ) {
								presetByOrigin[ origin ].forEach( value => {
									declarations.push(
										`--wp--preset--${ cssVarInfix }--${ Object( external_lodash_[ 'kebabCase' ] )(
											value.slug
										) }: ${ value[ valueKey ] }`
									);
								} );
							...
							if ( presetByOrigin[ origin ] ) {
								presetByOrigin[ origin ].forEach( _ref3 => {
									...
									classes.forEach( _ref4 => {
										...
										const classSelectorToUse = `.has-${ Object( external_lodash_[ 'kebabCase' ] )(
											slug
										) }-${ classSuffix }`;
			...
			function flattenTree() {
				...
				Object.keys( input ).forEach( key => {
					const newKey =
						prefix + Object( external_lodash_[ 'kebabCase' ] )( key.replace( '/', '-' ) );
			...
			const getNodesWithSettings = ( tree, blockSelectors ) => {
				...
				Object( external_lodash_[ 'forEach' ] )(
					( _tree$settings2 = tree.settings ) === null || _tree$settings2 === void 0
						? void 0
			...
			function useGlobalStylesOutput() {
				...
				const { merged: mergedConfig } = Object( external_wp_element_[ 'useContext' ] )(
					GlobalStylesContext
				);
				Object( external_wp_element_[ 'useEffect' ] )( () => {
					if (
						! ( mergedConfig !== null && mergedConfig !== void 0 && mergedConfig.styles ) ||
						! ( mergedConfig !== null && mergedConfig !== void 0 && mergedConfig.settings )
					) {
						return;
					}
			...
			function TemplateCard() {
				const { title, description, icon } = Object( external_wp_data_[ 'useSelect' ] )( select => {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )(
						...
						Object( external_wp_element_[ 'createElement' ] )( template_areas_TemplateAreas, null )
					)
				);
			}
			...
			function SidebarComplementaryAreaFills() {
				const { sidebar, isEditorSidebarOpened, hasBlockSelection } = Object(
					...
					const _sidebar = select( build_module[ 'i' /* store */ ] ).getActiveComplementaryArea(
						STORE_NAME
					);
					...
					Object( external_wp_element_[ 'createElement' ] )(
						...
						sidebarName === SIDEBAR_TEMPLATE &&
							Object( external_wp_element_[ 'createElement' ] )(
								external_wp_components_[ 'PanelBody' ],
								null,
								Object( external_wp_element_[ 'createElement' ] )( TemplateCard, null )
							),
			...
			const NavigationPanel = _ref2 => {
				...
				const { isNavigationOpen, siteTitle } = Object( external_wp_data_[ 'useSelect' ] )(
					select => {
						const { getEntityRecord } = select( external_wp_coreData_[ 'store' ] );
				...
				const { setIsNavigationPanelOpened } = Object( external_wp_data_[ 'useDispatch' ] )(
					store
				);
							...
							Object( external_wp_element_[ 'createElement' ] )(
								...
								Object( external_wp_element_[ 'createElement' ] )(
									...
									Object( external_wp_element_[ 'createElement' ] )(
										...
										null,
										Object( external_wp_element_[ 'createElement' ] )(
											external_wp_components_[ '__experimentalNavigationBackButton' ],
											{
			...
			const { Fill: NavigationPanelPreviewFill, Slot: NavigationPanelPreviewSlot } = Object(
				external_wp_components_[ 'createSlotFill' ]
			)( 'EditSiteNavigationPanelPreview' );
			const { Fill: NavigationSidebarFill, Slot: NavigationSidebarSlot } = Object(
				external_wp_components_[ 'createSlotFill' ]
			...
			function NavigationSidebar( _ref ) {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					null,
					Object( external_wp_element_[ 'createElement' ] )( navigation_toggle, null ),
			...
			function CreateTemplatePartModal( _ref ) {
				...
				const [ isSubmitting, setIsSubmitting ] = Object( external_wp_element_[ 'useState' ] )(
					false
				);
				...
				const templatePartAreas = Object( external_wp_data_[ 'useSelect' ] )(
					select =>
						select( external_wp_editor_[ 'store' ] ).__experimentalGetDefaultTemplatePartAreas(),
					[]
				);
				return Object( external_wp_element_[ 'createElement' ] )(
					external_wp_components_[ 'Modal' ],
			...
			function ConvertToTemplatePart( _ref ) {
				...
				const { createSuccessNotice } = Object( external_wp_data_[ 'useDispatch' ] )(
					external_wp_notices_[ 'store' ]
				);
				...
				const onConvert = async _ref2 => {
					...
					const cleanSlug =
						Object( external_lodash_[ 'kebabCase' ] )( title ).replace( /[^\w-]+/g, '' ) ||
						'wp-custom-part';
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					isModalOpen &&
						Object( external_wp_element_[ 'createElement' ] )( CreateTemplatePartModal, {
							closeModal: () => {
			...
			function TemplatePartConverter() {
				...
				const { clientIds, blocks } = Object( external_wp_data_[ 'useSelect' ] )( select => {
			...
			function NavigateToLink( _ref ) {
				...
				const post = Object( external_wp_data_[ 'useSelect' ] )(
					select =>
						...
						id &&
						type !== 'URL' &&
						select( external_wp_coreData_[ 'store' ] ).getEntityRecord( 'postType', type, id ),
					[ type, id ]
				);
				const onClick = Object( external_wp_element_[ 'useMemo' ] )( () => {
					...
					if (
						path === ( activePage === null || activePage === void 0 ? void 0 : activePage.path )
					)
						return null;
					return () =>
						onActivePageChange( {
					...
					post,
					activePage === null || activePage === void 0 ? void 0 : activePage.path,
					onActivePageChange,
				] );
				return (
					onClick &&
			...
			function BlockInspectorButton( _ref ) {
				let { onClick = () => {} } = _ref;
				const { shortcut, isBlockInspectorOpen } = Object( external_wp_data_[ 'useSelect' ] )(
					select => ( {
						...
						isBlockInspectorOpen:
							select( build_module[ 'i' /* store */ ] ).getActiveComplementaryArea( store.name ) ===
							SIDEBAR_BLOCK,
					} ),
					[]
				);
			...
			function ResizeHandle( _ref ) {
				...
				function handleKeyDown( event ) {
					...
					if (
						( direction === 'left' && keyCode === external_wp_keycodes_[ 'LEFT' ] ) ||
						( direction === 'right' && keyCode === external_wp_keycodes_[ 'RIGHT' ] )
					) {
						resizeWidthBy( DELTA_DISTANCE );
					} else if (
						( direction === 'left' && keyCode === external_wp_keycodes_[ 'RIGHT' ] ) ||
			...
			function ResizableEditor( _ref ) {
				...
				const deviceStyles = Object( external_wp_blockEditor_[ '__experimentalUseResizeCanvas' ] )(
					deviceType
				);
			...
			function BlockEditor( _ref ) {
				...
				const { settings, templateType, templateId, page } = Object(
					...
					select => {
						const { getSettings, getEditedPostType, getEditedPostId, getPage } = select( store );
						return {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )( EditTemplatePartMenuButton, null ),
					Object( external_wp_element_[ 'createElement' ] )( TemplatePartConverter, null ),
					Object( external_wp_element_[ 'createElement' ] )(
			...
			function KeyboardShortcuts( _ref ) {
				...
				const { __experimentalGetDirtyEntityRecords, isSavingEntityRecord } = Object(
					external_wp_data_[ 'useSelect' ]
				)( external_wp_coreData_[ 'store' ] );
										...
										Object( external_wp_element_[ 'createInterpolateElement' ] )(
											...
											),
											{
												StylesIconImage: Object( external_wp_element_[ 'createElement' ] )( 'img', {
													...
													src:
														"data:image/svg+xml,%3Csvg width='18' height='18' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M12 4c-4.4 0-8 3.6-8 8v.1c0 4.1 3.2 7.5 7.2 7.9h.8c4.4 0 8-3.6 8-8s-3.6-8-8-8zm0 15V5c3.9 0 7 3.1 7 7s-3.1 7-7 7z' fill='%231E1E1E'/%3E%3C/svg%3E%0A",
												} ),
											}
										)
									)
			...
			function WelcomeGuideStyles() {
				const { toggleFeature } = Object( external_wp_data_[ 'useDispatch' ] )( store );
				const { isActive, isStylesOpen } = Object( external_wp_data_[ 'useSelect' ] )( select => {
					const sidebar = select( build_module[ 'i' /* store */ ] ).getActiveComplementaryArea(
						store.name
					);
					return {
			...
			function WelcomeGuide() {
				return Object( external_wp_element_[ 'createElement' ] )(
					external_wp_element_[ 'Fragment' ],
					null,
					Object( external_wp_element_[ 'createElement' ] )( WelcomeGuideEditor, null ),
					Object( external_wp_element_[ 'createElement' ] )( WelcomeGuideStyles, null )
				);
			}
			...
			function useGlobalStylesRenderer() {
				...
				const { updateSettings } = Object( external_wp_data_[ 'useDispatch' ] )( store );
				Object( external_wp_element_[ 'useEffect' ] )( () => {
					if ( ! styles || ! settings ) {
						return;
					}
			...
			function useGlobalStylesUserConfig() {
				const { globalStylesId, settings, styles } = Object( external_wp_data_[ 'useSelect' ] )(
					select => {
				...
				const { getEditedEntityRecord } = Object( external_wp_data_[ 'useSelect' ] )(
					external_wp_coreData_[ 'store' ]
				);
				...
				const setConfig = Object( external_wp_element_[ 'useCallback' ] )(
					callback => {
						...
						const currentConfig = {
							styles:
								( _record$styles =
									record === null || record === void 0 ? void 0 : record.styles ) !== null &&
								_record$styles !== void 0
									? _record$styles
									: {},
							settings:
								( _record$settings =
									record === null || record === void 0 ? void 0 : record.settings ) !== null &&
								_record$settings !== void 0
									? _record$settings
									: {},
						};
			...
			function useTitle( title ) {
				...
				const siteTitle = Object( external_wp_data_[ 'useSelect' ] )( select => {
					...
					return ( _select$getEntityReco = select(
						external_wp_coreData_[ 'store' ]
					).getEntityRecord( 'root', 'site' ) ) === null || _select$getEntityReco === void 0
						? void 0
			...
			function Editor( _ref ) {
				...
				const {
					...
					return {
						...
						templateResolved: postId
							? hasFinishedResolution( 'getEntityRecord', [ 'postType', postType, postId ] )
							: false,
						entityId: postId,
				...
				const { setPage, setIsInserterOpened } = Object( external_wp_data_[ 'useDispatch' ] )(
					store
				);
				const { enableComplementaryArea } = Object( external_wp_data_[ 'useDispatch' ] )(
					build_module[ 'i' /* store */ ]
				);
				const [ isEntitiesSavedStatesOpen, setIsEntitiesSavedStatesOpen ] = Object(
				...
				const isReady =
					( settings === null || settings === void 0 ? void 0 : settings.siteUrl ) &&
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					external_wp_element_[ 'Fragment' ],
					null,
					Object( external_wp_element_[ 'createElement' ] )( URLQueryController, null ),
					isReady &&
						Object( external_wp_element_[ 'createElement' ] )(
												...
												Object( external_wp_element_[ 'createElement' ] )(
													build_module[ 'e' /* InterfaceSkeleton */ ],
													{
														...
														content: Object( external_wp_element_[ 'createElement' ] )(
															...
															template &&
																Object( external_wp_element_[ 'createElement' ] )( BlockEditor, {
														...
														footer: Object( external_wp_element_[ 'createElement' ] )(
			...
			function NewTemplate( _ref ) {
				let { postType } = _ref;
				const history = useHistory();
				const { templates, defaultTemplateTypes } = Object( external_wp_data_[ 'useSelect' ] )(
					select => ( {
				...
				const { getLastEntitySaveError } = Object( external_wp_data_[ 'useSelect' ] )(
					external_wp_coreData_[ 'store' ]
				);
				...
				const missingTemplates = Object( external_lodash_[ 'filter' ] )(
					defaultTemplateTypes,
					template =>
						Object( external_lodash_[ 'includes' ] )( DEFAULT_TEMPLATE_SLUGS, template.slug ) &&
						! Object( external_lodash_[ 'includes' ] )( existingTemplateSlugs, template.slug )
				);
			...
			function AddNewTemplate( _ref ) {
				...
				const postType = Object( external_wp_data_[ 'useSelect' ] )(
					select => select( external_wp_coreData_[ 'store' ] ).getPostType( templateType ),
					[ templateType ]
				);
			...
			function Actions( _ref ) {
				let { template } = _ref;
				const { removeTemplate, revertTemplate } = Object( external_wp_data_[ 'useDispatch' ] )(
					store
				);
				const { saveEditedEntityRecord } = Object( external_wp_data_[ 'useDispatch' ] )(
					external_wp_coreData_[ 'store' ]
				);
				const { createSuccessNotice, createErrorNotice } = Object(
					external_wp_data_[ 'useDispatch' ]
						...
						return Object( external_wp_element_[ 'createElement' ] )(
							...
							isRemovable &&
								Object( external_wp_element_[ 'createElement' ] )(
									external_wp_element_[ 'Fragment' ],
									null,
									Object( external_wp_element_[ 'createElement' ] )( RenameMenuItem, {
										template: template,
										onClose: onClose,
									} ),
									Object( external_wp_element_[ 'createElement' ] )(
			...
			function BaseAddedBy( _ref2 ) {
				...
				const [ isImageLoaded, setIsImageLoaded ] = Object( external_wp_element_[ 'useState' ] )(
					false
				);
				return Object( external_wp_element_[ 'createElement' ] )(
					external_wp_components_[ '__experimentalHStack' ],
				...
				return Object( external_wp_element_[ 'createElement' ] )( BaseAddedBy, {
					...
					imageUrl:
						user === null || user === void 0
							? void 0
							: ( _user$avatar_urls = user.avatar_urls ) === null || _user$avatar_urls === void 0
							? void 0
			...
			function AddedBySite() {
				const { name, logoURL } = Object( external_wp_data_[ 'useSelect' ] )( select => {
					var _getMedia;

					const { getEntityRecord, getMedia } = select( external_wp_coreData_[ 'store' ] );
					const siteData = getEntityRecord( 'root', '__unstableBase' );
					return {
						name: siteData === null || siteData === void 0 ? void 0 : siteData.name,
						logoURL:
							siteData !== null && siteData !== void 0 && siteData.site_logo
								? ( _getMedia = getMedia( siteData.site_logo ) ) === null || _getMedia === void 0
									? void 0
			...
			function Table( _ref ) {
				let { templateType } = _ref;
				const { templates, isLoading, postType } = Object( external_wp_data_[ 'useSelect' ] )(
					select => {
						const { getEntityRecords, hasFinishedResolution, getPostType } = select(
							external_wp_coreData_[ 'store' ]
						);
						return {
			...
			function List() {
				...
				const itemsListLabel =
					postType === null || postType === void 0
						? void 0
						: ( _postType$labels2 = postType.labels ) === null || _postType$labels2 === void 0
						? void 0
			...
			function EditSiteApp( _ref ) {
				...
				return Object( external_wp_element_[ 'createElement' ] )(
					...
					Object( external_wp_element_[ 'createElement' ] )( Routes, null, _ref2 => {
						let { params } = _ref2;
			...
			function getNeedsHomepageRedirect( params ) {
				...
				return (
					...
					! [ 'post', 'page', 'wp_template', 'wp_template_part' ].includes( postType )
				);
			}
			/**
			...
			async function getHomepageParams( siteUrl ) {
				...
				const { show_on_front: showOnFront, page_on_front: frontpageId } = siteSettings; // If the user has set a page as the homepage, use those details.
			...
			async function reinitializeEditor( target, settings ) {
				...
				try {
					...
					Object( external_wp_element_[ 'render' ] )(
						Object( external_wp_element_[ 'createElement' ] )( ErrorBoundaryWarning, {
							message: Object( external_wp_i18n_[ '__' ] )(
...

				{
					...
					if ( isLandingOnListPage ) {
						...
						Object( external_wp_data_[ 'dispatch' ] )( store ).setIsNavigationPanelOpened(
		...
		/***/ K8zD: /***/ function ( module, __webpack_exports__, __webpack_require__ ) {
			'use strict';
			/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
				'GRId'
			);
			...
			const globe = Object( _wordpress_element__WEBPACK_IMPORTED_MODULE_0__[ 'createElement' ] )(
				_wordpress_primitives__WEBPACK_IMPORTED_MODULE_1__[ 'SVG' ],
				{
					xmlns: 'http://www.w3.org/2000/svg',
					viewBox: '0 0 24 24',
