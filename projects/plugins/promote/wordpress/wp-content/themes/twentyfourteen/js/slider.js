	...
	$.featuredslider = function ( el, options ) {
		var slider = $( el ),
			...
			touch =
				...
				msGesture ||
				( window.DocumentTouch && document instanceof DocumentTouch ), // MSFT specific.
		...
		methods = {
			...
			controlNav: {
				...
				setupPaging: function () {
					...
					slider.controlNavScaffold = $(
						'<ol class="' + namespace + 'control-nav ' + namespace + type + '"></ol>'
					);
			...
			touch: function () {
				...
				function onMSGestureChange( e ) {
					...
					( transX = -e.translationX ), ( transY = -e.translationY );
