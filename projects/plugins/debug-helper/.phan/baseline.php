...
return [
    ...
    'file_suppressions' => [
        ...
        'modules/class-autoloader-debug-helper.php' => ['PhanEmptyForeach', 'PhanNoopNew', 'PhanUndeclaredClassMethod', 'PhanUndeclaredConstantOfClass', 'PhanUndeclaredMethod', 'PhanUndeclaredTypeReturnType'],
        ...
        'modules/class-idc-simulator.php' => ['PhanNoopNew', 'PhanUndeclaredClassMethod'],
        ...
        'modules/class-protect-helper.php' => ['PhanNoopNew', 'PhanUndeclaredClassMethod', 'PhanUndeclaredClassStaticProperty', 'PhanUndeclaredProperty'],
        'modules/class-rest-api-tester.php' => ['PhanNoopNew'],
        'modules/class-scan-helper.php' => ['PhanNoopNew', 'PhanParamTooMany', 'PhanTypeConversionFromArray', 'PhanTypeMismatchReturnProbablyReal', 'PhanUndeclaredConstant'],
        'modules/class-sync-data-settings-tester.php' => ['PhanNoopNew', 'PhanTypePossiblyInvalidDimOffset', 'PhanUndeclaredClass'],
        'modules/class-waf-helper.php' => ['PhanNoopNew', 'PhanTypeMismatchReturnProbablyReal', 'PhanUndeclaredClassConstant', 'PhanUndeclaredClassMethod', 'PhanUndeclaredConstant'],
