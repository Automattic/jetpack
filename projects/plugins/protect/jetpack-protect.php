...
$add_action( 'jetpack_protect_cleanup_helper_scripts', array( 'Automattic\\Jetpack\\Protect\\Helper_Script_Manager', 'cleanup_expired_helper_scripts' ) );

// Register REST routes.
$add_action( 'rest_api_init', array( 'Automattic\\Jetpack\\Protect\\REST_Controller', 'register_rest_routes' ) );
