...
export const PricingTableFrame = ( {
	args,
	price,
	offPrice,
	currency,
	getScan,
	getScanButtonIsLoading,
	getProtectFreeButtonIsLoading,
	getProtectFree,
	registrationError,
} ) => {
	return (
...
const ConnectedPricingTable = ( { onScanAdd } ) => {
	...
	return (
		<PricingTableFrame
			...
			currency={ currency }
			getScan={ getScan }
			getScanButtonIsLoading={ getScanButtonIsLoading }
			getProtectFreeButtonIsLoading={ getProtectFreeButtonIsLoading }
			getProtectFree={ getProtectFree }
