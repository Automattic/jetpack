 ...
 * Threats List Hook
 *
 * @typedef {object} useScanHistoryThreatsList
 ...
 * ---
 * @returns {useScanHistoryThreatsList} useScanHistoryThreatsList hook.
 */
const useScanHistoryThreatsList = () => {
	const [ selected, setSelected ] = useState( 'all' );

	const { plugins, themes, core, files, database } = useScanHistory();
...
export default useScanHistoryThreatsList;
