...
function wpcom_public_coming_soon_replace_yoast_seo_notice() {
	...
	if (
		...
		if ( $is_wpcom_public_coming_soon_enabled ) {
			...
			$text = __(
				'Heads up! Search engines are currently discouraged from indexing your site. If you want search engines to show this site in their search results you have to launch your site. %1$sClick here%2$s to change your site\'s privacy settings.'
			);
		}
