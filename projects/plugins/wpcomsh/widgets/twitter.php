...
<?php
	...
	function fetch_twitter_user_stream( $account, $hidereplies, $show, $include_retweets ) {
		...
		$response = self::wpcom_json_api_request_as_blog( $url, 2, [ 'method' => 'GET', 'headers' => [ 'content-type' => 'application/json' ] ], null, 'wpcom' );
	...
	function form( $instance ) {
		...
		*/
		?>
		<p><em><?php printf( __( "Please switch to the 'Twitter Timeline' widget. This widget will be going away in the future and the new widget allows for more customization.", 'jetpack' ) ); ?></em></p>
