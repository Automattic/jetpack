...
class Jetpack_Posts_I_Like_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			...
			<input id="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'number' ) ); ?>" type="number" value="<?php echo esc_attr( (string) $number ); ?>" min="1" max="15" />
		</p>
