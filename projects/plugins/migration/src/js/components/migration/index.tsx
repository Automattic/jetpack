...
export const ToS = createInterpolateElement(
	__(
		'By clicking "Get started", you agree to our <tosLink>Terms of Service</tosLink> and to <shareDetailsLink>sync your site\'s data</shareDetailsLink> with WordPress.com.',
		'wpcom-migration'
	),
	{
