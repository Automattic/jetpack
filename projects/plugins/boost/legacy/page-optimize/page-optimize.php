...
define( 'JETPACK_BOOST_PAGE_OPTIMIZE_CRON_CACHE_CLEANUP_JOB', 'page_optimize_cron_cache_cleanup' );
...
add_action( JETPACK_BOOST_PAGE_OPTIMIZE_CRON_CACHE_CLEANUP_JOB, 'jetpack_boost_page_optimize_cache_cleanup' );
...
function jetpack_boost_page_optimize_deactivate() {
	...
	wp_clear_scheduled_hook( JETPACK_BOOST_PAGE_OPTIMIZE_CRON_CACHE_CLEANUP_JOB, [ $cache_folder ] );
}
...
function jetpack_boost_page_optimize_should_concat_js() {
	...
	return !! get_option( 'jetpack_boost_page_optimize-js', jetpack_boost_page_optimize_js_default() );
}
...
function jetpack_boost_page_optimize_should_concat_css() {
	...
	return !! get_option( 'jetpack_boost_page_optimize-css', jetpack_boost_page_optimize_css_default() );
}
...
function jetpack_boost_page_optimize_init() {
...
add_action( 'plugins_loaded', 'jetpack_boost_page_optimize_init', 15 );
