	...
	<ModuleSurfaceProvider value="row">
		<Stack direction="column" gap="xl" className={ styles.settings }>
			<Group
				...
				description={ __(
					'Add your most important pages for targeted optimizations, including Critical CSS.',
					'jetpack-boost'
				) }
				icon={ desktop }
				defaultOpen={ false }
			...
			<Group
				...
				description={ __( 'Tools to load and deliver images more efficiently.', 'jetpack-boost' ) }
				icon={ image }
			>
				<LcpModule />
				<ImageCdn />
