...
<div class="jb-container--narrow">
	{#if $modulesState.critical_css.available}
		<Module
			slug="critical_css"
	...
	{#if $modulesState.render_blocking_js.available}
		<Module
	...
	{#if $modulesState.lazy_images.available}
		<Module slug="lazy_images" isActive={$modulesState.lazy_images.active} on:toggle={moduleToggle}>
	...
	{#if $modulesState.minify_js.available}
		<Module slug="minify_js" isActive={$modulesState.minify_js.active} on:toggle={moduleToggle}>
	...
	{#if $modulesState.minify_css.available}
		<Module slug="minify_css" isActive={$modulesState.minify_css.active} on:toggle={moduleToggle}>
	...
	{#if $modulesState.image_cdn.available}
		<Module slug="image_cdn" isActive={$modulesState.image_cdn.active} on:toggle={moduleToggle}>
	...
	<div class="settings">
		{#if $modulesState.image_guide.available}
			<Module
				slug="image_guide"
