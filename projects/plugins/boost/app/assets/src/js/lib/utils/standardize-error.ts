 ...
 * @param {unknown} defaultMessage - A default message to throw if no sensible error can be found.
 * @return {Error} the data guaranteed to be an Error or subclass thereof.
 */
export function standardizeError( data: unknown, defaultMessage?: string ): Error {
