...
use Automattic\Jetpack_Boost\Modules\Page_Cache\Page_Cache_Diagnostic;
...
jetpack_boost_Register_readonly_option( 'page_cache_diagnostic', array( Page_Cache_Diagnostic::class, 'get_status' ) );
