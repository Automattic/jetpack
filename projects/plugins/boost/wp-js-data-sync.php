...
use Automattic\Jetpack_Boost\Modules\Optimizations\Page_Cache\Data_Sync_Actions\Check_Setup;
...
jetpack_boost_register_action( 'page_cache', 'check-setup', Schema::as_void(), new Check_Setup() );
