...
class Display_Critical_CSS_Test extends BaseTestCase {
	...
	public function test_display_critical_css_with_svg() {
		...
		$this->assertStringContainsString( "<svg xmlns='http://www.w3.org/2000/svg' width='10' height='10' fill='%2328303d'>", $output );
		$this->assertStringContainsString( "<polygon points='0,0 10,0 5,5' />", $output );
