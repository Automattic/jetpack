...
## [3.2.1] - 2024-03-28
### Added
- Cache: Ensure cache engine is setup every time Settings page loads. [#36339]
- Cache: Clear cache if Boost module settings are changed. [#36452]
- Cache: Show status in Site Health if cache setup is not working properly. [#36449]
...
- General: Updated package dependencies. [#36539]
