...
## [3.4.0] - 2024-06-10
### Added
- Boost: added cache rebuild functionality [#37151]
- Boost: remove the advanced-cache.php when the Cache module is disabled [#37643]
- Cache: Allow easy migration from WPSC to Boost Cache [#36818]
- Critical CSS: Add a friendly error if css gen library is broken/missing. [#37283]
...
- Remove the explicit Plugin Install dependency. [#37430]
...
- Hotfix: Remove post types with empty Critical CSS URLs [#37389]
...
[3.4.0]: https://github.com/Automattic/jetpack-boost-production/compare/3.3.0...3.4.0
