...
Jetpack Boost automatically defers non-essential CSS when its “Optimize CSS Loading” feature is enabled and Critical CSS has been generated. In the modern dashboard, enable manual Critical CSS and then click **Generate** to start generation.
