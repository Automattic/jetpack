...
test( 'keeps all eight history dimensions in the tooltip', () => {
	render( <HistoryTooltip period={ history.periods[ 0 ] } /> );
	for ( const value of [
		'90 / 100',
		'80 / 100',
		'0.01',
...
test( 'retries a history error', () => {
	render( <HistoryChartCard isError { ...callbacks } /> );
