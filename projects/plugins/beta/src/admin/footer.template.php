...
/**
 * Jetpack Beta wp-admin page footer.
 *
 * Mirrors the @automattic/jetpack-components JetpackFooter (tiny Jetpack logo +
 * "Jetpack" on the left, the "An Automattic Airline" byline on the right)
 * without pulling in the React component library.
 *
...
<footer class="jetpack-beta-footer" role="contentinfo" aria-label="<?php esc_attr_e( 'Jetpack', 'jetpack-beta' ); ?>">
	<span class="jetpack-beta-footer__logo">
		...
		<span class="jetpack-beta-footer__name">Jetpack</span>
	</span>
	<a class="jetpack-beta-footer__a8c" href="https://automattic.com/" rel="noopener noreferrer" target="_blank" aria-label="<?php esc_attr_e( 'An Automattic Airline', 'jetpack-beta' ); ?>">
		<svg class="jetpack-beta-footer__a8c-logo" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 935 38.2" height="8" aria-labelledby="jp-automattic-byline-logo-title">
			<desc id="jp-automattic-byline-logo-title"><?php esc_html_e( 'An Automattic Airline', 'jetpack-beta' ); ?></desc>
