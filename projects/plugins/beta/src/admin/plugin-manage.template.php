...
<div class="jetpack-beta-container" >
	...
	<?php
	if ( $plugin->is_mu_plugin() ) {
		$url = sprintf( 'https://github.com/Automattic/jetpack-beta/blob/%s/docs/mu-plugin-info.md', rawurlencode( str_ends_with( JPBETA_VERSION, '-alpha' ) ? 'HEAD' : 'v' . JPBETA_VERSION ) );
		?>
