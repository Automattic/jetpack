...
class Scheduled_Updates_Logs {
	...
	const PLUGIN_UPDATE_FAIL      = 'PLUGIN_UPDATE_FAIL';
	const PLUGIN_UPDATE_ROLLBACK  = 'PLUGIN_UPDATE_ROLLBACK';
	 ...
	 *
	 * @return array An array containing the logs, split by run.
