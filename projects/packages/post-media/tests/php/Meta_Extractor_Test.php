...
class Meta_Extractor_Test extends BaseTestCase {
	...
	/**
	 * Helper to create attachment posts, replacing self::factory()->attachment->create_object().
	 *
	 ...
	 */
	private function create_attachment( $file_name, $parent_post_id, $args = array() ) {
		$defaults = array(
	...
	public function test_mediaextractor_extract_empty_array() {
		...
		$extract = Meta_Extractor::extract( get_current_blog_id(), $post_id );
	...
	public function test_mediaextractor_extract_image_with_alttext() {
		...
		$extract = Meta_Extractor::extract( get_current_blog_id(), $post_id, Meta_Extractor::ALL, true );
	...
	public function test_mediaextractor_extract_images_from_content_return_empty_array() {
		...
		$image_struct = Meta_Extractor::extract_images_from_content( $content, array() );
	...
	public function test_mediaextractor_extract_images_from_content_with_alttext_return_correct_image_struct() {
		...
		$image_struct = Meta_Extractor::extract_images_from_content( $content, array(), true );
	...
	public function test_mediaextractor_get_images_from_html_empty() {
		...
		$image_list = Meta_Extractor::get_images_from_html( $content, array() );
	...
	public function test_mediaextractor_get_images_from_html_already_extracted() {
		$content          = '';
		$images_extracted = array( 'http://example.org/image.jpg' );

		$image_list = Meta_Extractor::get_images_from_html( $content, $images_extracted );
	...
	public function test_mediaextractor_get_images_from_html_duplicate_in_already_extracted() {
		$content          = 'http://example.org/image.jpg';
		$images_extracted = array( 'http://example.org/image.jpg' );
	...
	private function add_test_post() {
		...
		$attachment_id_1 = $this->create_attachment( $img_name, $post_id );
		...
		$attachment_id_2 = $this->create_attachment( $img_name, $post_id );
	...
	public function test_mediaextractor_extract_links() {
		...
		$result = Meta_Extractor::extract( get_current_blog_id(), $post_id, Meta_Extractor::LINKS );
	...
	public function test_extract_images() {
		...
		$result = Meta_Extractor::extract( get_current_blog_id(), $post_id, Meta_Extractor::IMAGES );
	...
	public function test_extract_images_with_alt_text() {
		...
		$result = Meta_Extractor::extract( get_current_blog_id(), $post_id, Meta_Extractor::IMAGES, true );
	...
	public function test_extract_mentions() {
		...
		$result = Meta_Extractor::extract( get_current_blog_id(), $post_id, Meta_Extractor::MENTIONS );
	...
	public function test_extract_shortcodes() {
		...
		$result = Meta_Extractor::extract( get_current_blog_id(), $post_id, Meta_Extractor::SHORTCODES );
	...
	public function test_extract_embeds() {
		...
		$result = Meta_Extractor::extract( get_current_blog_id(), $post_id, Meta_Extractor::EMBEDS );
...
EOT;
		...
		$result = Meta_Extractor::get_images_from_html( $html, $already_extracted_images );
	...
	public function test_mediaextractor_exclude_video_links() {
		...
		$result = Meta_Extractor::extract( get_current_blog_id(), $post_id, Meta_Extractor::ALL );
	...
	public function test_mediaextractor_alt_text() {
		...
		$result = Meta_Extractor::extract( get_current_blog_id(), $post_id, Meta_Extractor::ALL, true );
	...
	public function test_audio_shortcode() {
		...
		$result = Meta_Extractor::extract( get_current_blog_id(), $post_id );
