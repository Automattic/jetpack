 ...
 * function-bucket. You can also call Images::get_image() to cycle through all of the methods until
...
class Images {
	 ...
	 *
	 * @since jetpack-6.9.0
	 * @since jetpack-14.8 Updated to use Block_Delimiter for improved performance.
	 * @since jetpack-14.9 Updated to use Block_Scanner for improved performance.
	 *
	...
	public static function from_html( $html_or_id, $width = 200, $height = 200 ) {
		...
		foreach ( $image_tags as $image_tag ) {
			 ...
			 *
			 * This filter runs inside the Images class, which powers image selection
