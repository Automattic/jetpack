...
return [
    ...
    'file_suppressions' => [
        ...
        'tests/php/tests/unit/AutoloaderTest.php' => ['PhanTypeMismatchArgument', 'PhanTypeMismatchArgumentProbablyReal'],
        'tests/php/tests/unit/PHPAutoloaderTest.php' => ['PhanDeprecatedFunction', 'PhanTypeMismatchArgumentProbablyReal'],
