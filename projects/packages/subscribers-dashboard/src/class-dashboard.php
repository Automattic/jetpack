...
class Dashboard {
	...
	public function add_wp_admin_submenu() {
		...
		if ( ( new Host() )->is_wpcom_platform() ) {
			$page_suffix = add_submenu_page( 'users.php', __( 'Subscribers', 'jetpack-subscribers-dashboard' ), __( 'Subscribers', 'jetpack-subscribers-dashboard' ), 'manage_options', 'subscribers', array( $this, 'render' ), 3 );
		} else {
