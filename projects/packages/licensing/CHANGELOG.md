...
## [4.1.0] - 2026-09-15
### Added
- Serve the license activation illustrations from the package and add their base URL to the admin script data. [#52204]
...
[4.1.0]: https://github.com/Automattic/jetpack-licensing/compare/v4.0.0...v4.1.0
