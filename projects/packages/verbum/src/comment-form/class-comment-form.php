 ...
 *
 * Loads the Verbum comment user experience on WordPress.com and Jetpack sites.
 *
 * @package automattic/jetpack-verbum
 */

namespace Automattic\Jetpack\Verbum;

use Automattic\Jetpack\Assets;
use Automattic\Jetpack\Status\Host;
use Automattic\Jetpack\Verbum\Blocks\Editor;
use Automattic\Jetpack\Verbum\Blocks\Utils;
use WP_Error;

/**
 * Renders the Verbum comment form and handles the comments submitted through it.
 *
...
class Comment_Form {
	...
	public function enqueue_assets() {
		...
		$hovercard_i18n = array(
			'Edit your profile →'      => __( 'Edit your profile →', 'jetpack-verbum' ),
			'View profile →'           => __( 'View profile →', 'jetpack-verbum' ),
			'Contact'                  => __( 'Contact', 'jetpack-verbum' ),
			'Send money'               => __( 'Send money', 'jetpack-verbum' ),
			'Gravatar not found.'      => __( 'Gravatar not found.', 'jetpack-verbum' ),
			'This profile is private.' => __( 'This profile is private.', 'jetpack-verbum' ),
			'Too Many Requests.'       => __( 'Too Many Requests.', 'jetpack-verbum' ),
			'Internal Server Error.'   => __( 'Internal Server Error.', 'jetpack-verbum' ),
			'Sorry, we are unable to load this Gravatar profile.' => __( 'Sorry, we are unable to load this Gravatar profile.', 'jetpack-verbum' ),
		);
		...
		wp_add_inline_script(
			...
			'window.VerbumComments = ' . wp_json_encode(
				array(
					'Log in or provide your name and email to leave a reply.' => __( 'Log in or provide your name and email to leave a reply.', 'jetpack-verbum' ),
					'Log in or provide your name and email to leave a comment.' => __( 'Log in or provide your name and email to leave a comment.', 'jetpack-verbum' ),
					'Receive web and mobile notifications for posts on this site.' => __( 'Receive web and mobile notifications for posts on this site.', 'jetpack-verbum' ),
					'Name'                               => __( 'Name', 'jetpack-verbum' ),
					'Email (address never made public)'  => __( 'Email (address never made public)', 'jetpack-verbum' ),
					'Website (optional)'                 => __( 'Website (optional)', 'jetpack-verbum' ),
					'Leave a reply. (log in optional)'   => __( 'Leave a reply. (log in optional)', 'jetpack-verbum' ),
					'Leave a comment. (log in optional)' => __( 'Leave a comment. (log in optional)', 'jetpack-verbum' ),
					'Log in to leave a reply.'           => __( 'Log in to leave a reply.', 'jetpack-verbum' ),
					'Log in to leave a comment.'         => __( 'Log in to leave a comment.', 'jetpack-verbum' ),
					/* translators: %s is the name of the provider (WordPress, Facebook, Twitter) */
					'Logged in via %s'                   => __( 'Logged in via %s', 'jetpack-verbum' ),
					'Log out'                            => __( 'Log out', 'jetpack-verbum' ),
					'Your browser is blocking the cookies needed to log in and comment here. Allow cookies in your privacy settings, then reload the page.' => __( 'Your browser is blocking the cookies needed to log in and comment here. Allow cookies in your privacy settings, then reload the page.', 'jetpack-verbum' ),
					'Email'                              => __( 'Email', 'jetpack-verbum' ),
					'(Address never made public)'        => __( '(Address never made public)', 'jetpack-verbum'), // phpcs:ignore PEAR.Functions.FunctionCallSignature.SpaceBeforeCloseBracket
					'Instantly'                          => __( 'Instantly', 'jetpack-verbum' ),
					'Daily'                              => __( 'Daily', 'jetpack-verbum' ),
					'Reply'                              => __( 'Reply', 'jetpack-verbum' ),
					'Comment'                            => __( 'Comment', 'jetpack-verbum' ),
					'WordPress'                          => __( 'WordPress', 'jetpack-verbum' ),
					'Weekly'                             => __( 'Weekly', 'jetpack-verbum' ),
					'Notify me of new posts'             => __( 'Notify me of new posts', 'jetpack-verbum' ),
					'Email me new posts'                 => __( 'Email me new posts', 'jetpack-verbum' ),
					'Email me new comments'              => __( 'Email me new comments', 'jetpack-verbum' ),
					'Cancel'                             => __( 'Cancel', 'jetpack-verbum' ),
					'Write a comment...'                 => __( 'Write a comment...', 'jetpack-verbum' ),
					'Write a reply...'                   => __( 'Write a reply...', 'jetpack-verbum' ),
					'Website'                            => __( 'Website', 'jetpack-verbum' ),
					'Optional'                           => __( 'Optional', 'jetpack-verbum' ),
					/* translators: Success message of a modal when user subscribes */
					'We\'ll keep you in the loop!'       => __( 'We\'ll keep you in the loop!', 'jetpack-verbum' ),
					'Loading your comment...'            => __( 'Loading your comment...', 'jetpack-verbum' ),
					/* translators: %s is the name of the site */
					'Discover more from'                 => sprintf( __( 'Discover more from %s', 'jetpack-verbum' ), html_entity_decode( get_bloginfo( 'name' ), ENT_QUOTES ) ),
					'Subscribe now to keep reading and get access to the full archive.' => __( 'Subscribe now to keep reading and get access to the full archive.', 'jetpack-verbum' ),
					'Continue reading'                   => __( 'Continue reading', 'jetpack-verbum' ),
					'Never miss a beat!'                 => __( 'Never miss a beat!', 'jetpack-verbum' ),
					'Interested in getting blog post updates? Simply click the button below to stay in the loop!' => __( 'Interested in getting blog post updates? Simply click the button below to stay in the loop!', 'jetpack-verbum' ),
					'Enter your email address'           => __( 'Enter your email address', 'jetpack-verbum' ),
					'Subscribe'                          => __( 'Subscribe', 'jetpack-verbum' ),
					'Comment sent successfully'          => __( 'Comment sent successfully', 'jetpack-verbum' ),
					'Save my name, email, and website in this browser for the next time I comment.' => __( 'Save my name, email, and website in this browser for the next time I comment.', 'jetpack-verbum' ),
	...
	public function comment_form_defaults( $args ) {
		$title_reply_default = __( 'Leave a comment', 'jetpack-verbum' );
		...
		return array_merge(
			...
			array(
				...
				'title_reply_to'       => __( 'Leave a reply to %s', 'jetpack-verbum' ),
				'cancel_reply_link'    => __( 'Cancel reply', 'jetpack-verbum' ),
...
HTML;
	...
	public static function verify_facebook_identity() {
		...
		if ( empty( $data['access_token'] ) ) {
			return new WP_Error( 'facebook', __( 'Error: your Facebook login has expired.', 'jetpack-verbum' ) );
		}
	...
	public function check_comment_allowed( int $comment_id ) {
		...
		wp_die( esc_html__( 'Sorry, this comment could not be posted.', 'jetpack-verbum' ) );
	}
	...
	public function add_jetpack_script_data( $data ) {
		if ( Utils::should_show_verbum_comments() ) {
