 ...
 *
 * Returns the embed data for the embed block. The core API requires
 * authentication, so we need to create our own endpoint.
 *
...
namespace Automattic\Jetpack\Verbum\REST;

/**
 * Verbum Comments Experience Embeds endpoint.
 */
class OEmbed_Controller extends \WP_REST_Controller {
	/**
	 * Constructor.
	 */
