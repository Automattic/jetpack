				...
				<table className="dataviews-view-table">
					<thead>
						<tr className="dataviews-view-table__row">
							<th>{ __( 'Connection', 'jetpack-publicize-pkg' ) }</th>
							<th>{ __( 'Time', 'jetpack-publicize-pkg' ) }</th>
							<th>{ __( 'Status', 'jetpack-publicize-pkg' ) }</th>
							<th>{ __( 'Actions', 'jetpack-publicize-pkg' ) }</th>
						</tr>
					</thead>
					<tbody>
