	...
	return (
		<ThemeProvider targetDom={ document.body }>
			<Modal className={ styles.modal } onRequestClose={ onClose } __experimentalHideHeader>
				...
				/>
				<SelectControl
					label={ __( 'Image Type', 'jetpack-publicize-pkg' ) }
					...
					options={ [
						...
						{ label: __( 'Custom Image', 'jetpack-publicize-pkg' ), value: 'custom' },
						{ label: __( 'No Image', 'jetpack-publicize-pkg' ), value: 'none' },
					] }
				...
				{ localImageType === 'custom' && (
					<MediaPicker
						...
						subTitle={ __( 'Add a custom image', 'jetpack-publicize-pkg' ) }
				...
				<TextControl
					...
					label={ __( 'Custom Header', 'jetpack-publicize-pkg' ) }
					help={ __(
				...
				<BaseControl __nextHasNoMarginBottom={ true } className={ styles.templateControl }>
					<BaseControl.VisualLabel>
						{ __( 'Templates', 'jetpack-publicize-pkg' ) }
					</BaseControl.VisualLabel>
