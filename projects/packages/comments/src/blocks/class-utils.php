...
/**
 * Utils offer utility functions for sanitizing and parsing blocks.
 */
class Utils {
	/**
	 ...
	 * @return string
	 */
	public static function render_comment_blocks( $comment_content ) {
	...
	/**
	 * Check if we should show the comment experience.
	 *
	 * This is used to determine if the comment experience should be shown on the current page.
	 *
	 * @return bool
	 */
