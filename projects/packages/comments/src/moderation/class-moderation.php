<?php
/**
 * Moderation feature for comments.
 *
...
use Automattic\Jetpack\Comments\Blocks\Editor_Assets;

/**
 * Moderation is responsible for moderating comments in wp-admin.
 *
...
class Moderation {
	...
	/**
	 * Enqueue scripts for loading the comment editor
	 *
