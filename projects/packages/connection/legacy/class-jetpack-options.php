...
class Jetpack_Options {
	...
	public static function get_option_names( $type = 'compact' ) {
		...
		return array(
			...
			'protected_owner',                     // (array)  Anchor identifying the locked connection owner. WordPress.com is authoritative; this is a local cache. Keys: wpcom_user_id, local_user_id, confirmed_at.
