...
class Jetpack_Options {
	...
	public static function get_option_names( $type = 'compact' ) {
		...
		return array(
			...
			'is_welcome_tour_active',              // (bool) Determines if the onboarding tour has been dismissed. Welcome tour is used after onboarding flow that streamlines Jetpack and user connection.
