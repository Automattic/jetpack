...
class Jetpack_Options {
	...
	public static function get_option_names( $type = 'compact' ) {
		...
		return array(
			...
			'dismissed_welcome_tour',              // (bool) Determines if the onboarding tour has been dismissed. Welcome tour is used after onboarding flow that streamlines Jetpack and user connection.
