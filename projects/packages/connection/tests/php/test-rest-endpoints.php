...
class Test_REST_Endpoints extends TestCase {
	...
	public function test_remote_authorize() {
		...
		add_filter( 'pre_option_' . ( new Secrets() )->LEGACY_SECRETS_OPTION_NAME, $options_filter );
		...
		remove_filter( 'pre_option_' . ( new Secrets() )->LEGACY_SECRETS_OPTION_NAME, $options_filter );
	...
	public function bypass_raw_options( array $options ) {
		$options[ ( new Secrets() )->LEGACY_SECRETS_OPTION_NAME ] = true;
