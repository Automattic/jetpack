		...
		switch ( $type ) {
			...
			case 'private':
				return array(
					...
					'token_site_lock', // (string) Domain name the tokens are locked for.
					'token_site_lock_expires', // (string) Domain lock expiration date-time in `DateTimeInterface::ATOM` format (e.g. 2005-08-15T15:52:01+00:00)
				);
