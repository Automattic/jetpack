( function ( $ ) {
	let menuSelector, nonceInput, methods;
	...
	methods = {
		...
		submitRow: function () {
			let submittedRow, currentInputs, allInputs, partialFormData;
	...
	$.fn.clickAddRow = function () {
		const tbody = this.find( 'tbody:last' ),
			row = tbody.find( 'tr:first' ).clone();
