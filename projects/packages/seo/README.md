...
- **Settings** — a tab to configure search-engine indexing, the XML sitemap, the title structure for all page types (front page, posts, pages, tags, archives), the front-page description, and site verification codes.
