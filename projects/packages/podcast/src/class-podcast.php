...
class Podcast {
	...
	public static function init() {
		 ...
		 *
		 * Until this filter returns true, the package stays inert so the
		 * legacy podcasting experience (`Automattic_Podcasting` in the wpcom
		 * mu-plugin and the at-pressable-podcasting bridge) keeps running
		 * unchanged. Flipping it on hands the in-admin SPA, REST integration,
		 * and feed customization over to this package.
		 *
		 * @since 0.1.0
		 *
