...
class Config {
	...
	public const PASSWORD_DETECTION_ERROR_MESSAGE         = 'Password validation failed.';
	...
	public const PASSWORD_MANAGER_USER_META_KEY = 'jetpack_account_protection_recent_password_hashes';
