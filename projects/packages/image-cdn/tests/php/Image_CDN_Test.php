...
class Image_CDN_Test extends Image_CDN_Attachment_TestCase {
	...
	public function tear_down() {
		...
		\Automattic\Jetpack\Test_Environment::maybe_set_reflectionproperty_or_reflectionmethod_as_accessible( $instance );
	...
	public function test_image_cdn_validate_image_url_file_types( $url, $expected ) {
		...
		\Automattic\Jetpack\Test_Environment::maybe_set_reflectionproperty_or_reflectionmethod_as_accessible( $testable_validate_image_url );
