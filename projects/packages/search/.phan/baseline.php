...
return [
    ...
    'file_suppressions' => [
        ...
        'src/class-helper.php' => ['PhanDeprecatedPartiallySupportedCallable', 'PhanTypeMismatchArgument', 'PhanTypeMismatchDefault', 'PhanTypeMismatchReturn', 'PhanUndeclaredClassMethod', 'PhanUndeclaredClassReference', 'PhanUndeclaredFunction', 'PhanUndeclaredTypeParameter'],
        ...
        'src/class-rest-controller.php' => ['PhanTypeMismatchArgumentProbablyReal'],
        ...
        'src/widgets/class-search-widget.php' => ['PhanPossiblyUndeclaredVariable', 'PhanTypeMismatchArgument', 'PhanTypeMismatchReturn', 'PhanTypeSuspiciousEcho', 'PhanUndeclaredClassMethod', 'PhanUndeclaredTypeProperty'],
        'src/wpes/class-query-builder.php' => ['PhanTypeMismatchDimAssignment', 'PhanTypeMismatchReturnProbablyReal', 'PhanUndeclaredProperty'],
        ...
        'tests/php/test-helpers.php' => ['PhanRedefinedUsedTrait', 'PhanTypeMismatchArgument', 'PhanTypeMismatchProperty', 'PhanTypePossiblyInvalidDimOffset', 'PhanUndeclaredTypeProperty', 'PhanUnextractableAnnotation'],
