<?php
/**
 * WC Product Filters parent block render.
 *
 * Pure layout container: emits a wrapper around the inner blocks so the
 * WC product-filter children (stock-status, rating, price, attribute, taxonomy)
 * share one column / spacing context. All search-side behavior lives in the
...
?>
<div <?php echo wp_kses_data( get_block_wrapper_attributes( array( 'class' => 'jetpack-search-wc-product-filters' ) ) ); ?>>
	<?php
