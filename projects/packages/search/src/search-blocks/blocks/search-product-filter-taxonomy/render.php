...
$filter_key = Search_Product_Filter_Taxonomy::derive_filter_key( (array) $attributes );
if ( '' === $filter_key || ! function_exists( 'wp_interactivity_state' ) ) {
	return;
}

// @phan-suppress-next-line PhanUndeclaredGlobalVariable
$config = Search_Product_Filter_Taxonomy::build_config( (array) $attributes, $filter_key );
...
?>
<div
	<?php echo wp_kses_data( get_block_wrapper_attributes( array( 'class' => 'jetpack-search-product-filter-taxonomy' ) ) ); ?>
