...
**Editor preview (collapsed trigger):**

![Collapsible Filters trigger button in the editor — collapsed default state.](../.docs-assets/filters-popover-trigger.png)

**Editor preview (open panel):**

![Open Collapsible Filters panel in the editor showing Active Filters, Clear, Category, Tag, and Post Type.](../.docs-assets/filters-popover-open.png)

**Settings panel:**

![Collapsible Filters block settings panel.](../.docs-assets/editor-filters-popover-inspector.png)

**Front-end view (closed, with active-filter badge):**

![Collapsible Filters trigger on the front end with a badge showing one active filter.](../.docs-assets/fe-filters-popover-trigger.png)

**Front-end view (open):**

![Open Collapsible Filters panel on the front end with populated buckets and an active filter pill.](../.docs-assets/fe-filters-popover-open.png)
