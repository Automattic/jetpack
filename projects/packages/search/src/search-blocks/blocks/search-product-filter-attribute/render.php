...
$filter_key = Search_Product_Filter_Attribute::derive_filter_key( (array) $attributes );
...
// @phan-suppress-next-line PhanUndeclaredGlobalVariable
$config = Search_Product_Filter_Attribute::build_config( (array) $attributes, $filter_key );
...
?>
<div
	<?php echo wp_kses_data( get_block_wrapper_attributes( array( 'class' => 'jetpack-search-product-filter-attribute' ) ) ); ?>
