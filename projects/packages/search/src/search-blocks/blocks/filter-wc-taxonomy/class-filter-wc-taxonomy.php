<?php
/**
 * Search product filter — WooCommerce product taxonomy block helpers.
 *
...
/**
 * Helper methods for the jetpack-search/filter-wc-taxonomy block.
 *
