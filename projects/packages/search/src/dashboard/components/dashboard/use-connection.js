	...
	const renderConnectScreen = () => {
		return (
			<ConnectScreenRequiredPlan
				...
				title={ __( 'The best replacement for WordPress search', 'jetpack-search-pkg' ) }
				apiRoot={ APIRoot }
				apiNonce={ APINonce }
			...
			>
				...
				<ul>
					<li>{ __( 'Search as you type', 'jetpack-search-pkg' ) }</li>
					<li>{ __( 'Bla bla bla…', 'jetpack-search-pkg' ) }</li>
				</ul>
			</ConnectScreenRequiredPlan>
		);
	};
