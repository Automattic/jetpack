<?php
/**
 * Search_Product_Filter_Attribute helper tests.
 *
 ...
 */
class Search_Product_Filter_Attribute_Test extends TestCase {

	public function test_derive_filter_key_returns_pa_slug() {
		$this->assertSame(
			'pa_color',
			Search_Product_Filter_Attribute::derive_filter_key(
	...
	public function test_derive_filter_key_rejects_empty_slug() {
		$this->assertSame(
			'',
			Search_Product_Filter_Attribute::derive_filter_key( array( 'attributeTaxonomy' => '' ) )
		);
		$this->assertSame( '', Search_Product_Filter_Attribute::derive_filter_key( array() ) );
	}
	...
	public function test_build_config_shapes_filter_type_as_taxonomy() {
		...
		// is shared.
		$config = Search_Product_Filter_Attribute::build_config(
			array(
