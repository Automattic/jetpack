 ...
 */
class Brute_Force extends Product {
	 ...
	 * @var string
	 */
	public static $slug = 'brute-force';

	/**
	 * The slug of the plugin associated with this product.
	 * Brute Force is a feature available as part of Jetpack plugin.
	 *
	 * @var string
	 */
	...
	public static function get_long_description() {
		return __( 'Automatically clear spam from comments and forms. Save time, get more responses.', 'jetpack-my-jetpack' );
	}
	...
	public static function get_features() {
		return array(
			...
			__( 'Automated real-time malware scan', 'jetpack-my-jetpack' ),
		);
	}
