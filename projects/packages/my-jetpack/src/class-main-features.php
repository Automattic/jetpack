	...
	public static function get_feature_definitions() {
		return array(
			...
			'jetpack-forms' => array(
				...
				'description'      => __( 'Build contact, sign-up and multistep forms that just work, with nothing to set up.', 'jetpack-my-jetpack' ),
				'long_description' => __( 'Break long forms into steps with a progress bar, and get every response by email and in your dashboard, with no limit on responses. Add file uploads and visitors’ files go straight to WordPress.com, so harmful or oversized files never land on your server.', 'jetpack-my-jetpack' ),
				'icon'             => 'list-bullets',
				'product'          => 'jetpack-forms',
				'essential'        => true,
				'paid_highlights'  => array(
					__( 'Secure file uploads, stored on WordPress.com instead of your server', 'jetpack-my-jetpack' ),
					__( 'No one can fill your hosting storage or slow your site with large uploads', 'jetpack-my-jetpack' ),
					__( 'Up to 10 files per field, 20 MB each, with nothing to configure', 'jetpack-my-jetpack' ),
				),
				'delivery'         => array(
					'in_jetpack' => true,
					'free'       => true,
