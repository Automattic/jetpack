	...
	public static function get_feature_definitions() {
		return array(
			'activity-log'  => array(
				...
				'description'     => __( 'See a chronological list of every change made to your site, from published posts to plugin updates and logins. When something breaks, the log tells you what changed and when.', 'jetpack-my-jetpack' ),
				'icon'            => 'list',
			...
			'anti-spam'     => array(
				...
				'description'     => __( 'Automatically clear spam from comments and form responses before it reaches you. Every submission is checked against a network that has filtered spam for millions of sites.', 'jetpack-my-jetpack' ),
				'icon'            => 'comment',
				'product'         => 'anti-spam',
			...
			'backup'        => array(
				...
				'description'     => __( 'Save every change as it happens and restore your whole site in one click. Backups are stored off-site, so they survive whatever happens to your host.', 'jetpack-my-jetpack' ),
				'icon'            => 'backup',
				'product'         => 'backup',
			...
			'blaze'         => array(
				...
				'description' => __( 'Promote your posts and pages to readers across WordPress.com and Tumblr. Campaigns start small and run for as long as you choose, with no long-term commitment.', 'jetpack-my-jetpack' ),
				'icon'        => 'megaphone',
			...
			'boost'         => array(
				...
				'description'     => __( 'Make your site faster with one-click fixes for the things that slow pages down: render-blocking CSS, unused JavaScript and oversized images.', 'jetpack-my-jetpack' ),
				'icon'            => 'trending-up',
				'product'         => 'boost',
				'essential'       => true,
			...
			'crm'           => array(
				...
				'description'     => __( 'Track leads, manage contacts and keep every customer conversation in one place. Your data stays on your own site rather than in someone else’s cloud.', 'jetpack-my-jetpack' ),
				'icon'            => 'people',
				'product'         => 'crm',
			...
			'jetpack-ai'    => array(
				...
				'description'     => __( 'Write, edit and translate content with an AI assistant built into the editor. It can draft a post, change the tone of a paragraph or turn your notes into a table.', 'jetpack-my-jetpack' ),
				'icon'            => 'star',
				'product'         => 'jetpack-ai',
			...
			'jetpack-forms' => array(
				...
				'description' => __( 'Collect responses with forms that need no setup, no third-party account and no per-response fee. Every submission lands in your dashboard and your inbox.', 'jetpack-my-jetpack' ),
				'icon'        => 'list-bullets',
			...
			'newsletter'    => array(
				...
				'description'     => __( 'Send your posts to subscribers by email the moment you publish. Readers subscribe from your own site, and the list stays yours.', 'jetpack-my-jetpack' ),
				'icon'            => 'envelope',
				'product'         => 'newsletter',
				'paid_highlights' => array(
			...
			'podcast'       => array(
				...
				'description' => __( 'Publish and manage a podcast from your site, with a player your readers can use without leaving the page. Your feed stays yours to take elsewhere.', 'jetpack-my-jetpack' ),
				'icon'        => 'audio',
			...
			'protect'       => array(
				...
				'description'     => __( 'Guard your site against malware and brute-force login attacks. Your plugins and themes are checked against a database of known vulnerabilities, so you hear about one the moment it affects you.', 'jetpack-my-jetpack' ),
				'icon'            => 'shield',
				'product'         => 'protect',
				'essential'       => true,
			...
			'search'        => array(
				...
				'description'     => __( 'Help visitors find what they are looking for instantly, with results that narrow as they type. Replaces the default WordPress search, which struggles once a site grows.', 'jetpack-my-jetpack' ),
				'icon'            => 'search',
				'product'         => 'search',
			...
			'social'        => array(
				...
				'description'     => __( 'Share new posts to your social accounts the moment they publish. Write once, and let each network get its own version of the message.', 'jetpack-my-jetpack' ),
				'icon'            => 'share',
				'product'         => 'social',
			...
			'stats'         => array(
				...
				'description'     => __( 'See who visits your site, what they read and where they came from, in a dashboard that loads in seconds. Designed to be useful without tracking your readers around the web.', 'jetpack-my-jetpack' ),
				'icon'            => 'chart-bar',
				'product'         => 'stats',
				'essential'       => true,
			...
			'videopress'    => array(
				...
				'description'     => __( 'Host ad-free, high quality video on your site, in a player that never ends on somebody else’s recommendations. Upload straight from the editor.', 'jetpack-my-jetpack' ),
				'icon'            => 'video',
				'product'         => 'videopress',
