...
return make_phan_config(
	...
	array(
		...
		'exclude_file_list' => array(
			// Test-only stub for the optional jetpack-waf dependency. Parsing it would make
			// Waf_Runner look declared, rendering the PhanUndeclaredClassMethod suppressions
			// in class-protect.php unused.
			'tests/php/stubs/class-waf-runner.php',
		),
