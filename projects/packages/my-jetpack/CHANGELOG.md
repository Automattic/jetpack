...
## [5.40.5] - 2026-07-06
### Changed
- Connection error notice: consume the resolved actions from the Connection package instead of duplicating the action-resolution logic. [#50081]
- Update package dependencies. [#50097]
- Update package dependencies. [#50183]
- Update package dependencies. [#50212]

### Fixed
- My Jetpack: de-duplicate search results so a product no longer appears twice (e.g. Forms, VideoPress) [#50056]
