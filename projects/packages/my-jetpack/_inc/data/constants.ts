...
export const REST_API_SITE_UPDATE_WELCOME_TOUR_STATUS = `${ REST_API_NAMESPACE }/site/update-welcome-tour-status`;
...
export const QUERY_UPDATE_WELCOME_TOUR_STATUS_KEY = 'update welcome tour status';
