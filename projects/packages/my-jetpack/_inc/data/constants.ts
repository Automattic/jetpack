...
export const REST_API_DISMISS_FEATURES_BANNER = '/wpcom/v2/my-jetpack/site/features/banner/dismiss';
...
export const QUERY_DISMISS_FEATURES_BANNER_KEY = 'dismiss features banner';
