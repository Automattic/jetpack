...
export const REST_API_SITE_DISMISS_WELCOME_TOUR = `${ REST_API_NAMESPACE }/site/dismiss-welcome-tour`;
...
export const QUERY_DISMISS_WELCOME_TOUR_KEY = 'dismiss welcome tour';
