...
export const REST_API_ADMIN_MENU_CUSTOMIZATION = `${ REST_API_NAMESPACE }/site/admin-menu`;
...
export const QUERY_ADMIN_MENU_CUSTOMIZATION_KEY = 'admin menu customization';
export const QUERY_SAVE_ADMIN_MENU_CUSTOMIZATION_KEY = 'save admin menu customization';
