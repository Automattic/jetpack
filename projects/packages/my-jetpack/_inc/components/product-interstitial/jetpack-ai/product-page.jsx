		...
		<AdminPage showHeader={ false } showBackground={ false }>
			...
			>
				<Col className={ classnames( styles[ 'product-interstitial__section' ] ) }>
					<div className={ styles[ 'product-interstitial__header' ] }>
				...
				{ /* <Col className={ styles[ 'product-interstitial__section' ] }>
					<div
						className={ classnames(
							styles[ 'product-interstitial__section-body' ],
				...
				>
					<div className={ styles[ 'product-interstitial__hero-content' ] }>
						<h1 className={ styles[ 'product-interstitial__hero-title' ] }>{ description }</h1>
						<div className={ styles[ 'product-interstitial__hero-text' ] }>
				...
				<Col className={ styles[ 'product-interstitial__section' ] }>
					<div className={ styles[ 'product-interstitial__section-body' ] }>
						<h2>AI Features</h2>
						<p>Discover all the Jetpack features powered by AI</p>
