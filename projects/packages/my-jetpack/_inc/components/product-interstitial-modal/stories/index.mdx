...
When including the component in My Jetpack `<ProductInterstitialMyJetpack />` component, there is a wrapper component provided that uses product's slug to generate proper modal content and is redirecting users to the corresponding product page.
