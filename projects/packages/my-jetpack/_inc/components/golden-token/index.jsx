...
function GoldenToken( { redeemClick, hasGoldenToken } ) {
	...
	return (
		<div id="modal" className="modal animating1">
			<svg id="jetpack-logo" xmlns="http://www.w3.org/2000/svg" width="139" height="38" fill="none">
				<path
					fill="#fff"
					fillRule="evenodd"
			...
			<div className="content-wrap">
				<div className="content-wrap-text">
					<p className="hi-user">Hey, Jetpack Friend</p>
					<h2>{ __( 'Your exclusive Jetpack Experience awaits', 'jetpack-my-jetpack' ) }</h2>
					<p>
						{ __(
			...
			<div className="powers-wrap content-wrap">
				<div className="content-wrap-text">
					<h2>{ __( 'Super powers are ready!', 'jetpack-my-jetpack' ) }</h2>
					<p>
						{ __(
				...
				<div className="jetpack-products">
					<div>
						<svg
							width="24"
							height="24"
