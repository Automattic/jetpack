...
/**
 * Post Get Ability Class
 *
 * Handles retrieving a single post by ID or URL with support for site switching.
 * Includes comprehensive post data with optional comments.
 */
class PostGetAbility implements AbilityInterface {
	use AbilityTrait;
	...
	public function get_config(): array {
		return array(
			'label'               => 'Get Post',
			'description'         => 'Retrieve a single post by ID or URL from one of your wordpress.com website (wpcom_site). Includes comprehensive post data with optional comments.',
	...
	private function get_input_schema(): array {
		return array(
			...
			'properties' => array(
				'wpcom_site'       => array(
					'type'        => 'string',
					'description' => 'Site ID (numeric) or site URL to get post from. If not provided, uses the current site',
				),
				'post_id'          => array(
					'type'        => 'integer',
