...
/**
 * Site Posts Search Ability Class
 *
 * Handles searching for posts within the current site with various filters including
 * content search, categories, tags, post types, and pagination.
 * Does not support site switching (for single site operations).
 */
class SitePostsSearchAbility implements AbilityInterface {
	use AbilityTrait;
	...
	public function get_config(): array {
		return array(
			'label'               => 'Site Posts Search',
			'description'         => 'Search for posts within the current site with various filters including content search, categories, tags, post types, and pagination. Automatically excludes confidential posts.',
