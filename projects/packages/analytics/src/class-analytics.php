...
namespace Automattic\Jetpack\Analytics;
...
class Analytics {
	...
	public static function init() {
		...
		add_action( 'jetpack-analytics_init', array( static::class, 'register_sidebar_items' ) );
	}
	...
	public static function register_sidebar_items() {
		if ( ! function_exists( 'jpa_register_jetpack_analytics_menu_item' ) ) {
			return;
		}

		jpa_register_jetpack_analytics_menu_item(
			'dashboard',
			__( 'Dashboard', 'jetpack-analytics' ),
			'/'
		);
	}
}
