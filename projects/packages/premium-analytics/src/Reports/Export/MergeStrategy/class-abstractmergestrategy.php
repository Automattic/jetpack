...
abstract class AbstractMergeStrategy implements MergeStrategyInterface {
	 ...
	 */
	protected function create_empty_item( array $template_item, ?CSVReportControllerInterface $controller = null ): array {
		$empty = array();
	 ...
	 */
	protected function get_default_value_for_field( string $field_name, ?CSVReportControllerInterface $controller = null ) {
