...
import styles from './chart-artwork.module.scss';
	...
	return (
		<div className={ className }>
			...
			>
				...
				<path d={ LINE_PATH } className={ styles.line } vectorEffect="non-scaling-stroke" />
				<defs>
					<linearGradient
						id={ gradientId }
						x1="126.236"
					...
					>
						<stop className={ styles.stop } stopOpacity="0" />
						<stop className={ styles.stop } offset="1" stopOpacity="0.5" />
					</linearGradient>
				</defs>
			</svg>
		</div>
