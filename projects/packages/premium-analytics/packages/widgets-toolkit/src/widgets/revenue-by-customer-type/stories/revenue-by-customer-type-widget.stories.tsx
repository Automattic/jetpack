...
import { RevenueByCustomerTypeWidget } from '../revenue-by-customer-type-widget';
import type { Meta, StoryObj, Decorator } from '@storybook/react';

const meta: Meta< typeof RevenueByCustomerTypeWidget > = {
	title: 'Packages/Premium Analytics/Widgets Toolkit/Widgets/RevenueByCustomerType',
	...
	parameters: {
		docs: {
			description: {
				component:
					'Displays revenue comparison between new and returning customers using a bar chart. Shows data for all product types with comparison support.',
			},
		},
	},
	decorators: [
...
type Story = StoryObj< typeof RevenueByCustomerTypeWidget >;
