...
import { SalesByDeviceWidget } from '../sales-by-device-widget';
import type { Meta, StoryObj, Decorator } from '@storybook/react';

const meta: Meta< typeof SalesByDeviceWidget > = {
	title: 'Packages/Premium Analytics/Widgets Toolkit/Widgets/SalesByDevice',
	component: SalesByDeviceWidget,
	tags: [ 'autodocs' ],
	parameters: {
		docs: {
			description: {
				component:
					'Displays sales attribution data by device type (Desktop, Mobile, Tablet) using a bar chart with comparison support.',
			},
		},
	},
	decorators: [
...
type Story = StoryObj< typeof SalesByDeviceWidget >;
