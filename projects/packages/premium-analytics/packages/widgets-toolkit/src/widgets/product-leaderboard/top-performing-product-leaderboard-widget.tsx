	...
	const chartData = useMemo( () => {
		...
		return (
			data?.data?.map( ( product, index: number ) => {
				...
				// chart show a missing-data placeholder instead of a fabricated
				// +100% delta. A product present with 0 revenue keeps its known
				// comparison value while its unavailable delta renders separately.
