 ...
 */
import { SectionHeader, SectionTabPanel } from '@jetpack-premium-analytics/ui';
import clsx from 'clsx';
/**
 * Internal dependencies
 */
import styles from './detail-page-layout.module.scss';
import type { SectionHeaderProps, SectionTabPanelProps } from '@jetpack-premium-analytics/ui';
