 ...
 */
import { Sparkline, Text } from '@jetpack-premium-analytics/externals';
import { formatMetricValue } from '@jetpack-premium-analytics/formatters';
import { __, _n, sprintf } from '@wordpress/i18n';
/**
 * Internal dependencies
 */
import { AbbreviatedText } from '../abbreviated-value';
...
export function PeakDistribution( {
	...
	const exactViews = formatMetricValue( shownValue, 'number', { decimals: valueDecimals } );
	const formattedViews = formatMetricValue( shownValue, 'number', {
	...
	return (
		<div className={ styles.body }>
			<div className={ styles.headline }>
				...
				<Text variant="body-md" className={ styles.views }>
					<AbbreviatedText
						display={ describeViews( formattedViews ) }
						exact={ describeViews( exactViews ) }
					/>
				</Text>
			</div>
