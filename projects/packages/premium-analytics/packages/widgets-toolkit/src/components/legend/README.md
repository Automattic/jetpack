...
```tsx
const items = [
  { label: 'Mobile', value: 241950, displayValue: '$241.95K', color: '#3858E9', comparison: 200000 },
  { label: 'Desktop', value: 148130, displayValue: '$148.13K', color: '#66BDFF', comparison: 160000 },
];
...
<PieChart.Legend
  render={ ( chartItems ) => (
    <Legend chartItems={ chartItems } items={ legendData } />
  ) }
/>
```
