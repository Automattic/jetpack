		...
		chartData: [
			{
				label: 'Views',
				data: [
					{ date: new Date( '2026-07-27' ), value: 120 },
					{ date: new Date( '2026-07-28' ), value: 95 },
					{ date: new Date( '2026-07-29' ), value: 143 },
					{ date: new Date( '2026-07-30' ), value: 88 },
					{ date: new Date( '2026-07-31' ), value: 167 },
					{ date: new Date( '2026-08-01' ), value: 52 },
					{ date: new Date( '2026-08-02' ), value: 74 },
				],
			},
		],
		dataFormat: { type: 'number' },
