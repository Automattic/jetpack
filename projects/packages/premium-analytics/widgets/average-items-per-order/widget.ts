 ...
 * which is a *script module* (`wpScriptModuleExports`): this import is
 * externalized rather than bundled, so the styled date-picker graph never
 * enters the widget metadata build (which has no style plugins). See
