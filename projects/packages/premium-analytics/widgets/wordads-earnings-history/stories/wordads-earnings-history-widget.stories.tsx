...
const meta = {
	...
	parameters: {
		docs: {
			description: {
				component:
					'The "WordAds earnings" widget — WordAds earnings by period (amount, payment status), ported from the Jetpack Stats WordAds page. Ads served lives in the full report. A site with adjustment rows gets an "Adjustments" link with a count badge at the far end of the footer, into the Adjustments history tab of the report; the shared fixture has two, so the default story shows it.',
			},
		},
	},
