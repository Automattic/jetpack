...
- Post detail: Add the "Totals" column to the "All-time traffic" card, with centered month labels and labels that stay in view while a long history scrolls; picking a total reads the page over that year. [#52137]
...
- Post detail: Replace the daily "Traffic activity" heatmap with an "All-time traffic" table of monthly views, and picking a month applies it as the page's period. [#52118]
...
### Fixed
- All-time traffic: Read the clock in the site timezone when a cell opens the current month or year. [#52214]
