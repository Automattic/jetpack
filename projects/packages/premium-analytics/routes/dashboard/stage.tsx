...
// NOTE: the real watched module `woocommerce_analytics` is not registered as a
// Jetpack sync module yet, so this branch points ANALYTICS_SYNC_MODULE (and the
// backend milestone filter) at `posts` purely so the panel can show real sync
// progress. See the PR testing instructions.
export const stage = () => {
	...
	return (
		<div className="jetpack-premium-analytics-dashboard">
			...
			<div style={ { border: '1px solid #ccc', padding: 16, marginTop: 16 } }>
				<h2>site-sync / useSyncStatus (TEMP harness — watching `posts`)</h2>
				<ul>
