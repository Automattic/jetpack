...
class Helper_Script_Manager {
	...
	/**
	 * Installs a Jetpack Helper Script, and returns its filesystem path and access url.
	 *
	 * @access public
	 * @static
	 *
	 * @param string $script_body Jetpack Helper Script file contents.
	...
	public static function install_helper_script( $script_body ) {
		...
		// Refuse to install a Jetpack Helper Script that is too large.
		if ( strlen( $script_body ) > self::MAX_FILESIZE ) {
			return new \WP_Error( 'invalid_helper', 'Invalid Jetpack Helper Script size' );
		}

		// Replace '[wp_path]' in the Jetpack Helper Script with the WordPress installation location. Allows the Jetpack Helper Script to find WordPress.
		$script_body = str_replace( '[wp_path]', addslashes( ABSPATH ), $script_body );

		// Create a jetpack-temp directory for the Jetpack Helper Script.
		...
		return new \WP_Error( 'install_faied', 'Failed to install Jetpack Helper Script' );
	}
	 ...
	 * @static
	 *
	 * @param string $path Path to Jetpack Helper Script to delete.
	...
	/**
	 * Search for Jetpack Helper Scripts that are suspiciously old, and clean them out.
	 *
	 * @access public
	 * @static
	 */
	...
	/**
	 * Search for and delete all Jetpack Helper Scripts. Used during uninstallation.
	 *
	 * @access public
	 * @static
	 */
	...
	/**
	 * Search for and delete Jetpack Helper Scripts. If an $expiry_time is specified, only delete Jetpack Helper Scripts
	 ...
	 * @static
	 *
	 * @param string $dir Path to Jetpack Helper Script directory.
