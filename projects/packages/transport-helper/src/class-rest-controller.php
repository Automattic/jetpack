...
class REST_Controller {
	...
	public static function register_rest_routes() {
		// Install a Jetpack Helper Script to assist with fetching data.
		register_rest_route(
			'jetpack/v4',
			'/helper-script',
			array(
				'methods'             => WP_REST_Server::CREATABLE,
				'callback'            => __CLASS__ . '::install_jetpack_helper_script',
		...
		// Delete a Jetpack Helper Script.
		register_rest_route(
			'jetpack/v4',
			'/helper-script',
			array(
				'methods'             => WP_REST_Server::DELETABLE,
				'callback'            => __CLASS__ . '::delete_jetpack_helper_script',
				'permission_callback' => __CLASS__ . '::jetpack_helper_script_permissions_callback',
				'args'                => array(
					'path' => array(
	 ...
	 */
	public static function jetpack_helper_script_permissions_callback() {
	...
	/**
	 * Install the Jetpack Helper Script.
	 *
	 * @access public
	 * @static
	 *
	 ...
	 */
	public static function install_jetpack_helper_script( $request ) {
	 ...
	 */
	public static function delete_jetpack_helper_script( $request ) {
