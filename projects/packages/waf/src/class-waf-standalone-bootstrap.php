...
class Waf_Standalone_Bootstrap {
	...
	public function generate() {
		...
		$automatic_rules_enabled_option = get_option( Waf_Runner::AUTOMATIC_RULES_ENABLED_OPTION_NAME, false );
		$ip_lists_enabled_option        = get_option( Waf_Runner::IP_LISTS_ENABLED_OPTION_NAME, false );
		...
		$code = "<?php\n"
			...
			. sprintf( "define( 'JETPACK_WAF_AUTOMATIC_RULES_ENABLED', %s );\n", var_export( $automatic_rules_enabled_option, true ) )
			. sprintf( "define( 'JETPACK_WAF_IP_LISTS_ENABLED', %s );\n", var_export( $ip_lists_enabled_option, true ) )
