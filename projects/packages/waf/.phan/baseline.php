...
return [
    ...
    // PhanTypeArraySuspicious : 4 occurrences
    ...
    'file_suppressions' => [
        ...
        'src/class-waf-constants.php' => ['PhanUndeclaredConstant'],
        ...
        'src/class-waf-runtime.php' => ['PhanGenericConstructorTypes', 'PhanTypeArraySuspiciousNullable', 'PhanUndeclaredConstant', 'PhanUnextractableAnnotationElementName', 'PhanUnextractableAnnotationSuffix'],
        'src/class-waf-standalone-bootstrap.php' => ['PhanUndeclaredMethod'],
        'src/class-waf-transforms.php' => ['PhanTypeInvalidDimOffset'],
        ...
        'tests/php/unit/test-waf-runtime-targets.php' => ['PhanRedefinedUsedTrait', 'PhanTypeMismatchReturn', 'PhanUnextractableAnnotationElementName', 'PhanUnextractableAnnotationSuffix'],
        'tests/php/unit/test-waf-runtime.php' => ['PhanTypeMismatchArgument'],
