...
class Capabilities_Bridge {
	...
	/**
	 * Proxy `/sites/{id}/rewind` (v2, as_user) and project the response
	 * into the shape the React layer expects.
	 *
	...
	public static function get_capabilities() {
		...
		return rest_ensure_response(
			array(
				...
				'planSlug'      => isset( $body['plan_slug'] ) ? (string) $body['plan_slug'] : null,
			)
		);
	}
}
