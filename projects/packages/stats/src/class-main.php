...
class Main {
	...
	public static function should_track() {
		 ...
		 * protection configured, a site option, so only do it when there is a list to compare
		 * against. The filter is unset on almost every site, which makes this the common path.
		 *
