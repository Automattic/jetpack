...
class Integration_Serialization_Test extends TestCase {
	...
	public function test_serialization_to_string() {
		...
		$this->assertSame( wp_json_encode( $expect_with_fallback, JSON_UNESCAPED_SLASHES ), wp_json_encode( $with_fallback, JSON_UNESCAPED_SLASHES ) );
	}
	...
	public function test_serialization_assoc_nested() {
		...
		$this->assertSame( $expect_schema_to_be, $schema->schema() );
		$this->assertSame( wp_json_encode( $expect_schema_to_be, JSON_UNESCAPED_SLASHES ), wp_json_encode( $schema, JSON_UNESCAPED_SLASHES ) );
	}
	...
	public function test_serialization_array_fallbacks() {
		...
		$this->assertSame( wp_json_encode( $expect_array_value_fallback, JSON_UNESCAPED_SLASHES ), wp_json_encode( $array_value_fallback, JSON_UNESCAPED_SLASHES ) );
		...
		$this->assertSame( wp_json_encode( $expect_array_group_fallback, JSON_UNESCAPED_SLASHES ), wp_json_encode( $array_group_fallback, JSON_UNESCAPED_SLASHES ) );
