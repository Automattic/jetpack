...
return [
    ...
    'file_suppressions' => [
        ...
        'scripts/core-calls.php' => ['PhanTypeMismatchDeclaredParam', 'PhanUndeclaredClassCatch', 'PhanUndeclaredClassMethod', 'PhanUndeclaredTypeParameter'],
        'scripts/core-definitions.php' => ['PhanTypeMismatchDeclaredParam', 'PhanUndeclaredClassCatch', 'PhanUndeclaredClassMethod', 'PhanUndeclaredTypeParameter'],
        ...
        'src/api/class-plugin-downloader.php' => ['PhanUndeclaredProperty'],
        'src/class-declarations.php' => ['PhanUndeclaredClassMethod'],
