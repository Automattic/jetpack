...
if ( function_exists( 'add_action' ) ) {
	...
	add_action( 'plugins_loaded', array( Automattic\Jetpack\Assets\Shared_Extension_Utils_Assets::class, 'configure' ), 1 );
} else {
	global $wp_filter;
	...
	$wp_filter['plugins_loaded'][1][] = array(
		'accepted_args' => 0,
		'function'      => array( Automattic\Jetpack\Assets\Shared_Extension_Utils_Assets::class, 'configure' ),
	);
}
