...
abstract class Module {
	...
	public function get_next_chunk( $config, $status, $chunk_size ) {
		// phpcs:disable WordPress.DB.PreparedSQL.InterpolatedNotPrepared,Generic.WhiteSpace.ScopeIndent.Incorrect,WordPress.DB.DirectDatabaseQuery.DirectQuery,PEAR.Functions.FunctionCallSignature.Indent
		global $wpdb;
		return $wpdb->get_col(
"
...
"
		...
		// phpcs:enable WordPress.DB.PreparedSQL.InterpolatedNotPrepared,Generic.WhiteSpace.ScopeIndent.Incorrect,WordPress.DB.DirectDatabaseQuery.DirectQuery,PEAR.Functions.FunctionCallSignature.Indent
	}
	...
	public function get_last_item( $config ) {
		global $wpdb;
		// phpcs:disable WordPress.DB.PreparedSQL.InterpolatedNotPrepared,WordPress.DB.DirectDatabaseQuery.NoCaching,WordPress.DB.DirectDatabaseQuery.DirectQuery,Generic.WhiteSpace.ScopeIndent.Incorrect,PEAR.Functions.FunctionCallSignature.Indent
		return $wpdb->get_var(
"
SELECT {$this->id_field()}
FROM {$wpdb->{$this->table_name()}}
...
"
		...
		// phpcs:enable WordPress.DB.PreparedSQL.InterpolatedNotPrepared,WordPress.DB.DirectDatabaseQuery.NoCaching,WordPress.DB.DirectDatabaseQuery.DirectQuery,Generic.WhiteSpace.ScopeIndent.Incorrect,PEAR.Functions.FunctionCallSignature.Indent
	}
