...
## [0.12.0] - 2026-09-14
### Added
- Sidebar: Let a menu item declare what gates it and a stable key hosts can name it by, and add the `jetpack_admin_menu_visibility` filter so hosts can force an item visible or hidden. A hidden item's page stays reachable by URL. [#52102]
