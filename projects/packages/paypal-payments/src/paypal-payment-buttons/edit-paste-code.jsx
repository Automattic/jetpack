...
/**
 * PayPal Payment Buttons — paste-code block editor (V1).
 *
 * @package
 */
...
/**
 * The paste-code editor: the merchant builds a button on PayPal.com and pastes
 * the generated code here. Shown while the API-managed buttons flag is off.
 *
 ...
 */
export default function PasteCodeEdit( { attributes, setAttributes, isSelected } ) {
