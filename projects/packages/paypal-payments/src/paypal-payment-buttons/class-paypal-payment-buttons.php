...
class PayPal_Payment_Buttons {
	...
	/**
	 * PayPal wordmark SVG markup for inline button rendering.
	 *
	 * @return string SVG markup.
	 */
	private static function get_paypal_logo_svg() {
		return '<svg class="jetpack-paypal-button__logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 101 32" aria-hidden="true" focusable="false">'
