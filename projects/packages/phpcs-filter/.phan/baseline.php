...
return [
    ...
    'file_suppressions' => [
        ...
        'tests/php/PhpcsFilterTest.php' => ['PhanPossiblyUndeclaredVariable', 'PhanRedefinedUsedTrait'],
        'tests/php/StdinBootstrapTest.php' => ['PhanRedefinedUsedTrait', 'PhanTypeArraySuspiciousNullable', 'PhanUndeclaredClassMethod'],
    ],
