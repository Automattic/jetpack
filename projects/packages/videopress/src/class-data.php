...
class Data {
	...
	/**
	 * Gets whether auto-generated captions are disabled for the site.
	 *
	 * Captions are generated by default, so this opt-out option defaults to false.
	 *
	 * @return boolean If auto-generated captions should be skipped for new videos.
	 */
	public static function get_videopress_auto_generated_captions_disabled() {
		return boolval( get_option( 'videopress_auto_generated_captions_disabled', false ) );
	}
	...
	public static function get_videopress_settings() {
		...
		return array(
			...
			'videopress_auto_generated_captions_disabled' => self::get_videopress_auto_generated_captions_disabled(),
