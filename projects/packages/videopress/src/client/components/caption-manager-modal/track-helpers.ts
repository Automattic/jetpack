...
import type { trackKindOptionProps, VideoTextTrack } from '../../lib/video-tracks/types';

export const DEFAULT_KIND: trackKindOptionProps = 'subtitles';
export const LISTABLE_TRACK_KIND_OPTIONS: trackKindOptionProps[] = [ 'captions', 'subtitles' ];
...
export const getTrackLanguageKey = ( track: Pick< VideoTextTrack, 'kind' | 'srcLang' > ) =>
...
export const getCaptionTrackSourceKey = ( captionTrack: SavedCaptionTrack ) =>
...
export const isMatchingCaptionTrackLanguage = (
...
export const ACCEPTED_FILE_TYPES = getAcceptedFileTypes( SUPPORTED_CAPTION_FORMATS );
 ...
 */
export const isAcceptedTrackFile = ( file: File | null, supportedFormats: string[] ): boolean => {
	if ( ! file ) {
		return false;
	}
 ...
 */
export const isTrackReady = ( track: VideoTextTrack ) =>
 ...
 */
export const getTrackSourceLabel = ( track: VideoTextTrack ) => {
 ...
 */
export const getTrackStatusLabel = ( track: VideoTextTrack ) => {
...
export const getDefaultCueStartTime = ( currentTime: number ) =>
	formatSecondsAsTimestamp( currentTime );

export const getDefaultCueEndTime = ( currentTime: number ) =>
	formatSecondsAsTimestamp( currentTime + 2 );
