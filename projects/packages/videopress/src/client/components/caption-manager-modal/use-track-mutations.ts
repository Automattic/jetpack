	...
	const uploadAndReconcileTrack = useCallback(
		async ( {
			...
			const trackUpdatePayload = {
				...
				/*
				 * The user just authored or uploaded this track, so it's never
				 * auto-generated; drop a replaced auto track's ASR provenance instead
				 * of letting it carry over and make the new track read as generated.
				 */
				isAutoGenerated: false,
				source: trackToUpdate?.source === 'asr' ? undefined : trackToUpdate?.source,
			};
