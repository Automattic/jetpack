...
export type CustomizeOptionsProps = {
...
export type VideoPressApiIFrameObjectProps = {
	info: {
		guid: () => Promise< string >;
	...
	customize?: {
		set: ( options: CustomizeOptionsProps ) => void;
	};
};

export type VideoPressApiIFrameProps = (
	iframe: HTMLIFrameElement,
	callback: () => void
) => VideoPressApiIFrameObjectProps;

declare global {
	interface Window {
		VideoPressIframeApi: VideoPressApiIFrameProps;
	}
}
