		...
		<BlockControls group="block">
			<Dropdown
				...
				renderToggle={ ( { isOpen, onToggle } ) => (
					<ToolbarButton
						label={ __( 'Poster image', 'jetpack-videopress' ) }
						showTooltip
					...
					return (
						<>
							<NavigableMenu className="block-editor-media-replace-flow__media-upload-menu">
								<MediaUploadCheck>
									<MediaUpload
										title={ __( 'Select Poster Image', 'jetpack-videopress' ) }
										onSelect={ image => {
										...
										render={ ( { open } ) => (
											...
											>
												{ ! poster
													? __( 'Select Poster Image', 'jetpack-videopress' )
													: __(
												...
												<p id={ videoPosterDescription } hidden>
													{ poster
														? sprintf(
																...
																__( 'The current poster image url is %s', 'jetpack-videopress' ),
																poster
														  )
														: __(
								...
								{ !! poster && (
									<MenuItem
										...
										icon={ linkOff }
									>
										{ __( 'Remove and use default', 'jetpack-videopress' ) }
									</MenuItem>
								) }
							</NavigableMenu>
