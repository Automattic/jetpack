...
export type VideoNavTab = 'details' | 'analytics' | 'editor';

const TAB_VALUES: VideoNavTab[] = [ 'details', 'analytics', 'editor' ];
...
/**
 * The Details / Analytics / Editor sub-nav for a single video. Same visual
		...
		<Tabs.Root className="vp-video-nav" value={ activeTab } onValueChange={ onValueChange }>
			<div className="jp-admin-page-tabs jp-admin-page-tabs--minimal">
				<Tabs.List variant="minimal">
					...
					<Tabs.Tab value="analytics">{ __( 'Analytics', 'jetpack-videopress-pkg' ) }</Tabs.Tab>
