...
const Editor = ( {
	...
	// A broken WordPress.com connection is why saves and uploads fail here;
	// surface the reconnect notice at the top of the full-chrome screen. The
	// embedded bridge sits inside DashboardLayout, whose own surfaces carry
	// the notice already.
