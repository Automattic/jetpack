...
import StudioTimelineTransport from '../../../../client/components/chapters-editor/timeline/transport';
import StudioEditorZoomControl from '../../../../client/components/chapters-editor/timeline/zoom-control';
import StudioEditorCutChip from './cut-chip';
import type { ZoomLadder } from '../../../../client/components/chapters-editor/timeline/zoom-ladder';
		...
		<div className="vp-chapters-timeline__toolbar">
			...
			{ selectedCut && (
				<StudioEditorCutChip
					disabled={ locked }
					cut={ selectedCut }
					onRemove={ () => onRemoveCut( selectedCut.id ) }
				/>
			) }
