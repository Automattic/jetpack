...
import { parseTimecode } from '../preview/parse-timecode';
 ...
 */
export default function StudioEditorTimecodeBox( { valueMs, onSeek }: Props ): ReactElement {
	...
	return (
		<input
			className="vp-studio-timeline__timecode"
			type="text"
