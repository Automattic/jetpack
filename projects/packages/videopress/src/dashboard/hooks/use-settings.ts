...
type ApiSettings = {
	...
	videopress_auto_generated_captions_disabled: boolean;
...
export type Settings = {
	...
	videoPressAutoGeneratedCaptionsDisabled: boolean;
	siteIsPrivate: boolean;
	siteType: string;
};

export type SettingsPatch = Partial<
	Pick< Settings, 'videoPressVideosPrivateForSite' | 'videoPressAutoGeneratedCaptionsDisabled' >
>;
...
function fromApi( raw: ApiSettings ): Settings {
	return {
		...
		videoPressAutoGeneratedCaptionsDisabled: raw.videopress_auto_generated_captions_disabled,
	...
	return useMutation< void, Error, SettingsPatch, { previous?: Settings } >( {
		mutationFn: async patch => {
			const data: Partial<
				Pick<
					ApiSettings,
					'videopress_videos_private_for_site' | 'videopress_auto_generated_captions_disabled'
				>
			> = {};
			...
			if ( patch.videoPressAutoGeneratedCaptionsDisabled !== undefined ) {
				data.videopress_auto_generated_captions_disabled =
					patch.videoPressAutoGeneratedCaptionsDisabled;
			}
