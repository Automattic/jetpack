...
'
	...
	/**
	 * Test render_rating_icons generates correct SVG icons for stars.
	 */
	public function test_render_rating_icons_generates_star_icons() {
		// Use reflection to access the private static method
		$reflection = new \ReflectionClass( Contact_Form::class );
		$method     = $reflection->getMethod( 'render_rating_icons' );
		...
		$result = $method->invoke( null, $rating_data );

		// Should contain 5 SVG elements
		$this->assertSame( 5, substr_count( $result, '<svg' ) );

		// Should have 4 filled icons
		$this->assertSame( 4, substr_count( $result, 'is-filled' ) );

		// Should contain the star SVG path
		$this->assertStringContainsString( 'M12 17.27L18.18 21', $result );
	}

	/**
	 * Test render_rating_icons generates correct SVG icons for hearts.
	 */
	public function test_render_rating_icons_generates_heart_icons() {
		$reflection = new \ReflectionClass( Contact_Form::class );
		$method     = $reflection->getMethod( 'render_rating_icons' );
		$method->setAccessible( true );
		...
		// Should have 2 filled icons
		$this->assertSame( 2, substr_count( $result, 'is-filled' ) );

		// Should contain the heart SVG path
		$this->assertStringContainsString( 'M12 21.35l-1.45-1.32', $result );
	}

	/**
	 * Test render_rating_icons handles empty rating data.
	 */
	public function test_render_rating_icons_returns_empty_for_empty_data() {
		$reflection = new \ReflectionClass( Contact_Form::class );
		$method     = $reflection->getMethod( 'render_rating_icons' );
		$method->setAccessible( true );
	...
	/**
	 * Test render_rating_icons handles zero rating.
	 */
	public function test_render_rating_icons_handles_zero_rating() {
		$reflection = new \ReflectionClass( Contact_Form::class );
		$method     = $reflection->getMethod( 'render_rating_icons' );
		$method->setAccessible( true );
		...
		// Should have 0 filled icons
		$this->assertSame( 0, substr_count( $result, 'is-filled' ) );
	}

	/**
	 * Test render_rating_icons handles different max rating values.
	 */
	public function test_render_rating_icons_handles_different_max_rating() {
		$reflection = new \ReflectionClass( Contact_Form::class );
		$method     = $reflection->getMethod( 'render_rating_icons' );
		$method->setAccessible( true );
		...
		// Should contain 10 SVG elements
		$this->assertSame( 10, substr_count( $result, '<svg' ) );

		// Should have 7 filled icons
		$this->assertSame( 7, substr_count( $result, 'is-filled' ) );
	}

	/**
	 * Test render_rating_icons generates valid HTML with proper CSS classes.
	 */
	public function test_render_rating_icons_generates_valid_html() {
		$reflection = new \ReflectionClass( Contact_Form::class );
		$method     = $reflection->getMethod( 'render_rating_icons' );
		$method->setAccessible( true );
		...
		// Should contain proper CSS class
		$this->assertStringContainsString( 'class="field-rating__icon', $result );
