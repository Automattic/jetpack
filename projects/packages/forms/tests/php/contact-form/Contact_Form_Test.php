...
EOT;
	...
	public function test_validate_form_with_errors() {
		...
		$form = new Contact_Form(
			...
			"[contact-field label='Name' type='name' required='1'/][contact-field label='Email' type='email' required='1'/][contact-field label='Invite' type='email' /][contact-field label='Choose' type='checkbox-multiple' options='truth,dare' required='1'/][contact-field label='Choose Radio' type='radio' options='truth,dare' required='1'/][contact-field label='Choose Empty' type='radio' options='truth,dare' required='1'/][contact-field label='Pick' type='checkbox-multiple' options='truth,dare' required='1'/]"
		);
		$form->validate();
		unset( $_POST ); // Clean up the global $_POST variable after the test.
