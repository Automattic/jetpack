 ...
 *
 * Each slide names its own artwork, so an omission can't compile. What is still
 * worth pinning is that the pairing is the intended one — nothing structural
 * stops a slide being given the wrong image.
 */
