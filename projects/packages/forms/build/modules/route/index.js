	...
	'../../../node_modules/.pnpm/use-sync-external-store@1.6.0_react@18.3.1/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js'(
		...
		( function () {
			...
			function useSyncExternalStore$2( subscribe2, getSnapshot ) {
				didWarnOld18Alpha ||
					void 0 === React12.startTransition ||
			...
			var React12 = require_react(),
				...
				useState4 = React12.useState,
				useEffect4 = React12.useEffect,
				useLayoutEffect3 = React12.useLayoutEffect,
				useDebugValue = React12.useDebugValue,
			...
			exports.useSyncExternalStore =
				void 0 !== React12.useSyncExternalStore ? React12.useSyncExternalStore : shim;
			'undefined' !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ &&
	...
	'../../../node_modules/.pnpm/use-sync-external-store@1.6.0_react@18.3.1/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js'(
		...
		( function () {
			...
			'undefined' !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ &&
				'function' === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart &&
				__REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart( Error() );
			const React12 = require_react(),
				shim = require_shim(),
				objectIs = 'function' === typeof Object.is ? Object.is : is,
				useSyncExternalStore = shim.useSyncExternalStore,
				useRef7 = React12.useRef,
				useEffect4 = React12.useEffect,
				useMemo3 = React12.useMemo,
				useDebugValue = React12.useDebugValue;
			exports.useSyncExternalStoreWithSelector = function (
				...
				const value = useSyncExternalStore( subscribe2, instRef[ 0 ], instRef[ 1 ] );
				useEffect4(
					function () {
						inst.hasValue = true;
						inst.value = value;
	...
	for ( const derived of relatedVals ) {
		...
		if ( stores ) {
			for ( const store of stores ) {
				...
				if ( ! ( relatedLinkedDerivedVals == null ? void 0 : relatedLinkedDerivedVals.length ) )
					continue;
...
const Store = class {
	...
	setState( updater ) {
		...
		} else if ( isUpdaterFunction( updater ) ) {
...
function parseHref( href, state ) {
	...
	return {
		...
		search:
			searchIndex > -1 ? href.slice( searchIndex, hashIndex === -1 ? void 0 : hashIndex ) : '',
					...
					( next.optionals > prev.optionals ||
						( next.optionals === prev.optionals &&
							( next.node.isIndex > prev.node.isIndex ||
								( next.node.isIndex === prev.node.isIndex && next.depth > prev.depth ) ) ) ) ) ) )
	);
}
 ...
 * @param root0.path
 * @param root0.params
 * @param root0.decodeCharMap
 */
function interpolatePath( { path, params, decodeCharMap } ) {
	let isMissingParams = false;
	const usedParams = {};
	if ( ! path || path === '/' ) return { interpolatedPath: '/', usedParams, isMissingParams };
	if ( ! path.includes( '$' ) ) return { interpolatedPath: path, usedParams, isMissingParams };
	const length = path.length;
	let cursor = 0;
	let segment;
	let joined = '';
 ...
 * @param root0.shouldScrollRestoration
 * @param root0.scrollToTopSelectors
...
const setupPendingTimeout = ( inner, matchId, route, match ) => {
	...
	const shouldPending = !! (
		...
		pendingMs !== Infinity &&
		( route.options.pendingComponent ?? inner.router.options?.defaultPendingComponent )
	);
	if ( shouldPending ) {
	...
	if ( shouldSkipLoader( inner, matchId ) ) {
		...
		if ( prevMatch._nonReactive.loaderPromise ) {
			...
			const staleAge = preload
				? route.options.preloadStaleTime ?? inner.router.options.defaultPreloadStaleTime ?? 3e4
	...
	constructor( options ) {
			...
			const filter = d => {
				...
				const gcTime =
					( d.preload
						...
						: route.options.gcTime ?? this.options.defaultGcTime ) ?? 5 * 60 * 1e3;
		...
		this.preloadRoute = async opts => {
			...
			const activeMatchIds = new Set(
				[ ...this.state.matches, ...( this.state.pendingMatches ?? [] ) ].map( d => d.id )
			);
 ...
 * @param root0.routesById
 * @param root0.processedTree
 */
 ...
 * @param root0.search
 * @param root0.dest
 * @param root0.destRoutes
 * @param root0._includeValidateSearch
 */
...
function ClientOnly( { children, fallback = null } ) {
	return useHydrated()
		? /* @__PURE__ */ ( 0, import_jsx_runtime2.jsx )( import_react.default.Fragment, { children } )
		: /* @__PURE__ */ ( 0, import_jsx_runtime2.jsx )( import_react.default.Fragment, {
				children: fallback,
		  } );
}
/**
...
const routerContext = React2.createContext( null );
/**
 *
 */
...
const matchContext = React4.createContext( void 0 );
const dummyMatchContext = React4.createContext( void 0 );
...
function useMatch( opts ) {
	const nearestMatchId = React5.useContext( opts.from ? dummyMatchContext : matchContext );
...
const useLayoutEffect2 = typeof window !== 'undefined' ? React6.useLayoutEffect : React6.useEffect;
/**
 *
 * @param value
 */
 ...
 * @param ref
 * @param callback
 * @param intersectionObserverOptions2
 * @param options
 */
...
const React11 = __toESM( require_react(), 1 );
...
const React9 = __toESM( require_react(), 1 );
/**
 *
 */
...
const React10 = __toESM( require_react(), 1 );
...
function renderRouteNotFound( router, route, data ) {
	...
	return /* @__PURE__ */ ( 0, import_jsx_runtime7.jsx )( route.options.notFoundComponent, {
		...data,
	} );
}
...
function ScrollRestoration() {
	...
	const resolvedKey =
		userKey !== defaultGetScrollRestorationKey( router.latestLocation ) ? userKey : void 0;
	...
	return /* @__PURE__ */ ( 0, import_jsx_runtime9.jsx )( ScriptOnce, {
		children: `(${ restoreScroll.toString() })(${ JSON.stringify( restoreScrollOptions ) })`,
	} );
}

// ../../../node_modules/.pnpm/@tanstack+react-router@1.139.12_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@tanstack/react-router/dist/esm/Match.js
const Match = React10.memo( function MatchImpl( { matchId } ) {
	const router = useRouter();
	...
	const pendingElement = PendingComponent
		? /* @__PURE__ */ ( 0, import_jsx_runtime10.jsx )( PendingComponent, {} )
		: null;
	...
	return /* @__PURE__ */ ( 0, import_jsx_runtime10.jsxs )( ShellComponent, {
		children: [
			/* @__PURE__ */ ( 0, import_jsx_runtime10.jsx )( matchContext.Provider, {
				value: matchId,
						...
						children: /* @__PURE__ */ ( 0, import_jsx_runtime10.jsx )( ResolvedNotFoundBoundary, {
							...
							children:
								resolvedNoSsr || matchState._displayPending
									? /* @__PURE__ */ ( 0, import_jsx_runtime10.jsx )( ClientOnly, {
											fallback: pendingElement,
											children: /* @__PURE__ */ ( 0, import_jsx_runtime10.jsx )( MatchInner, {
												matchId,
											} ),
									  } )
...
function OnRendered() {
	const router = useRouter();
	const prevLocationRef = React10.useRef( void 0 );
...
var MatchInner = React10.memo( function MatchInnerImpl( { matchId } ) {
	const router = useRouter();
	...
	if ( match.status === 'error' ) {
		if ( router.isServer ) {
			...
			return /* @__PURE__ */ ( 0, import_jsx_runtime10.jsx )( RouteErrorComponent, {
				error: match.error,
				reset: void 0,
				info: {
					componentStack: '',
...
var Outlet = React10.memo( function OutletImpl() {
	...
	const pendingElement = router.options.defaultPendingComponent
		? /* @__PURE__ */ ( 0, import_jsx_runtime10.jsx )( router.options.defaultPendingComponent, {} )
		: null;
	...
	const nextMatch = /* @__PURE__ */ ( 0, import_jsx_runtime10.jsx )( Match, {
		matchId: childMatchId,
	} );
	if ( routeId === rootRouteId ) {
		return /* @__PURE__ */ ( 0, import_jsx_runtime10.jsx )( React10.Suspense, {
			fallback: pendingElement,
			children: nextMatch,
		} );
	}
...
function Matches() {
	...
	const pendingElement = PendingComponent
		? /* @__PURE__ */ ( 0, import_jsx_runtime11.jsx )( PendingComponent, {} )
		: null;
	const ResolvedSuspense =
		router.isServer || ( typeof document !== 'undefined' && router.ssr )
			? SafeFragment
			: React11.Suspense;
	const inner = /* @__PURE__ */ ( 0, import_jsx_runtime11.jsxs )( ResolvedSuspense, {
		fallback: pendingElement,
		children: [
	...
	return router.options.InnerWrap
		? /* @__PURE__ */ ( 0, import_jsx_runtime11.jsx )( router.options.InnerWrap, {
				children: inner,
		  } )
		: inner;
}
...
function RouterContextProvider( { router, children, ...rest } ) {
	...
	const provider = /* @__PURE__ */ ( 0, import_jsx_runtime12.jsx )( routerContext2.Provider, {
		value: router,
		children,
	} );
	if ( router.options.Wrap ) {
		return /* @__PURE__ */ ( 0, import_jsx_runtime12.jsx )( router.options.Wrap, {
			children: provider,
		} );
	}
	return provider;
...
export { Link, privateApis, redirect, useInvalidate, useNavigate, useParams, useSearch };
