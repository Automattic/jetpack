...
2. **`rasterize-icons`** — Converts each `icon.svg` to a 48x48 retina WebP (`field-*@2x.webp`) with transparent background, optimized for minimal file size.
...
pnpm rasterize-icons   # icon.svg → icon@2x.webp
```
