...
class Contact_Form_Field extends Contact_Form_Shortcode {
	...
	public function render() {
		...
		$field_required_indicator = $this->get_attribute( 'requiredindicator' );
	 ...
	 * @return string HTML
	 */
	public function render_label( $type, $id, $label, $required, $required_field_text, $extra_attrs = array(), $always_render = false, $required_indicator = 'text' ) {
		$form_style = $this->get_form_style();
	 ...
	 * @return string HTML
	 */
	public function render_legend_as_label( $type, $id, $legend, $required, $required_field_text, $extra_attrs = array(), $required_indicator = 'text' ) {
		if ( ! empty( $this->label_styles ) ) {
			$extra_attrs['style'] = $this->label_styles;
		}
		...
		return '<legend '
				...
				. ( $required && $required_indicator !== 'hidden' ? '<span class="grunion-label-required">' . $required_field_text . '</span>' : '' )
				. "</legend>\n";
	}
	 ...
	 * @return string HTML
	 */
	public function render_email_field( $id, $label, $value, $class, $required, $required_field_text, $placeholder, $required_indicator = 'text' ) {
	 ...
	 * @return string HTML
	 */
	public function render_telephone_field( $id, $label, $value, $class, $required, $required_field_text, $placeholder, $required_indicator = 'text' ) {
	 ...
	 * @return string HTML
	 */
	public function render_url_field( $id, $label, $value, $class, $required, $required_field_text, $placeholder, $required_indicator = 'text' ) {
	 ...
	 * @return string HTML
	 */
	public function render_textarea_field( $id, $label, $value, $class, $required, $required_field_text, $placeholder, $required_indicator = 'text' ) {
		if ( ! is_string( $value ) ) {
			$value = '';
		}
	 ...
	 * @return string HTML
	 */
	public function render_radio_field( $id, $label, $value, $class, $required, $required_field_text, $required_indicator = 'text' ) {
	 ...
	 * @return string HTML
	 */
	public function render_checkbox_field( $id, $label, $value, $class, $required, $required_field_text, $required_indicator = 'text' ) {
		...
		$field .= wp_kses_post( $label ) . ( $required && $required_indicator !== 'hidden' ? '<span class="grunion-label-required" aria-hidden="true">' . $required_field_text . '</span>' : '' );
		$field .= "</label>\n";
	 ...
	 */
	private function render_file_field( $id, $label, $class, $required, $required_field_text, $required_indicator = 'text' ) {
	 ...
	 * @return string HTML
	 */
	public function render_checkbox_multiple_field( $id, $label, $value, $class, $required, $required_field_text, $required_indicator = 'text' ) {
		$options_classes   = $this->get_attribute( 'optionsclasses' );
		$options_styles    = $this->get_attribute( 'optionsstyles' );
		$form_style        = $this->get_form_style();
		$is_outlined_style = 'outlined' === $form_style;
	 ...
	 * @return string HTML
	 */
	public function render_select_field( $id, $label, $value, $class, $required, $required_field_text, $required_indicator = 'text' ) {
	 ...
	 * @return string HTML
	 */
	public function render_date_field( $id, $label, $value, $class, $required, $required_field_text, $placeholder, $required_indicator = 'text' ) {
	 ...
	 * @return string HTML
	 */
	public function render_time_field( $id, $label, $value, $class, $required, $required_field_text, $placeholder, $required_indicator = 'text' ) {
	 ...
	 * @return string HTML
	 */
	public function render_image_select_field( $id, $label, $value, $class, $required, $required_field_text, $required_indicator = 'text' ) {
	 ...
	 * @return string HTML
	 */
	public function render_number_field( $id, $label, $value, $class, $required, $required_field_text, $placeholder, $extra_attrs = array(), $required_indicator = 'text' ) {
	 ...
	 * @return string HTML
	 */
	public function render_default_field( $id, $label, $value, $class, $required, $required_field_text, $placeholder, $type, $required_indicator = 'text' ) {
	 ...
	 * @return string HTML
	 */
	public function render_outline_label( $id, $label, $required, $required_field_text, $required_indicator = 'text' ) {
	 ...
	 * @return string HTML
	 */
	public function render_animated_label( $id, $label, $required, $required_field_text, $required_indicator = 'text' ) {
	 ...
	 * @return string HTML
	 */
	public function render_below_label( $id, $label, $required, $required_field_text, $required_indicator = 'text' ) {
		return '
			<label
				for="' . esc_attr( $id ) . '"
			...
			>'
			. esc_html( $label )
			. ( $required && $required_indicator !== 'hidden' ? '<span>' . $required_field_text . '</span>' : '' ) .
			'</label>';
	}
	 ...
	 * @return string HTML
	 */
	public function render_field( $type, $id, $label, $value, $class, $placeholder, $required, $required_field_text, $extra_attrs = array(), $required_indicator = 'text' ) {
	 ...
	 */
	public function render_slider_field( $id, $label, $value, $class, $required, $required_field_text, $placeholder, $extra_attrs = array(), $required_indicator = 'text' ) {
