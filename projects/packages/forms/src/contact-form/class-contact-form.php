...
class Contact_Form extends Contact_Form_Shortcode {
	...
	private static function get_field_type_icon( $field_type ) {
		$icons = array(
			// Text field - short text input icon
			'text'              => '<path d="M12 7H4V8.5H12V7ZM19.75 17.25V10.75H4.25V17.25H19.75ZM5.75 15.75V12.25H18.25V15.75H5.75Z" fill="currentColor"/>',
			// Textarea field - long text input icon
			'textarea'          => '<path d="M20 5H4V6.5H20V5ZM5.5 11.5H18.5V18.5H5.5V11.5ZM20 20V10H4V20H20Z" fill="currentColor"/>',
			// Name field - person icon
			'name'              => '<path d="M8.25 11.5C9.63071 11.5 10.75 10.3807 10.75 9C10.75 7.61929 9.63071 6.5 8.25 6.5C6.86929 6.5 5.75 7.61929 5.75 9C5.75 10.3807 6.86929 11.5 8.25 11.5ZM8.25 10C8.80228 10 9.25 9.55228 9.25 9C9.25 8.44772 8.80228 8 8.25 8C7.69772 8 7.25 8.44772 7.25 9C7.25 9.55228 7.69772 10 8.25 10ZM13 15.5V17.5H11.5V15.5C11.5 14.8096 10.9404 14.25 10.25 14.25H6.25C5.55964 14.25 5 14.8096 5 15.5V17.5H3.5V15.5C3.5 13.9812 4.73122 12.75 6.25 12.75H10.25C11.7688 12.75 13 13.9812 13 15.5ZM20.5 11H14.5V9.5H20.5V11ZM20.5 14.5H14.5V13H20.5V14.5Z" fill="currentColor"/>',
			// Email field - envelope icon
			'email'             => '<path d="M20 5.5H4C3.17157 5.5 2.5 6.17157 2.5 7V17C2.5 17.8284 3.17157 18.5 4 18.5H20C20.8284 18.5 21.5 17.8284 21.5 17V7C21.5 6.17157 20.8284 5.5 20 5.5ZM4 7H20V7.58579L12 12.8685L4 7.58579V7ZM4 17V9.41421L11.4472 14.2453C11.7823 14.4579 12.2177 14.4579 12.5528 14.2453L20 9.41421V17H4Z" fill="currentColor"/>',
			// Phone field - mobile phone icon
			'phone'             => '<path d="M15 4H9C7.89543 4 7 4.89543 7 6V18C7 19.1046 7.89543 20 9 20H15C16.1046 20 17 19.1046 17 18V6C17 4.89543 16.1046 4 15 4ZM15.5 18C15.5 18.2761 15.2761 18.5 15 18.5H9C8.72386 18.5 8.5 18.2761 8.5 18V6C8.5 5.72386 8.72386 5.5 9 5.5H15C15.2761 5.5 15.5 5.72386 15.5 6V18ZM13 17H11V15.5H13V17Z" fill="currentColor"/>',
			'telephone'         => '<path d="M15 4H9C7.89543 4 7 4.89543 7 6V18C7 19.1046 7.89543 20 9 20H15C16.1046 20 17 19.1046 17 18V6C17 4.89543 16.1046 4 15 4ZM15.5 18C15.5 18.2761 15.2761 18.5 15 18.5H9C8.72386 18.5 8.5 18.2761 8.5 18V6C8.5 5.72386 8.72386 5.5 9 5.5H15C15.2761 5.5 15.5 5.72386 15.5 6V18ZM13 17H11V15.5H13V17Z" fill="currentColor"/>',
			// URL field - globe icon
			'url'               => '<path d="M12 3.3c-4.8 0-8.8 3.9-8.8 8.8 0 4.8 3.9 8.8 8.8 8.8 4.8 0 8.8-3.9 8.8-8.8s-4-8.8-8.8-8.8zm6.5 5.5h-2.6c-.3-1.3-.7-2.4-1.3-3.4 1.7.6 3.1 1.8 3.9 3.4zM12 4.8c.9 1.1 1.6 2.4 2 3.7h-4c.4-1.3 1.1-2.6 2-3.7zM5 13.3c-.2-.6-.3-1.3-.3-2s.1-1.4.3-2h3c-.1.7-.1 1.3-.1 2s0 1.3.1 2H5zm.5 1.5h2.6c.3 1.3.7 2.4 1.3 3.4-1.7-.6-3.1-1.8-3.9-3.4zm2.6-6H5.5c.8-1.6 2.2-2.8 3.9-3.4-.6 1-1 2.1-1.3 3.4zM12 19.2c-.9-1.1-1.6-2.4-2-3.7h4c-.4 1.3-1.1 2.6-2 3.7zm2.4-5.2H9.6c-.1-.7-.2-1.3-.2-2s.1-1.4.2-2h4.8c.1.7.2 1.3.2 2s-.1 1.4-.2 2zm.4 5.1c.6-1 1-2.2 1.3-3.4h2.6c-.8 1.6-2.2 2.8-3.9 3.4zM16 13.3c.1-.7.1-1.3.1-2s0-1.3-.1-2h3c.2.6.3 1.3.3 2s-.1 1.4-.3 2h-3z" fill="currentColor"/>',
			// Date field - calendar icon
			'date'              => '<path fill-rule="evenodd" d="M4.5 7H19.5V19C19.5 19.2761 19.2761 19.5 19 19.5H5C4.72386 19.5 4.5 19.2761 4.5 19V7ZM3 5V7V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V7V5C21 3.89543 20.1046 3 19 3H5C3.89543 3 3 3.89543 3 5ZM11 9.25H7V13.25H11V9.25Z" fill="currentColor"/>',
			// Time field - clock icon
			'time'              => '<path fill-rule="evenodd" clip-rule="evenodd" d="M12 18.5C10.2761 18.5 8.62279 17.8152 7.40381 16.5962C6.18482 15.3772 5.5 13.7239 5.5 12C5.5 10.2761 6.18482 8.62279 7.40381 7.40381C8.62279 6.18482 10.2761 5.5 12 5.5C13.7239 5.5 15.3772 6.18482 16.5962 7.40381C17.8152 8.62279 18.5 10.2761 18.5 12C18.5 13.7239 17.8152 15.3772 16.5962 16.5962C15.3772 17.8152 13.7239 18.5 12 18.5ZM4 12C4 9.87827 4.84285 7.84344 6.34315 6.34315C7.84344 4.84285 9.87827 4 12 4C14.1217 4 16.1566 4.84285 17.6569 6.34315C19.1571 7.84344 20 9.87827 20 12C20 14.1217 19.1571 16.1566 17.6569 17.6569C16.1566 19.1571 14.1217 20 12 20C9.87827 20 7.84344 19.1571 6.34315 17.6569C4.84285 16.1566 4 14.1217 4 12ZM13 13V8H11.5V11.5H9.5V13H13Z" fill="currentColor"/>',
			// Number field - same as text field
			'number'            => '<path d="M12 7H4V8.5H12V7ZM19.75 17.25V10.75H4.25V17.25H19.75ZM5.75 15.75V12.25H18.25V15.75H5.75Z" fill="currentColor"/>',
			// Select/dropdown field - dropdown icon
			'select'            => '<path d="M5 4.5H19C19.2761 4.5 19.5 4.72386 19.5 5V19C19.5 19.2761 19.2761 19.5 19 19.5H5C4.72386 19.5 4.5 19.2761 4.5 19V5C4.5 4.72386 4.72386 4.5 5 4.5ZM19 3H5C3.89543 3 3 3.89543 3 5V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V5C21 3.89543 20.1046 3 19 3ZM8.93582 10.1396L8.06396 11.3602L11.9999 14.1716L15.9358 11.3602L15.064 10.1396L11.9999 12.3283L8.93582 10.1396Z" fill="currentColor"/>',
			// Radio field - single choice icon
			'radio'             => '<path d="M4 7.75C4 9.40685 5.34315 10.75 7 10.75C8.65685 10.75 10 9.40685 10 7.75C10 6.09315 8.65685 4.75 7 4.75C5.34315 4.75 4 6.09315 4 7.75ZM20 8.5H12V7H20V8.5ZM20 17H12V15.5H20V17ZM7 17.75C6.17157 17.75 5.5 17.0784 5.5 16.25C5.5 15.4216 6.17157 14.75 7 14.75C7.82843 14.75 8.5 15.4216 8.5 16.25C8.5 17.0784 7.82843 17.75 7 17.75ZM4 16.25C4 17.9069 5.34315 19.25 7 19.25C8.65685 19.25 10 17.9069 10 16.25C10 14.5931 8.65685 13.25 7 13.25C5.34315 13.25 4 14.5931 4 16.25Z" fill="currentColor"/>',
			// Checkbox field - checkbox icon
			'checkbox'          => '<path fill-rule="evenodd" d="M6.125 6H17.875C17.944 6 18 6.05596 18 6.125V17.875C18 17.944 17.944 18 17.875 18H6.125C6.05596 18 6 17.944 6 17.875V6.125C6 6.05596 6.05596 6 6.125 6ZM4.5 6.125C4.5 5.22754 5.22754 4.5 6.125 4.5H17.875C18.7725 4.5 19.5 5.22754 19.5 6.125V17.875C19.5 18.7725 18.7725 19.5 17.875 19.5H6.125C5.22754 19.5 4.5 18.7725 4.5 17.875V6.125ZM10.5171 16.4421L16.5897 8.71335L15.4103 7.78662L10.4828 14.0579L8.57616 11.7698L7.42383 12.7301L10.5171 16.4421Z" fill="currentColor"/>',
			// Checkbox multiple - multiple choice icon
			'checkbox-multiple' => '<path d="M7.0812 10.1419L10.6001 5.45005L9.40006 4.55005L6.91891 7.85824L5.53039 6.46972L4.46973 7.53038L7.0812 10.1419ZM12 8.5H20V7H12V8.5ZM12 17H20V15.5H12V17ZM8.5 14.5H5.5V17.5H8.5V14.5ZM5.5 13H8.5C9.32843 13 10 13.6716 10 14.5V17.5C10 18.3284 9.32843 19 8.5 19H5.5C4.67157 19 4 18.3284 4 17.5V14.5C4 13.6716 4.67157 13 5.5 13Z" fill="currentColor"/>',
			// File upload field - upload icon
			'file'              => '<path d="M18 11.2v-.1l-.6-.5-5-4.7-.5-.2H12h-.3l-.5.2-5 4.7-.6.5v.1c0 .1-.1.3-.1.4 0 .5.5 1 1 1h1.6v4.5c0 .8.7 1.5 1.5 1.5h4.9c.8 0 1.5-.7 1.5-1.5v-4.5h1.5c.5 0 1-.5 1-1 0-.1-.1-.3-.1-.4zm-6-3.2 3.5 3.2h-1.6c-.5 0-.9.4-.9 1v5h-2v-5c0-.6-.4-1-1-1H8.5L12 8z" fill="currentColor"/>',
			// Rating field - star icon
			'rating'            => '<path d="M11.776 4.454a.25.25 0 01.448 0l2.069 4.192a.25.25 0 00.188.137l4.626.672a.25.25 0 01.139.426l-3.348 3.263a.25.25 0 00-.072.222l.79 4.607a.25.25 0 01-.362.263l-4.138-2.175a.25.25 0 00-.232 0l-4.138 2.175a.25.25 0 01-.363-.263l.79-4.607a.25.25 0 00-.071-.222L4.754 9.881a.25.25 0 01.139-.426l4.626-.672a.25.25 0 00.188-.137l2.069-4.192z" fill="currentColor"/>',
			// Consent field - document with checkmark icon
			'consent'           => '<path d="M7 5.5H17C17.2761 5.5 17.5 5.72386 17.5 6V13H19V6C19 4.89543 18.1046 4 17 4H7C5.89543 4 5 4.89543 5 6V18C5 19.1046 5.89543 20 7 20H11.5V18.5H7C6.72386 18.5 6.5 18.2761 6.5 18V6C6.5 5.72386 6.72386 5.5 7 5.5ZM16 7.75H8V9.25H16V7.75ZM8 11H13V12.5H8V11Z" fill="currentColor"/><path d="M20.1087 15.9382L15.9826 21.6689L12.959 18.5194L14.0411 17.4806L15.8175 19.331L18.8914 15.0618L20.1087 15.9382Z" fill="currentColor"/>',
			// Image select field - image icon
			'image-select'      => '<path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM5 4.5h14c.3 0 .5.2.5.5v8.4l-3-2.9c-.3-.3-.8-.3-1 0L11.9 14 9 12c-.3-.2-.6-.2-.8 0l-3.6 2.6V5c-.1-.3.1-.5.4-.5zm14 15H5c-.3 0-.5-.2-.5-.5v-2.4l4.1-3 3 1.9c.3.2.7.2.9-.1L16 12l3.5 3.4V19c0 .3-.2.5-.5.5z" fill="currentColor"/>',
		);

		// Default icon for unknown types (same as text field)
		$default_icon = $icons['text'];
		$icon_path    = isset( $icons[ $field_type ] ) ? $icons[ $field_type ] : $default_icon;

		return '<svg class="field-type-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">' . $icon_path . '</svg>';
	}
