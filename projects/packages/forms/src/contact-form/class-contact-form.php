...
class Contact_Form extends Contact_Form_Shortcode {
	...
	public function process_submission() {
		...
		if ( $comment_author_ip ) {
			$comment_author_ip_with_flag = ( $response->get_country_flag() ? $response->get_country_flag() . ' ' : '' ) . $comment_author_ip;
			...
			$footer_ip                   = sprintf(
				...
				'<a href="' . esc_url( $ip_lookup_url ) . '">' . esc_html( $comment_author_ip_with_flag ) . '</a>'
			);
		}
		$footer_browser = null;
