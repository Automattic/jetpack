		...
		innerBlocks: [
			...
			[
				'jetpack/field-radio',
				{
					...
					innerBlocks: [
						[ 'jetpack/field-option-radio', { label: __( '1 - Very bad', 'jetpack-forms' ) } ],
						[ 'jetpack/field-option-radio', { label: __( '2 - Poor', 'jetpack-forms' ) } ],
						[ 'jetpack/field-option-radio', { label: __( '3 - Average', 'jetpack-forms' ) } ],
						[ 'jetpack/field-option-radio', { label: __( '4 - Good', 'jetpack-forms' ) } ],
						[ 'jetpack/field-option-radio', { label: __( '5 - Excellent', 'jetpack-forms' ) } ],
					],
				},
			],
