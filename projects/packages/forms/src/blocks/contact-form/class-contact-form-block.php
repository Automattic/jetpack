	...
	public static function register_child_blocks() {
		...
		Blocks::jetpack_register_block(
			...
			array(
				...
				'selectors'    => array(
					'border' => '.wp-block-jetpack-input, .is-style-outlined .notched-label > *, .is-style-outlined .grunion-radio-options, .is-style-outlined .grunion-checkbox-multiple-options',
				),
