...
class Dashboard {
	...
	public function add_admin_submenu() {
		...
		if ( apply_filters( 'jetpack_forms_alpha', true ) ) {
			...
			// It only exists once `build/build.php` is loaded. Without it the page has nothing to
			// render, so show an explanation rather than the legacy mount point, whose bundle
			// load_admin_scripts() does not enqueue on this screen.
