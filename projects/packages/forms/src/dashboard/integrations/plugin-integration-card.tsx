...
/**
 * Plugin integration card for dashboard
 *
 ...
 * @return Plugin integration card component
 */
const PluginDashboardIntegrationCard = ( {
	isExpanded,
	onToggle,
	data,
	refreshStatus,
...
export default PluginDashboardIntegrationCard;
