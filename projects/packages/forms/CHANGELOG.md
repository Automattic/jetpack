...
### Fixed
- Post to URL: Prevent a fatal TypeError when a form's legacy hiddenFields attribute is stored as a name => value map or JSON string instead of an array of objects. [#49539]
