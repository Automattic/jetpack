...
- Contact Form: revalidate fields on focus out [#34401]
- Contact Form: revalidate missing value as user types [#34518]

### Changed
- Contact Form: align checkbox and radio button baselines [#34429]
- Contact Form: refactored accessible-form.js [#34400]
- Updated package dependencies. [#34416]

### Fixed
- Contact Form: add margin below global error message [#34447]
- Contact Form: ensure warning icons are visible [#34455]
- Contact Form: fix checkbox field layout in editor [#34405]
- Contact Form: replace jQuery UI select by native element [#34441]
- Contact Form: specify version for accessible-form script [#34457]
- Fix potential undefined variable access in `Contact_Form_Plugin`. [#34500]
