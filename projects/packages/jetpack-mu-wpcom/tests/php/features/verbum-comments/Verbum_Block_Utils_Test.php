...
class Verbum_Block_Utils_Test extends \WorDBless\BaseTestCase {
	...
	public function test_comment_text_block_sanitization_sanity_check() {
		...
		/*
		 * The classes here come from core's block rendering, not from Verbum, and they move
		 * between WordPress releases. Update them when core changes rather than reading
		 * anything into them.
		 */
