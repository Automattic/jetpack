...
function wpcom_nosara_track_admin_page_views() {
	...
	<script type="text/javascript">
		var _admin_pv_props = {
			...
			source: 'wp-admin',
			blog_id: '<?php echo esc_js( $current_blog->blog_id ); ?>',
			user_type: '<?php echo esc_js( implode( ',', WPCOM_User::get_types() ) ); ?>'
		};
		_tkq = window._tkq || [];
...
add_action( 'admin_footer', 'wpcom_nosara_track_admin_page_views' );
...
add_action( 'customize_controls_print_footer_scripts', 'wpcom_maybe_track_customizer' );
