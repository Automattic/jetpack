...
class Global_Styles_Fonts_Message_Control extends \WP_Customize_Control {
	...
	private function render_intro_text() {
		$intro_text = __( 'You can change your fonts using Global Styles, which can be found in the Block Editor.', 'jetpack-mu-wpcom' );
		?>
			<p>
	...
	private function render_learn_more_link() {
		...
		$learn_more_link_text = __( 'Learn more about changing fonts using Global Styles.', 'jetpack-mu-wpcom' );
		?>
			<p>
				<a
	...
	private function maybe_render_block_editor_link() {
		...
		$block_editor_link_text = __( 'Click here to open the Block Editor and change your fonts.', 'jetpack-mu-wpcom' );
		?>
			<p>
				<a
