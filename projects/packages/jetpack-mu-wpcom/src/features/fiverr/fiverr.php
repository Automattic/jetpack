<?php
/**
 * Adds a fiverr promo cta to the general settings page
 *
...
function wpcom_fiverr_cta() {
	add_settings_field( 'wpcom_fiverr_cta', '', 'wpcom_fiverr_cta_display', 'general', 'default' );
}
add_action( 'admin_init', 'wpcom_fiverr_cta' );

/**
 * Display the fiverr cta on the general settings page.
 */
function wpcom_fiverr_cta_display() {
	?>
		...
		<td>
			...
			<p>
				...
				>
					...
					<span style="vertical-align: middle;">Try Fiverr Logo Maker</span>
				</a>
			</p>
		</td>
	<tr>
