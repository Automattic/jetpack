			...
			add_action(
				...
				function ( $wp_admin_bar ) {
					...
					$wp_admin_bar->add_menu(
						array(
							'id'     => 'agents-manager',
							'title'  => '<span title="' . __( 'Agents Manager', 'jetpack-mu-wpcom' ) . '"><svg id="agents-manager-icon" class="ab-icon" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
