...
class WP_Template {
	...
	public function get_page_template_content() {
		...
		return "<!-- wp:a8c/template {\"templateId\":$header_id,\"label\":\"" . __( 'Header', 'jetpack-mu-wpcom' ) . '","className":"fse-template-part fse-header"} /-->' .
				'<!-- wp:a8c/post-content /-->' .
				"<!-- wp:a8c/template {\"templateId\":$footer_id,\"label\":\"" . __( 'Footer', 'jetpack-mu-wpcom' ) . '","className":"fse-template-part fse-footer"} /-->';
	}
