...
class UserSubscriptionsExecutor implements ExecutorInterface {
	...
	private function get_billing_history( int $limit ): WP_Error|array {
		...
		$current_user_id = $this->get_current_user_id(); // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable
	...
	private function get_usage_data(): WP_Error|array {
		...
		if ( $user_sites ) {
			foreach ( $user_sites as $site ) { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable
	 ...
	 */
	private function get_placeholder_subscription_details( int $subscription_id ): array { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable
		$subscriptions = $this->get_placeholder_subscriptions();
