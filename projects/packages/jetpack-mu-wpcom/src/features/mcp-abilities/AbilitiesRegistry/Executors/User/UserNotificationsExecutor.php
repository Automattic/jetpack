...
class UserNotificationsExecutor implements ExecutorInterface {
	 ...
	 */
	private function list_notification_settings( array $input ): WP_Error|array { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable
	 ...
	 */
	private function get_other_notification_settings( int $user_id ): array { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable
		return array(
			'comment_like'  => true,
			'comment_reply' => true,
		);
	 ...
	 */
	private function get_wpcom_notification_settings( int $user_id ): array { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable
		return array(
			'marketing'  => true,
			'research'   => true,
			'community'  => true,
