...
class Wpcom_Block_Patterns_From_Api_Test extends TestCase {
	...
	public function test_patterns_request_succeeds_with_empty_cache() {
		...
		$wpcom_block_patterns_from_api = new Wpcom_Block_Patterns_From_Api( $utils_mock );
		...
		$this->assertEquals( array( 'a8c/' . $this->pattern_mock_object['name'] => true ), $wpcom_block_patterns_from_api->register_patterns() );
	}
