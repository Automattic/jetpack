...
## [2.3.1] - 2026-05-14
### Security
- If an artifact already contains a `.git` dir, skip it. This avoids certain attacks based on having malicious hooks or config in the artifact. [#48830]

## [2.3.0] - 2025-08-06
### Added
- Check that the commit we're mirroring is not an ancestor of the commit already there when updating an existing mirror branch. This avoids accidental reverts if Actions runs are misordered. [#43913]

### Fixed
- Add a workaround for [a git bug](https://lore.kernel.org/git/20250428192320.3595509-1-jonathantanmy@google.com/). [#44303]
...
[2.3.2]: https://github.com/Automattic/action-push-to-mirrors/compare/v2.3.1...v2.3.2
[2.3.1]: https://github.com/Automattic/action-push-to-mirrors/compare/v2.3.0...v2.3.1
[2.3.0]: https://github.com/Automattic/action-push-to-mirrors/compare/v2.2.2...v2.3.0
