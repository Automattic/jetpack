...
init_repo
assert_commits origin/trunk I H G F D3 C3 B3 E D2 C2 B2 D1 C1 B1 A

TAGS=( tagI )
test_begin "Tag I"
init_repo
assert_commits origin/trunk I

TAGS=( tagD1 tagD3 )
test_begin "Tags D1, D3"
init_repo
assert_commits origin/trunk I H G F D3 C3 B3 E D2 D1
...
init_repo
assert_commits origin/trunk I H G F D3 C3 B3 E D2 C2 B2 D1
...
init_repo
assert_commits origin/trunk I H G F D3 C3 B3 E D2 C2 B2 D1 C1 B1
...
TAGS=( tagA tagI )
test_begin "Tag I with old trunk"
if ( init_repo || true ); then
	testfail 'Expected `init_repo` to exit'
fi

TAGS=( tagD1 )
test_begin "Tag D1 with old trunk"
init_repo
assert_commits origin/trunk F D3 C3 B3 E D2 D1

TAGS=( tagE )
test_begin "Tag E with old trunk"
init_repo
assert_commits origin/trunk F D3 E

TAGS=( tagD3 )
test_begin "Tag D3 with old trunk"
init_repo
assert_commits origin/trunk F D3 E

TAGS=( tagB1 tagB2 tagB3 )
test_begin "Tags B1, B2, B3 with old trunk"
init_repo
assert_commits origin/trunk F D3 C3 B3 E D2 C2 B2 D1 C1 B1
