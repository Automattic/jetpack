...
const webpackConfig = {
	...
	entry: {
		...
		'modules-publicize-gutenberg': './modules/publicize/assets/gutenberg_client/publicize-gutenberg-plugin.jsx',
	},
	output: {
		...
		rules: [
			{
				...
				include: [
					...
					path.join( __dirname, 'modules/publicize/assets/gutenberg_client' ),
				]
			},
			{
				test: /\.json$/,
