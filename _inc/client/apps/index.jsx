...
const Apps = ( props ) => {
	...
	const trackManagePluginsClick = () => {
		analytics.tracks.recordJetpackClick( {
			page: 'apps',
			target: 'manage_plugins'
		} );
	};

	const trackTryEditorClick = () => {
		analytics.tracks.recordJetpackClick( {
			page: 'apps',
			target: 'try_editor'
		} );
	...
	const trackLaunchReaderClick = () => {
		analytics.tracks.recordJetpackClick( {
			page: 'apps',
			target: 'launch_reader'
		} );
	};

	const trackIosAppClick = () => {
		analytics.tracks.recordJetpackClick( {
			page: 'apps',
			target: 'ios_app'
		} );
	...
	const trackLinuxClick = () => {
		analytics.tracks.recordJetpackClick( {
			page: 'apps',
			target: 'download_linux'
		} );
	};
	...
	return (
...

				{
					...
					?	<div className="jp-landing-apps__feature">
							...
							<div className="jp-landing-apps__feature-col jp-landing-apps__feature-desc">
								...
								<Button
									href={ 'https://wordpress.com/plugins/' + props.siteRawUrl }
									className="is-primary"
									onClick={ trackManagePluginsClick }
								>
									{ __( 'Manage Plugins' ) }
								</Button>
							</div>
...

				{
					...
					?	<div className="jp-landing-apps__feature">
							<div className="jp-landing-apps__feature-col jp-landing-apps__feature-desc">
								...
								<Button
									href={ 'https://wordpress.com/post/' + props.siteRawUrl }
									className="is-primary"
									onClick={ trackTryEditorClick }
								>
					...
					canViewStats ? (
						<div className="jp-landing-apps__feature">
							...
							<div className="jp-landing-apps__feature-col jp-landing-apps__feature-desc">
								...
								<Button
									href={ 'https://wordpress.com/stats/' + props.siteRawUrl }
									className="is-primary"
									onClick={ trackViewStatsClick }
								>
									{ __( 'View Your Stats' ) }
								</Button>
							</div>
				...
				<div className="jp-landing-apps__feature">
					...
					<div className="jp-landing-apps__feature-col jp-landing-apps__feature-desc">
						...
						<Button
							...
							className="is-primary"
							onClick={ trackLaunchReaderClick }
						>
							{ __( 'Launch Reader' ) }
						</Button>
					</div>
			...
			<div className="jp-landing-apps__footer">
				...
				<div className="jp-landing-apps__downloads">
					...
					<p className="jp-landing-apps__btn-container">
						<Button
							href="http://itunes.apple.com/us/app/wordpress/id335703880?mt=8"
							title={ __( 'WordPress.com in the App Store' ) }
							className="jp-app-button button-ios"
							onClick={ trackIosAppClick }
						>
		...
		c0,0.5,0,1,0.1,1.4C52.5,28.3,56.5,26.1,59.8,22.2z"></path></svg>
							iOS</Button>
						<Button
							href="http://play.google.com/store/apps/details?id=org.wordpress.android"
							title={ __( 'WordPress.com in Google Play' ) }
							className="jp-app-button button-android"
							onClick={ trackAndroidAppClick }
						>
		...
		C75,35.7,73.1,34.1,71,34.1z"></path></svg>
					...
					<p className="jp-landing-apps__btn-container">
						<Button
							href="https://apps.wordpress.com/d/osx"
							title={ __( 'WordPress.com for Mac OS X' ) }
							className="jp-app-button button-macosx"
							onClick={ trackOsxClick }
						>
		...
		L31.31,33.849z"></path></svg>
							Mac OS X</Button>
						<Button
							href="https://apps.wordpress.com/d/windows"
							title={ __( 'WordPress.com for Windows' ) }
							className="jp-app-button button-windows"
		...
		V24h18V7.5L22,10.031z"></path></svg>
							Windows</Button>
						<Button
							href="https://apps.wordpress.com/d/linux"
							title={ __( 'WordPress.com for Linux' ) }
							className="jp-app-button button-linux"
							onClick={ trackLinuxClick }
						>
