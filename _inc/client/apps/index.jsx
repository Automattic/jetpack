	...
	return (
				...
				<div className="jp-landing-apps__downloads">
					...
					<p className="jp-landing-apps__btn-container">
						<Button href="http://itunes.apple.com/us/app/wordpress/id335703880?mt=8" title={ __( 'WordPress.com in the App Store' ) } className="jp-app-button button-ios">
							<svg width="28" height="28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96"><title>Download the free WordPress app for your iPhone</title><path d="M74.7,62.2c-3.5-3.2-5.2-7.2-5.3-12.1c-0.1-6.2,2.8-11.1,8.5-14.5c-3.2-4.5-8-7.1-14.4-7.6c-2.4-0.2-5.2,0.3-8.7,1.5
		...
		c0,0.5,0,1,0.1,1.4C52.5,28.3,56.5,26.1,59.8,22.2z"></path></svg>
						...
						<Button href="http://play.google.com/store/apps/details?id=org.wordpress.android" title={ __( 'WordPress.com in Google Play' ) } className="jp-app-button button-android">
							<svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96"><title>Download the free WordPress app for your Android based phone</title><path d="M25,34.1c-2.1,0-4,1.7-4,3.7v16.6c0,2,1.9,3.7,4,3.7c2.1,0,4-1.7,4-3.7V37.8C29,35.7,27.1,34.1,25,34.1z M31,35v29.5
		...
		C75,35.7,73.1,34.1,71,34.1z"></path></svg>
					...
					<p className="jp-landing-apps__btn-container">
						<Button href="https://apps.wordpress.com/d/osx" title={ __( 'WordPress.com for Mac OS X' ) } className="jp-app-button button-macosx">
							<svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><title>Download the free WordPress app for your apple computer</title><path d="M24,8C15.163,8,8,15.163,8,24s7.163,16,16,16s16-7.163,16-16S32.837,8,24,8z M31.31,33.849h-0.986
		...
		L31.31,33.849z"></path></svg>
						...
						<Button href="https://apps.wordpress.com/d/windows" title={ __( 'WordPress.com for Windows' ) } className="jp-app-button button-windows">
							<svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><title>Download the free WordPress app for your PC</title><path d="M8,35.5l13,2.031V25H8V35.5z M8,24h13V10.172L8,12V24z M22,37.688L40,40.5V25H22V37.688z M22,10.031
