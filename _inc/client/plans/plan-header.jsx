				...
				planCard = (
					<div className="jp-landing__plan-card">
						...
						<div className="jp-landing__plan-card-current">
							...
							<p className="jp-landing__plan-features-text">{ __( 'With this plan you are provided with spam-protection, daily backups (up to 30 days), unlimited backup storage, security scanning, and priority support.' ) }</p>
						</div>
					</div>
				);
				break;
				...
				planCard = (
					<div className="jp-landing__plan-card">
						...
						<div className="jp-landing__plan-card-current">
							...
							<p className="jp-landing__plan-features-text">{ __( 'You get spam-protection, real-time backups (unlimited archive), unlimited backup storage, security scanning, SEO tools, PollDaddy, and priority support.' ) }</p>
						</div>
					</div>
				);
				break;
