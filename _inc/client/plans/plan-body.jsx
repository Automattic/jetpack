...
const PlanBody = React.createClass( {
	...
	render() {
		let planCard;
		const planFeatures = [];
		const siteHasAkismet = this.props.isPluginInstalled( 'akismet/akismet.php' ) && this.props.isPluginActive( 'akismet/akismet.php' );
		const siteHasVaultPress = this.props.isPluginInstalled( 'vaultpress/vaultpress.php' ) && this.props.isPluginActive( 'vaultpress/vaultpress.php' );
		switch ( this.props.plan ) {
			...
			case 'jetpack_business_monthly':
				planFeatures.push(
					<div className="jp-landing__plan-features-card" key="antispam">
						...
						{ ( ! this.props.isFetchingPluginsData && siteHasAkismet )
							? (
				...
				if ( includes( [ 'jetpack_personal', 'jetpack_personal_monthly' ], this.props.plan ) ) {
					planFeatures.push(
						<div className="jp-landing__plan-features-card" key="backups">
							...
							{ ( ! this.props.isFetchingPluginsData && siteHasVaultPress )
								? (
				...
				if ( includes( [ 'jetpack_premium', 'jetpack_premium_monthly' ], this.props.plan ) ) {
					planFeatures.push(
						<div className="jp-landing__plan-features-card" key="backups">
				...
				if ( includes( [ 'jetpack_business', 'jetpack_business_monthly' ], this.props.plan ) ) {
					planFeatures.push(
						<div className="jp-landing__plan-features-card" key="backups">
							<h3 className="jp-landing__plan-features-title">{ __( 'Backups & Security Scanning' ) }</h3>
				...
				if ( includes( [ 'jetpack_premium', 'jetpack_premium_monthly', 'jetpack_business', 'jetpack_business_monthly' ], this.props.plan ) ) {
					planFeatures.push(
						<div className="jp-landing__plan-features-card" key="ads">
				...
				if ( includes( [ 'jetpack_premium', 'jetpack_premium_monthly' ], this.props.plan ) ) {
					planFeatures.push(
						<div className="jp-landing__plan-features-card" key="video">
				...
				if ( includes( [ 'jetpack_business', 'jetpack_business_monthly' ], this.props.plan ) ) {
					planFeatures.push(
						<div className="jp-landing__plan-features-card" key="seo">
							...
							{ ! this.props.isFetchingPluginsData && this.props.isModuleActivated( 'seo-tools' )
								? (
				...
				if ( includes( [ 'jetpack_business', 'jetpack_business_monthly' ], this.props.plan ) ) {
					planFeatures.push(
						<div className="jp-landing__plan-features-card" key="ga">
				...
				if ( includes( [ 'jetpack_personal', 'jetpack_personal_monthly' ], this.props.plan ) ) {
					planFeatures.push(
						<div className="jp-landing__plan-features-card" key="upsell">
