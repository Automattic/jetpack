...
export const CustomContentTypes = React.createClass( {
	contentTypeConfigure( type, legend ) {
		const disabledOrHref = this.props.getSettingCurrentValue( 'jetpack_' + type, 'custom-content-types' )
...
export default moduleSettingsForm( CustomContentTypes );
