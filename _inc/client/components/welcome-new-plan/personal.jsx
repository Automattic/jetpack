...
class WelcomePersonal extends Component {
	renderInnerContent() {
		return (
			<div>
				...
				<Button className="jp-welcome-new-plan__button" href={ '#/traffic' } onClick={ this.props.dismiss } primary >Got it!</Button>
			</div>
		);
	}
	...
	render() {
		return (
			<JetpackDialogue
				svg={ <img src={ imagePath + 'welcome-personal.svg' } width="160" alt={ __( 'People around page' ) } style={ { paddingLeft: "60px" } } /> }
