			...
			<div className={ classes }>
				<Card className="jp-support-card__happiness">
					...
					<div className="jp-support-card__happiness-contact">
						...
						<p className="jp-support-card__desc"><a href="http://jetpack.com/support/" title="Go to Jetpack.com/support" target="_blank">View our support page</a><span>,</span> <a href="https://wordpress.org/support/plugin/jetpack" title="Go to the WordPress.org support forums" target="_blank">check the forums for answers</a><span>, or</span> <a href="https://jetpack.com/contact-support/" title="Contact Jetpack support staff directly" target="_blank">contact us directly</a><span>.</span></p>
					</div>
				</Card>
