					...
					starrySky = (
						<div className="jp-landing-plans__header">
							...
							<p className="jp-landing-plans__header-description">
								{ __(
									'Automated backups, one-click restores, spam filtering, and malware scanning.'
								) }
							</p>
							<div className="jp-landing-plans__header-img-container">
								<div className="jp-landing-plans__header-col-left">
									<h3 className="jp-landing-plans__header-subtitle">
										{ __( 'How much is your website worth?' ) }
									</h3>
									<p className="jp-landing-plans__header-text">
										{ __(
											'For less than the price of a coffee a month you can rest easy knowing your hard work (or livelihood) is backed up.'
										) }
										<br />
										<br />
										{ __(
											'Upgrade to a weekly coffee and fully protect your site from malware, infiltrations, and security loopholes with automated malware scanning.'
										) }
									</p>
								...
								<div className="jp-landing-plans__header-col-right">
									<svg
										...
										version="1.1"
										aria-labelledby="wpcomLogin"
										role="img"
									>
										<title id="wpcomLogin">
											{ __( 'Image of WordPress login screen protected by Jetpack' ) }
										</title>
										<defs>
											<rect id="path-1" x="0" y="0" width="1005" height="700" rx="8" />
											<polygon id="path-3" points="0 80 80 80 80 0 0 0 0 80" />
											<rect id="path-5" x="22" y="154" width="280" height="35" />
											<mask
												id="mask-6"
											...
											<rect id="path-7" x="22" y="234" width="280" height="35" />
											<mask
												id="mask-8"
												maskContentUnits="userSpaceOnUse"
												maskUnits="objectBoundingBox"
											...
											<rect id="path-9" x="22" y="291" width="15" height="15" />
											<mask
												id="mask-10"
												maskContentUnits="userSpaceOnUse"
												maskUnits="objectBoundingBox"
											...
											<rect id="path-11" x="230" y="289" width="71" height="30" rx="3" />
											<filter
												x="-50"
												y="-50"
												width="200"
											...
											>
												...
												/>
												<feColorMatrix values="0" type="matrix" in="shadowOffsetOuter1" />
											</filter>
											<filter
												x="-50"
												y="-50"
											...
											>
												...
												/>
												<feColorMatrix values="0" type="matrix" in="shadowInnerInner1" />
											</filter>
											<mask
												id="mask-14"
												maskContentUnits="userSpaceOnUse"
											...
											<polygon id="path-15" points="54 33.75 54 0 0 0 0 33.75 0 67.5 54 67.5" />
										</defs>
										<g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
											<g
												id="Plans---wp-login-stripped"
												transform="translate(-197.000000, -136.000000)"
											>
												<g id="Editor-Container" transform="translate(197.000000, 136.000000)">
													<g id="Simple-Layout">
														<g id="bg">
															<mask id="mask-2" fill="white">
																<use xlinkHref="#path-1" />
															</mask>
															<use id="content-bg-mask" fill="#F1F1F1" xlinkHref="#path-1" />
														</g>
														<g id="chrome">
															<rect fill="#FEFEFE" x="0" y="0" width="1005" height="53" rx="8" />
															<rect
																id="Rectangle"
																fill="#F1F1F1"
																x="0"
															...
															/>
															<path
																d="M27.5 31C23.36 31 20 27.64 20 23.5 20 19.36 23.36 16 27.5 16 31.64 16 35 19.36 35 23.5 35 27.64 31.64 31 27.5 31L27.5 31ZM77.5 31C73.36 31 70 27.64 70 23.5 70 19.36 73.36 16 77.5 16 81.64 16 85 19.36 85 23.5 85 27.64 81.64 31 77.5 31L77.5 31ZM52.5 31C48.36 31 45 27.64 45 23.5 45 19.36 48.36 16 52.5 16 56.64 16 60 19.36 60 23.5 60 27.64 56.64 31 52.5 31L52.5 31Z"
																id="Shape"
																fill="#8D8D8D"
															/>
														</g>
													...
													<g
														id="login-form"
														opacity="0.5"
														transform="translate(340.000000, 156.000000)"
													>
														<rect
															id="log-bg"
															fill="#FFFFFF"
														...
														<g id="btn">
															<use
																...
																xlinkHref="#path-11"
															/>
															<use fill="#36A3CA" fillRule="evenodd" xlinkHref="#path-11" />
															<use
																fill="black"
																fillOpacity="1"
													...
													<g id="security" transform="translate(428.000000, 275.000000)">
														<circle id="Oval" fill="#3D596D" cx="75" cy="75" r="75" />
														<g id="Page-1" transform="translate(48.000000, 37.500000)">
															<mask id="mask-16" fill="white">
																<use xlinkHref="#path-15" />
															</mask>
															<g id="Clip-2" />
															<path
																d="M30.38 46.31L30.38 54 23.63 54 23.63 46.31C21.62 45.15 20.25 42.99 20.25 40.5 20.25 36.77 23.27 33.75 27 33.75 30.73 33.75 33.75 36.77 33.75 40.5 33.75 42.99 32.38 45.15 30.38 46.31L30.38 46.31ZM16.88 16.87C16.88 11.29 21.42 6.75 27 6.75 32.58 6.75 37.13 11.29 37.13 16.87L37.13 20.25 16.88 20.25 16.88 16.87ZM47.25 20.25L43.88 20.25 43.88 16.87C43.88 7.57 36.3 0 27 0 17.7 0 10.13 7.57 10.13 16.87L10.13 20.25 6.75 20.25C3.02 20.25 0 23.27 0 27L0 60.75C0 64.48 3.02 67.5 6.75 67.5L47.25 67.5C50.98 67.5 54 64.48 54 60.75L54 27C54 23.27 50.98 20.25 47.25 20.25L47.25 20.25Z"
																id="Fill-1"
																fill="#FFFFFF"
																mask="url(#mask-16)"
															/>
