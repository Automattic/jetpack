...
export const Comments = React.createClass( {
	...
	render() {
		const comments = this.props.module( 'comments' ),
			...
			gravatar = this.props.module( 'gravatar-hovercards' ),
			markdown = this.props.module( 'markdown' );
...
export default moduleSettingsForm( Comments );
