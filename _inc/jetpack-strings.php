...
__( "There are unsaved settings in this tab that will be lost if you leave it. Proceed?", "jetpack" ), // _inc/client/main.jsx:58
__( "Show falling snow on my blog from Dec 1st until Jan 4th.", "jetpack" ), // _inc/client/appearance/index.jsx:111
__( "Show falling snow in the holiday period.", "jetpack" ), // _inc/client/appearance/index.jsx:98
__( "Holiday Snow", "jetpack" ), // _inc/client/appearance/index.jsx:97
__( "Learn More", "jetpack" ), // _inc/client/appearance/index.jsx:86
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/appearance/index.jsx:56
__( "WordPress.com for Linux", "jetpack" ), // _inc/client/apps/index.jsx:190
__( "WordPress.com for Windows", "jetpack" ), // _inc/client/apps/index.jsx:186
__( "WordPress.com for Mac OS X", "jetpack" ), // _inc/client/apps/index.jsx:181
__( "A desktop app that gives WordPress a permanent home on your computer. Not to mention the distraction free environment you get writing outside of a web browser.", "jetpack" ), // _inc/client/apps/index.jsx:178
__( "On Your Desktop", "jetpack" ), // _inc/client/apps/index.jsx:177
__( "WordPress.com in Google Play", "jetpack" ), // _inc/client/apps/index.jsx:165
__( "WordPress.com in the App Store", "jetpack" ), // _inc/client/apps/index.jsx:156
__( "Publish content, track stats, moderate comments and so much more from anywhere in the world. Our mobile apps are open source, free and available to you on Apple or Android devices.", "jetpack" ), // _inc/client/apps/index.jsx:153
__( "In Your Pocket", "jetpack" ), // _inc/client/apps/index.jsx:152
__( "Get WordPress apps for any screen.", "jetpack" ), // _inc/client/apps/index.jsx:145
__( "Inspiration strikes any time, anywhere.", "jetpack" ), // _inc/client/apps/index.jsx:141
__( "Launch Reader", "jetpack" ), // _inc/client/apps/index.jsx:119
__( "The WordPress apps all have impressively fast and full featured readers so you can catch up with your favorite sites and join the conversation anywhere, any time.", "jetpack" ), // _inc/client/apps/index.jsx:117
__( "Connect with the Community", "jetpack" ), // _inc/client/apps/index.jsx:116
__( "View Your Stats", "jetpack" ), // _inc/client/apps/index.jsx:94
__( "Monitor your visitors with advanced stats. Watch for trends, learn what content performs the best and understand your visitors from anywhere in the world.", "jetpack" ), // _inc/client/apps/index.jsx:92
__( "Connect with your Visitors", "jetpack" ), // _inc/client/apps/index.jsx:91
__( "Try the New Editor", "jetpack" ), // _inc/client/apps/index.jsx:72
__( "Our new editor is lightning fast, optimized for writers and eliminates distractions, giving you the ability to focus on your work.", "jetpack" ), // _inc/client/apps/index.jsx:70
__( "Focus on your Writing", "jetpack" ), // _inc/client/apps/index.jsx:69
__( "Manage Plugins", "jetpack" ), // _inc/client/apps/index.jsx:56
__( "Most security flaws are found in outdated plugins. Use our Web and Desktop apps to turn on auto-updates or update plugins manually for all your websites in one convenient place.", "jetpack" ), // _inc/client/apps/index.jsx:54
__( "Bulk and automatic updates", "jetpack" ), // _inc/client/apps/index.jsx:53
...
__( "View your {{a}}Email Followers{{/a}}", "jetpack" ), // _inc/client/engagement/index.jsx:147
__( "View {{a}}All Stats{{/a}}", "jetpack" ), // _inc/client/engagement/index.jsx:133
__( "Learn More", "jetpack" ), // _inc/client/engagement/index.jsx:127
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/engagement/index.jsx:97
__( "Your site must be accessible by search engines for this feature to work properly. You can change this in {{a}}Reading Settings{{/a}}.", "jetpack" ), // _inc/client/engagement/index.jsx:50
...
__( "Performance", "jetpack" ), // _inc/client/at-a-glance/index.jsx:55
...
__( "{{a}}Activate Monitor{{/a}} to receive notifications if your site goes down.", "jetpack" ), // _inc/client/at-a-glance/monitor.jsx:62
__( "Unavailable in Dev Mode.", "jetpack" ), // _inc/client/at-a-glance/monitor.jsx:61
__( "Jetpack is monitoring your site. If we think your site is down you will receive an email.", "jetpack" ), // _inc/client/at-a-glance/monitor.jsx:48
__( "Loading…", "jetpack" ), // _inc/client/at-a-glance/monitor.jsx:37
...
__( "{{a}}Activate Manage and turn on auto updates{{/a}}", "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:81
__( "{{a}}Turn on plugin auto updates{{/a}}", "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:80
_n( "Needs updating. ", "Need updating. ", 1, "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:70
_n( "%(number)s plugin", "%(number)s plugins", 1, "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:60
...
__( "Learn More", "jetpack" ), // _inc/client/security/index.jsx:118
__( "Pro", "jetpack" ), // _inc/client/security/index.jsx:81
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/security/index.jsx:54
__( "Automatically backup your entire site.", "jetpack" ), // _inc/client/security/index.jsx:49
__( "Site Backups", "jetpack" ), // _inc/client/security/index.jsx:49
__( "State-of-the-art spam defense.", "jetpack" ), // _inc/client/security/index.jsx:48
__( "Automated, comprehensive protection from threats and attacks.", "jetpack" ), // _inc/client/security/index.jsx:45
__( "Security Scanning", "jetpack" ), // _inc/client/security/index.jsx:45
__( "Learn More", "jetpack" ), // _inc/client/writing/index.jsx:109
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/writing/index.jsx:75
...
_x( "Privacy", "Shorthand for Privacy Policy.", "jetpack" ), // _inc/client/components/footer/index.jsx:123
__( "Automattic's Privacy Policy", "jetpack" ), // _inc/client/components/footer/index.jsx:121
_x( "Terms", "Shorthand for Terms of Service.", "jetpack" ), // _inc/client/components/footer/index.jsx:114
__( "WordPress.com Terms of Service", "jetpack" ), // _inc/client/components/footer/index.jsx:112
__( "Disconnect Jetpack", "jetpack" ), // _inc/client/components/footer/index.jsx:84
__( "Disconnect from WordPress.com", "jetpack" ), // _inc/client/components/footer/index.jsx:82
_x( "Debug", "Navigation item. Noun. Links to a debugger tool for Jetpack.", "jetpack" ), // _inc/client/components/footer/index.jsx:69
__( "Test your site’s compatibility with Jetpack.", "jetpack" ), // _inc/client/components/footer/index.jsx:67
_x( "Reset Options (dev versions only)", "Navigation item.", "jetpack" ), // _inc/client/components/footer/index.jsx:53
__( "This will reset all Jetpack options, are you sure?", "jetpack" ), // _inc/client/components/footer/index.jsx:34
__( "Do you really want to disconnect your site from WordPress.com?", "jetpack" ), // _inc/client/components/footer/index.jsx:28
...
__( "Link to WordPress.com", "jetpack" ), // _inc/client/components/jetpack-notices/index.jsx:170
__( "You, %(userName)s, are not connected to WordPress.com.", "jetpack" ), // _inc/client/components/jetpack-notices/index.jsx:155
__( "Currently in {{a}}Development Mode{{/a}} because your site URL lacks a dot (e.g. http://localhost).{{br/}}Some features are disabled.", "jetpack" ), // _inc/client/components/jetpack-notices/index.jsx:108
__( "Currently in {{a}}Development Mode{{/a}} via the JETPACK_DEV_DEBUG constant.{{br/}}Some features are disabled.", "jetpack" ), // _inc/client/components/jetpack-notices/index.jsx:99
__( "Currently in {{a}}Development Mode{{/a}} via the jetpack_development_mode filter.{{br/}}Some features are disabled.", "jetpack" ), // _inc/client/components/jetpack-notices/index.jsx:90
__( "You are running Jetpack on a {{a}}staging server{{/a}}.", "jetpack" ), // _inc/client/components/jetpack-notices/index.jsx:55
...
__( "News Sitemap: {{a}}%(url)s{{/a}}", "jetpack" ), // _inc/client/components/module-settings/index.jsx:805
__( "Sitemap: {{a}}%(url)s{{/a}}", "jetpack" ), // _inc/client/components/module-settings/index.jsx:795
__( "Search engines will find the sitemaps at these locations:", "jetpack" ), // _inc/client/components/module-settings/index.jsx:793
__( "Use Markdown for comments", "jetpack" ), // _inc/client/components/module-settings/index.jsx:774
__( "Add a phrase", "jetpack" ), // _inc/client/components/module-settings/index.jsx:746
__( "Ignored Phrases", "jetpack" ), // _inc/client/components/module-settings/index.jsx:742
__( "Redundant Phrases", "jetpack" ), // _inc/client/components/module-settings/index.jsx:738
__( "Phrases to Avoid", "jetpack" ), // _inc/client/components/module-settings/index.jsx:734
__( "Passive Voice", "jetpack" ), // _inc/client/components/module-settings/index.jsx:730
__( "Jargon", "jetpack" ), // _inc/client/components/module-settings/index.jsx:726
__( "Hidden Verbs", "jetpack" ), // _inc/client/components/module-settings/index.jsx:722
__( "Double Negatives", "jetpack" ), // _inc/client/components/module-settings/index.jsx:718
__( "Diacritical Marks", "jetpack" ), // _inc/client/components/module-settings/index.jsx:714
__( "Complex Phrases", "jetpack" ), // _inc/client/components/module-settings/index.jsx:710
__( "Clichés", "jetpack" ), // _inc/client/components/module-settings/index.jsx:706
__( "Bias Language", "jetpack" ), // _inc/client/components/module-settings/index.jsx:702
__( "Enable proofreading for the following grammar and style rules: ", "jetpack" ), // _inc/client/components/module-settings/index.jsx:698
__( "English Options", "jetpack" ), // _inc/client/components/module-settings/index.jsx:697
__( "Use automatically detected language to proofread posts and pages", "jetpack" ), // _inc/client/components/module-settings/index.jsx:694
__( "The proofreader supports English, French, German, Portuguese and Spanish.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:689
__( "Automatic Language Detection", "jetpack" ), // _inc/client/components/module-settings/index.jsx:687
__( "A post or page is updated", "jetpack" ), // _inc/client/components/module-settings/index.jsx:684
__( "A post or page is first published", "jetpack" ), // _inc/client/components/module-settings/index.jsx:680
__( "Automatically proofread content when: ", "jetpack" ), // _inc/client/components/module-settings/index.jsx:676
__( "Proofreading", "jetpack" ), // _inc/client/components/module-settings/index.jsx:675
__( "Enable Testimonials for this site.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:649
__( "Enable Portfolio Projects for this site.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:644
__( "Configure Testimonials", "jetpack" ), // _inc/client/components/module-settings/index.jsx:635
__( "Configure Portfolios", "jetpack" ), // _inc/client/components/module-settings/index.jsx:625
__( "Link your account to WordPress.com to start using this feature.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:599
__( "Regenerate address", "jetpack" ), // _inc/client/components/module-settings/index.jsx:590
__( "Highlight and copy the following text to your clipboard:", "jetpack" ), // _inc/client/components/module-settings/index.jsx:586
__( "Copied!", "jetpack" ), // _inc/client/components/module-settings/index.jsx:585
_x( "Copy", "verb", "jetpack" ), // _inc/client/components/module-settings/index.jsx:584
__( "Email Address", "jetpack" ), // _inc/client/components/module-settings/index.jsx:581
__( "Display all your gallery pictures in a cool mosaic", "jetpack" ), // _inc/client/components/module-settings/index.jsx:548
__( "Excerpts", "jetpack" ), // _inc/client/components/module-settings/index.jsx:544
__( "Meta key example: ", "jetpack" ), // _inc/client/components/module-settings/index.jsx:522
__( "Meta key example: ", "jetpack" ), // _inc/client/components/module-settings/index.jsx:505
__( "Meta key example: ", "jetpack" ), // _inc/client/components/module-settings/index.jsx:488
__( "Enter your meta key \"content\" value to verify your blog with {{a}}Google Search Console{{/a}}, {{a1}}Bing Webmaster Center{{/a1}} and {{a2}}Pinterest Site Verification{{/a2}}.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:466
__( "View people's profiles when you mouse over their Gravatars", "jetpack" ), // _inc/client/components/module-settings/index.jsx:442
__( "Show a promo for the WordPress mobile apps in the footer of the mobile theme", "jetpack" ), // _inc/client/components/module-settings/index.jsx:424
__( "Mobile Promos", "jetpack" ), // _inc/client/components/module-settings/index.jsx:420
__( "Featured Images", "jetpack" ), // _inc/client/components/module-settings/index.jsx:413
__( "Excerpts", "jetpack" ), // _inc/client/components/module-settings/index.jsx:406
__( "Track each infinite Scroll post load as a page view in Google Analytics", "jetpack" ), // _inc/client/components/module-settings/index.jsx:388
__( "Scroll infinitely (Shows 7 posts on each load)", "jetpack" ), // _inc/client/components/module-settings/index.jsx:384
__( "Background Color", "jetpack" ), // _inc/client/components/module-settings/index.jsx:359
__( "Show photo metadata (Exif) in carousel, when available", "jetpack" ), // _inc/client/components/module-settings/index.jsx:356
__( "Mobile Promos", "jetpack" ), // _inc/client/components/module-settings/index.jsx:352
__( "Require Two-Step Authentication", "jetpack" ), // _inc/client/components/module-settings/index.jsx:334
__( "Match By Email", "jetpack" ), // _inc/client/components/module-settings/index.jsx:330
...
__( "Your Current IP: %(ip)s", "jetpack" ), // _inc/client/components/module-settings/index.jsx:253
__( "Report Visibility: Select the roles that will be able to view stats reports", "jetpack" ), // _inc/client/components/module-settings/index.jsx:232
__( "Registered Users: Count the page views of registered users who are logged in", "jetpack" ), // _inc/client/components/module-settings/index.jsx:225
__( "Hide the stats smiley face image. The image helps collect stats but should still work when hidden.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:222
__( "Smiley", "jetpack" ), // _inc/client/components/module-settings/index.jsx:218
__( "Put a chart showing 48 hours of views in the admin bar", "jetpack" ), // _inc/client/components/module-settings/index.jsx:215
__( "Admin Bar", "jetpack" ), // _inc/client/components/module-settings/index.jsx:211
__( "Show a \"follow comments\" option in the comment form.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:193
__( "Show a \"follow blog\" options in the comment form", "jetpack" ), // _inc/client/components/module-settings/index.jsx:189
__( "Can readers subscribe to your posts, comments or both?", "jetpack" ), // _inc/client/components/module-settings/index.jsx:184
__( "Color Scheme", "jetpack" ), // _inc/client/components/module-settings/index.jsx:163
__( "A few catchy words to motivate your readers to comment.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:160
__( "Comments headline", "jetpack" ), // _inc/client/components/module-settings/index.jsx:152
__( "{{a}}Manage Likes visibility from the Sharing Module Settings{{/a}}", "jetpack" ), // _inc/client/components/module-settings/index.jsx:133
__( "WordPress.com Likes are:", "jetpack" ), // _inc/client/components/module-settings/index.jsx:121
__( "Preview", "jetpack" ), // _inc/client/components/module-settings/index.jsx:99
__( "Use a large and visually striking layout", "jetpack" ), // _inc/client/components/module-settings/index.jsx:97
__( "Show a \"Related\" header to more clearly separate the related section from posts", "jetpack" ), // _inc/client/components/module-settings/index.jsx:93
__( "Related", "jetpack" ), // _inc/client/components/module-settings/index.jsx:71
__( "Upgrade Focus: VideoPress For Weddings", "jetpack" ), // _inc/client/components/module-settings/index.jsx:64
__( "The WordPress for Android App Gets a Big Facelift", "jetpack" ), // _inc/client/components/module-settings/index.jsx:61
__( "Big iPhone/iPad Update Now Available", "jetpack" ), // _inc/client/components/module-settings/index.jsx:58
__( "Subscriber", "jetpack" ), // _inc/client/components/module-settings/index.jsx:39
__( "{{link}}Configure your %(module_slug)s Settings {{/link}}", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:145
__( "{{link}}Configure your %(module_slug)s Settings {{/link}}", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:123
__( "Real-time offsite backups with automated restores deliver peace-of-mind, so you can focus on writing great content and increasing traffic while we protect every aspect of your investment. Upgrade today.", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:116
...
__( "This module has no configuration options", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:107
__( "Configure your Security Scans", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:78
__( "You can see the information about security scanning in the \"At a Glance\" section.", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:75
__( "Upgrade Jetpack and our state-of-the-art security scanner will hunt out malicious files and report them immediately so that you're never unaware of what is happening on your website.", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:69
__( "Search your content.", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:42
...
_x( "Writing", "Navigation item.", "jetpack" ), // _inc/client/components/navigation-settings/index.jsx:125
_x( "Engagement", "Navigation item.", "jetpack" ), // _inc/client/components/navigation-settings/index.jsx:120
_x( "General", "Navigation item.", "jetpack" ), // _inc/client/components/navigation-settings/index.jsx:115
_x( "General", "Navigation item.", "jetpack" ), // _inc/client/components/navigation-settings/index.jsx:105
_x( "Writing", "Navigation item.", "jetpack" ), // _inc/client/components/navigation-settings/index.jsx:95
_x( "Appearance", "Navigation item.", "jetpack" ), // _inc/client/components/navigation-settings/index.jsx:90
_x( "Security", "Navigation item.", "jetpack" ), // _inc/client/components/navigation-settings/index.jsx:85
_x( "Engagement", "Navigation item.", "jetpack" ), // _inc/client/components/navigation-settings/index.jsx:80
_x( "General", "Navigation item.", "jetpack" ), // _inc/client/components/navigation-settings/index.jsx:75
__( "Search for a Jetpack feature.", "jetpack" ), // _inc/client/components/navigation-settings/index.jsx:54
__( "{{hideOnMobile}}Enjoying Jetpack or have feedback?{{/hideOnMobile}} {{reviewLink}}Leave us a review{{/reviewLink}}{{hideOnMobile}},{{/hideOnMobile}} {{twitterLink}}follow us on Twitter{{/twitterLink}}{{hideOnMobile}}, and{{/hideOnMobile}} {{facebookLink}}like us on Facebook{{/facebookLink}}{{hideOnMobile}}.{{/hideOnMobile}}", "jetpack" ), // _inc/client/components/support-card/index.jsx:80
__( "Like us on Facebook", "jetpack" ), // _inc/client/components/support-card/index.jsx:107
__( "Follow Jetpack on Twitter", "jetpack" ), // _inc/client/components/support-card/index.jsx:99
__( "Leave a Jetpack review", "jetpack" ), // _inc/client/components/support-card/index.jsx:91
__( "{{supportLink}}View our support page{{/supportLink}}{{hideOnMobile}},{{/hideOnMobile}} {{forumLink}}check the forums for answers{{/forumLink}}{{hideOnMobile}}, or{{/hideOnMobile}} {{contactLink}}contact us directly{{/contactLink}}{{hideOnMobile}}.{{/hideOnMobile}}", "jetpack" ), // _inc/client/components/support-card/index.jsx:45
__( "Contact Jetpack support staff directly", "jetpack" ), // _inc/client/components/support-card/index.jsx:69
__( "Go to the WordPress.org support forums", "jetpack" ), // _inc/client/components/support-card/index.jsx:62
__( "Go to Jetpack.com/support", "jetpack" ), // _inc/client/components/support-card/index.jsx:55
__( "We offer free, full support to all of our Jetpack users. Our support team is always around to help you.", "jetpack" ), // _inc/client/components/support-card/index.jsx:42
