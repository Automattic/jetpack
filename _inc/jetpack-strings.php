...
__('Preview: Not enough related posts found','jetpack'),
__('Placeholder image','jetpack'),
__('Grey square','jetpack'),
__('Icon for image','jetpack'),
__('August 3, 2018','jetpack'),
__('In “Uncategorized”','jetpack'),
__('Autoplay','jetpack'),
__('Autoplay between slides','jetpack'),
__('Delay between transitions','jetpack'),
__('The Reduce Motion accessibility option is selected, therefore autoplay will be disabled in this browser.','jetpack'),
__('Effects','jetpack'),
__('Transition effect','jetpack'),
__('Edit Slideshow','jetpack'),
__('Slideshow','jetpack'),
__('Drag images, upload new ones or select files from your library.','jetpack'),
__('Upload an image','jetpack'),
__('Show total subscribers','jetpack'),
__('Subscriber count unavailable','jetpack'),
_n('Join %s other subscriber',
'Join %s other subscribers','jetpack'),
__('Edit Gallery','jetpack'),
__('Tiled gallery','jetpack'),
__('images','jetpack'),
__('Tiled gallery settings','jetpack'),
__('Columns','jetpack'),
__('Link To','jetpack'),
__('Attachment Page','jetpack'),
__('Media File','jetpack'),
__('None','jetpack'),
...
__('Advertisements','jetpack'),
__('Report this Ad','jetpack'),
__('Pick an ad format','jetpack'),
...
_x('Slide','Slideshow transition effect','jetpack'),
_x('Fade','Slideshow transition effect','jetpack'),
