...
__( "View your earnings", "jetpack" ), // _inc/client/engagement/index.jsx:233
__( "View your {{a}}Email Followers{{/a}}", "jetpack" ), // _inc/client/engagement/index.jsx:214
__( "View {{a}}All Stats{{/a}}", "jetpack" ), // _inc/client/engagement/index.jsx:199
__( "Learn More", "jetpack" ), // _inc/client/engagement/index.jsx:192
__( "Pro", "jetpack" ), // _inc/client/engagement/index.jsx:146
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/engagement/index.jsx:126
...
__( "Backups & Security Scanning", "jetpack" ), // _inc/client/plans/plan-body.jsx:107
__( "Configure VaultPress", "jetpack" ), // _inc/client/plans/plan-body.jsx:96
__( "View your security dashboard", "jetpack" ), // _inc/client/plans/plan-body.jsx:91
__( "Daily backup of all your site data with unlimited space, one-click restores, automated security scanning, and priority support (powered by VaultPress).", "jetpack" ), // _inc/client/plans/plan-body.jsx:85
__( "Backups & Security Scanning", "jetpack" ), // _inc/client/plans/plan-body.jsx:84
__( "Configure VaultPress", "jetpack" ), // _inc/client/plans/plan-body.jsx:73
__( "View your security dashboard", "jetpack" ), // _inc/client/plans/plan-body.jsx:68
__( "Daily backup of all your site data with unlimited space and one-click restores (powered by VaultPress).", "jetpack" ), // _inc/client/plans/plan-body.jsx:62
__( "Backups", "jetpack" ), // _inc/client/plans/plan-body.jsx:61
__( "Configure Akismet", "jetpack" ), // _inc/client/plans/plan-body.jsx:52
__( "View your spam stats", "jetpack" ), // _inc/client/plans/plan-body.jsx:47
__( "State-of-the-art spam defense powered by Akismet.", "jetpack" ), // _inc/client/plans/plan-body.jsx:41
...
__( "No Results Found.", "jetpack" ), // _inc/client/search/index.jsx:214
__( "Learn More", "jetpack" ), // _inc/client/search/index.jsx:203
__( "Upgrade", "jetpack" ), // _inc/client/search/index.jsx:169
__( "Pro", "jetpack" ), // _inc/client/search/index.jsx:148
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/search/index.jsx:113
__( "Keep your site backed up!", "jetpack" ), // _inc/client/search/index.jsx:74
__( "Site Backups", "jetpack" ), // _inc/client/search/index.jsx:73
__( "Keep those spammers away!", "jetpack" ), // _inc/client/search/index.jsx:67
__( "Automatically scan your site for common threats and attacks.", "jetpack" ), // _inc/client/search/index.jsx:60
__( "Security Scanning", "jetpack" ), // _inc/client/search/index.jsx:59
...
__( "Learn More", "jetpack" ), // _inc/client/writing/index.jsx:145
__( "Pro", "jetpack" ), // _inc/client/writing/index.jsx:118
__( "Upgrade", "jetpack" ), // _inc/client/writing/index.jsx:108
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/writing/index.jsx:85
...
__( "Display an ad unit at the top of each page.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:768
__( "News Sitemap: {{a}}%(url)s{{/a}}", "jetpack" ), // _inc/client/components/module-settings/index.jsx:743
__( "Sitemap: {{a}}%(url)s{{/a}}", "jetpack" ), // _inc/client/components/module-settings/index.jsx:733
__( "Search engines will find the sitemaps at these locations:", "jetpack" ), // _inc/client/components/module-settings/index.jsx:731
__( "Use Markdown for comments", "jetpack" ), // _inc/client/components/module-settings/index.jsx:712
__( "Add a phrase", "jetpack" ), // _inc/client/components/module-settings/index.jsx:684
__( "Ignored Phrases", "jetpack" ), // _inc/client/components/module-settings/index.jsx:680
__( "Redundant Phrases", "jetpack" ), // _inc/client/components/module-settings/index.jsx:676
__( "Phrases to Avoid", "jetpack" ), // _inc/client/components/module-settings/index.jsx:672
__( "Passive Voice", "jetpack" ), // _inc/client/components/module-settings/index.jsx:668
__( "Jargon", "jetpack" ), // _inc/client/components/module-settings/index.jsx:664
__( "Hidden Verbs", "jetpack" ), // _inc/client/components/module-settings/index.jsx:660
__( "Double Negatives", "jetpack" ), // _inc/client/components/module-settings/index.jsx:656
__( "Diacritical Marks", "jetpack" ), // _inc/client/components/module-settings/index.jsx:652
__( "Complex Phrases", "jetpack" ), // _inc/client/components/module-settings/index.jsx:648
__( "Clichés", "jetpack" ), // _inc/client/components/module-settings/index.jsx:644
__( "Bias Language", "jetpack" ), // _inc/client/components/module-settings/index.jsx:640
__( "Enable proofreading for the following grammar and style rules: ", "jetpack" ), // _inc/client/components/module-settings/index.jsx:636
__( "English Options", "jetpack" ), // _inc/client/components/module-settings/index.jsx:635
__( "Use automatically detected language to proofread posts and pages", "jetpack" ), // _inc/client/components/module-settings/index.jsx:632
__( "The proofreader supports English, French, German, Portuguese and Spanish.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:627
__( "Automatic Language Detection", "jetpack" ), // _inc/client/components/module-settings/index.jsx:625
__( "A post or page is updated", "jetpack" ), // _inc/client/components/module-settings/index.jsx:622
__( "A post or page is first published", "jetpack" ), // _inc/client/components/module-settings/index.jsx:618
__( "Automatically proofread content when: ", "jetpack" ), // _inc/client/components/module-settings/index.jsx:614
__( "Proofreading", "jetpack" ), // _inc/client/components/module-settings/index.jsx:613
__( "Enable Testimonials for this site.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:587
__( "Enable Portfolio Projects for this site.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:582
__( "Configure Testimonials", "jetpack" ), // _inc/client/components/module-settings/index.jsx:573
__( "Configure Portfolios", "jetpack" ), // _inc/client/components/module-settings/index.jsx:563
__( "Link your account to WordPress.com to start using this feature.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:537
__( "Regenerate address", "jetpack" ), // _inc/client/components/module-settings/index.jsx:528
__( "Highlight and copy the following text to your clipboard:", "jetpack" ), // _inc/client/components/module-settings/index.jsx:524
__( "Copied!", "jetpack" ), // _inc/client/components/module-settings/index.jsx:523
_x( "Copy", "verb", "jetpack" ), // _inc/client/components/module-settings/index.jsx:522
__( "Email Address", "jetpack" ), // _inc/client/components/module-settings/index.jsx:519
__( "Display all your gallery pictures in a cool mosaic", "jetpack" ), // _inc/client/components/module-settings/index.jsx:486
__( "Meta key example:", "jetpack" ), // _inc/client/components/module-settings/index.jsx:461
__( "Meta key example:", "jetpack" ), // _inc/client/components/module-settings/index.jsx:444
__( "Meta key example:", "jetpack" ), // _inc/client/components/module-settings/index.jsx:427
__( "Meta key example:", "jetpack" ), // _inc/client/components/module-settings/index.jsx:410
__( "Enter your meta key \"content\" value to verify your blog with {{a}}Google Search Console{{/a}}, {{a1}}Bing Webmaster Center{{/a1}} and {{a2}}Pinterest Site Verification{{/a2}}.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:388
__( "Show a promo for the WordPress mobile apps in the footer of the mobile theme", "jetpack" ), // _inc/client/components/module-settings/index.jsx:368
__( "Mobile Promos", "jetpack" ), // _inc/client/components/module-settings/index.jsx:364
__( "Featured Images", "jetpack" ), // _inc/client/components/module-settings/index.jsx:357
__( "Excerpts", "jetpack" ), // _inc/client/components/module-settings/index.jsx:350
__( "Track each infinite Scroll post load as a page view in Google Analytics", "jetpack" ), // _inc/client/components/module-settings/index.jsx:332
__( "Scroll infinitely (Shows 7 posts on each load)", "jetpack" ), // _inc/client/components/module-settings/index.jsx:328
__( "Background Color", "jetpack" ), // _inc/client/components/module-settings/index.jsx:303
__( "Show photo metadata (Exif) in carousel, when available", "jetpack" ), // _inc/client/components/module-settings/index.jsx:300
__( "Mobile Promos", "jetpack" ), // _inc/client/components/module-settings/index.jsx:296
__( "Require Two-Step Authentication", "jetpack" ), // _inc/client/components/module-settings/index.jsx:278
__( "Match By Email", "jetpack" ), // _inc/client/components/module-settings/index.jsx:274
__( "{{link}}Configure your Monitor notificaton settings on WordPress.com{{/link}}", "jetpack" ), // _inc/client/components/module-settings/index.jsx:253
__( "IPv4 and IPv6 are acceptable. {{br/}} To specify a range, enter the low value and high value separated by a dash. Example: 12.12.12.1-12.12.12.100", "jetpack" ), // _inc/client/components/module-settings/index.jsx:226
__( "Make sure to add your most frequently used IP addresses as they can change between your home, office or other locations. Removing an IP address from the list below will remove it from your whitelist.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:217
__( "Whitelisting an IP address prevents it from ever being blocked by Jetpack.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:216
__( "Whitelist Management", "jetpack" ), // _inc/client/components/module-settings/index.jsx:215
__( "Your Current IP: %(ip)s", "jetpack" ), // _inc/client/components/module-settings/index.jsx:209
__( "Report Visibility: Select the roles that will be able to view stats reports", "jetpack" ), // _inc/client/components/module-settings/index.jsx:188
__( "Registered Users: Count the page views of registered users who are logged in", "jetpack" ), // _inc/client/components/module-settings/index.jsx:181
__( "Hide the stats smiley face image. The image helps collect stats but should still work when hidden.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:178
__( "Smiley", "jetpack" ), // _inc/client/components/module-settings/index.jsx:174
__( "Put a chart showing 48 hours of views in the admin bar", "jetpack" ), // _inc/client/components/module-settings/index.jsx:171
__( "Admin Bar", "jetpack" ), // _inc/client/components/module-settings/index.jsx:167
__( "Show a \"follow comments\" option in the comment form.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:149
__( "Show a \"follow blog\" options in the comment form", "jetpack" ), // _inc/client/components/module-settings/index.jsx:145
__( "Can readers subscribe to your posts, comments or both?", "jetpack" ), // _inc/client/components/module-settings/index.jsx:140
__( "Color Scheme", "jetpack" ), // _inc/client/components/module-settings/index.jsx:119
__( "A few catchy words to motivate your readers to comment.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:116
__( "Comments headline", "jetpack" ), // _inc/client/components/module-settings/index.jsx:108
__( "{{a}}Manage Likes visibility from the Sharing Module Settings{{/a}}", "jetpack" ), // _inc/client/components/module-settings/index.jsx:89
__( "WordPress.com Likes are:", "jetpack" ), // _inc/client/components/module-settings/index.jsx:77
...
__( "{{link}}Configure your %(module_slug)s Settings {{/link}}", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:182
__( "{{link}}Configure your %(module_slug)s Settings {{/link}}", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:153
__( "Real-time offsite backups with automated restores deliver peace-of-mind, so you can focus on writing great content and increasing traffic while we protect every aspect of your investment. Upgrade today.", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:146
__( "Let search engines and visitors know that you are serious about your websites integrity by upgrading Jetpack. Our anti-spam tools will eliminate comment spam, protect your SEO, and make it easier for visitors to stay in touch.", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:144
__( "This module has no configuration options", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:137
