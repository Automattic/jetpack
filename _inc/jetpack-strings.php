...
__( "We are backing up your site in real-time.", "jetpack" ), // _inc/client/at-a-glance/backups.jsx:192
__( "We are backing up your site daily.", "jetpack" ), // _inc/client/at-a-glance/backups.jsx:193
__( "View your site's backups", "jetpack" ), // _inc/client/at-a-glance/backups.jsx:200
__( "Unavailable in Dev Mode.", "jetpack" ), // _inc/client/at-a-glance/backups.jsx:220
...
__( "Search", "jetpack" ), // _inc/client/at-a-glance/search.jsx:31
__( "Loading…", "jetpack" ), // _inc/client/at-a-glance/search.jsx:79
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/at-a-glance/search.jsx:88
__( "Upgrade", "jetpack" ), // _inc/client/at-a-glance/search.jsx:99
__( "Search", "jetpack" ), // _inc/client/at-a-glance/search.jsx:116
__( "Jetpack Search is powering search on your site.", "jetpack" ), // _inc/client/at-a-glance/search.jsx:127
__( "Add Search (Jetpack) Widget", "jetpack" ), // _inc/client/at-a-glance/search.jsx:144
__( "{{a}}Activate{{/a}} to help visitors quickly find answers with highly relevant instant search results and powerful filtering.", "jetpack" ), // _inc/client/at-a-glance/search.jsx:154
...
__( "Site Backups", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:134
__( "Real-time backup of all your site data with unlimited space, one-click restores, and automated security scanning.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:136
__( "View your security activity", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:144
__( "Daily backup of all your site data with unlimited space and one-click restores", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:154
__( "Daily backup of all your site data with unlimited space, one-click restores, automated security scanning, and priority support", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:159
__( "Real-time backup of all your site data with unlimited space, one-click restores, automated security scanning, and priority support", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:164
__( "A secure site, locked and protected by Jetpack", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:179
__( "Site Security", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:183
__( " (powered by VaultPress).", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:184
__( "View your security dashboard", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:191
...
__( "View settings", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:321
__( "A cloud with multiple types of content floating around it", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:334
__( "Video Hosting", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:338
__( "High-speed, high-definition video hosting with no third-party ads.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:340
__( "Upload videos", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:347
__( "Activate video hosting", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:354
__( "Interface showing a chronological list of changes and updates in a site", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:366
__( "Activity", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:372
__( "View a chronological list of all the changes and updates to your site in an organized, readable way.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:374
__( "View your site activity", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:382
__( "A chart showing an healthy increase in earnings", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:394
__( "Monetize your site with ads", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:399
__( "WordAds lets you earn money by displaying promotional content. Start earning today.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:402
__( "View your earnings", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:411
__( "Start earning", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:418
__( "Site stats showing an evolution in traffic and engagement", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:432
__( "SEO Tools", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:436
__( "Advanced SEO tools to help your site get found when people search for relevant content.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:438
__( "Configure site SEO", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:447
__( "Activate SEO tools", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:454
__( "Site stats showing an evolution in traffic and engagement", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:468
__( "Google Analytics", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:473
__( "Complement WordPress.com’s stats with Google’s in-depth look at your visitors and traffic patterns.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:476
__( "Configure Google Analytics", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:485
__( "Activate Google Analytics", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:492
__( "A secure site, locked and protected by Jetpack", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:505
__( "Try a premium theme", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:510
__( "Access hundreds of beautifully designed premium themes at no extra cost.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:513
__( "Browse premium themes", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:521
__( "A secure site, locked and protected by Jetpack", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:534
__( "Marketing Automation", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:539
__( "Schedule unlimited tweets, Facebook posts, and other social posts in advance.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:542
__( "Schedule posts", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:551
__( "Activate Publicize", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:558
__( "A secure site, locked and protected by Jetpack", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:582
__( "Always-on security", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:586
__( "Prevent login attacks, and get instant notifications when there’s an issue with your site.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:588
__( "Set up your site security", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:596
__( "A fast and performant website", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:606
__( "Optimized performance", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:611
__( "Load pages faster by serving your images from our global network of servers.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:614
__( "Make your site faster", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:622
__( "A wide variety of themes and tools to customize a site", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:632
__( "Design the perfect website", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:637
__( "Get unlimited access to hundreds of professional themes, and customize your site exactly how you like it.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:640
__( "Explore free themes", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:648
__( "Site stats showing an evolution in traffic and engagement", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:658
__( "Increase traffic to your site", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:663
__( "Reach a wider audience by automatically sharing your posts on social media.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:666
__( "Start sharing", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:674
__( "Interface showing a chronological list of changes and updates in a site", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:684
__( "Site activity", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:690
__( "View a chronological list of all the changes and updates to your site in an organized, readable way.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:692
__( "View your site activity", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:700
__( "Chat bubbles representing getting in touch with support", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:710
__( "Support documentation", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:715
__( "Need help? Learn about getting started, customizing your site, using advanced code snippets, and more.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:718
__( "Search support docs", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:726
__( "Take your site to the next level!", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:735
__( "Expand your audience with pro SEO tools.", "jetpack" ), // _inc/client/my-plan/my-plan-body.jsx:738
...
__( "Solutions", "jetpack" ), // _inc/client/plans/product-selector.jsx:75
__( "Looking for specific features? We've got you covered.", "jetpack" ), // _inc/client/plans/product-selector.jsx:77
__( "Which backup option is best for me?", "jetpack" ), // _inc/client/plans/product-selector.jsx:88
...
__( "Theme enhancements", "jetpack" ), // _inc/client/writing/theme-enhancements.jsx:124
__( "Loads the next posts automatically when the reader approaches the bottom of the page.", "jetpack" ), // _inc/client/writing/theme-enhancements.jsx:136
__( "Create a smooth, uninterrupted reading experience by loading more content as visitors scroll to the bottom of your archive pages.", "jetpack" ), // _inc/client/writing/theme-enhancements.jsx:144
__( "Load more posts using the default theme behavior", "jetpack" ), // _inc/client/writing/theme-enhancements.jsx:152
__( "Load more posts in page with a button", "jetpack" ), // _inc/client/writing/theme-enhancements.jsx:156
__( "Load more posts as the reader scrolls down", "jetpack" ), // _inc/client/writing/theme-enhancements.jsx:160
__( "Theme support required.", "jetpack" ), // _inc/client/writing/theme-enhancements.jsx:177
__( "Learn more about adding support for Infinite Scroll to your theme.", "jetpack" ), // _inc/client/writing/theme-enhancements.jsx:181
__( "Learn more", "jetpack" ), // _inc/client/writing/theme-enhancements.jsx:185
__( "Enhance CSS customization panel", "jetpack" ), // _inc/client/writing/theme-enhancements.jsx:207
...
__( "Jetpack is currently powering features on your site. Once you disconnect Jetpack, these features will no longer be available and your site may no longer function the same way.", "jetpack" ), // _inc/client/components/jetpack-termination-dialog/features.jsx:98
__( "Jetpack is currently powering features on your site. Once you disable Jetpack, these features will no longer be available and your site may no longer function the same way.", "jetpack" ), // _inc/client/components/jetpack-termination-dialog/features.jsx:101
__( " We’ve highlighted some of the features you rely on below.", "jetpack" ), // _inc/client/components/jetpack-termination-dialog/features.jsx:105
__( "Jetpack has many powerful tools that can help you achieve your goals", "jetpack" ), // _inc/client/components/jetpack-termination-dialog/features.jsx:127
__( "Have a question? We’d love to help! {{a}}Send a question to the Jetpack support team.{{/a}}", "jetpack" ), // _inc/client/components/jetpack-termination-dialog/features.jsx:138
...
_x( "Saving…", "Button caption", "jetpack" ), // _inc/client/components/settings-card/index.jsx:329
_x( "Save settings", "Button caption", "jetpack" ), // _inc/client/components/settings-card/index.jsx:330
...
__( "Select a backup option:", "jetpack" ), // _inc/client/plans/single-product-backup/body.jsx:51
__( "Daily Backups", "jetpack" ), // _inc/client/plans/single-product-backup/index.jsx:27
__( "Real-Time Backups", "jetpack" ), // _inc/client/plans/single-product-backup/index.jsx:36
...
__( "Upgrade to %(name)s for {{price/}} %(billingTimeFrame)s", "jetpack" ), // _inc/client/plans/single-product-components/upgrade-button.jsx:31
__( "Up to 100 records", "jetpack" ), // _inc/client/plans/single-product-search/index.jsx:29
__( "Up to 1,000 records", "jetpack" ), // _inc/client/plans/single-product-search/index.jsx:31
__( "Up to 10,000 records", "jetpack" ), // _inc/client/plans/single-product-search/index.jsx:33
__( "Up to 100,000 records", "jetpack" ), // _inc/client/plans/single-product-search/index.jsx:35
__( "Up to 1,000,000 records", "jetpack" ), // _inc/client/plans/single-product-search/index.jsx:37
__( "Up to %(tierMaximumRecords)s records", "jetpack" ), // _inc/client/plans/single-product-search/index.jsx:40
__( "Learn More", "jetpack" ), // _inc/client/plans/single-product-search/index.jsx:71
__( "Eligible Tier: ", "jetpack" ), // _inc/client/plans/single-product-search/index.jsx:75
_n( "Your current site record size: %s record", "Your current site record size: %s records", 1, "jetpack" ), // _inc/client/plans/single-product-search/index.jsx:81
__( "Upgrade to Jetpack Search", "jetpack" ), // _inc/client/plans/single-product-search/index.jsx:117
