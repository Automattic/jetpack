...
_x( "Sharing", "Navigation item.", "jetpack" ), // _inc/client/admin.js:80
_x( "Writing", "Navigation item.", "jetpack" ), // _inc/client/admin.js:79
_x( "Traffic", "Navigation item.", "jetpack" ), // _inc/client/admin.js:78
_x( "Security", "Navigation item.", "jetpack" ), // _inc/client/admin.js:77
_x( "Discussion", "Navigation item.", "jetpack" ), // _inc/client/admin.js:76
_x( "Settings", "Navigation item.", "jetpack" ), // _inc/client/admin.js:75
...
_x( "Spam comments blocked.", "Example: \"412 Spam comments blocked\"", "jetpack" ), // _inc/client/at-a-glance/akismet.jsx:114
__( "Whoops! Your Akismet key is missing or invalid. {{akismetSettings}}Go to Akismet settings to fix{{/akismetSettings}}.", "jetpack" ), // _inc/client/at-a-glance/akismet.jsx:93
__( "Invalid key", "jetpack" ), // _inc/client/at-a-glance/akismet.jsx:88
__( "For state-of-the-art spam defense, please {{a}}activate Akismet{{/a}}.", "jetpack" ), // _inc/client/at-a-glance/akismet.jsx:70
__( "For state-of-the-art spam defense, please {{a}}install Akismet{{/a}}.", "jetpack" ), // _inc/client/at-a-glance/akismet.jsx:48
__( "Loading…", "jetpack" ), // _inc/client/at-a-glance/akismet.jsx:31
__( "Spam Protection", "jetpack" ), // _inc/client/at-a-glance/akismet.jsx:20
__( "Unavailable in Dev Mode.", "jetpack" ), // _inc/client/at-a-glance/backups.jsx:88
__( "To automatically back up your entire site, please {{a}}upgrade your account{{/a}}.", "jetpack" ), // _inc/client/at-a-glance/backups.jsx:71
__( "To automatically back up your entire site, please {{a}}install and activate{{/a}} VaultPress.", "jetpack" ), // _inc/client/at-a-glance/backups.jsx:62
__( "{{a}}View backup details{{/a}}.", "jetpack" ), // _inc/client/at-a-glance/backups.jsx:48
__( "Loading…", "jetpack" ), // _inc/client/at-a-glance/backups.jsx:30
__( "Backups", "jetpack" ), // _inc/client/at-a-glance/backups.jsx:20
...
__( "Performance", "jetpack" ), // _inc/client/at-a-glance/index.jsx:105
__( "Connections", "jetpack" ), // _inc/client/at-a-glance/index.jsx:61
__( "Manage security on WordPress.com", "jetpack" ), // _inc/client/at-a-glance/index.jsx:51
__( "Security", "jetpack" ), // _inc/client/at-a-glance/index.jsx:46
__( "{{a}}Activate Monitor{{/a}} to receive notifications if your site goes down.", "jetpack" ), // _inc/client/at-a-glance/monitor.jsx:53
__( "Unavailable in Dev Mode.", "jetpack" ), // _inc/client/at-a-glance/monitor.jsx:52
__( "Jetpack is monitoring your site. If we think your site is down, you will receive an email.", "jetpack" ), // _inc/client/at-a-glance/monitor.jsx:39
__( "Downtime Monitoring", "jetpack" ), // _inc/client/at-a-glance/monitor.jsx:19
__( "{{a}}Activate{{/a}} to enhance the performance and speed of your images.", "jetpack" ), // _inc/client/at-a-glance/photon.jsx:40
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/at-a-glance/photon.jsx:39
__( "Jetpack is improving and optimizing your image speed.", "jetpack" ), // _inc/client/at-a-glance/photon.jsx:27
__( "Image Performance", "jetpack" ), // _inc/client/at-a-glance/photon.jsx:18
__( "All plugins are up-to-date. Awesome work!", "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:85
__( "{{a}}Turn on plugin auto updates{{/a}}", "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:71
_n( "Needs updating. ", "Need updating. ", 1, "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:61
_n( "%(number)s plugin", "%(number)s plugins", 1, "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:51
__( "Loading…", "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:37
__( "Plugin Updates", "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:26
__( "{{a}}Activate Protect{{/a}} to keep your site protected from malicious sign in attempts.", "jetpack" ), // _inc/client/at-a-glance/protect.jsx:60
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/at-a-glance/protect.jsx:59
__( "Total malicious attacks blocked on your site.", "jetpack" ), // _inc/client/at-a-glance/protect.jsx:47
__( "Jetpack is actively blocking malicious login attempts. Data will display here soon!", "jetpack" ), // _inc/client/at-a-glance/protect.jsx:35
__( "Unavailable in Dev Mode.", "jetpack" ), // _inc/client/at-a-glance/scan.jsx:127
__( "For automated, comprehensive scanning of security threats, please {{a}}upgrade your account{{/a}}.", "jetpack" ), // _inc/client/at-a-glance/scan.jsx:110
__( "For automated, comprehensive scanning of security threats, please {{a}}install and activate{{/a}} VaultPress.", "jetpack" ), // _inc/client/at-a-glance/scan.jsx:101
__( "Loading…", "jetpack" ), // _inc/client/at-a-glance/scan.jsx:96
__( "No threats found, you're good to go!", "jetpack" ), // _inc/client/at-a-glance/scan.jsx:86
__( "{{a}}Contact Support{{/a}}", "jetpack" ), // _inc/client/at-a-glance/scan.jsx:71
__( "{{a}}View details at VaultPress.com{{/a}}", "jetpack" ), // _inc/client/at-a-glance/scan.jsx:69
...
__( "The Jetpack Premium plan now offers you the ability to generate income from your site by showing high-quality paid ads to your visitors. Professional plan customers also benefit from SEO tools to help optimize search engine traffic.", "jetpack" ), // _inc/client/plans/plan-body.jsx:387
__( "Premium traffic and monetization tools", "jetpack" ), // _inc/client/plans/plan-body.jsx:386
__( "Bulletproof spam filtering protects your brand, your readers, and improves SEO. Malware scanning helps maintain peace of mind and keeps your backend safe from intruders.", "jetpack" ), // _inc/client/plans/plan-body.jsx:383
__( "Real-time backup with unlimited space, one-click restores, bulletproof spam monitoring, malware defense, and brute-force login protection - all in one place and optimized for WordPress.", "jetpack" ), // _inc/client/plans/plan-body.jsx:382
__( "Maximum grade security", "jetpack" ), // _inc/client/plans/plan-body.jsx:381
__( "Explore Jetpack Professional", "jetpack" ), // _inc/client/plans/plan-body.jsx:366
__( "Google Analytics integration", "jetpack" ), // _inc/client/plans/plan-body.jsx:363
__( "Unlimited ad-free video hosting", "jetpack" ), // _inc/client/plans/plan-body.jsx:362
__( "SEO and social media previewing tools", "jetpack" ), // _inc/client/plans/plan-body.jsx:361
__( "Business class security: real-time backups and threat resolution", "jetpack" ), // _inc/client/plans/plan-body.jsx:360
__( "Over 200 Premium themes to explore", "jetpack" ), // _inc/client/plans/plan-body.jsx:359
__( "Jetpack Professional is the tool used by WordPress professionals. On top of the services you already enjoy, you also benefit from:", "jetpack" ), // _inc/client/plans/plan-body.jsx:358
__( "Explore Jetpack Professional", "jetpack" ), // _inc/client/plans/plan-body.jsx:357
__( "Compare Plans", "jetpack" ), // _inc/client/plans/plan-body.jsx:347
__( "Google Analytics integration", "jetpack" ), // _inc/client/plans/plan-body.jsx:344
__( "Income generation from a WordPress ad program", "jetpack" ), // _inc/client/plans/plan-body.jsx:343
__( "SEO and social media previewing tools", "jetpack" ), // _inc/client/plans/plan-body.jsx:342
__( "Unlimited and ad-free video hosting", "jetpack" ), // _inc/client/plans/plan-body.jsx:341
__( "Social media automation and scheduling", "jetpack" ), // _inc/client/plans/plan-body.jsx:340
__( "Business class security: malware scanning, real-time backups, and threat resolution", "jetpack" ), // _inc/client/plans/plan-body.jsx:339
__( "Over 200 Premium themes to explore", "jetpack" ), // _inc/client/plans/plan-body.jsx:338
__( "Learn about Jetpack services used by WordPress professionals. On top of the security essentials you currently enjoy, Jetpack offers you:", "jetpack" ), // _inc/client/plans/plan-body.jsx:337
__( "Explore Premium and Professional Options", "jetpack" ), // _inc/client/plans/plan-body.jsx:336
__( "Activate Google Analytics", "jetpack" ), // _inc/client/plans/plan-body.jsx:325
__( "Configure Google Analytics", "jetpack" ), // _inc/client/plans/plan-body.jsx:316
__( "Track website statistics with Google Analytics for a deeper understanding of your website visitors and customers.", "jetpack" ), // _inc/client/plans/plan-body.jsx:312
__( "Google Analytics", "jetpack" ), // _inc/client/plans/plan-body.jsx:311
__( "Activate SEO Tools", "jetpack" ), // _inc/client/plans/plan-body.jsx:300
__( "Configure Site SEO", "jetpack" ), // _inc/client/plans/plan-body.jsx:291
__( "Advanced SEO tools to help your site get found when people search for relevant content.", "jetpack" ), // _inc/client/plans/plan-body.jsx:287
__( "SEO Tools", "jetpack" ), // _inc/client/plans/plan-body.jsx:286
__( "Activate VideoPress", "jetpack" ), // _inc/client/plans/plan-body.jsx:275
__( "Upload Videos Now", "jetpack" ), // _inc/client/plans/plan-body.jsx:266
__( "Fast, optimized, ad-free, and unlimited video hosting for your site (powered by VideoPress).", "jetpack" ), // _inc/client/plans/plan-body.jsx:262
__( "Video Hosting", "jetpack" ), // _inc/client/plans/plan-body.jsx:261
__( "Activate VideoPress", "jetpack" ), // _inc/client/plans/plan-body.jsx:250
__( "Upload Videos Now", "jetpack" ), // _inc/client/plans/plan-body.jsx:241
__( "13Gb of fast, optimized, and ad-free video hosting for your site (powered by VideoPress).", "jetpack" ), // _inc/client/plans/plan-body.jsx:237
__( "Video Hosting", "jetpack" ), // _inc/client/plans/plan-body.jsx:236
__( "Activate Publicize", "jetpack" ), // _inc/client/plans/plan-body.jsx:225
__( "Schedule Posts", "jetpack" ), // _inc/client/plans/plan-body.jsx:216
__( "Schedule multiple Facebook, Twitter, and other social media postings in advance and view share history stats.", "jetpack" ), // _inc/client/plans/plan-body.jsx:211
__( "Social Media Scheduling", "jetpack" ), // _inc/client/plans/plan-body.jsx:210
__( "Activate Ads", "jetpack" ), // _inc/client/plans/plan-body.jsx:199
__( "View your earnings", "jetpack" ), // _inc/client/plans/plan-body.jsx:190
__( "Earn income by allowing Jetpack to display high quality ads (powered by WordAds).", "jetpack" ), // _inc/client/plans/plan-body.jsx:186
__( "Ads", "jetpack" ), // _inc/client/plans/plan-body.jsx:185
__( "Configure VaultPress", "jetpack" ), // _inc/client/plans/plan-body.jsx:174
__( "View your security dashboard", "jetpack" ), // _inc/client/plans/plan-body.jsx:169
__( "Real-time backup of all your site data with unlimited space, one-click restores, automated security scanning, one-click threat resolution, and priority support (powered by VaultPress).", "jetpack" ), // _inc/client/plans/plan-body.jsx:165
__( "Backups & Security Scanning", "jetpack" ), // _inc/client/plans/plan-body.jsx:164
__( "Configure VaultPress", "jetpack" ), // _inc/client/plans/plan-body.jsx:153
__( "View your security dashboard", "jetpack" ), // _inc/client/plans/plan-body.jsx:148
__( "Daily backup of all your site data with unlimited space, one-click restores, automated security scanning, and priority support (powered by VaultPress).", "jetpack" ), // _inc/client/plans/plan-body.jsx:144
__( "Backups & Security Scanning", "jetpack" ), // _inc/client/plans/plan-body.jsx:143
__( "Configure VaultPress", "jetpack" ), // _inc/client/plans/plan-body.jsx:132
__( "View your security dashboard", "jetpack" ), // _inc/client/plans/plan-body.jsx:127
__( "Daily backup of all your site data with unlimited space and one-click restores (powered by VaultPress).", "jetpack" ), // _inc/client/plans/plan-body.jsx:123
__( "Backups", "jetpack" ), // _inc/client/plans/plan-body.jsx:122
__( "Configure Akismet", "jetpack" ), // _inc/client/plans/plan-body.jsx:113
__( "View your spam stats", "jetpack" ), // _inc/client/plans/plan-body.jsx:108
__( "State-of-the-art spam defense powered by Akismet.", "jetpack" ), // _inc/client/plans/plan-body.jsx:104
__( "Spam Protection", "jetpack" ), // _inc/client/plans/plan-body.jsx:103
__( "Explore", "jetpack" ), // _inc/client/plans/plan-body.jsx:97
__( "Exclusive hand-crafted designs you will love with dedicated support directly from the themes' authors.", "jetpack" ), // _inc/client/plans/plan-body.jsx:92
__( "Unlimited Premium Themes", "jetpack" ), // _inc/client/plans/plan-body.jsx:91
...
__( "By connecting your site you agree to our fascinating {{tosLink}}Terms of Service{{/tosLink}} and to {{shareDetailsLink}}share details{{/shareDetailsLink}} with WordPress.com", "jetpack" ), // _inc/client/components/connect-button/index.jsx:142
__( "Connect Jetpack", "jetpack" ), // _inc/client/components/connect-button/index.jsx:128
...
_x( "Paid", "Short label appearing near a paid feature configuration block.", "jetpack" ), // _inc/client/components/dash-item/index.jsx:109
__( "Settings", "jetpack" ), // _inc/client/components/dash-item/index.jsx:95
...
__( "Upgrade", "jetpack" ), // _inc/client/components/support-card/index.jsx:120
__( "Get a faster resolution to your support questions.", "jetpack" ), // _inc/client/components/support-card/index.jsx:118
__( "Search our support site", "jetpack" ), // _inc/client/components/support-card/index.jsx:110
__( "Ask a question", "jetpack" ), // _inc/client/components/support-card/index.jsx:101
__( "Your paid plan gives you access to prioritized Jetpack support.", "jetpack" ), // _inc/client/components/support-card/index.jsx:90
__( "Jetpack comes with free, basic support for all users.", "jetpack" ), // _inc/client/components/support-card/index.jsx:89
__( "We're here to help", "jetpack" ), // _inc/client/components/support-card/index.jsx:84
...
__( "Jetpack keeps you safe, too: you’re protected from spam in comments and contact forms, and our brute force login protection prevents hackers from accessing your data. And if something does go wrong, you can restore a backup of your site in a single click.", "jetpack" ), // _inc/client/components/welcome-new-plan/personal.jsx:47
__( "Security", "jetpack" ), // _inc/client/components/welcome-new-plan/personal.jsx:45
__( "Using Jetpack’s powerful Publicize feature and built-in sharing tools, you’ll find new ways to grow your following and increase traffic. Automatically share your newest posts on social media, or allow followers to subscribe via email for your latest content right in their inbox.", "jetpack" ), // _inc/client/components/welcome-new-plan/personal.jsx:40
__( "Sharing", "jetpack" ), // _inc/client/components/welcome-new-plan/personal.jsx:38
__( "With Jetpack Personal, you have access to more than 100 free, professionally-designed WordPress themes. Choose the theme that best fits your site and customize colors, images, or add a variety of new widgets.", "jetpack" ), // _inc/client/components/welcome-new-plan/personal.jsx:33
__( "Themes", "jetpack" ), // _inc/client/components/welcome-new-plan/personal.jsx:31
__( "Thanks for choosing a Jetpack Personal plan. Jetpack is now backing up your site and scanning for security threats.", "jetpack" ), // _inc/client/components/welcome-new-plan/personal.jsx:27
__( "Your Premium Jetpack plan is powering up!", "jetpack" ), // _inc/client/components/welcome-new-plan/premium.jsx:102
__( "Welcome Premium", "jetpack" ), // _inc/client/components/welcome-new-plan/premium.jsx:101
__( "Monetize your site with ads", "jetpack" ), // _inc/client/components/welcome-new-plan/premium.jsx:92
__( "Enable premium video player", "jetpack" ), // _inc/client/components/welcome-new-plan/premium.jsx:84
__( "Start exploring Jetpack Premium now to see all the benefits of your new plan.", "jetpack" ), // _inc/client/components/welcome-new-plan/premium.jsx:69
__( "Keeping your hard work safe is important, too. Jetpack Premium gives you brute force login protection, automated spam filtering, and malware scanning. You also get daily backups  with hassle-free restores, just in case you need them.", "jetpack" ), // _inc/client/components/welcome-new-plan/premium.jsx:63
__( "Security", "jetpack" ), // _inc/client/components/welcome-new-plan/premium.jsx:61
__( "Using Jetpack’s powerful sharing tools, you can automatically share your newest posts on social media, or schedule your content to be re-shared at any date or time you choose. And along with growing your following, you can grow your business with tools like payment buttons and ads.", "jetpack" ), // _inc/client/components/welcome-new-plan/premium.jsx:56
__( "Sharing", "jetpack" ), // _inc/client/components/welcome-new-plan/premium.jsx:54
__( "With Jetpack Premium, you can create the perfect site, no matter its purpose. Customize your site’s appearance with one of more than 200 free themes, or enhance your content with up to 13 GB of HD video -- all hosted free of ads or watermarks.", "jetpack" ), // _inc/client/components/welcome-new-plan/premium.jsx:49
__( "Themes", "jetpack" ), // _inc/client/components/welcome-new-plan/premium.jsx:47
__( "Thanks for choosing a Jetpack Premium plan. Jetpack is now backing up your site, scanning for security threats, and enabling monetization features.", "jetpack" ), // _inc/client/components/welcome-new-plan/premium.jsx:43
__( "Your Professional Jetpack plan is taking care of business!", "jetpack" ), // _inc/client/components/welcome-new-plan/professional.jsx:112
__( "Welcome Professional", "jetpack" ), // _inc/client/components/welcome-new-plan/professional.jsx:111
__( "Review SEO features", "jetpack" ), // _inc/client/components/welcome-new-plan/professional.jsx:102
__( "Monetize your site with ads", "jetpack" ), // _inc/client/components/welcome-new-plan/professional.jsx:94
__( "Install premium themes", "jetpack" ), // _inc/client/components/welcome-new-plan/professional.jsx:86
__( "Start exploring Jetpack Professional now to see all the benefits of your new plan.", "jetpack" ), // _inc/client/components/welcome-new-plan/professional.jsx:71
...
__( "Security", "jetpack" ), // _inc/client/components/welcome-new-plan/professional.jsx:63
...
__( "Sharing", "jetpack" ), // _inc/client/components/welcome-new-plan/professional.jsx:56
