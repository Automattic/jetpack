...
$jetpack_strings = array(__('Google+ will shut down in April 2019. You can keep posting with your existing Google+ connection through March.','jetpack'),
...
__('Default Checked State','jetpack'),
__('ID','jetpack'),
...
__('Radio','jetpack'),
__('Inpsired by radios, only one radio item can be selected at a time. Add several radio button items.','jetpack'),
__('Select','jetpack'),
__('Option','jetpack'),
__('Choose','jetpack'),
__('Dropdown','jetpack'),
...
__('Submit','jetpack'),
__('Email Address','jetpack'),
__('Lets you add an email address with an automatically generated click-to-email link.','jetpack'),
