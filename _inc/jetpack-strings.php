...
__( "Compare Plans", "jetpack" ), // _inc/client/plans/plan-body.jsx:405
__( "We support all Jetpack users, regardless of plan. But customers on a paid subscription enjoy priority support so that security issues are identified and fixed for you as soon as possible. ", "jetpack" ), // _inc/client/plans/plan-body.jsx:398
__( "Enjoy priority support", "jetpack" ), // _inc/client/plans/plan-body.jsx:397
__( "The Jetpack Premium plan now offers you the ability to generate income from your site by showing high-quality paid ads to your visitors. Professional plan customers also benefit from SEO tools to help optimize search engine traffic.", "jetpack" ), // _inc/client/plans/plan-body.jsx:393
__( "Premium traffic and monetization tools", "jetpack" ), // _inc/client/plans/plan-body.jsx:392
__( "Bulletproof spam filtering protects your brand, your readers, and improves SEO. Malware scanning helps maintain peace of mind and keeps your backend safe from intruders.", "jetpack" ), // _inc/client/plans/plan-body.jsx:389
__( "Real-time backup with unlimited space, one-click restores, bulletproof spam monitoring, malware defense, and brute-force login protection - all in one place and optimized for WordPress.", "jetpack" ), // _inc/client/plans/plan-body.jsx:388
__( "Maximum grade security", "jetpack" ), // _inc/client/plans/plan-body.jsx:387
__( "Explore Jetpack Professional", "jetpack" ), // _inc/client/plans/plan-body.jsx:372
__( "Business class security: real-time backups and threat resolution", "jetpack" ), // _inc/client/plans/plan-body.jsx:369
__( "Over 200 Premium themes to explore", "jetpack" ), // _inc/client/plans/plan-body.jsx:368
__( "Jetpack Professional is the tool used by WordPress professionals. On top of the services you already enjoy, you also benefit from:", "jetpack" ), // _inc/client/plans/plan-body.jsx:367
__( "Explore Jetpack Professional", "jetpack" ), // _inc/client/plans/plan-body.jsx:366
__( "Compare Plans", "jetpack" ), // _inc/client/plans/plan-body.jsx:356
__( "Google Analytics integration", "jetpack" ), // _inc/client/plans/plan-body.jsx:353
__( "Income generation from a WordPress ad program", "jetpack" ), // _inc/client/plans/plan-body.jsx:352
__( "SEO and social media previewing tools", "jetpack" ), // _inc/client/plans/plan-body.jsx:351
__( "Unlimited and ad-free video hosting", "jetpack" ), // _inc/client/plans/plan-body.jsx:350
__( "Social media automation and scheduling", "jetpack" ), // _inc/client/plans/plan-body.jsx:349
__( "Business class security: malware scanning, real-time backups, and threat resolution", "jetpack" ), // _inc/client/plans/plan-body.jsx:348
__( "Over 200 Premium themes to explore", "jetpack" ), // _inc/client/plans/plan-body.jsx:347
__( "Learn about Jetpack services used by WordPress professionals. On top of the security essentials you currently enjoy, Jetpack offers you:", "jetpack" ), // _inc/client/plans/plan-body.jsx:346
__( "Explore Premium and Professional Options", "jetpack" ), // _inc/client/plans/plan-body.jsx:345
...
__( "Activate VideoPress", "jetpack" ), // _inc/client/plans/plan-body.jsx:284
__( "Upload Videos Now", "jetpack" ), // _inc/client/plans/plan-body.jsx:275
__( "Fast, optimized, ad-free, and unlimited video hosting for your site (powered by VideoPress).", "jetpack" ), // _inc/client/plans/plan-body.jsx:271
...
__( "Explore", "jetpack" ), // _inc/client/plans/plan-body.jsx:157
__( "Exclusive hand-crafted designs you will love with dedicated support directly from the themes' authors.", "jetpack" ), // _inc/client/plans/plan-body.jsx:152
...
__( "Configure your Security Scans", "jetpack" ), // _inc/client/security/backups-scan.jsx:180
_x( "Backups and security scanning", "Settings header", "jetpack" ), // _inc/client/security/backups-scan.jsx:167
...
__( "To configure search filters add the {{link}}Jetpack Search widget to your sidebar{{/link}}.", "jetpack" ), // _inc/client/traffic/search.jsx:42
__( "Replace WordPress built-in search with an improved search experience", "jetpack" ), // _inc/client/traffic/search.jsx:37
...
__( "Media", "jetpack" ), // _inc/client/writing/media.jsx:136
__( "Color scheme", "jetpack" ), // _inc/client/writing/media.jsx:99
__( "Show photo metadata (Exif) in carousel, when available", "jetpack" ), // _inc/client/writing/media.jsx:93
__( "Connect your user account to WordPress.com to use this feature", "jetpack" ), // _inc/client/writing/post-by-email.jsx:111
__( "Create address", "jetpack" ), // _inc/client/writing/post-by-email.jsx:98
__( "Regenerate address", "jetpack" ), // _inc/client/writing/post-by-email.jsx:97
...
__( "Features can be activated or deactivated at any time.", "jetpack" ), // _inc/client/components/jumpstart/index.jsx:94
__( "Jetpack's recommended features include:", "jetpack" ), // _inc/client/components/jumpstart/index.jsx:84
__( "We're now collecting stats, securing your site, and speeding up your images. Pretty soon you'll be able to see everything going on with your site right through Jetpack! Welcome aboard.", "jetpack" ), // _inc/client/components/jumpstart/index.jsx:74
__( "Your Jetpack site is ready to go!", "jetpack" ), // _inc/client/components/jumpstart/index.jsx:69
__( "Person with laptop", "jetpack" ), // _inc/client/components/jumpstart/index.jsx:66
__( "Jupiter", "jetpack" ), // _inc/client/components/jumpstart/index.jsx:56
__( "Stars", "jetpack" ), // _inc/client/components/jumpstart/index.jsx:55
...
__( "Major new features from Jetpack", "jetpack" ), // _inc/client/components/upgrade-notice-content/index.jsx:72
__( "Jetpack Search", "jetpack" ), // _inc/client/components/upgrade-notice-content/index.jsx:71
__( "Compare paid plans", "jetpack" ), // _inc/client/components/upgrade-notice-content/index.jsx:61
__( "Read the full announcement!", "jetpack" ), // _inc/client/components/upgrade-notice-content/index.jsx:57
__( "Our Elasticsearch-powered search service is now out of beta and availalbe to all Professional plan customers. This replaces default WordPress search with a faster engine that returns more relevant search results to your users.", "jetpack" ), // _inc/client/components/upgrade-notice-content/index.jsx:47
__( "Elasticsearch", "jetpack" ), // _inc/client/components/upgrade-notice-content/index.jsx:44
__( "Fast and relevant search results", "jetpack" ), // _inc/client/components/upgrade-notice-content/index.jsx:41
__( "We have also upgraded all our Premium plan customers to unlimited high-speed video storage (up from 13Gb) and significantly reduced the assets (CSS and JavaScript) that Jetpack downloads when using features like infinite scroll and embedding rich content with shortcodes.", "jetpack" ), // _inc/client/components/upgrade-notice-content/index.jsx:35
__( "Sites that have large numbers of images can turn on Lazy Loading Images which significantly speeds up the site loading times for the end user. Instead of waiting for the entire site to load Jetpack will instead show the site instantly and only download additional images when scrolling.", "jetpack" ), // _inc/client/components/upgrade-notice-content/index.jsx:29
__( "Speed up your site and its content", "jetpack" ), // _inc/client/components/upgrade-notice-content/index.jsx:25
__( "This release of Jetpack brings major new features and big improvements to your WordPress site.", "jetpack" ), // _inc/client/components/upgrade-notice-content/index.jsx:21
