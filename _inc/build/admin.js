...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stateReduxStore = __webpack_require__(175);
	
	var _stateReduxStore2 = _interopRequireDefault(_stateReduxStore);
	
	var _componentsNavigation = __webpack_require__(179);
	
	var _componentsNavigation2 = _interopRequireDefault(_componentsNavigation);
	
	var _componentsMasthead = __webpack_require__(199);
	
	var _componentsMasthead2 = _interopRequireDefault(_componentsMasthead);
	
	_reactDom2['default'].render(_react2['default'].createElement(
		'div',
		null,
		_react2['default'].createElement(_componentsMasthead2['default'], null),
		_react2['default'].createElement(
			'div',
			{ className: 'jp-lower' },
			_react2['default'].createElement(
				_reactRedux.Provider,
				{ store: _stateReduxStore2['default'] },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stateReducer = __webpack_require__(177);
	
	var _stateReducer2 = _interopRequireDefault(_stateReducer);
	
	exports['default'] = createJetpackStore();
	
	function createJetpackStore() {
		var finalCreateStore = (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2['default']), typeof window === 'object' && typeof window.devToolsExtension !== 'undefined' ? window.devToolsExtension() : function (f) {
			return f;
		})(_redux.createStore);
		return finalCreateStore(_stateReducer2['default']);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = __webpack_require__(178);
	
	var genericReducer = function genericReducer(state, action) {
	...
	module.exports = {
		...
		modules: {
			installed: [{
				...
				module_slug: '',
				module_name: 'Site Stats',
				description: 'Collect traffic stats and insights.',
				long_description: '',
				requires_connection: true,
				free: true,
				activated: true
			}, {
				module_slug: 'sharedaddy',
				module_name: 'Sharing',
				...
				module_slug: 'related-posts',
				module_name: 'Related Posts',
				...
				module_slug: '',
				module_name: 'Enhanced Distribution',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _atAGlance = __webpack_require__(180);
	
	var _engagement = __webpack_require__(190);
	
	var _security = __webpack_require__(192);
	
	var _generalSettings = __webpack_require__(194);
	
	var React = __webpack_require__(142),
	    Tabs = __webpack_require__(196),
	    Card = __webpack_require__(182);
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						Tabs.Panel,
						{ title: 'At a Glance' },
						React.createElement(_atAGlance.Page, null)
					),
					React.createElement(
						Tabs.Panel,
						{ title: 'Engagement' },
						React.createElement(_engagement.Page, null)
					),
					React.createElement(
						Tabs.Panel,
						{ title: 'Security' },
						React.createElement(_security.Page, null)
					),
					React.createElement(
						Tabs.Panel,
						{ title: 'Site Health' },
					...
					React.createElement(
						...
						React.createElement(_generalSettings.Page, null)
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Page = __webpack_require__(181);
	
	_defaults(exports, _interopExportWildcard(_Page, _defaults));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsCard = __webpack_require__(182);
	...
	var Page = function Page(props) {
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(
				_componentsCard2['default'],
				null,
				'Hello There! Your site stats have been activated.',
			...
			_react2['default'].createElement(
				...
				_react2['default'].createElement(
					'p',
					null,
					'To automatically scan your site for malicious files, please ',
					_react2['default'].createElement(
						'a',
						{ href: '' },
			...
			_react2['default'].createElement(
				...
				_react2['default'].createElement(
					...
					' to receive email notifications if your site goes down.'
				)
			),
			_react2['default'].createElement(
				'h1',
			...
			_react2['default'].createElement(
				...
				_react2['default'].createElement(
					...
					' ',
					'to automaticallly block spam comments. It\'s free!.'
				)
			),
			_react2['default'].createElement(
				_componentsCard2['default'],
			...
			_react2['default'].createElement(
				...
				_react2['default'].createElement(
					'p',
					null,
					'Photon is active and enhancing image performance automaticallye, behind the scenes. ',
					_react2['default'].createElement(
						'a',
						{ href: '' },
						' Learn more'
			...
			_react2['default'].createElement(
				...
				_react2['default'].createElement(
					...
					_react2['default'].createElement(
						'a',
						{ href: '' },
						'Activate Site Verification'
					),
					' to verify your site and increase ranking with Google, Bing, and Pinterest.'
				)
			),
			_react2['default'].createElement(
				_componentsCard2['default'],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CardSection = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				{ className: classnames('dops-card-section', this.props.className), style: this.props.style },
				this.props.title ? this._renderWithTitle() : this.props.children
			);
		},
	
		_renderWithTitle: function _renderWithTitle() {
	...
	var Card = React.createClass({
		...
		render: function render() {
			...
			var iconLabel = _props.iconLabel;
	
			var other = _objectWithoutProperties(_props, ['style', 'title', 'meta', 'icon', 'iconLabel']);
	
			return React.createElement(
				'div',
				_extends({}, other, { className: 'dops-card ' + this.props.className, style: this.props.style }),
				this.props.title && React.createElement(
					...
					(icon || iconLabel) && this._renderIcon()
				),
				this.props.children
			);
		},
		...
		_renderIcon: function _renderIcon() {
			return React.createElement(
				'span',
				{ className: 'dops-card-icon', style: { color: this.props.iconColor } },
				this.props.icon && React.createElement(Icon, { name: this.props.icon, style: { backgroundColor: this.props.iconColor } }),
		...
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(
				...
				_react2['default'].createElement(
					'p',
					null,
					'Manage how your statistics are displayed.'
				)
			),
			_react2['default'].createElement(
				_componentsCard2['default'],
				...
				_react2['default'].createElement(
					'p',
					null,
					'Display social sharing & a like button on your site.'
				)
			),
			_react2['default'].createElement(
				_componentsCard2['default'],
				...
				_react2['default'].createElement(
					'p',
					null,
					'Instantly share your content with search engines and more.'
				)
			),
			_react2['default'].createElement(
				_componentsCard2['default'],
				...
				_react2['default'].createElement(
					'p',
					null,
					'Display your related posts underneath each post.'
				)
			),
			_react2['default'].createElement(
				_componentsCard2['default'],
				...
				_react2['default'].createElement(
					'p',
					null,
					'Automatically share content on your social media accounts'
				)
			),
			_react2['default'].createElement(
				_componentsCard2['default'],
				...
				_react2['default'].createElement(
					'p',
					null,
					'Verify your site with Google, Bing, and more.'
				)
			),
			_react2['default'].createElement(
				_componentsCard2['default'],
			...
			_react2['default'].createElement(
				...
				_react2['default'].createElement(
					'p',
					null,
					'Allow users to comment with Facebook, Twitter, or WordPress.com'
				)
			),
			_react2['default'].createElement(
				_componentsCard2['default'],
				...
				_react2['default'].createElement(
					'p',
					null,
					'Receive notifications of activity on your site on your mobile device.'
				)
			)
		);
	};
		...
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(
				...
				_react2['default'].createElement(
					'h2',
					null,
					'Import Jetpack Feature Configuration'
				),
				_react2['default'].createElement(
					'p',
					null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabs = React.createClass({
		...
		handleSelectTab: function handleSelectTab(index, e) {
			e.preventDefault();
			this.selectTab(index);
		},
	
		handleMouseOverTab: function handleMouseOverTab(index) {
			this.setState({ hoverTab: index });
		},
	
		handleMouseOutTab: function handleMouseOutTab(index) {
			...
			return React.createElement(
				...
				React.Children.map(this.props.children, (function (child, index) {
					...
					return React.createElement(
						...
						React.createElement(
							'button',
							{ ref: ref, onClick: this.handleSelectTab.bind(this, index), onMouseOver: this.handleMouseOverTab.bind(this, index), onMouseOut: this.handleMouseOutTab.bind(this, index) },
							title
						)
					);
				}).bind(this))
	...
	var Masthead = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement('img', { src: State.imagePath + "/jetpack-logo.svg", alt: 'Jetpack by WordPress.com' }),
				React.createElement(
					'ul',
					null,
					React.createElement(
