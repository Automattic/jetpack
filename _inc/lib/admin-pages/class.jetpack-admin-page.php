...
abstract class Jetpack_Admin_Page {
	...
	function add_actions() {
		...
		if (
			...
			add_action( 'admin_enqueue_scripts', array( 'Jetpack_Connection_Banner', 'enqueue_button_scripts' ) );
			add_action( 'admin_enqueue_scripts', array( 'Jetpack_Connection_Banner', 'enqueue_button_styles' ) );
