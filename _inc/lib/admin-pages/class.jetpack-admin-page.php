...
abstract class Jetpack_Admin_Page {
	...
	function render_footer() {
		...
		$is_connected = Jetpack::is_active() || Jetpack::is_development_mode();
		$about_url = ( $is_connected )
			? admin_url( 'admin.php?page=jetpack_about' )
			: 'https://jetpack.com';

		$privacy_url = ( $is_connected )
			? $admin_url . '#/privacy'
		...
		<div class="jp-footer">
				...
				<ul class="jp-footer__links">
					...
					<?php } ?>
					<?php if ( current_user_can( 'manage_options' ) && $is_connected ) { ?>
						<li class="jp-footer__link-item">
