		...
		">
			...
			<div class="jp-footer">
				...
				<ul class="jp-footer__links">
					...
					<li class="jp-footer__link-item">
						<a href="<?php echo esc_url( admin_url() . 'admin.php?page=jetpack_about' ); ?>" title="<?php esc_attr__( 'About Jetpack', 'jetpack' ); ?>" class="jp-footer__link"><?php echo esc_html__( 'About', 'jetpack' ); ?></a>
					</li>
					<li class="jp-footer__link-item">
