 ...
 * @param \Jetpack_Jetpack_Tracks_Client $event The event object.
 * @return \Jetpack_Jetpack_Tracks_Client|\WP_Error
 */
...
function jetpack_tracks_build_event_obj( $user, $event_name, $properties = array(), $event_timestamp_millis = false ) {
	...
	return new Jetpack_Jetpack_Tracks_Client( array_merge( $blog_details, (array) $properties, $identity, array(
		'_en' => $event_name,
