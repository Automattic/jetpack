		...
		<div class="footer">
			...
			<nav class="primary nav-horizontal">
				<div class="a8c-attribution">
					<span>
						...
						'<a href="https://automattic.com/" class="a8c-logo" target="_blank">Automattic</a>'
						); ?>
					</span>
				</div>
			</nav><!-- .primary -->
			...
			<nav class="secondary nav-horizontal">
				<div class="secondary-footer">
					<a href="https://jetpack.com" target="_blank">Jetpack <?php echo JETPACK__VERSION; ?></a>
					<a href="https://en.wordpress.com/tos/" target="_blank"><?php esc_html_e( 'Terms', 'jetpack' ); ?></a>
					...
					<a href="https://jetpack.com/contact-support/" target="_blank" title="<?php esc_attr_e( 'Contact the Jetpack Happiness Squad.', 'jetpack' ); ?>"><?php _e( 'Support', 'jetpack' ); ?></a>
					<a href="https://jetpack.com/survey/?rel=<?php echo JETPACK__VERSION; ?>" target="_blank" title="<?php esc_attr_e( 'Take a survey.  Tell us how we&#8217;re doing.', 'jetpack' ); ?>"><?php _e( 'Give Us Feedback', 'jetpack' ); ?></a>
