...
/******/ 	return __webpack_require__(__webpack_require__.s = "./_inc/search/src/index.jsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./_inc/search/components/api.js":
/*!***************************************!*\
  !*** ./_inc/search/components/api.js ***!
  \***************************************/
...
var JetpackSearchAPI =
/*#__PURE__*/
function () {
  function JetpackSearchAPI() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, JetpackSearchAPI);
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(JetpackSearchAPI, [{
    key: "getAPIUrl",
    value: function getAPIUrl(query) {
      var url = 'https://public-api.wordpress.com/rest/v1.3/sites/20115252/search?q=';
    ...
    value: function fetch(query) {
      return Object(unfetch__WEBPACK_IMPORTED_MODULE_2__["default"])(this.getAPIUrl(query));
    }
  }]);

  return JetpackSearchAPI;
}();

/* harmony default export */ __webpack_exports__["default"] = (JetpackSearchAPI);

/***/ }),

/***/ "./_inc/search/components/search-result.jsx":
/*!**************************************************!*\
  !*** ./_inc/search/components/search-result.jsx ***!
  \**************************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(SearchResult, _Component);

  function SearchResult() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, SearchResult);

    return _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(SearchResult).apply(this, arguments));
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(SearchResult, [{
    key: "render",
    value: function render() {
      var result = this.props.result;
      return Object(preact__WEBPACK_IMPORTED_MODULE_5__["h"])("p", null, result.fields.author);
    }
  }]);
...
/***/ "./_inc/search/components/search-results.jsx":
/*!***************************************************!*\
  !*** ./_inc/search/components/search-results.jsx ***!
  \***************************************************/
/*! exports provided: default */
...
/* harmony import */ var _search_result__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./search-result */ "./_inc/search/components/search-result.jsx");
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(SearchResults, [{
    ...
    value: function render() {
      var _this$props = this.props,
          _this$props$results = _this$props.results,
          results = _this$props$results === void 0 ? [] : _this$props$results,
          query = _this$props.query;
      return Object(preact__WEBPACK_IMPORTED_MODULE_6__["h"])("div", null, Object(preact__WEBPACK_IMPORTED_MODULE_6__["h"])("p", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('You are searching for "%s"'), query), "."), results.map(function (result) {
        return Object(preact__WEBPACK_IMPORTED_MODULE_6__["h"])(_search_result__WEBPACK_IMPORTED_MODULE_7__["default"], {
          result: result
        });
      }));
    }
...
/***/ "./_inc/search/components/search-widget.jsx":
/*!**************************************************!*\
  !*** ./_inc/search/components/search-widget.jsx ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.mjs");
/* harmony import */ var preact_portal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! preact-portal */ "./node_modules/preact-portal/dist/preact-portal.js");
/* harmony import */ var preact_portal__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(preact_portal__WEBPACK_IMPORTED_MODULE_9__);
...
/* harmony import */ var _search_results__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./search-results */ "./_inc/search/components/search-results.jsx");
/* harmony import */ var _components_api__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../components/api */ "./_inc/search/components/api.js");
...
var api = new _components_api__WEBPACK_IMPORTED_MODULE_12__["default"]();

var SearchWidget =
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_6___default()(SearchWidget, _Component);

  function SearchWidget() {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, SearchWidget);

    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_4___default()(SearchWidget).apply(this, arguments));

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this), "bindInput", function (input) {
      return _this.input = input;
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this), "onChangeQuery", function (event) {
    ...
    _this.requestId = 0;
    _this.state = {
      query: _this.props.initialValue,
      results: []
    };
    _this.onChangeQuery = _this.onChangeQuery.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this));
    _this.getResults = lodash_debounce__WEBPACK_IMPORTED_MODULE_10___default()(_this.getResults.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this)), 500);

    _this.getResults(_this.props.initialValue);

    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(SearchWidget, [{
    ...
    value: function getResults(query) {
      ...
      if (query) {
        if (api) {
          ...
          api.fetch(query).then(function (response) {
            return response.json();
          }).then(function (json) {
            if (_this2.requestId === requestId) {
              _this2.setState({
                results: json
              });
            }
    ...
    value: function render() {
      ...
      return Object(preact__WEBPACK_IMPORTED_MODULE_8__["h"])("div", null, Object(preact__WEBPACK_IMPORTED_MODULE_8__["h"])("p", null, Object(preact__WEBPACK_IMPORTED_MODULE_8__["h"])("input", {
        type: "search",
        value: query,
        onInput: this.onChangeQuery,
        ref: this.bindInput
      })), Object(preact__WEBPACK_IMPORTED_MODULE_8__["h"])(preact_portal__WEBPACK_IMPORTED_MODULE_9___default.a, {
        into: "#results"
      }, Object(preact__WEBPACK_IMPORTED_MODULE_8__["h"])(_search_results__WEBPACK_IMPORTED_MODULE_11__["default"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
        query: query
      }, results))));
    }
  }]);
  ...
  return SearchWidget;
}(preact__WEBPACK_IMPORTED_MODULE_8__["Component"]);

/* harmony default export */ __webpack_exports__["default"] = (SearchWidget);

/***/ }),

/***/ "./_inc/search/src/index.jsx":
/*!***********************************!*\
  !*** ./_inc/search/src/index.jsx ***!
  \***********************************/
/*! no exports provided */
...
/* harmony import */ var _components_search_widget__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/search-widget */ "./_inc/search/components/search-widget.jsx");
/** @jsx h */
...
var injectSearchWidget = function injectSearchWidget(initialValue, target, grabFocus) {
  Object(preact__WEBPACK_IMPORTED_MODULE_0__["render"])(Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])(_components_search_widget__WEBPACK_IMPORTED_MODULE_1__["default"], {
...
/******/ })));
//# sourceMappingURL=jp-search.bundle.js.map